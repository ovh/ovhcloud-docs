...
<Tabs>
  <Tab label="Étape 1">
    ...
    <img className="thumbnail" alt="Vue de la ressource Managed Hosting for WordPress dans la liste des hébergements WordPress" src="/images/guides/web-cloud/managed-hosting/mainwp-site-management/managed-hosting-for-wordpress.png" loading="lazy" />
  </Tab>
  <Tab label="Étape 2">
    ...
    <img className="thumbnail" alt="Page Informations générales de la ressource avec le bouton Gérer mes sites en haut à droite" src="/images/guides/web-cloud/managed-hosting/mainwp-site-management/mainwp-access.png" loading="lazy" />
  </Tab>
  <Tab label="Étape 3">
