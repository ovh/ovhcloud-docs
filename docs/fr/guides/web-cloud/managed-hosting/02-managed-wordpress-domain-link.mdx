...
<summary>Commander un nouveau domaine</summary>
...
<Tabs>
  <Tab label="Étape 1">
    Dans le tunnel d'ajout, sélectionnez <code className="action">Commander un nouveau domaine</code>.

    {/* DRAFT: To screenshot — capturer le tunnel d'ajout à l'étape de sélection du parcours Commander un domaine */}
  </Tab>
  <Tab label="Étape 2">
    Saisissez le nom de domaine souhaité et cliquez sur <code className="action">Rechercher</code>. Les extensions disponibles et leurs tarifs s'affichent.
