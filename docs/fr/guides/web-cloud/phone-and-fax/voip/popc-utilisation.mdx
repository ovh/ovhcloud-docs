...
Les appels entrants apparaissent dans la zone `Entrant`. Pour répondre à un appel, deux méthodes sont possibles :

- faites un double clic sur l'appel qui apparaît en rouge ;
- faites un clic droit sur l'appel puis cliquez sur <code className="action">Répondre</code>.
