...
description: Statistiques sur la QoS des appels
...
[Bases de l'API](/guides/manage-and-operate/api/first-steps)
...
![](/images/guides/web-cloud/phone-and-fax/voip/statistiques-sur-la-qos-des-appels/img_2547.jpg)
...
```
<div class="container">
    <p ng-show="loading"><img src="/static/lightbox2/img/loading.gif" alt="loading.."/></p>
...
<div id="size" >
    ...
    <p ng-show="requestTime">fetched in {{requestTime}} seconds.</p>
</div>
```
...
![](/images/guides/web-cloud/phone-and-fax/voip/statistiques-sur-la-qos-des-appels/img_2546.jpg)
