...
Vous pouvez déplacer des lignes téléphoniques et numéros alias d'un groupe à un autre, pour répondre à plusieurs cas d'usage, telle qu'une facturation distincte entre entités au sein d'une entreprise.
