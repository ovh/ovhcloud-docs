...
Pour créer un token nous allons utiliser la console API (il est possible de créer un token directement en API sans passer par la console). Rendez-vous sur la page des <ApiLink>API</ApiLink> et utilisez le call API suivant :
