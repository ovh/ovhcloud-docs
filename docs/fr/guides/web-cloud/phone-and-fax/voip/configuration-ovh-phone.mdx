...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="etiquettes-touches" src="/images/web-cloud/phone-and-fax/voip/configuration-ovh-phone/etiquettesb.mp4" />
