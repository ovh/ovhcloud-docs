...
Nous recommandons de compiler Freeswitch sur votre machine directement. Vous obtiendrez plus d'informations via ce lien : **[https://freeswitch.org/confluence/display/FREESWITCH/Debian](https://freeswitch.org/confluence/display/FREESWITCH/Debian)**
