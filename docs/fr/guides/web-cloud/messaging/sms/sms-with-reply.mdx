...
- Disposer d'un [compte SMS OVHcloud](/links/telecom/sms) crédité.
...
Le service de réponse par SMS fonctionne simplement :
...
Dans l'espace client, cliquez sur l'onglet <code className="action">Message et campagne</code> de votre compte SMS et sélectionnez <code className="action">Gestion des SMS</code>. Cliquez ensuite sur <code className="action">SMS reçus</code>.
