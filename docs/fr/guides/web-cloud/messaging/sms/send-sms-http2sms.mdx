...
- Disposer d'un expéditeur SMS actif. Pour en savoir plus à ce sujet, vous pouvez consulter ce [guide](/guides/web-cloud/messaging/sms/send-sms-control-panel#etape-1-configurer-lexpediteur-et-le-destinataire)

## En pratique

Envoyez un SMS via une requête HTTPS avec ses champs obligatoires (et facultatifs, le cas échéant) à l'adresse suivante : [https://www.ovh.com/cgi-bin/sms/http2sms.cgi?](https://www.ovh.com/cgi-bin/sms/http2sms.cgi?).

<img className="thumbnail" alt="Formulaire d'envoi de SMS par URL http2sms" src="/images/web-cloud/messaging/sms/send-sms-http2sms/img_4011.jpg" loading="lazy" />
