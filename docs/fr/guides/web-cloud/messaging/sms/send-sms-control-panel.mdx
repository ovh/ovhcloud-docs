...
### Étape 1 : Configurer l’expéditeur et le destinataire <a name="configure-sender-recipient"></a>
...
### Étape 2 : Composer votre SMS <a name="compose-sms"></a>
...
#### Taille des SMS à caractère commercial <a name="commercial-sms-size"></a>
