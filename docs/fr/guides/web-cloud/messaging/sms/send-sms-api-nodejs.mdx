...
<CreateToken rights="GET=/sms&GET=/sms/*&GET=/sms/*/jobs&POST=/sms/*/jobs">page de création de token OVHcloud</CreateToken> (cette url vous permet d'avoir automatiquement les bons droits pour les étapes décrites dans ce guide).
