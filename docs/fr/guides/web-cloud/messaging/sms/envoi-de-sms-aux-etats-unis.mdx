...
- Avoir accès aux <ApiLink>API OVHcloud</ApiLink> (uniquement pour la méthode d'envoi via API).
...
Rendez-vous sur l'<ApiLink>API OVHcloud</ApiLink> puis utilisez l’API suivante :
