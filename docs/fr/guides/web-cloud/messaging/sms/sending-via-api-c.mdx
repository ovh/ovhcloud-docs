...
La <ApiLink section="/sms" regions={["eu"]}>console d'API</ApiLink> vous permettra de découvrir d'autres méthodes pour faciliter l'intégration de services tels que : SMS réponses, envoi en masse avec fichier CSV, publipostage, suivi des accusés de réception...
