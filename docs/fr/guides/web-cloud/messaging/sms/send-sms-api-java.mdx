...
Créez vos identifiants de Script (toutes les clés en une fois) sur cette page : <CreateToken rights="GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs">page de création de token OVHcloud</CreateToken> (Cette URL vous permet d'avoir automatiquement les bons droits pour les étapes décrites dans ce guide).
