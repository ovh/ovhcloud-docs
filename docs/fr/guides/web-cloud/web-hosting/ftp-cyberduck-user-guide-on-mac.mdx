...
- En-dessous se trouve le contenu que vous souhaitez afficher. Par exemple, si vous cliquez sur l’icône <code className="action">History</code>, la liste de vos actions y apparaitra.
...
1. Connectez-vous à l’espace FTP de votre hébergement web.
...
Dans la nouvelle fenêtre, insérez la commande `CHMOD 705 /` puis cliquez sur <code className="action">Send</code> pour exécuter la commande. En confirmation, le message `200 Permissions changed on /` devrait apparaître dans l’encadré du dessous.
