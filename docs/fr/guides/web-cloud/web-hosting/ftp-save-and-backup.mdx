...
Lorsque vous effectuez une sauvegarde de sécurité pour votre site et que vous utilisez une base de données, faites également une sauvegarde de votre base de données. N’hésitez pas à consulter notre guide pour [récupérer une sauvegarde de votre (vos) base(s) de données](/guides/web-cloud/web-hosting/sql-database-export).
...
<Region zones={['eu']}>
- Disposer d’une offre d'[hébergement web](/links/web/hosting) (ne fonctionne pas avec un hébergement Cloud Web).
</Region>
