...
En effet, lorsque vous vous connectez de manière classique à l’espace FTP d’un hébergement web, la connexion s’effectue directement en vous positionnant à l’intérieur du dossier équivalent au dossier `FTP-main-login` de notre exemple.
