...
description: "Découvrez comment protéger un répertoire ou l’accès à l’administration de votre site web via une authentification avec les fichiers « .htaccess » et « .htpasswd »"
...
### Étape 1 : créer les fichiers « crypt.php », « .htaccess » et « .htpasswd »
...
### Étape 2 : compléter le fichier « crypt.php »

Remontez dans le « dossier racine » où vous avez créé le fichier « crypt.php ». Cliquez sur <code className="action">Éditer</code> puis placez les lignes suivantes :
...
### Étape 3 : définir les utilisateurs et les mots de passe chiffrés avec le fichier « .htpasswd »
...
Remplacez les valeurs `user1`, `user2` et `user3` de notre exemple par vos propres noms d’utilisateurs.
...
### Étape 4 : configurer les règles dans le fichier « .htaccess »
