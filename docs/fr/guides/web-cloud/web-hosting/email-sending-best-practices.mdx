...
| **Identité de l’expéditeur** | L’adresse `From:` est déclarée par le script. Vérifiez que votre enregistrement SPF autorise les serveurs OVHcloud. | L’adresse `From:` doit correspondre au compte authentifié. L’e-mail est signé <Tooltip term="dkim">DKIM</Tooltip> si DKIM est activé pour votre domaine. |
