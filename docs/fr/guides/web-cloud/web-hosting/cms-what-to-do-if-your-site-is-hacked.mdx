...
- votre site Web n’apparaît plus correctement ou plus du tout, sans aucune modification (FTP, SQL ou DNS) de votre part ;
...
- l’utilisation d’un plugin ou d’un thème « non officiel », notamment si vous utilisez un Content Management System (CMS) comme WordPress, Joomla!, PrestaShop ou Drupal ;
...
### Étape 1 - scanner l’ensemble de vos appareils
...
### Étape 2 - modifier ses mots de passe <a name="step2"></a>
...
### Étape 3 - rechercher les fichiers malveillants et les failles de sécurité
...
:::tip
Plusieurs sites (non gérés par OVHcloud) peuvent vous permettre d’obtenir des informations sur les IPs malveillantes. Vous pouvez utiliser l’un d’entre eux pour récupérer des informations telles que le fournisseur de l’IP, sa géolocalisation, le gestionnaire, etc.
...
### Étape 4 - supprimer les éléments malveillants et corriger les failles de sécurité
...
Votre site devrait réapparaître si ces actions ont été correctement effectuées.
...
### Étape 5 - Mettre à jour votre site
