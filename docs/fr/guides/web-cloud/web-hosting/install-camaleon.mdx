...
*   **Si vous souhaitez ajouter un multisite** : cliquez sur <code className="action">Actions</code>, puis sur <code className="action">Ajouter un domaine ou sous-domaine</code> à droite du tableau.
...
Félicitations, votre site utilisant Camaleon CMS est maintenant disponible ! Il ne vous reste plus qu’à le configurer.  

### Étape 7 : utiliser HTTPS
