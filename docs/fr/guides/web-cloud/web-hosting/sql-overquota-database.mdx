...
### Étape 1 : identifier la ou les table(s) volumineuse(s)
...
Si votre base de données est présente sur une solution [Web Cloud Databases](/links/web/databases), consultez notre guide « [Web Cloud Databases - Se connecter à votre base de données](/guides/web-cloud/databases/db-connecting-database-server) », puis passez directement à l’[étape 1.2](#step1.2) du présent guide.
...
### Étape 2 : déterminer l’utilité du contenu présent dans la ou les table(s) volumineuse(s)
...
:::info
Si vous utilisez un Content Management System (CMS) tel que WordPress, Joomla!, PrestaShop ou Drupal, vérifiez que vos tables volumineuses ne sont pas liées à un plugin/thème récemment installé ou mis à jour.
...
### Étape 3 : mener une action corrective
...
- [Premiers pas avec l’offre Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
- [Importer votre ancienne base de données dans votre offre Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
...
### Étape 4 : Sortir la base de données du statut « READ ONLY » (lecture seule)
