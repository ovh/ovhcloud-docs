...
:::info
Ces limitations concernent **uniquement** les e-mails émis à l’aide de la fonction *mail()* de PHP et ne concernent pas les autres offres e-mail (envoi SMTP).
...
Pour en savoir plus, consultez les détails de nos [offres d’hébergement web](/links/web/hosting) et notre guide « [Premiers pas avec votre offre Web Cloud Databases](/guides/web-cloud/databases/db-getting-started) ».
...
Pour plus d’informations sur la gestion des bases de données et sur la connexion à l’interface *phpMyAdmin*, reportez-vous au guide « [Créer une base de données sur son hébergement web](/guides/web-cloud/web-hosting/sql-create-database) ».
