...
Pour ces CMS, vous pouvez également effectuer ces modifications directement [en base de données](/guides/web-cloud/web-hosting/sql-create-database#accéder-à-linterface-phpmyadmin). Vous devrez changer l’URL d’accès à votre site dans la table prévue à cet effet.
