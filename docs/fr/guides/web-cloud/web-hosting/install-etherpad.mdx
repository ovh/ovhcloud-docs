...
Dans le tableau, vérifiez que le moteur d’exécution Node.js est bien lié aux domaines concernés et que le dossier racine est correct. Si tel est le cas, poursuivez vers l’étape 3 « [Se connecter à votre Cloud Web via SSH](#etape-3-se-connecter-a-votre-cloud-web-via-ssh) ».
