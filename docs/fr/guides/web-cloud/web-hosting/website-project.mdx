...
Si vous disposez d’un hébergement web **Performance**, **Agency**, **Agency Plus** ou **Agency Max**, vous pouvez activer gratuitement un serveur de base de données [Web Cloud Databases](/links/web/databases).
...
Si votre offre d'[hébergement web](/links/web/hosting) dispose de cette option, consultez notre guide « [Créer des tâches automatisées (CRON) sur votre hébergement Web](/guides/web-cloud/web-hosting/cron-tasks) » pour plus de détails.
