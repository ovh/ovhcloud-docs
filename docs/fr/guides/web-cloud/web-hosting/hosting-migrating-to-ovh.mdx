...
:::info
OVHcloud propose des serveurs de base de données Web Cloud Databases. Si vous souhaitez utiliser cette offre avec votre site web, retrouvez l’ensemble de notre documentation sur ce produit sur [notre page dédiée](/guides/web-cloud/databases/landing-page-databases).
...
- Retrouvez l’ensemble de nos guides d’aide à la configuration dans les sections `Configuration sur ordinateur` et `Configuration sur smartphone` de [notre documentation sur l’offre Email Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro).
</Region>

<Region zones={['eu', 'ca']}>
#### Pour les comptes e-mail « Exchange » :

- Retrouvez l’ensemble de nos guides d’aide à la configuration dans les sections `Configuration Exchange sur ordinateur` et `Configuration Exchange sur smartphone` de [notre documentation sur l’offre Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange).
</Region>

### Étape 9 : remplacer les serveurs DNS actifs de votre nom de domaine par ceux d’OVHcloud <a name="step9"></a>

La zone DNS préconfigurée lors de l’[étape 2](#step2) n’est pas encore appliquée à votre nom de domaine. Actuellement, votre nom de domaine utilise toujours les serveurs DNS de votre fournisseur d’origine.
