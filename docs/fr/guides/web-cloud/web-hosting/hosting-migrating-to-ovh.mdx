...
:::info
L'offre « Email-Pro » est uniquement disponible pour les clients situés en Europe.<br/>
L'offre « Exchange » est indisponible pour les clients situés en Asie-Pacifique.
:::
...
- **Gamme Business** :
    - L'hébergement [Startup](https://www.ovhcloud.com/fr/web-hosting/) avec **10 adresses e-mail** « MX Plan »
...
- **Gamme Agencies** :
    - L'hébergement [Agency](https://www.ovhcloud.com/fr/web-hosting/) avec **1000 adresses e-mail** « MX Plan »
    - L'hébergement [Agency Plus](https://www.ovhcloud.com/fr/web-hosting/) avec **1000 adresses e-mail** « MX Plan »
    - L'hébergement [Agency Max](https://www.ovhcloud.com/fr/web-hosting/) avec **1000 adresses e-mail** « MX Plan »

- L'hébergement [Cloud Web](https://www.ovhcloud.com/fr/web-hosting/cloud-web-offer/) avec **200 adresses e-mail** « MX Plan ». Cette offre est utilisée par les développeurs d'applications et est uniquement disponible pour les services hébergés en Europe.
...
**Sélectionnez l'onglet correspondant à votre localisation.**
...
:::tip
Notez les deux valeurs cibles ayant pour type d'enregistrement « NS ». Ces valeurs peuvent avoir plusieurs formes :

- `dnsXX.ovh.net` et `nsXX.ovh.net` (ou `dnsXX.ovh.ca` et `nsXX.ovh.ca` pour les services hébergés hors Europe)
- `dns200.anycast.me` et `ns200.anycast.me`

Elles correspondent aux serveurs DNS associés à cette zone DNS pour votre nom de domaine.
Elles serviront lors de l'[étape 9](#step9) de ce guide.
...
- Votre nom de domaine (sans les « www ») vers la cible de type « MX » : « mx1.mail.ovh.net. » (ou « mx1.mail.ovh.ca. » pour les services e-mail hébergés hors Europe).
- Votre nom de domaine (sans les « www ») vers la cible de type « MX » : « mx2.mail.ovh.net. » (ou « mx2.mail.ovh.ca. » pour les services e-mail hébergés hors Europe).
- Votre nom de domaine (sans les « www ») vers la cible de type « MX » : « mx3.mail.ovh.net. » (ou « mx3.mail.ovh.ca. » pour les services e-mail hébergés hors Europe).
...
Remplacez les serveurs DNS actuels (du registrar d'origine) par les deux serveurs DNS déclarés dans la zone DNS OVHcloud (de type `dnsXX.ovh.net` et `nsXX.ovh.net`, `dnsXX.ovh.ca` et `nsXX.ovh.ca` pour les services hébergés hors Europe ou encore `dns200.anycast.me` et `ns200.anycast.me` si vous avez souscrit à l'option DNS Anycast). Cette manipulation se fait dans l'interface de gestion du registrar d'origine.
