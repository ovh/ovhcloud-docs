...
Un [hébergement web mutualisé](/links/web/hosting) permet de déclarer des domaines ou sous-domaines sur les sites web qu’il contient. Un domaine ou un sous-domaine est nécessaire pour déployer votre site web réalisé avec **Cecil**.
