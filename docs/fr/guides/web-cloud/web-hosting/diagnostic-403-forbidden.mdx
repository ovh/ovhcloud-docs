...
Pour identifier ces failles de sécurité, analysez les [« logs web »](/guides/web-cloud/web-hosting/logs-and-statistics) de votre hébergement web ou faites appel à un [prestataire spécialisé](/links/partner) afin de réaliser un audit de sécurité de vos sites web.
