...
:::info
Certains sites web utilisent des [Content Delivery Network (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) pour héberger, par exemple, des librairies *Javascript* (comme *JQuery*). 
...
Voici un exemple de redirection que vous pouvez ajouter dans un fichier « [.htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite) », à la racine de votre site web (en remplaçant l’URL `https://www.yourdomain.tld` par la vôtre):
