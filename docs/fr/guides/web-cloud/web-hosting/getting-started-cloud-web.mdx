...
<Tabs>
  ...
  <Tab label="Étape 3">
    Si vous disposez de l’offre [Cloud Web](/links/web/hosting-cloud-web-offer) avec 2 vCores, vous pouvez ajouter un second moteur d’exécution (maximum 2 par offre) en cliquant sur le bouton <code className="action">Actions</code>, puis sur <code className="action">Ajouter un moteur d'exécution</code>.
  </Tab>
</Tabs>
...
#### 2. Vérifier et/ou modifier les enregistrements DNS
