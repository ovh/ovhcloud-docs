...
SVN, qui est l’abréviation de « subversion », est un système de gestion de versions. 
...
Après avoir obtenu votre clé, ajoutez-la sur votre hébergement dans le fichier .ssh/authorized_keys2. Pour cela, tapez la ligne de commande ci-dessous :
...
Vous retrouverez également ces informations en consultant notre guide [Utiliser l’accès SSH de son hébergement web](/guides/web-cloud/web-hosting/ssh-on-webhosting).
:::
...
Vous pouvez faire un test depuis l’ordinateur se connectant au dépôt SVN en tapant la ligne :
...
Il existe une très bonne documentation en anglais pour Subversion : [https://svnbook.red-bean.com/en/1.5/index.html](https://svnbook.red-bean.com/en/1.5/index.html)
