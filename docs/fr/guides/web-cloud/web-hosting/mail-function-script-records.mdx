...
Si vous souhaitez gérer les adresses e-mail comprises dans votre offre MX Plan ou dans votre offre d’[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/), consultez notre documentation sur les [E-mails mutualisés - MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan).
:::
