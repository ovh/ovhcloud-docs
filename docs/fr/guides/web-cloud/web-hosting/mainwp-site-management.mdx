...
- **Lien direct :** <ManagerLink to="/#/web-hosting/managed-hosting-for-wordpress">Managed hosting for WordPress</ManagerLink>
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page <ManagerLink to="/#/web-hosting/managed-hosting-for-wordpress">Managed hosting for WordPress</ManagerLink> de votre espace client OVHcloud et identifiez la ressource à gérer dans la liste affichée.

    {/* DRAFT: To screenshot — capturer la vue de la ressource Managed Hosting for WordPress dans la liste des hébergements WordPress (managed-hosting-overview.png) */}
  </Tab>
  <Tab label="Étape 2">
