...
Dans votre espace client OVHcloud, accédez à votre service Zimbra et renommez l'adresse e-mail Zimbra provisoire en l'adresse MX Plan migrée. Si on reprend l'exemple de l'étape 2 du chapitre 1.2 plus haut, l'adresse provisoire `contact2@mydomain.ovh` sera renommée en `contact@mydomain.ovh` qui est son adresse e-mail d'usage.
