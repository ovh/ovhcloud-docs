...
- Disposer d'une solution [Exchange](https://www.ovhcloud.com/fr/emails-exchange/).
- Disposer d'un ou plusieurs noms de domaine.
- Être en mesure de modifier la configuration de votre nom de domaine ([zone DNS](/guides/web-cloud/domains/dns-zone-edit)).
...
:::warning
Par défaut, l'ensemble des comptes e-mail d'une plateforme sont interconnectés. Toutes les adresses créées sur votre service e-mail seront en mesure de visualiser l'ensemble des adresses de ce service dans l'annuaire, y compris celles possédant un nom de domaine différent.

<Region zones={['eu']}>

Pour dissocier l'affichage des domaines, il est nécessaire de commander une autre plateforme [Exchange ou Email Pro](https://www.ovhcloud.com/fr/emails/) pour le ou les noms de domaine concernés.

</Region>

<Region zones={['ca']}>

Pour dissocier l'affichage des domaines, il est nécessaire de commander une autre plateforme [Exchange](https://www.ovhcloud.com/fr/emails-exchange/) pour le ou les noms de domaine concernés.
...
Si vous souhaitez configurer votre adresse e-mail sur un logiciel de messagerie ou un périphérique comme un smartphone ou une tablette, ou obtenir de l'aide concernant les fonctionnalités de votre service e-mail, consultez nos documentations accessibles depuis la page [Exchange](https://www.ovhcloud.com/fr/emails-exchange/).
