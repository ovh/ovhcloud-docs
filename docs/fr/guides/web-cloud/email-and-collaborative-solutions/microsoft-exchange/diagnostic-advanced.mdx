...
<img className="thumbnail" alt="Diagnostic Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-01.png" loading="lazy" />

La procédure de diagnostic prendra environ 3 à 10 minutes. Voici un exemple de résultats :

<img className="thumbnail" alt="Diagnostic Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-02.png" loading="lazy" />
