...
### Étape 1 : réception de l'e-mail de configuration de votre plateforme <a name="etape-1-reception-de-lemail-de-configuration-de-votre-serveur"></a>
...
### Étape 2 : initialisation de votre plateforme <a name="etape-2-initialisation-de-votre-plateforme"></a>
