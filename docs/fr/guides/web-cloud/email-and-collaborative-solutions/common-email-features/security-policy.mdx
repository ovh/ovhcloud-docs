...
:::info
Si vous ne voyez pas apparaître l'onglet <code className="action">Plus</code> dans le panneau de gestion de votre offre <code className="action">MX Plan</code>, cela signifie que vous êtes sur une offre MX Plan historique. Il n'y a pas de gestion de la politique de sécurité sur l'offre MX Plan historique.
