...
:::info
Si vous ne voyez pas apparaître l'onglet <code className="action">Plus</code> dans le panneau de gestion de votre offre <code className="action">MX Plan</code>, cela signifie que votre service utilise le webmail Roundcube. La gestion de la politique de sécurité n'est pas disponible sur les services MX Plan utilisant Roundcube.
...
<Region zones={['ca']}>
Une fois ces informations complétées, validez ces changements en cliquant sur <code className="action">Suivant</code>, puis sur <code className="action">Valider</code> pour l'offre « MX Plan ». Cliquez sur <code className="action">Enregistrer les modifications</code> pour l'offre Exchange.
</Region>

<Region zones={['apac']}>
Une fois ces informations complétées, validez ces changements en cliquant sur <code className="action">Suivant</code>, puis sur <code className="action">Valider</code> pour l'offre « MX Plan ».
</Region>
