...
<img className="thumbnail" alt="Création d'une nouvelle migration dans OVHcloud Mail Migrator, étape 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
