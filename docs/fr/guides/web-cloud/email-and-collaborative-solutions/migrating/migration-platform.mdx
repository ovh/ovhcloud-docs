...
- Si vous devez migrer **un compte Exchange ou Zimbra PRO** vers un compte **Email Pro** ou **Zimbra STARTER**, vous devez vous assurer que vos comptes e-mail n'excèdent pas les 15 Go, capacité commune à Email Pro et Zimbra STARTER. Les fonctions collaboratives, la synchronisation des calendriers et contacts ne sont pas présentes sur Email Pro ou Zimbra STARTER et ne peuvent pas être migrées.
