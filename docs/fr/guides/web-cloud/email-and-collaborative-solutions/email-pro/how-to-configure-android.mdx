...
<Tabs>
  ...
  <Tab label="Configuration existante">
    ...
    3. Sélectionnez <code className="action">Ajouter un compte</code><br/><br/>![emailpro](/images/assets/screens/email-clients/android/android-existing.png)&#123;thumbnail .h-600&#125;
  </Tab>
</Tabs>
