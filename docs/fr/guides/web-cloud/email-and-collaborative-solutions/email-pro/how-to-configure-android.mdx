...
<img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/emailpro-android-00.png" loading="lazy" />
...
<Tabs>
  <Tab label="Première configuration">
    Sélectionnez <code className="action">Ajouter une adresse e-mail</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Configuration existante">
    ...
    3. Sélectionnez <code className="action">Ajouter un compte</code><br/><br/><img className="thumbnail" alt="Ajout d'un compte existant dans l'application Gmail sur Android" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/common/popimap-01.png" loading="lazy" />
...
<img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/common/popimap-02.png" loading="lazy" />
