...
Les adresses e-mail de l'offre **MX Plan** et [Zimbra Starter](/links/web/zimbra) peuvent être configurées sur un logiciel de messagerie compatible. Cela vous permet d'envoyer et de recevoir vos messages depuis l'application de votre choix.
...
- Disposer d'une solution e-mail OVHcloud préalablement configurée, parmi les suivantes :
    ...
    <Region zones={['eu']}>
    - [Zimbra](/links/web/zimbra) Starter (**uniquement**).
    </Region>
...
:::info
Pour plus d'informations sur la configuration d'une adresse e-mail depuis le client de messagerie nouvel Outlook sur Windows, consultez [le centre d'aide de Microsoft](https://support.microsoft.com/fr-fr/office/start-using-new-outlook-for-windows-4395454d-cb2f-4c16-bb24-fa4bb36650ae).
:::
