...
Sur les services MX Plan utilisant le webmail Zimbra ou OWA, on parle de *réinitialisation de compte* lorsque vous devez supprimer celui-ci.
...
<Region zones={['eu']}>
Consultez l'ensemble de nos offres e-mail [Zimbra](/links/web/zimbra) ou [Exchange](https://www.ovhcloud.com/fr/emails-exchange/) pour compléter votre offre MX Plan sur le même nom de domaine.
</Region>
