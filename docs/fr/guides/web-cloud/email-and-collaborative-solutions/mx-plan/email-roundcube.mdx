...
:::info
Après avoir saisi votre adresse e-mail et votre mot de passe sur la page de connexion OVHcloud, vous pouvez être redirigé vers la fenêtre de connexion **Roundcube** : il vous faut alors ressaisir ces mêmes identifiants. Selon votre compte, il est aussi possible que vous accédiez directement à votre webmail, sans cette seconde étape.
:::

<img className="thumbnail" alt="Roundcube - fenêtre de connexion" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-roundcube/roundcube-login-window.png" loading="lazy" />
