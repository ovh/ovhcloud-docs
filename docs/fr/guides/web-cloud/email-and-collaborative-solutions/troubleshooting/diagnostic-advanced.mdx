...
<ZoneTabs>
  <Tab label="Compte e-mail MX Plan">
    Pour une offre **MX Plan**, rendez-vous sur [la page de nos guides MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan) et vérifiez la configuration de votre logiciel de messagerie à l'aide des guides disponibles dans la section `Configuration d'une application e-mail sur votre ordinateur` ou `Configurer une application e-mail sur votre smartphone ou tablette`, selon l'appareil utilisé.
  </Tab>
  <Tab label="Email Pro" availableIn={['eu']}>
    Pour une offre **Email Pro**, rendez-vous sur [la page de nos guides Email Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro) et vérifiez la configuration de votre logiciel de messagerie à l'aide des guides disponibles dans la section `Configuration d'une application e-mail sur votre ordinateur` ou `Configurer une application e-mail sur votre smartphone ou tablette`, selon l'appareil utilisé.
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    Pour une offre **Exchange**, rendez-vous sur [la page de nos guides Microsoft Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange) et vérifiez la configuration de votre logiciel de messagerie à l'aide des guides disponibles dans la section `Configuration d'une application e-mail sur votre ordinateur` ou `Configurer une application e-mail sur votre smartphone ou tablette`, selon l'appareil utilisé.
  </Tab>
  <Tab label="Zimbra" availableIn={['eu']}>
    Pour une offre **Zimbra**, rendez-vous sur [la page de nos guides Zimbra](/guides/web-cloud/email-and-collaborative-solutions/zimbra/landing-page-zimbra) et vérifiez la configuration de votre logiciel de messagerie à l'aide des guides disponibles dans la section `Configuration d'une application e-mail sur votre ordinateur` ou `Configurer une application e-mail sur votre smartphone ou tablette`, selon l'appareil utilisé.
  </Tab>
</ZoneTabs>
