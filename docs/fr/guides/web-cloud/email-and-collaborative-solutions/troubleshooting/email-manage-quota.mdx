...
Depuis l'onglet <code className="action">Comptes e-mail</code>, cliquez sur le bouton <code className="action">...</code> à droite du compte à modifier, puis cliquez sur <code className="action">Modifier</code>.
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    L'offre Email Pro dispose d'une capacité unique de 15 Go. Si vous avez besoin d'un stockage plus important, vous devrez passer sur une offre proposant davantage d'espace. Pour cela, lisez la section [changer d'offre pour augmenter sa capacité](#switchingoffer) de ce guide.<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
...
Si vous le souhaitez, il est possible de libérer l'espace de stockage de votre compte e-mail en stockant vos e-mails directement sur votre ordinateur. Pour cela il vous sera nécessaire de faire appel à un logiciel de messagerie installé sur votre ordinateur.
...
Configuration d'un compte Email Pro sur **macOS** :<br/><br/>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows) (gratuit)<br/><br/>
