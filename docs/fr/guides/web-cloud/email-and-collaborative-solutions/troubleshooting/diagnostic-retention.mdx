...
- Disposer d'une solution e-mail OVHcloud :
    <Region zones={['eu']}>
    - **MX Plan** ([Zimbra et OWA uniquement](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities#instructions)) proposée parmi nos [offres d’hébergement web](https://www.ovhcloud.com/fr/web-hosting/), incluse dans un [Hébergement gratuit](https://www.ovhcloud.com/fr/domains/free-web-hosting/)
    </Region>
    <Region zones={['ca']}>
    - **MX Plan** ([Zimbra et OWA uniquement](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities#instructions)) proposée parmi nos [offres d’hébergement web](https://www.ovhcloud.com/fr/web-hosting/)
    </Region>
...
:::info
Pour les offres de type **Private Exchange**, le lien de connexion au webmail se situe dans le cadre **Connexion** de l'onglet <code className="action">Informations générales</code> sur votre plateforme.
:::
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-retention/retention-owa-01.png" loading="lazy" />

Une fenêtre supplémentaire apparaît. Il est possible que votre navigateur internet bloque par défaut l'apparition des fenêtres de type *pop-up*, assurez-vous donc qu'il autorise celles-ci.
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-retention/retention-owa-02.png" loading="lazy" />
