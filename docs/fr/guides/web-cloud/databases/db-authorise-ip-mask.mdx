...
<Tabs>
  ...
  <Tab label="Étape 3">
    ...
    :::info
    En décochant cette case, vous bloquez aussi l’accès à **phpMyAdmin** via le lien disponible dans votre espace client OVHcloud, et ce pour l’ensemble de votre solution Web Cloud Databases.
    :::
