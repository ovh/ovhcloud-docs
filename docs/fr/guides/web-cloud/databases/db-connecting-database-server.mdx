...
:::warning
Si vous utilisez une offre « Web Cloud Databases »/« SQL Privé », n’oubliez pas d’autoriser votre IP à l’aide du guide sur la [configuration de votre serveur de base de données](/guides/web-cloud/databases/db-configure-optimise-database-server#gérer-vos-accès).
