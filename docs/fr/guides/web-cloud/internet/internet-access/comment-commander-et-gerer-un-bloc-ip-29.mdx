...
<Tabs>
  <Tab label="Via les API OVHcloud">
    ...
    Rendez-vous sur les <ApiLink>API OVHcloud</ApiLink> puis connectez-vous avec votre identifiant client OVHcloud. Dès lors, utilisez les deux API ci-dessous afin de configurer le bloc IP /29.
