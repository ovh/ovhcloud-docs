...
Une fois connecté, rendez-vous dans l'univers <code className="action">Télécom</code> puis <code className="action">Accès Internet</code>. Vous y retrouverez votre offre.
