...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="profil adsl" src="/images/web-cloud/internet/internet-access/modification-du-profil-de-synchronisation/ProfilsADSL.mp4" />

**Pour un accès VDSL :**

<video className="thumbnail" autoPlay loop muted playsInline aria-label="profil vdsl" src="/images/web-cloud/internet/internet-access/modification-du-profil-de-synchronisation/ProfilsVDSL.mp4" />
