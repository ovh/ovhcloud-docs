...
:::info
Si vous n'utilisez pas une connexion Wi-Fi, poursuivez dès à présent vers la vérification suivante : « [3. Vérifier la configuration réseau de votre modem](/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation#3-vérifier-la-configuration-réseau-de-votre-modem) ».
