...
- [Vérifier l'activité de ma connexion depuis l'espace client](/guides/web-cloud/internet/internet-access/verifier-lien-xdsl-sature#vérifier-lactivité-de-ma-connexion-depuis-lespace-client).

- [Effectuer un test ponctuel de débit](/guides/web-cloud/internet/internet-access/verifier-lien-xdsl-sature#effectuer-un-test-ponctuel-de-débit).
...
Vous ne constatez alors pas de saturation de votre connexion. Si tel est le cas, veuillez poursuivre vers l'étape « [Effectuer un test ponctuel de débit](/guides/web-cloud/internet/internet-access/verifier-lien-xdsl-sature#effectuer-un-test-ponctuel-de-débit) » de cette documentation.
