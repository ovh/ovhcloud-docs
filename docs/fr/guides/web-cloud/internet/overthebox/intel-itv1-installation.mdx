...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-network.mp4" />
...
- Si vous ne voyez pas le domaine **overthebox.ovh**, veuillez renouveler manuellement la configuration réseau de votre ordinateur. Pour ce faire :
    - Sous **Windows**, ouvrez une invite de commande grâce au raccourci clavier **Windows + R** puis en tapant **cmd** dans la zone d'exécution.
