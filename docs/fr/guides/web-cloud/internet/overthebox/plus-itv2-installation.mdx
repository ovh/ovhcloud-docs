...
### Utiliser un service OverTheBox en mode WireGuard

WireGuard est un mode de fonctionnement alternatif au tunnel OverTheBox historique. Pour basculer votre service en mode WireGuard et le configurer, consultez le guide « [Comment configurer WireGuard sur OverTheBox](/guides/web-cloud/internet/overthebox/config-wireguard) ».
