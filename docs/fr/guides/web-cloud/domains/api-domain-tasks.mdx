...
1. `/me/task/domain` et ses sous-routes : <Api version="v1" section="/me" method="GET" route={"/me/task/domain"} />
2. `/domain/{serviceName}/task` et ses sous-routes : <Api version="v1" section="/domain" method="GET" route={"/domain/\{serviceName\}/task"} />
