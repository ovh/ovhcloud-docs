...
Si vous souhaitez **transférer** votre nom de domaine de Hostinger vers un autre bureau d’enregistrement (comme OVHcloud), le nouveau bureau d’enregistrement peut demander un code d’autorisation (code « EPP » ou « Auth ») pour vérifier que vous avez bien le droit d’agir sur le nom de domaine.
Pour vous familiariser avec le changement de titulaire d’un nom de domaine, nous vous invitons à consulter ce [guide](/guides/web-cloud/domains/trade-domain).
