...
N’hésitez pas à créer un ticket d’assistance depuis le [centre d’aide](/links/support-contact) si besoin.
...
:::info
Une fois la résiliation demandée, vous pouvez accélérer la suppression en créant un ticket d’assistance depuis le [centre d’aide](/links/support-contact). Des documents justificatifs seront à fournir pour accélérer cette suppression.
...
- **Jour 15** : Si le titulaire du nom de domaine n’a pas encore répondu, nous envoyons un e-mail à l’administrateur du nom de domaine pour l’informer de la situation et de la désactivation du nom de domaine.
...
Après avoir vérifié et confirmé les deux points ci-dessus, si vous ne parvenez toujours pas à récupérer l’e-mail de validation du titulaire, nous vous invitons à ouvrir un ticket d’assistance depuis le [centre d’aide](/links/support-contact) pour demander le renvoi de cet e-mail.
...
Pour cela, vous devez être a minima déclaré en tant que [contact « Facturation »](/guides/account-and-service-management/account-information/managing-contacts) du nom de domaine concerné. Vous devrez ensuite modifier le mode de renouvellement du nom de domaine pour le passer en **renouvellement automatique**.
...
En cas de doute, nous vous invitons à ouvrir un ticket d’assistance depuis le [centre d’aide](/links/support-contact) en y précisant le nom de domaine et l’hébergement web concerné.
...
- **Champs e-mail** : `MX`, `SPF`, `DKIM` et `DMARC`.
...
- Enregistrements DNS e-mails :
    - [Configurer un enregistrement MX pour la gestion des e-mails](/guides/web-cloud/domains/dns-zone-mx)
...
En cas d’erreur, nous vous invitons à ouvrir un ticket d’assistance depuis le [centre d’aide](/links/support-contact) en y précisant les informations suivantes :
...
|Élément dans le résultat|Description|Correspondance dans l’exemple ci-dessus|
|---|---|---|
...
<Tabs>
  ...
  <Tab label="Étape 2">
    ...
    **Cas n°2** - Le nom de domaine concerné n’apparaît pas dans la liste :
    ...
    Dans cette situation et si vous ne connaissez pas cet autre identifiant client, nous vous invitons à ouvrir un ticket d’assistance depuis le [centre d’aide](/links/support-contact) pour récupérer la gestion de la zone DNS.
  </Tab>
</Tabs>
