...
Selon l’extension, vous pouvez recevoir un e-mail d’OVHcloud vous demandant de confirmer le transfert sortant avant qu’il puisse se poursuivre. Consultez [Confirmer un changement de titulaire ou un transfert sortant](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
