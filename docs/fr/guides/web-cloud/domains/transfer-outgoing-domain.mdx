...
Selon l’extension, vous pouvez recevoir un e-mail d’OVHcloud concernant le transfert sortant. Le confirmer accélère la procédure et le refuser annule le transfert ; si vous n’effectuez aucune action, le transfert se finalise automatiquement, généralement au bout de 5 jours. Consultez [Confirmer un changement de titulaire ou un transfert sortant](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
