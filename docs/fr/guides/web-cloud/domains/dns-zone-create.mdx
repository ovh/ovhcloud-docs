...
Dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, ouvrez la section `Web Cloud` et cliquez sur <code className="action">Zones DNS</code>. Cliquez ensuite sur le bouton <code className="action">Commander</code>.
