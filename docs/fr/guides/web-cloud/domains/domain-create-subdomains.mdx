...
- [Associer, autoriser et configurer votre sous-domaine avec un service OVHcloud](#link-subdomain)
    ...
    <Region zones={['eu']}>
    - [Cas 3 - Créer des adresses Email Pro avec un sous-domaine](#link-subdomain-case-3)
    </Region>
...
:::info
La modification d’une zone DNS associée à un nom de domaine entraîne un délai de <Tooltip term="dnsPropagation">propagation</Tooltip> de **4** à **24** heures maximum pour que celle-ci soit effective.
...
#### Cas 3 - Créer des adresses Email Pro avec un sous-domaine <a name="link-subdomain-case-3"></a>

Pour débloquer la création d’adresses Email Pro personnalisées avec un sous-domaine, connectez-vous à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> et sélectionnez <code className="action">Web Cloud</code>. Cliquez sur <code className="action">E-mails Pro</code> puis sélectionnez la plateforme Email Pro que vous souhaitez utiliser avec votre sous-domaine. Sur la page qui s’affiche, rendez-vous dans l’onglet <code className="action">Domaine associés</code> puis cliquez sur le bouton <code className="action">Ajouter un domaine</code> à droite.

Vous pourrez ainsi déclarer votre sous-domaine sur votre plateforme Email Pro.

Pour plus de détails sur la configuration d’une plateforme Email Pro, consultez les guides suivants :
