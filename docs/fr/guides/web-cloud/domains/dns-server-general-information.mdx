...
Retrouvez ci-dessous un tableau présentant ces 4 types de serveurs DNS et leurs interactions. Les exemples donnés dans le tableau seront réalisés à partir d’une requête DNS envoyée depuis un navigateur web pour connaître l’adresse IP du site web *domain.tld*.
