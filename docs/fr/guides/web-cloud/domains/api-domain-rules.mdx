...
| `domain`  | oui         | Le nom de domaine concerné                                    |
...
Chacun de ces objets est optionnel. Si le moteur de règles a besoin de l’un d’eux pour vérifier une règle, une erreur sera retournée.
