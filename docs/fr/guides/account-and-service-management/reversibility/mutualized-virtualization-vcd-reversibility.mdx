...
| **Fonction** | **Description** | **Formats disponibles** | **Modèle de migration** | **Documentation disponible** |
| --- | --- | --- | --- | --- |
| Gestion des réseaux virtuels | Configuration réseaux (subnets) spécifique à OVHcloud | NA | **Entrante** : adaptation des configurations réseau à l’environnement OVHcloud <br/>**Sortante** : pas d'export possible des configurations. Prendre note de l’architecture et la reproduire dans l’environnement cible | [Public VCF-as-a-Service - Concepts réseaux et bonnes pratiques](/guides/hosted-private-cloud/powered-by-vmware/vcd-network-concepts) <br/><br/>[Public VCF-as-a-Service - Création de composants réseaux via Public VCF as-a-Service](/guides/hosted-private-cloud/powered-by-vmware/vcd-network-creation) |
