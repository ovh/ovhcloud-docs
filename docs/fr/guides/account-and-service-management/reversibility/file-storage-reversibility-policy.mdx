...
Les fonctionnalités du produit File Storage sont réparties en trois catégories :
...
| **Snapshots Manuels/Automatiques** | Création/restauration de snapshots pour la sauvegarde ou la restauration instantanée. | NFSv3 | **Entrant** : copiez les données du snapshot à l’aide d’outils tels que rsync.<br/>**Sortant** : exportez les données restaurées à l’aide de rsync ou d’outils similaires. | Documentation File Storage |
