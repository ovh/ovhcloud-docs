...
| Versionning d'objet | Gestion native des versions d’objets (stockage de chaque version lors de la modification/suppression) | S3 (versioning) | **Entrant** : Import des objets versionnés depuis un autre S3.<br/> **Sortant** : Export des versions via API/CLI, compatible avec d’autres S3. | [Premiers pas avec la gestion de versions](/guides/storage-and-backup/object-storage/s3-versioning) |
