...
Dans votre <ManagerLink to="/#/public-cloud/pci/projects">projet Public Cloud</ManagerLink>, accédez à la rubrique `Project Management` et cliquez sur <code className="action">Quota and Regions</code>. Cliquez sur <code className="action">Contacter le support</code>.
