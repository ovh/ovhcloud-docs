...
Pour utiliser l'<ApiLink section="/service" method="GET" route={"/service/\{serviceId\}/renew"}>API de renouvellement</ApiLink>, vous aurez besoin du `serviceId`. Cette information est disponible avec l'API `serviceInfos`, par exemple :
