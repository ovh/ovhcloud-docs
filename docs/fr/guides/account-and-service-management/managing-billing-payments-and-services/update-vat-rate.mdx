...
Cliquez sur <code className="action">Entrer mon numéro de SIRET</code> et saisissez votre numéro de SIRET : les champs associés (nom de l'entreprise, N° TVA, N° SIREN) se renseignent alors automatiquement.
