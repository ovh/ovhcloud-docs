...
Donne tous les droits techniques sur l'ensemble des produits OVHcloud.
Ce groupe de permissions reprend les droits anciennement portés par le rôle nicTech
...
Ce groupe de permissions reprend les droits anciennement portés par le rôle nicBilling
