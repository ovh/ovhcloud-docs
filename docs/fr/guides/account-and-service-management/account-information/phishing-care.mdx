...
**Repérez le logo OVHcloud dans votre boîte de réception**

Plusieurs messageries, dont Gmail, Yahoo et Apple Mail avec une adresse iCloud.com, affichent le logo OVHcloud à côté du nom de l'expéditeur pour les e-mails envoyés par OVHcloud depuis une adresse se terminant par `ovhcloud.com`. Dans Gmail, une coche bleue l'accompagne.

<img className="thumbnail" alt="Logo OVHcloud affiché à côté du nom de l'expéditeur" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Ce logo est affiché par votre messagerie, pas par le message : un e-mail frauduleux ne peut pas le reproduire. Toutes les messageries ne l'affichent pas encore, donc son absence ne prouve rien à elle seule : dans ce cas, appuyez-vous sur les vérifications décrites ci-dessous.

Vérifiez ensuite si l'e-mail que vous avez reçu est aussi visible sur la page <ManagerLink to="/#/communication">Mes communications</ManagerLink>. Vous y retrouverez les copies des e-mails officiels envoyés par OVHcloud.
...
<img className="thumbnail" alt="Outlook Windows - identifier la version" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
