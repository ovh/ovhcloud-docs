...
Vous pouvez aussi, à tout moment, créer des snapshots manuels, les conserver sans limitation de durée ou les supprimer. Cette fonctionnalité est disponible au sein de votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> ou via l'appel <ApiLink>API</ApiLink> suivant :
