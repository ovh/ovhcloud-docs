...
:::info
**Astuce :** Reportez-vous à la <ApiLink>console d'API OVHcloud</ApiLink> pour obtenir des informations précises sur les opérations, les méthodes HTTP et les schémas de requête.
:::
