...
- Une [instance OVHcloud Public Cloud](/guides/public-cloud/compute/getting-started) dans la même région.
- Un [réseau privé vRack Private Network](/guides/public-cloud/network-services/vrack) actif dans la même région.
...
Suivez la procédure décrite dans l'**étape 1 : activer et gérer un vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/vrack) ».
...
Suivez la procédure décrite dans l'**étape 2 : créer un réseau privé dans le vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/vrack) ».
...
Suivez la procédure décrite dans l'**étape 3 : intégrer une instance au vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/vrack) ».
