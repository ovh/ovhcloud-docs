...
- Avoir accès à la page des <ApiLink>API OVHcloud</ApiLink>
...
Toutes les routes API utilisées pour ce guide sont disponibles dans la <ApiLink section="/storage">section */storage*</ApiLink> de la console API.
