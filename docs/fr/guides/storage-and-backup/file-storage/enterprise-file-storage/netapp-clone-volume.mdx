...
:::info
Vous pouvez créer un volume et un snapshot de type `manual` grâce à l'<ApiLink>API OVHcloud</ApiLink> ou depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.
