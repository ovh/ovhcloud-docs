...
- Avoir accèss aux <ApiLink>API OVHcloud</ApiLink>
...
:::warning
Pour commander un produit via Terraform, votre compte doit avoir un moyen de paiement par défaut défini. Cela se fait depuis l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou via l'appel API suivant : <Api version="v1" section="/me" method="GET" route={"/me/payment/method"} />
