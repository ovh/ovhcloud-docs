...
:::info
Pour accéder directement à votre cluster Ceph, veuillez consulter [ce guide](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-access-cluster).
