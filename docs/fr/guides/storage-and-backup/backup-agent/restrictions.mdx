...
- Le produit n'est compatible qu'avec des serveurs communiquant avec l'IP publique assignée par OVHcloud aux serveurs. À ce jour, il est incompatible avec les adresses Additional IP ou le vRack.
