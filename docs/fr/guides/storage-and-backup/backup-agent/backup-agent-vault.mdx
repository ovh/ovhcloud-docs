...
- Vos données de sauvegarde sont automatiquement envoyées vers un Vault créé à **Gravelines (GRA)**, nommé **backup-vault-gra-1**.
...
- Le serveur Bare Metal à **RBX** envoie ses données vers **backup-vault-gra-1** à **Gravelines (GRA)**.
- Le serveur Bare Metal à **GRA** envoie ses données vers **backup-vault-sbg-1** à **Strasbourg (SBG)**.
