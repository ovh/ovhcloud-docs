...
Une fois que l'agent aura fait des sauvegardes, vous pourrez restaurer vos données de deux façons : Restauration par fichier (FLR), ou restauration du serveur.
