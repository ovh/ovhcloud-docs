...
Vous pouvez trouver les logs de votre Backup Agent dans le dossier: `C:\ProgramData\Veeam\` ou `/var/log`.
...
[Contactez le support OVHcloud](https://help.ovhcloud.com/csm?id=csm_get_help) qui pourra investiguer. Veillez à nous fournir des logs et des captures d'écran.
