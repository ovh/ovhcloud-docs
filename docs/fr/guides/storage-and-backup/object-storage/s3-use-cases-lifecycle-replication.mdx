...
<Tabs>
  <Tab label="Via l'espace client OVHcloud">
    **Étape 1 - Activer le versioning sur les deux buckets**
    ...
    Cliquez sur <code className="action">Object Storage</code> dans le menu de gauche, puis cliquez sur le nom de votre bucket source (`compliance-primary-<region>`) depuis l'onglet <code className="action">Mes conteneurs</code>.
