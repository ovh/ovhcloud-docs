...
description: "Découvrez comment permettre aux utilisateurs de charger des fichiers directement depuis leur navigateur vers un bucket OVHcloud Object Storage via un formulaire HTML signé côté serveur"
...
:::info
OVHcloud Object Storage prend en charge les formats d'URL **virtual-hosted style** et path style pour les chargements POST :
