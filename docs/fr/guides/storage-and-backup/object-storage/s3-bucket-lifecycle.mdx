...
| AbortIncompleteMultipartUpload                      | non       | Une action de lifecycle qui applique une opération de suppression sur les parties d'un téléversement multi-parties incomplet.  <br/><br/> ⚠️ Cet attribut est mutuellement exclusif avec Filter.Tag, Filter.ObjectSizeGreaterThan et Filter.ObjectSizeLessThan ; i.e, si vous filtrez les objets par tags et/ou par taille, vous devez configurer une autre règle pour supprimer les téléversements multi-parties incomplets.|
