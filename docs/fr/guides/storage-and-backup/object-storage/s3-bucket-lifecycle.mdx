...
- **Suppression des marqueurs de suppression expirés** : supprime les marqueurs de suppression qui n'ont plus aucune version non courante. Aucun champ supplémentaire requis.<br/>
:::rappel
Doit être spécifié dans une autre règle si un délai d'expiration en jours a été défini ou si des tags ont été spécifiés à l'étape 2.
:::
...
- **Suppression des uploads multipart incomplets** : arrête et supprime les parties des uploads multipart incomplets.
    - **Jours après l'initiation** : nombre de jours après le lancement de l'upload avant que ses parties soient supprimées (doit être supérieur à 0).<br/>
:::rappel
Doit être spécifié dans une autre règle si des tags et/ou un filtrage par taille ont été définis à l'étape 2.
:::
