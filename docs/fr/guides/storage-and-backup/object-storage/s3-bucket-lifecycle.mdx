...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, ouvrez la section <code className="action">Public Cloud</code> et sélectionnez votre projet. Dans le menu de gauche, cliquez sur <code className="action">Object Storage</code> sous **Storage**, puis cliquez sur le nom du bucket cible. Accédez à l'onglet <code className="action">Lifecycle</code> et cliquez sur <code className="action">Créer une règle</code>.
...
Une fois tous les champs requis remplis, cliquez sur <code className="action">Créer une règle</code>. La règle apparaît dans la liste des règles de lifecycle et est appliquée de manière asynchrone dans les 24 heures.

**Gestion des règles existantes.**

Depuis la liste des règles de lifecycle, cliquez sur le bouton <code className="action">...</code> à la fin de la ligne d'une règle pour accéder aux actions suivantes :
