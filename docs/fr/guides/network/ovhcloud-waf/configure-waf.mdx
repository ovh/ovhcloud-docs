...
| Les modifications de protection ne sont pas appliquées | Les modifications n'ont pas été enregistrées. | Vérifiez que le bouton <code className="action">Apply changes</code> a été cliqué dans l'onglet <code className="action">Protection</code>. Les modifications des listes d'IP doivent être enregistrées avec <code className="action">Save</code> dans l'onglet <code className="action">Advanced</code>. |
