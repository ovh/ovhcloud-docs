...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Règles L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-rules.mp4" />

Le schéma ci-dessous montre la combinaison de L2 et L3.
