...
- Chaque Availability Zone prend en charge jusqu’à 4 peers BGP. Plus de détails dans [Configurer votre réseau vRack](/guides/network/ovhcloud-connect/vrack-network-setup).
