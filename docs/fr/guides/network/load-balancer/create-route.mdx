...
La gestion des routes n'est accessible qu'au travers de l'<ApiLink>API OVHcloud</ApiLink>. Elle n'est valable que pour les protocoles **http** et **tcp**, et le chemin <code className="action">/ipLoadbalancing/&#123;serviceName&#125;/&#123;protocol&#125;/route/</code> expose l'API dédiée aux routes.
