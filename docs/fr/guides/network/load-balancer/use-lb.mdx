...
|Graphiques|Des graphiques présentant le nombre de connexions simultanées ou le nombre de requêtes par minute. Pour en savoir plus sur ces métriques et sur la manière de les interroger, consultez le guide « [Suivre les métriques de votre Load Balancer OVHcloud](/guides/network/load-balancer/use-api-metrics) »|
