...
La réponse porte sur l'ensemble du service, ainsi que sur le détail de vos farms, frontends et serveurs, chacun indiquant un total et un décompte par statut.

Les différents statuts peuvent être :

- `ok` : Fonctionnement normal.
- `warn` : Fonctionnement dégradé.
- `error` : Hors service.
