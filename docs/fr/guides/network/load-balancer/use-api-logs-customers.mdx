...
Vous pouvez utiliser l'appel API ci-dessous, où **serviceName** est le nom interne de votre Load Balancer, que vous pouvez retrouver sur la page de gestion du Load Balancer de votre espace client OVHcloud ou en utilisant <ApiLink section="/ipLoadbalancing" method="GET" route={"/ipLoadbalancing"}>l'appel API dédié</ApiLink>.
...
Vous pouvez récupérer les spécifications de l'API dans le portail <ApiLink section="/dbaas/logs" method="POST" route={"/dbaas/logs/\{serviceName\}/output/graylog/stream"}>OVH API</ApiLink>.
...
- **serviceName** : il s'agit du nom interne de votre Load Balancer, que vous pouvez retrouver sur la page de gestion du Load Balancer de votre espace client OVHcloud ou en utilisant <ApiLink section="/ipLoadbalancing" method="GET" route={"/ipLoadbalancing"}>l'appel API dédié</ApiLink>.

La requête POST a une charge utile qui nécessite :

- `kind` : le type de journal que vous voulez transférer, soit « http » ou « tcp ». Vous pouvez trouver les types disponibles en utilisant <ApiLink section="/ipLoadbalancing" method="GET" route={"/ipLoadbalancing/\{serviceName\}/log/kind"}>l'appel API dédié</ApiLink>.
...
[Suivre les métriques de votre Load Balancer OVHcloud](/guides/network/load-balancer/use-api-metrics)
