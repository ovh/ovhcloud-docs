...
|-----------|----------|-------------|
| `ovhSubsidiary` | Yes | La filiale du pays dont vous souhaitez consulter le catalogue, par exemple : FR (chaîne de caractères) |

Les valeurs acceptées, ainsi que la devise dans laquelle chacune retourne les tarifs, dépendent de votre zone commerciale :
...
:::info
La valeur `EU` figure dans l'énumération de ce paramètre dans le schéma de l'API, mais elle n'est pas acceptée par cet appel.
:::
