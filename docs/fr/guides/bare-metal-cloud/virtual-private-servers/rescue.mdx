...
Vous pouvez modifier directement les fichiers situés dans `/mnt`. Pour exécuter les commandes du VPS lui-même, accédez au système monté avec la commande suivante. Ces commandes utiliseront alors les binaires et les fichiers de configuration du VPS, et non ceux de l'environnement rescue :
