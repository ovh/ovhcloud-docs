...
La meilleure option consiste à ouvrir notre <ApiLink>console API</ApiLink> et à vérifier si votre licence peut être déplacée vers un autre VPS. Retrouvez les bases dans notre guide « [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps) ».
