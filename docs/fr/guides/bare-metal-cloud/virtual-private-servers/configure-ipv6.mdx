...
<Tabs>
  ...
  <Tab label="Via les API OVHcloud">
    Rendez-vous sur la page des <ApiLink>API OVHcloud</ApiLink> :
...
- [Application persistante sur Redhat et dérivés (Rocky Linux, AlmaLinux, etc.)](#persistentredhat).
- [Application persistante sur Fedora 43 et versions ultérieures](#persistentfedora).
...
#### Application persistante sur Red Hat et ses dérivés (Rocky Linux, AlmaLinux, etc.) <a name="persistentredhat"></a>

Deux méthodes existent pour configurer votre réseau selon le système d'exploitation installé sur votre serveur :

- **pour Rocky Linux & AlmaLinux (8/9)** : Utilisez la méthode basée sur les fichiers *network-scripts* ;
...
#### Application persistante sur Fedora 43 et versions ultérieures <a name="persistentfedora"></a>
