...
description: Installez Fabric ou NeoForge sur votre serveur Minecraft avec le Game Panel pour exécuter des contenus moddés avec des chargeurs de mods personnalisés.
...
Une fois téléchargé, ouvrez les <code className="action">Settings</code> de votre serveur, allez dans l'onglet <code className="action">File Manager</code> et importez le fichier `.jar` dans le répertoire `serverfiles` à l'aide de <code className="action">Upload files</code> ou par glisser-déposer.

### Étape 4 — Exécuter l'installateur

Ouvrez l'onglet <code className="action">Terminal</code> depuis les <code className="action">Settings</code> de votre serveur et exécutez la commande appropriée à votre chargeur de mods.
...
2. Ouvrez l'onglet <code className="action">File Manager</code> depuis les <code className="action">Settings</code> de votre serveur.
