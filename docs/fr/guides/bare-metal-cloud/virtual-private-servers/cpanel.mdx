...
Nous vous recommandons également de consulter notre guide pour [sécuriser un VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps), d'utiliser [nos solutions de sauvegarde](/guides/bare-metal-cloud/virtual-private-servers/landing-page-vps) et de configurer le [Edge Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network).
