...
Premièrement, ajoutez votre bloc d'Additional IP au vRack.
...
[Configurer le réseau sur Windows Server 2016/2019 avec Hyper-V](/guides/bare-metal-cloud/dedicated-servers/hyperv-network-hg-scale)
