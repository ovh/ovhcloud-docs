...
<Tabs>
  ...
  <Tab label="Via les API OVHcloud">
    Sur la <ApiLink>page API OVHcloud</ApiLink>, cliquez en haut à droite sur <code className="action">Login</code>. Sur la page suivante, saisissez votre identifiant client OVHcloud.
