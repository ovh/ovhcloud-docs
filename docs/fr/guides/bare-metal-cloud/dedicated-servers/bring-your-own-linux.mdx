...
| customizations/enableLacpBonding | Activation de LACP pour agréger plusieurs interfaces réseau (si applicable)⁵ | ❌ |
...
⁵ Pour savoir quand cette option s'applique et ce qu'elle configure, consultez le guide « [Comprendre l'agrégation de liens sur les serveurs dédiés](/guides/bare-metal-cloud/dedicated-servers/link-aggregation-overview) ».
