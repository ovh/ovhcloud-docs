...
⁵ Pour savoir quand cette option s'applique et ce qu'elle configure, consultez le guide « [Understanding link aggregation on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/link-aggregation-overview) ».
