...
Pour cela, il vous sera nécessaire de [redémarrer](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server#redémarrage-de-votre-serveur-dédié) votre serveur ESXi à travers l'espace client OVHcloud.
:::
