...
Rendez-vous sur la <ApiLink>console API</ApiLink>, puis utilisez les API ci-dessous afin de modifier l'annonce du bloc IP.

<Api version="v1" section="/vrack" method="GET" route={"/vrack"} />

Cette API permet de récupérer la liste des services vRack. Si vous n'arrivez pas à identifier le service concerné grâce à ces références, aidez-vous de votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> pour le récupérer.
