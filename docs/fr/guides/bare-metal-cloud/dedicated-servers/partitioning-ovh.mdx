...
Les [serveurs dédiés](/links/bare-metal/bare-metal) OVHcloud vous permettent de configurer les disques, le [RAID matériel](/guides/bare-metal-cloud/dedicated-servers/raid-hard), le [RAID logiciel](/guides/bare-metal-cloud/dedicated-servers/raid-soft), LVM, ZFS, etc. pendant [la réinstallation](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server) de votre système d'exploitation depuis l’[API OVHcloud](/links/api) ou depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Dans cet article, nous allons nous concentrer sur l'[API OVHcloud](/links/api).<br/>
