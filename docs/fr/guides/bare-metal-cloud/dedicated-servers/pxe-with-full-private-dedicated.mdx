...
La seule différence majeure notable est que les [réseaux privés](/guides/network/ovhcloud-connect/introduction) n'ont donc pas accès à tout ce qui n'appartient pas à votre infrastructure.<br/>
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="iPXE en action" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/animation.mp4" />
