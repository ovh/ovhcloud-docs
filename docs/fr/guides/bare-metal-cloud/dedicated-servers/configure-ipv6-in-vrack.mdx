...
Renseignez l'identifiant de votre vRack (par exemple `pn-9000000`) dans le *path parameter* `serviceName` et indiquez le bloc IPv6 dans le *request body* :
...
Activez SLAAC dans le *request body* :
...
Utilisez l'appel suivant pour définir un tel sous-réseau :
