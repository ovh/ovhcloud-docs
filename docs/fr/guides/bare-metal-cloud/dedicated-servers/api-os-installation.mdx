...
Concernant la question `enableLacpBonding`, consultez le guide « [Understanding link aggregation on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/link-aggregation-overview) » pour savoir quand elle s'applique et ce qu'elle configure.
