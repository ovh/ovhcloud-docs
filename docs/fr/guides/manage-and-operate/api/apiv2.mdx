...
Une nouvelle branche des API OVHcloud est disponible sous le préfixe **/v2** sur [https://api.eu.ovhcloud.com/v2](https://api.eu.ovhcloud.com/console/?branch=v2). 
...
Il est possible de voir la liste des versions disponible sur la console de l'API OVHcloud. Pour cela, ouvrez la [console](https://api.eu.ovhcloud.com/console/?section=%2Fiam&branch=v2#servers).
