...
| --- | --- | --- |
| `extractable` | Oui (création / PATCH) | Si `true`, le matériel de clé peut être exporté (en clair ou encapsulé, selon la classe de clé). Par défaut : `false` — sauf les clés uniquement publiques, qui valent `true`. |
