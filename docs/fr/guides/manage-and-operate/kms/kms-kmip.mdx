...
- Avoir [créé un certificat d'accès](/guides/manage-and-operate/kms/okms-certificate-management) et [configuré une politique IAM](/guides/manage-and-operate/kms/okms-authentication-methods) pour l'accès KMIP. KMIP ne prend en charge que l'authentification par certificat — voir [Méthodes d'authentification OKMS](/guides/manage-and-operate/kms/okms-authentication-methods).
...
La procédure de configuration varie en fonction du produit à intégrer, mais ne nécessite aucune autre configuration préalable sur le KMS OVHcloud que de [générer un certificat d'accès](/guides/manage-and-operate/kms/okms-certificate-management) et d'accorder les [droits IAM KMIP](#iam-rights) requis. KMIP ne prend pas en charge l'authentification par PAT ou compte de service.
