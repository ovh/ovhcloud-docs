...
- Avoir [créé un certificat d'accès](/guides/manage-and-operate/kms/okms-certificate-management) et [configuré une politique IAM](/guides/manage-and-operate/kms/okms-authentification-method) pour l'accès KMIP. KMIP ne prend en charge que l'authentification par certificat — voir [Méthodes d'authentification OKMS](/guides/manage-and-operate/kms/okms-authentification-method).
