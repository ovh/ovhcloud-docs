...
Votre `okmsId` et votre endpoint régional sont tous deux renvoyés par l'appel d'API suivant :

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

L'`okmsId` figure également dans le <ManagerLink to="/#/okms/key-management-service">dashboard de votre domaine OKMS</ManagerLink>.
...
Vous pouvez aussi l'ouvrir depuis le lien Swagger du <ManagerLink to="/#/okms/key-management-service">tableau de bord de votre domaine OKMS</ManagerLink>.
