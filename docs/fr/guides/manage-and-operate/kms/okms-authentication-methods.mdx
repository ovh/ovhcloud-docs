...
| **Plan de contrôle (API OVHcloud)** | <ApiLink section="/okms" version="v2">`/v2/okms`</ApiLink> | Commander des domaines, gérer les identifiants, configurer la journalisation |
...
:::info
Votre `okmsId` et votre endpoint régional sont tous deux renvoyés par l'appel API suivant :

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

Les deux figurent également dans l'onglet **Informations générales** du <ManagerLink to="/#/okms/key-management-service">dashboard de votre domaine OKMS</ManagerLink>.
:::
...
### Configurer l'authentification <a id="set-up-authentication"></a>
...
### Utiliser l'interface Swagger OKMS <a id="use-the-okms-swagger-ui"></a>
...
Vous pouvez aussi l'ouvrir depuis le lien Swagger du <ManagerLink to="/#/okms/key-management-service">dashboard de votre domaine OKMS</ManagerLink>.
...
### Droits IAM pour OKMS <a id="iam-rights-for-okms"></a>
...
Appliquez ces modèles à la ressource de votre domaine OKMS. Son URN est affiché dans l'onglet **Informations générales** du <ManagerLink to="/#/okms/key-management-service">dashboard de votre domaine OKMS</ManagerLink>. Remplacez `<identity_urn>` et `<okms_urn>` par vos valeurs. Créez les politiques via l'[espace client](/guides/account-and-service-management/account-information/iam-policy-ui) ou l'[API IAM](/guides/account-and-service-management/account-information/iam-policies-api).
