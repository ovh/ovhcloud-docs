...
- Connaître votre `okmsId` et votre endpoint régional, tous deux renvoyés par <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> et affichés dans l'onglet **Informations générales** du <ManagerLink to="/#/okms/key-management-service">dashboard de votre domaine OKMS</ManagerLink>.
