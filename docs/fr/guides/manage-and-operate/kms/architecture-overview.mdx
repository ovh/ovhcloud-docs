...
Pour les régions 3-AZ, l'architecture mono-AZ est dupliquée sur les 3 zones de disponibilité.

<img className="thumbnail" alt="Présentation de l'architecture" src="/images/manage-and-operate/kms/architecture-overview/KMS_Overview_3AZ.png" loading="lazy" />
...
Un Hardware Security Module (HSM) est un dispositif physique spécialisé conçu pour générer, stocker et utiliser des clés cryptographiques de manière sécurisée. Les clés protégées par HSM ne quittent jamais le matériel : les opérations cryptographiques s'exécutent sur un équipement dédié et résistant aux manipulations, ce qui renforce la confidentialité et l'intégrité des clés.

OVHcloud utilise des HSM Thales Luna, certifiés FIPS 140-3 Level 3 et Common Criteria EAL4+.

Les clés créées avec le niveau de protection HSM sont répliquées sur trois HSM physiques distincts. Leur emplacement exact dépend de la région sélectionnée pour l'OKMS.

#### Régions 3-AZ

Dans les régions 3-AZ, les trois HSM sont répartis sur toutes les zones de disponibilité.

#### Régions 1-AZ

Dans les régions 1-AZ, deux HSM sont situés dans la région et un troisième HSM distant est déployé dans une région voisine distincte.

Emplacements des HSM distants :

- **EU-WEST-GRA** (à venir) : EU-WEST-RBX
- **EU-WEST-RBX** (à venir) : EU-WEST-SBG
- **EU-WEST-SBG** (à venir) : EU-WEST-GRA
