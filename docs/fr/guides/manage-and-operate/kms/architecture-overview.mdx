...
Sur les régions 3-AZ, les trois HSM sont répartis sur toutes les zones de disponibilité.

#### Régions 1-AZ

Sur les régions 1-AZ, deux HSM sont situés dans la région et un troisième HSM distant est déployé dans une région voisine distincte.
