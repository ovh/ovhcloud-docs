...
<img className="thumbnail" alt="Flux Graylog affichant une entrée de log Kubernetes avec ses métadonnées en champs distincts" src="/images/manage-and-operate/observability/logs-data-platform/ingestion-kubernetes-fluent-bit/kube_graylog.png" loading="lazy" />
