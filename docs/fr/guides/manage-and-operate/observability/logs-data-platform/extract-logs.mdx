...
| Authentification | Utilisateur/mot de passe basique **ou** jeton bearer IAM (voir la [FAQ IAM](/guides/manage-and-operate/observability/logs-data-platform/iam-presentation-faq)). |
