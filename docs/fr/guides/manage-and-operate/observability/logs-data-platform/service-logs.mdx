...
| :----------- | :----------- | :--------- |
| Security & Identity - OVHcloud Account - Activity | Espace client OVHcloud et API | [Génération des logs des comptes OVHcloud avec Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - OVHcloud Account - Audit | Espace client OVHcloud et API | [Génération des logs des comptes OVHcloud avec Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - OVHcloud Account - IAM | Espace client OVHcloud et API | [Génération des logs des comptes OVHcloud avec Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - Key Management Service | Espace client OVHcloud et API | [Transférer les logs du KMS OVHcloud à Logs Data Platform](/guides/manage-and-operate/kms/logs) |
| Bare Metal Cloud - Dedicated Servers | Espace client OVHcloud et API | [Transfert des logs (Logs Forwarding) pour les serveurs dédiés OVHcloud](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-logs-to-customers) |
| Public Cloud | Espace client OVHcloud et API | [Introduction aux logs Public Cloud](/guides/public-cloud/cross-functional/logs-concepts) |
| Public Cloud - Managed Kubernetes Service | Espace client OVHcloud et API | [Redirection des logs d'audit du Managed Kubernetes Service](/guides/public-cloud/containers-orchestration/managed-kubernetes/forwarding-audit-logs) |
| Public Cloud - Load Balancer | Espace client OVHcloud et API | [Transfert des logs (Logs Forwarding) TCP / HTTP / HTTPS du Load Balancer Public Cloud](/guides/public-cloud/network-services/loadbalancer-logs-forward) |
| Public Cloud - Databases | Espace client OVHcloud et API | [Configurer le transfert des logs pour les bases de données Public Cloud](/guides/public-cloud/databases/logs-to-customers) |
| Public Cloud - Analytics | Espace client OVHcloud et API | [Mettre en place le transfert de logs d'un service Analytics](/guides/public-cloud/data-analytics/analytics/logs-to-customers) |
| Hosted Private Cloud - Managed VMware vSphere | Espace client OVHcloud et API | [Logs Data Platform - Collecter les logs VMware on OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vmware-ldp) |
| Web Cloud - Web Hosting | Espace client OVHcloud et API | [Hébergement web - Comment activer et gérer les logs ?](/guides/web-cloud/web-hosting/enable-ldp-web-hosting) |
| Web Cloud - Managed Hosting for WordPress | Espace client OVHcloud et API | [Managed Hosting for WordPress - Récupérer et analyser vos logs](/guides/web-cloud/managed-hosting/wordpress-logs) |
| Web Cloud - Web Cloud Databases | Espace client OVHcloud et API | [Web Cloud Databases - Comment gérer les logs ?](/guides/web-cloud/databases/db-retrieve-logs) |
| Web Cloud - Private Exchange | Espace client OVHcloud et API | [Exchange - Comment gérer les logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Web Cloud - Trusted Exchange | Espace client OVHcloud et API | [Exchange - Comment gérer les logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Infrastructure solutions - OVHcloud Connect | Espace client OVHcloud et API | [Transfert des logs (Log Forwarding) pour OVHcloud Connect](/guides/network/ovhcloud-connect/logs-to-customers) |
| Infrastructure solutions - OVHcloud Load Balancer | Espace client OVHcloud et API | [Transfert des logs (Log Forwarding) TCP / HTTP / HTTPS du Load Balancer OVHcloud](/guides/network/load-balancer/use-api-logs-customers) |
...
- Tous les logs *applicatifs* des Public Cloud Databases sont envoyés vers un autre flux de données (flèche bleue).
...
- vous pouvez autoriser votre équipe d'administration de bases de données à consulter uniquement le flux de données contenant les logs de vos Public Cloud Databases.
