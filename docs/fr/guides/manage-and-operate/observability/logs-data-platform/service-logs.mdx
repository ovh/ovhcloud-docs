...
- A [Logs Data Platform](https://www.ovhcloud.com/fr/identity-security-operations/logs-data-platform/) account
...
| Infrastructure solutions - OVHcloud Connect | OVHcloud Control Panel & API | [OVHcloud Connect Logs Forwarding](/guides/network/ovhcloud-connect/logs-forwarding) |
