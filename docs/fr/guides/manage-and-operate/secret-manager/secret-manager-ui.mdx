...
- Pour accéder aux secrets via l'API REST ou l'API compatible HashiCorp Vault KV2, configurez une [méthode d'authentification](/guides/manage-and-operate/kms/okms-authentification-method) pour votre domaine OKMS (jeton d'accès personnel, compte de service ou certificat d'accès).
...
Un utilisateur disposant des droits IAM nécessaires peut accéder au contenu d'un secret. Configurez l'authentification et les politiques IAM comme décrit dans [Méthodes d'authentification OKMS](/guides/manage-and-operate/kms/okms-authentification-method).
...
Avant d'appeler l'une ou l'autre API, configurez une [méthode d'authentification](/guides/manage-and-operate/kms/okms-authentification-method) et la [politique IAM](/guides/manage-and-operate/kms/okms-authentification-method#iam-rights-for-okms) requise sur votre domaine OKMS. Pour l'utilisation de l'API REST, un jeton d'accès personnel (PAT) ou un compte de service est recommandé.
