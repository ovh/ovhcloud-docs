...
- Avoir [configuré une méthode d'authentification](/guides/manage-and-operate/kms/okms-authentification-method) pour le plan de données OKMS (ce guide utilise un jeton d'accès personnel).
