...
<img className="thumbnail" alt="Nouveau cluster" src="/images/hosted-private-cloud/powered-by-vmware/create-cluster-enable-evc/en02newcluster.png" loading="lazy" />
...
L'option vSAN nécessite des hôtes compatibles. Consultez le [guide du Panneau de configuration Hosted Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud) pour savoir comment en commander si nécessaire.
:::
...
Cliquez sur <code className="action">OK</code> lorsque vous avez terminé.
