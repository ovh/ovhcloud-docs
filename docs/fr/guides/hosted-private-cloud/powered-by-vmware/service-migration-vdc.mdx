...
- **Etape 1.1:** [Choisir votre gamme](#etape-11-choisir-votre-gamme)
- **Etape 1.2:** [Sélectionner vos hosts (compute)](#etape-12-sélectionner-vos-hosts-compute)
- **Etape 1.3:** [Sélectionner vos datastores (storage)](#etape-13-sélectionner-vos-datastores-storage)
...
- **Etape 2.1:** [Ajouter un nouveau vDC de destination](#etape-21-ajouter-un-nouveau-vdc-de-destination)
- **Etape 2.2:** [Ajouter des nouveaux hosts et datastores](#etape-22-ajouter-des-nouveaux-hosts-et-datastores)
- **Etape 2.3:** [Convertir une datastore comme global](#etape-23-convertir-une-datastore-comme-global)
...
- **Etape 3.1:** [Vérifier les caractéristiques héritées (Certifications, KMS, restrictions d'accès)](#etape-31-vérifier-les-caractéristiques-héritées-certifications-kms-restrictions-daccès)
  - **Etape 3.1.1:** [Certifications](#etape-311-certifications)
  - **Etape 3.1.2:** [Key Management Server (KMS)](#etape-312-key-management-server-kms)
  - **Etape 3.1.3:** [Restrictions d'accès](#etape-313-restrictions-daccès)
- **Etape 3.2:** [Gérer les droits des utilisateurs](#etape-32-gérer-les-droits-des-utilisateurs)
- **Etape 3.3:** [Activer les options Veeam Managed Backup & Zerto Disaster Recovery](#etape-33-activer-les-options-veeam-managed-backup--zerto-disaster-recovery)
- **Etape 3.4:** [Vérifier votre réseau (vRack, IP publique)](#etape-34-vérifier-votre-réseau-vrack-ip-publique)
  - **Etape 3.4.1:** [vRack](#etape-341-vrack)
  - **Etape 3.4.2:** [Réseau publique](#etape-342-réseau-publique)
...
- **Etape 4.1:** [Reconfigurer VMware High Availability (HA)](#etape-41-reconfigurer-vmware-high-availability-ha)
- **Etape 4.2:** [Reconfigurer VMware Distributed Resource Scheduler (DRS)](#etape-42-reconfigurer-vmware-distributed-resource-scheduler-drs)
- **Etape 4.3:** [Reconstruire vos resource pools](#etape-43-reconstruire-vos-resource-pools)
- **Etape 4.4:** [Recréer vos Datastores Clusters (si pertinent)](#etape-44-recréer-vos-datastores-clusters-si-pertinent)
- **Etape 4.5:** [Activer vSAN (si pertinent)](#etape-45-activer-vsan-si-pertinent)
- **Etape 4.6:** [Recréer votre configuration réseau vSphere](#etape-46-recréer-votre-configuration-réseau-vsphere)
- **Etape 4.7:** [Vérifier l'organisation de votre inventaire (si pertinent)](#etape-47-vérifier-lorganisation-de-votre-inventaire-si-pertinent)
- **Etape 4.8:** [Migrer NSX-V vers NSX (si pertinent)](#etape-48-migrer-nsx-v-vers-nsx-si-pertinent)
  - **Etape 4.8.1:** [NSX Distributed Firewall](#etape-481-nsx-distributed-firewall)
  - **Etape 4.8.2:** [NSX Distributed Logical Router](#etape-482-nsx-distributed-logical-router)
  - **Etape 4.8.3:** [NSX Edges](#etape-483-nsx-edges)
    - **Etape 4.8.3.1:** [Créer les T1 et les segments](#etape-4831-créer-les-t1-et-les-segments)
    - **Etape 4.8.3.2:** [DHCP](#etape-4832-dhcp)
    - **Etape 4.8.3.3:** [DNS](#etape-4833-dns)
    - **Etape 4.8.3.4:** [Règles NAT](#etape-4834-règles-nat)
    - **Etape 4.8.3.5:** [Load Balancing NSX](#etape-4835-load-balancing-nsx)
    - **Etape 4.8.3.6:** [Pare-feu des passerelles T0 T1](#etape-4836-pare-feu-des-passerelles-t0-t1)
    - **Etape 4.8.3.7:** [VPN](#etape-4837-vpn)
      - **Etape 4.8.3.7.1:** [IPSec](#etape-48371-ipsec)
      - **Etape 4.8.3.7.2:** [SSL VPN](#etape-48372-ssl-vpn)
    - **Etape 4.8.3.8:** [Reconfiguration du bloc IP initial](#etape-4838-reconfiguration-du-bloc-ip-initial)
- **Etape 4.9:** [Etendre la protection Zerto Disaster Recovery Protection (si pertinent)](#etape-49-etendre-la-protection-zerto-disaster-recovery-protection-si-pertinent)
  - **Etape 4.9.1:** [VPG Source](#etape-491-vpg-source)
  - **Etape 4.9.2:** [VPG Destination](#etape-492-vpg-destination)
...
- **Etape 5.1:** [Storage Motion](#etape-51-storage-motion)
- **Etape 5.2:** [vMotion](#etape-52-vmotion)
...
- **Etape 6.1:** [Reconfigurer Veeam Managed Backup (si pertinent)](#etape-61-reconfigurer-veeam-managed-backup-si-pertinent)
- **Etape 6.2:** [Reconfigurer Zerto Disaster Recovery (si pertinent)](#etape-62-reconfigurer-zerto-disaster-recovery-si-pertinent)
- **Etape 6.3:** [Recréer les règles d'affinité](#etape-63-recréer-les-règles-daffinité)
- **Etape 6.4:** [Reconfigurer la Private Gateway (si pertinent)](#etape-64-reconfigurer-la-private-gateway-si-pertinent)
- **Etape 6.5:** [Passer les hosts en mode maintenance](#etape-65-passer-les-hosts-en-mode-maintenance)
- **Etape 6.6:** [Supprimer les anciens datastores](#etape-66-supprimer-les-anciens-datastores)
- **Etape 6.7:** [Supprimer les anciens hosts](#etape-67-supprimer-les-anciens-hosts)
- **Etape 6.8:** [Supprimer le vDC source](#etape-68-supprimer-le-vdc-source)
