...
- **Etape 1.2:** [Sélectionner vos hosts (compute)](#etape-12-selectionner-vos-hosts-compute)
- **Etape 1.3:** [Sélectionner vos datastores (storage)](#etape-13-selectionner-vos-datastores-storage)
...
- **Etape 3.1:** [Vérifier les caractéristiques héritées (Certifications, KMS, restrictions d'accès)](#etape-31-verifier-les-caracteristiques-heritees-certifications-kms-restrictions-dacces)
  ...
  - **Etape 3.1.3:** [Restrictions d'accès](#etape-313-restrictions-dacces)
- **Etape 3.2:** [Gérer les droits des utilisateurs](#etape-32-gerer-les-droits-des-utilisateurs)
...
- **Etape 3.4:** [Vérifier votre réseau (vRack, IP publique)](#etape-34-verifier-votre-reseau-vrack-ip-publique)
  - **Etape 3.4.1:** [vRack](#etape-341-vrack)
  - **Etape 3.4.2:** [Réseau publique](#etape-342-reseau-publique)
...
- **Etape 4.4:** [Recréer vos Datastores Clusters (si pertinent)](#etape-44-recreer-vos-datastores-clusters-si-pertinent)
- **Etape 4.5:** [Activer vSAN (si pertinent)](#etape-45-activer-vsan-si-pertinent)
- **Etape 4.6:** [Recréer votre configuration réseau vSphere](#etape-46-recreer-votre-configuration-reseau-vsphere)
- **Etape 4.7:** [Vérifier l'organisation de votre inventaire (si pertinent)](#etape-47-verifier-lorganisation-de-votre-inventaire-si-pertinent)
- **Etape 4.8:** [Migrer NSX-V vers NSX (si pertinent)](#etape-48-migrer-nsx-v-vers-nsx-si-pertinent)
  ...
  - **Etape 4.8.3:** [NSX Edges](#etape-483-nsx-edges)
    - **Etape 4.8.3.1:** [Créer les T1 et les segments](#etape-4831-creer-les-t1-et-les-segments)
    - **Etape 4.8.3.2:** [DHCP](#etape-4832-dhcp)
    - **Etape 4.8.3.3:** [DNS](#etape-4833-dns)
    - **Etape 4.8.3.4:** [Règles NAT](#etape-4834-regles-nat)
...
- **Etape 6.3:** [Recréer les règles d'affinité](#etape-63-recreer-les-regles-daffinite)
