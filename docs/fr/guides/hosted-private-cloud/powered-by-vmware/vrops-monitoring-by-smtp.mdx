...
Vous pouvez contrôler que le flux a bien été ouvert en utilisant l'appel API suivant : <Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/vrops/outgoingFlow/\{outgoingFlowId\}"} />
