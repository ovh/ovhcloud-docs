...
- Avoir accès à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou à l'<ApiLink>interface d'administration de vos services par API</ApiLink>.
...
Dans le menu <code className="action">Hosted Private Cloud</code>, cliquez sur l'onglet <code className="action">Opérations</code>. Sélectionnez <code className="action">À faire</code> dans le menu déroulant permettant de filtrer les opérations.
...
Rendez-vous sur l'<ApiLink>interface d'administration de vos services par API</ApiLink>. Vous pouvez vous aider de notre guide « [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps) ».
