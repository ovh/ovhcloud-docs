...
Vous pourrez suivre le déplacement du bloc IP depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> dans la partie <code className="action">Hosted Private Cloud</code> puis <code className="action">Private Cloud</code>. Cliquez sur votre service Hosted Private Cloud puis sur l'onglet <code className="action">Opérations</code>.
