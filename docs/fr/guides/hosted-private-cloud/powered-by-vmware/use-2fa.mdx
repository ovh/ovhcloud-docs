...
Ces applications doivent être préalablement autorisées au travers de la politique d'accès au vCenter qui est paramétrable dans votre [espace client](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#sécurité)
