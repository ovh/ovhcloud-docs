...
- Être connecté à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> ou à la <ApiLink>console API console pour vos services</ApiLink>.
...
Sélectionnez votre infrastructure sous <code className="action">Managed VMware vSphere</code> puis cliquez sur l'onglet <code className="action">Operations</code>. 
