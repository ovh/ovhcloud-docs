...
Dans votre [interface vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection), placez-vous dans la vue <code className="action">Stockage</code>.
