...
<code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX.XXX.XXX.XXX</code> > <code className="action">Utilisateur</code> > <code className="action">Modifier</code> puis activez le bouton <code className="action">NSX Interface</code>.
...
Cliquez sur : <code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX-XXX-XXX-XXX</code> > <code className="action">Utilisateur</code> > <code className="action">Modifier</code>.
...
Toujours depuis votre arborescence Hosted Private Cloud, cliquez sur <code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX-XXX-XXX-XXX</code>.
<br/><br/>
