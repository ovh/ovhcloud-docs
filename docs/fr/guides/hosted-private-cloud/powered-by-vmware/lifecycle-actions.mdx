...
- Avoir accès aux <ApiLink>API OVHCloud</ApiLink>. Au besoin, consultez le guide « [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps) ».
...
Cliquez sur l'onglet <code className="action">Hosted Private Cloud</code> et sélectionnez votre service dans la liste <code className="action">Managed VMware vSphere</code>.
