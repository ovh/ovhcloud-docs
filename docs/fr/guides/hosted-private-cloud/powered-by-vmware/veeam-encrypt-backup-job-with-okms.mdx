...
Vous pouvez créer votre certificat d’accès dans OKMS en utilisant soit l’<ApiLink>API OVHcloud</ApiLink>, soit <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>.
...
2. Récupérez le certificat avec une requête GET :
    ...
    <Api version="v2" section="/okms" method="GET" route={"/okms/resource/\\{okmsId\\}/credential"} />
