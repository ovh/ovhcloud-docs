...
- Avoir parcouru le guide [OPCP - Intégration réseau et connexion à la plateforme](/guides/hosted-private-cloud/opcp/opcp-network-architecture), qui décrit l'architecture réseau dans laquelle s'inscrivent ces pré-requis.
