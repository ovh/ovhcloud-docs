...
- Le mot de passe SED du serveur cible, délivré par l'équipe OVH lors du déploiement.
...
Une fois connecté, il vous sera demandé de saisir le mot de passe SED afin de déclencher le déverrouillage depuis le shell PBA.
