...
Pour les sauvegarder, la meilleure solution consiste à stocker les secrets Kubernetes dans votre gestionnaire de mots de passe de confiance, entièrement séparé de l'installation OPCP.
