...
Des sauvegardes des données du contrôleur sont réalisées dans OPCP. Elles vous permettent de récupérer en cas de problèmes physiques ou logiques. Les sauvegardes mentionnées ici ne couvrent pas le reste, comme l'ensemble des données présentes sur les serveurs OPCP.
