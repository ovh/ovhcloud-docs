...
Pour vérifier l'état actuel du nœud et récupérer son identifiant, consultez le guide « [Cycle de vie d'un nœud OPCP](/guides/hosted-private-cloud/opcp/node-lifecycle) ».
