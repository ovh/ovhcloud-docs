...
- Savoir consulter l'inventaire NetBox (voir le guide « [OPCP - Comment visualiser l'inventaire des nœuds](/guides/hosted-private-cloud/opcp/how-to-see-node-inventory) »).
