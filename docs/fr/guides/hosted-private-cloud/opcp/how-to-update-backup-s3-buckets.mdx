...
description: "Découvrez comment changer les buckets de stockage objet S3 utilisés par les sauvegardes de la plateforme OPCP, puis réinitialiser les dépôts de sauvegarde"
