...
description: Découvrez comment créer un nouveau compte utilisateur dans le Landing Zone Manager et s'y connecter pour la première fois
...
Connectez-vous au Landing Zone Manager avec un compte disposant des privilèges d'administrateur. Depuis la navigation principale, ouvrez la section <code className="action">Account management</code>.

<img className="thumbnail" alt="Page d'accueil du Landing Zone Manager" src="/images/hosted-private-cloud/opcp/landing-zone-manager-create-user-account/landingzone_homepage.png" loading="lazy" />

### Étape 2 : Créer un nouveau compte utilisateur

Cliquez sur le bouton <code className="action">+ Create new account</code> pour ouvrir le formulaire de création de compte utilisateur.
...
<img className="thumbnail" alt="Formulaire de création d'utilisateur" src="/images/hosted-private-cloud/opcp/landing-zone-manager-create-user-account/landingzone_create_user.png" loading="lazy" />
...
<img className="thumbnail" alt="Formulaire de connexion au Landing Zone Manager" src="/images/hosted-private-cloud/opcp/landing-zone-manager-create-user-account/landingzone_loginpage.png" loading="lazy" />
