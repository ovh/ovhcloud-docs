...
- **Lien direct :** [SAP HANA](/links/control-panel/privatecloud-sap-hana)
- **Pour accéder à vos services :** <code className="action">Hosted Private Cloud</code> > <code className="action">SAP Features Hub</code> > Sélectionnez votre service
...
<Api version="v1" section="/dedicatedCloud" method="DELETE" route={"/dedicatedCloud/\{serviceName\}/sap/\{taskId\}"} />
