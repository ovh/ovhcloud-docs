...
description: "Présentation des licences incluses dans l'offre Nutanix on OVHcloud packagée"
...
<img className="thumbnail" alt="Resumé licences" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/02-available-services/recap.png" loading="lazy" />
