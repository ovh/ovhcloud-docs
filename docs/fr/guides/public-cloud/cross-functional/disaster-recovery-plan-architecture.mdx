...
- Avoir accès à l'<ManagerLink to="/#/public-cloud/pci/projects">espace client OVHcloud</ManagerLink> et aux [API OVHcloud](/guides/manage-and-operate/api/first-steps)
