...
| :----------- | :----------- | :--------- |
| Public Cloud - Compute | Espace client OVHcloud et API | [Comprendre les logs d'API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Block Storage | Espace client OVHcloud et API | [Comprendre les logs d'API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Network | Espace client OVHcloud et API | [Comprendre les logs d'API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Managed Kubernetes Service | Espace client OVHcloud et API | [Managed Kubernetes Service Audit Logs Forwarding](/guides/public-cloud/containers-orchestration/managed-kubernetes/forwarding-audit-logs) |
