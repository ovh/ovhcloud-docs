...
Générez des identifiants API avec le <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">générateur de tokens API OVHcloud</CreateToken>. Stockez l'Application Key, l'Application Secret et le Consumer Key de manière sécurisée — jamais dans le contrôle de version.
