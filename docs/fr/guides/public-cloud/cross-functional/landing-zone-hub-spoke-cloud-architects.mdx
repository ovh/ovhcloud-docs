...
La construction d'une landing zone hub and spoke est un projet complexe impliquant plusieurs équipes. [OVHcloud Professional Services](https://www.ovhcloud.com/en-gb/professional-services/) peut vous accompagner dans la revue d'architecture, le déploiement assisté et l'évaluation de la maturité opérationnelle.
:::
...
La configuration IaC complète d'OrbitalEdge — y compris les fichiers `terraform.tfvars` pour les quatre spokes — est disponible sous `examples/orbital-edge` dans le dépôt [hub-and-spoke-public-cloud](https://github.com/ovh/public-cloud-examples/landing-zone).
...
:::info
Vous cherchez une implémentation IaC prête à l'emploi ? Le projet open source [hub-and-spoke-public-cloud](https://github.com/ovh/public-cloud-examples/landing-zone) fournit une référence OpenTofu complète pour cette architecture sous `deployments/mono-vrack-lan-transit`.
...
Pour la liste complète et à jour, consultez la [page de disponibilité des régions OVHcloud Public Cloud](https://www.ovhcloud.com/en-gb/public-cloud/regions-availability/).
...
Pour un guide détaillé sur l'IAM OVHcloud, consultez [Sécuriser et structurer vos projets Public Cloud](/guides/public-cloud/cross-functional/securing-and-structuring-projects).
...
2. **OVH Gateway** sur le réseau WAN — fournit le NAT et le routage Internet pour tout le trafic sortant des spokes. Consultez le [guide Réseau privé avec Gateway](/guides/public-cloud/network-services/getting-started-02-create-private-network-gateway) pour les étapes de configuration.
...
Les services managés OVHcloud (Managed Databases, Managed Kubernetes) prennent également en charge la transmission native des journaux vers LDP — voir [Transmettre des journaux depuis les produits OVHcloud vers Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-logs-forwarding).
...
[Demander un devis auprès des OVHcloud Professional Services](https://www.ovhcloud.com/en-gb/professional-services/)
...
- [Meilleures pratiques pour sécuriser et structurer vos projets OVHcloud Public Cloud](/guides/public-cloud/cross-functional/securing-and-structuring-projects)
- [Comment utiliser Terraform avec OVHcloud Public Cloud](/guides/public-cloud/cross-functional/how-to-use-terraform)
- [Configurer le vRack pour Public Cloud via l'API OVHcloud](/guides/public-cloud/network-services/getting-started-08-creating-vrack-with-api)
