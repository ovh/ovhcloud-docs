...
Pour démarrer un projet, vous devrez nécessairement enregistrer un moyen de paiement lors de la création du projet.
...
Votre moyen de paiement étant enregistré, il servira à débiter le montant calculé pour votre [facturation en fin de mois](/guides/public-cloud/cross-functional/analyze-billing). Ce calcul repose sur le temps d'utilisation de chaque ressource, en fonction du prix des ressources. Pour les instances, les prix sont généralement affichés sous forme de tarif horaire pour plus de lisibilité, mais la facturation se fait à la seconde, avec une durée minimale de facturation d'une minute.
