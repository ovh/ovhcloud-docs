...
Outre le *end point* de l'API, les clés nécessaires sont `application_key`, `application_secret` et `consumer_key`. Ces clés peuvent être générées via la <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">page de génération de token OVHcloud</CreateToken>.
