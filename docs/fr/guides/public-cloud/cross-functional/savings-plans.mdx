...
- Si le client dispose de 15 instances de type B3-8 et souscrit à un Savings Plan pour 10 instances B3-8, les 10 premières seront automatiquement couvertes par la facturation du Savings Plan et les 5 autres seront facturées au tarif standard.
...
Les vCPUs supplémentaires, c'est-à-dire ceux qui ne sont pas couverts par votre Savings Plan, sont facturés à la seconde au tarif standard, comme pour une facturation classique.
