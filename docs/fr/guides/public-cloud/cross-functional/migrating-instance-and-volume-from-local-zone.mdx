...
Vérifiez d'abord la classe de stockage du volume source, et reprenez-la pour le nouveau volume sauf si vous souhaitez délibérément en changer — la classe de stockage affecte à la fois la performance et la facturation :
