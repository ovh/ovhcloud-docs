...
La partie 1 s'est terminée sur la région cible : chargez de nouveau le fichier OpenRC de la Local Zone source. La commande ci-dessous et l'étape 6 s'exécutent sur celle-ci, et l'étape 8 revient à la région cible.
