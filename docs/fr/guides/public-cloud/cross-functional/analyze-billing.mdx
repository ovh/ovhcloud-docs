...
* Une [instance Public Cloud](/guides/public-cloud/compute/getting-started)
...
Le but est de fournir une facturation qui correspond au mieux à l'utilisation qu'ont les clients de ce service. Pour répondre à cet objectif, il est nécessaire de rendre la facturation granulaire. Pour les ressources facturées à la durée, comme les instances, l'unité est le temps, compté en secondes. Les ressources de stockage suivent une unité différente, basée sur la capacité (voir la section « [Stockage](#le-stockage) » ci-dessous).

Pour chaque ressource facturée à la durée, un compteur d'usage (en secondes) démarre à la création de la ressource et se termine à sa suppression, selon le principe que chaque seconde d'utilisation est due au-delà d'une durée minimale de facturation d'une minute — sans arrondi à l'heure supérieure.
...
Pour l'instance, du 4 du mois à 9:40 au 12 du même mois à 16:30, il y a 200 heures d'utilisation. Elles sont facturées 0,111 euros par heure.

Pour le stockage, du 8 du mois à 10:00 au 12 du même mois à 16:30, il y a 103 heures d'utilisation. Le Go de Classic Volume coûte 0,04 euros/mois (0,0000555556 euros/heure).
...
L'utilisation d'une instance étant mesurée à la seconde (au-delà d'une durée minimale de facturation d'une minute), les périodes d'utilisation plus courtes sont facturées avec la même précision : par exemple, si vous utilisez une instance pendant seulement 20 minutes, vous ne serez facturé que pour ces 20 minutes, sans arrondi à l'heure supérieure.
...
Dans le mode de facturation à l'heure, le service est facturé pour la durée exacte d'utilisation, à la seconde près.
...
Ces instances sont payées le 1er du mois suivant, pour la consommation exacte — calculée à la seconde — du mois précédent.
