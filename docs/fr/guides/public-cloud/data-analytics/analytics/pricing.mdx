...
Cet exemple illustre la manière dont l'utilisation est reportée et facturée avant et après l'évolution du modèle de tarification.

### Configuration de l'exemple

Les services suivants sont déployés au cours du mois d'avril (30 jours) :

| Service        | Offre      | Flavor | Stockage additionnel       | Date de création  |
| -------------- | ---------- | ------ | -------------------------- | ----------------- |
| Kafka          | Production | B3-8   | 180 Go                     | 1er avril à 00:00 |
| Kafka Connect  | Production | B3-8   | N/A                        | 15 avril à 00:00  |
| ClickHouse n°1 | Production | B3-8   | 400 Go                     | 1er avril à 00:00 |
| ClickHouse n°2 | Production | B3-32  | N/A                        | 1er avril à 00:00 |
...
Dans le nouveau modèle de facturation, les ressources de calcul, de stockage et de sauvegarde sont reportées séparément.
