...
```bash
ovhcloud cloud reference managed-rancher list-plans --cloud-project <project_id>
```

**2. List available versions:**

```bash
ovhcloud cloud reference managed-rancher list-versions --cloud-project <project_id>
```
