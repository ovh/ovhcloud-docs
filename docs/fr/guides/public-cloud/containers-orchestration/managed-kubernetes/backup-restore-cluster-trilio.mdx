...
<ol>
  <li>An <a href="/guides/storage-and-backup/object-storage/pcs-create-container#créer-un-conteneur">OVHcloud Object Storage Container/Bucket</a> and a <code>Object Storage</code> User which will have permission to access the Object Storage Container.</li>
...
- To create Target for the `OVHcloud Object Storage using S3 Swift API`, use [this link](/guides/storage-and-backup/object-storage/pcs-create-container#créer-un-conteneur).
