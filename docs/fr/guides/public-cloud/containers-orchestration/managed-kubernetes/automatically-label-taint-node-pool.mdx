...
Le nom du service de votre cluster (son identifiant unique) apparaît dans l'URL de l'espace client OVHcloud lorsque vous êtes sur la page de détails du cluster, ainsi que dans l'onglet Vue d'ensemble du cluster.
