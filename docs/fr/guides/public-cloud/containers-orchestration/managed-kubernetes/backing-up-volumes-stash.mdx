...
Pour vérifier que les sauvegardes ont bien été créées, ouvrez l'<ManagerLink to="/#/pci/projects">espace client OVHcloud</ManagerLink>, rendez-vous dans votre projet Public Cloud, puis consultez la section **Snapshots** ou **Volume Backups**. Vous devriez y voir les snapshots listés, confirmant que la sauvegarde a bien été effectuée.
