...
Créez des **identifiants de script dédiés** (comme [décrit ici](https://github.com/ovh/go-ovh#supported-apis)). Suivez notre tutoriel [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps) pour les générer via la <CreateToken>page de génération de token OVHcloud</CreateToken>, puis notez l'Application Key, l'Application Secret et la Consumer Key : vous en aurez besoin à l'étape suivante.
