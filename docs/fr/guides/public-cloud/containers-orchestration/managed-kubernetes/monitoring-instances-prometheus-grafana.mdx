...
1. Connectez-vous à l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), rendez-vous dans la section **Public Cloud**, puis sélectionnez votre projet.
...
Créez des **identifiants de script dédiés** (comme [décrit ici](https://github.com/ovh/go-ovh#supported-apis)) :

1. Rendez-vous sur [https://api.ovh.com/](https://api.ovh.com/) et cliquez sur **Connexion**. Authentifiez-vous avec vos identifiants OVHcloud.
2. Suivez les instructions à l'écran pour générer un token (Application Key, Application Secret, Consumer Key).
3. Notez les trois valeurs : vous en aurez besoin à l'étape suivante.
