...
1. Connectez-vous à l'<ManagerLink to="/#/pci/projects">espace client OVHcloud</ManagerLink>, rendez-vous dans la section **Public Cloud**, puis sélectionnez votre projet.
