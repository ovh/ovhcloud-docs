...
Dans ce guide, notre conteneur Object Storage est nommé `popeye` et sa région est `GRA`. Vous pouvez vérifier et configurer le nom du conteneur dans l'<ManagerLink to="/#/pci/projects">espace client OVHcloud</ManagerLink>, dans la section **Public Cloud** > votre projet > **Object Storage**.
...
1. Dans l'<ManagerLink to="/#/pci/projects">espace client OVHcloud</ManagerLink>, rendez-vous dans la section **Public Cloud** > votre projet, puis cliquez sur **Utilisateurs & Rôles** dans le menu de gauche.
