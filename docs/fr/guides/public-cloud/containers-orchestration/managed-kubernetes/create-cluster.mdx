...
<Tabs>
  <Tab label="Via l'espace client OVHcloud">
    ...
    Configurez le node pool par défaut. Un node pool est un groupe de nœuds partageant la même configuration. Consultez le guide [Gérer les node pools](/guides/public-cloud/containers-orchestration/managed-kubernetes/managing-nodes) pour plus d'informations.
    ...
    <img className="thumbnail" alt="Node pool par défaut" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster6.png" loading="lazy" />
