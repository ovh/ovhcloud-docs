...
<Tabs>
  ...
  <Tab label="Espace client OVHcloud">
    Dans l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), rendez-vous dans la section **Public Cloud** et sélectionnez votre projet. Dans le menu de gauche, sous **Conteneurs et orchestration**, cliquez sur **Managed Kubernetes Service**, puis cliquez sur **Créer un cluster**.
