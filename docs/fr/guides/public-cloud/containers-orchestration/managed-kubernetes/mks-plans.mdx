...
La taille du cluster définit le nombre de nœuds de travail dans le cluster Kubernetes. Le plan Free prend en charge jusqu'à 100 nœuds, ce qui est adapté à l'apprentissage, aux tests ou aux projets à petite échelle. Le plan Standard évolue jusqu'à 500 nœuds, permettant des déploiements de production moyens à grands.
...
#### Régions prises en charge par plan
...
Pour une liste complète des régions prises en charge par plan et leur architecture de déploiement (1-AZ vs 3-AZ), consultez le guide « [Datacenters, nœuds et storage flavors - Disponibilité régionale par plan MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/datacenters-nodes-storage-flavors) ».
