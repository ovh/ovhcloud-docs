...
Le service Load Balancer Public Cloud est facturé à l'heure et apparaîtra dans votre projet Public Cloud. Pour plus d'informations, reportez-vous à la documentation suivante : [Tarifs du Network Load Balancer](/links/public-cloud/prices-network)
:::
...
$ helm install ingress-nginx ingress-nginx/ingress-nginx -n ingress-nginx --create-namespace
NAME: ingress-nginx
LAST DEPLOYED: Mon Sep 14 14:13:09 2026
...
NAME: ingress-nginx
LAST DEPLOYED: Mon Sep 14 17:08:00 2026
NAMESPACE: ingress-nginx
STATUS: deployed
REVISION: 3
TEST SUITE: None
...
- l'annotation `service.beta.kubernetes.io/ovh-loadbalancer-proxy-protocol: v2`
- l'annotation `loadbalancer.openstack.org/proxy-protocol: v2`
- `ExternalTrafficPolicy: Local`

Vérifiez la ConfigMap du contrôleur :

```bash
kubectl -n ingress-nginx describe configmap ingress-nginx-controller
```
...
- `use-proxy-protocol: "true"`
- `real-ip-header: proxy_protocol`
- `proxy-real-ip-cidr` réglé sur vos adresses IP de sortie ou sur la plage de votre sous-réseau
