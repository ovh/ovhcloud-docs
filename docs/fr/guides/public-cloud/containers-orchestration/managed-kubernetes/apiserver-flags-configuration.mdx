...
Dans la section Public Cloud, vous pouvez récupérer l'identifiant de votre service grâce au bouton <code className="action">Copier dans le presse-papier</code>. Le nom du service de votre cluster (son identifiant unique) apparaît dans l'URL de l'espace client OVHcloud lorsque vous êtes sur la page de détails du cluster, ainsi que dans l'onglet Vue d'ensemble du cluster.
