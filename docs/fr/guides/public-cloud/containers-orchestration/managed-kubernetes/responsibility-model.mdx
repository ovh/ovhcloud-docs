...
description: "Partage de responsabilité entre OVHcloud et le client pour l'utilisation du service Kubernetes Managé"
...
Rejoignez notre canal Discord dédié : [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud). Posez vos questions, donnez votre avis et échangez directement avec l'équipe qui développe nos services de conteneurs et d'orchestration.
