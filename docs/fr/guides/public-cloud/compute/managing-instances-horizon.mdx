...
:::warning
Attacher ou détacher des interfaces alors que l'instance est en cours d'exécution peut modifier l'ordre des interfaces vu par le système invité après un redémarrage. Si vous réorganisez plusieurs interfaces, consultez [Ordre des interfaces après un attachement/détachement à chaud](/guides/public-cloud/network-services/vrack#interface-order-after-reboot) et validez le résultat avec un [hard reboot](#reboot-an-instance) avant de vous y fier en production.
:::
...
### Redémarrer une instance <a name="reboot-an-instance"></a>
