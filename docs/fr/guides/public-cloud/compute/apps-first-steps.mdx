...
- Une [instance Public Cloud](/guides/public-cloud/compute/getting-started) dans votre compte OVHcloud.
...
|---|---|
|serviceName *|Il s'agit de votre ID de projet Public Cloud|
|instanceId *|Il s'agit de l'UUID de votre instance|
...
1. Obtenez votre URL à usage unique [en suivant ces étapes](#détails-de-connexion-à-lapplication).
...
1. Obtenez l'URL d'accès à votre application en [suivant ces étapes](#détails-de-connexion-à-lapplication).
2. Cliquez sur l'URL renvoyée par l'API.
