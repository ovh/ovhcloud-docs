...
:::info
Les commandes ci-dessous sont identiques, quelle que soit la procédure suivie ci-dessus. Les valeurs de fichier, de bloc et de taille indiquées dans l'exemple de résultat correspondent à l'exemple pour une partition de 2 To ou moins (un disque de 70 Go) utilisé précédemment dans ce guide. Si vous avez suivi la procédure pour les partitions de plus de 2 To, votre propre résultat affichera des valeurs plus élevées reflétant votre disque redimensionné, mais les étapes restent identiques.
:::
