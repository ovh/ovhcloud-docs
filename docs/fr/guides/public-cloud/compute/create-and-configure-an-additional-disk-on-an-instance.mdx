...
- Disposer d'une instance [Public Cloud](/guides/public-cloud/compute/getting-started) dans votre compte OVHcloud
...
:::warning
**Impact du chiffrement (LUKS) sur les performances.** Les volumes chiffrés ont un impact sur les performances d'environ 10 % par rapport à des volumes équivalents non chiffrés.
