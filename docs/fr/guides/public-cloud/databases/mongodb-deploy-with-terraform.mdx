...
- **Terraform requirements**
    ...
    - You must have created a token for the OVHcloud API. If it's not already created, please refer to the following guide: [First Steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps)
