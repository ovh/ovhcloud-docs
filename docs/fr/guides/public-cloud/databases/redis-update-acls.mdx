...
Comme expliqué sur cette page : [Capacités de Valkey, utilisateurs et rôles](/guides/public-cloud/databases/redis-capabilities#users-and-roles), les ACLs des utilisateurs ne peuvent pas être mises à jour depuis l'espace client OVHcloud.
