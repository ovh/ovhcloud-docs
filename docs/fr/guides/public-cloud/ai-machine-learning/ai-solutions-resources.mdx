...
- Un accès à l'<ManagerLink to="/#/public-cloud/pci/projects">espace client OVHcloud</ManagerLink> ou [à la CLI AI OVHcloud](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installée sur votre ordinateur
