...
The following table lists the models currently being decommissioned:
...
- The **Announcement date** indicates when the decommissioning was announced via email to affected users and on the `#ai-news channel` of the OVHcloud [Discord server](https://discord.gg/ovhcloud).
- The **Decommission date** indicates when the model will be removed from the API and start returning 404 errors.

This table is updated whenever a decommissioning decision is made.

## Billing principles

For detailed information on models, quantization, pricing units, and prices, please visit the <code className="action">AI Endpoints</code> section of the `AI and Machine Learning` drop-down menu, on the [OVHcloud website](/links/public-cloud/prices-ai):
