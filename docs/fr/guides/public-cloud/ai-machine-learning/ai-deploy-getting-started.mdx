...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis rendez-vous dans la catégorie <code className="action">AI & Machine Learning</code> du menu de gauche et choisissez <code className="action">AI Deploy</code>.
