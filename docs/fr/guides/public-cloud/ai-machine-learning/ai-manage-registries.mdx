...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis rendez-vous dans la section `AI Training`, située sous `AI & Machine Learning`.
...
<Tabs>
  <Tab label="Depuis l'espace client (UI)">
    Pour ajouter votre registre privé via l'interface, cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis rendez-vous dans la section `AI Dashboard`, située sous `AI & Machine Learning`.
...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis rendez-vous dans la section `AI Dashboard`, située sous `AI & Machine Learning`.
