...
<img className="thumbnail" alt="Schéma d'états d'un job AI Training et des transitions entre ses onze statuts" src="/images/public-cloud/ai-machine-learning/training-guide-03-concepts-jobs/status-diagram.svg" loading="lazy" />
