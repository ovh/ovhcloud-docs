...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis rendez-vous dans la section <code className="action">AI Training</code>, située sous `AI & Machine Learning`.
