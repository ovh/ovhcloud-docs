...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis sélectionnez la section `Object Storage` (dans la catégorie Storage) et créez un nouveau conteneur d'objets en cliquant sur `Storage` > `Object Storage` > `Créer un conteneur d'objets`.
...
Cliquez sur <ManagerLink to="/#/public-cloud/pci/projects">ce lien</ManagerLink> pour accéder à votre projet Public Cloud, puis sélectionnez la section `AI Training` (dans la catégorie AI & Machine Learning) et créez un nouveau job en cliquant sur `AI Training` > `Lancer un job`.
