---
title: AI Training - Tutoriel - Entraînez un modèle à reconnaître les sons des mammifères marins
...
Vous pouvez consulter l'étape Notebook dans le tutoriel : [Analyse et classification audio avec l'IA](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification).
...
Vous pouvez réutiliser l'Object Storage précédent utilisé dans le tutoriel Notebook [Analyse et classification audio avec l'IA](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification) ou suivre l'étape [Envoyer votre dataset sur Public Cloud Storage](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification#envoyer-votre-dataset-sur-public-cloud-storage) de ce même tutoriel.
...
Pour créer l'application utilisant le modèle entraîné, vous pouvez suivre ce tutoriel : [Déployer une app pour une tâche de classification audio avec Streamlit](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-sounds-classification).
