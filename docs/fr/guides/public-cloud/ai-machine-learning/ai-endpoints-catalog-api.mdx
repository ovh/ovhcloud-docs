...
`https://oai.endpoints.kepler.ai.cloud.ovh.net/v1` is the base endpoint used to actually call AI Endpoints models (see the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/ai-endpoints-getting-started) and [AI Endpoints - Responses API](/guides/public-cloud/ai-machine-learning/ai-endpoints-responses-api) guides). This article does not cover that endpoint; instead, it covers the separate **Catalog API**, a discovery service for browsing available models and their metadata.
