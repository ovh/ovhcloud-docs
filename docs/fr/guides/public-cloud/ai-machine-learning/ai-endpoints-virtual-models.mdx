...
| qwen@biggest?``input_cost<0.5`` | **Exemple :** Qwen3-Coder-30B-A3B-Instruct | Le plus grand modèle Qwen dont le coût du token d’entrée est inférieur à 0,50 € par million de tokens |
