...
|-----------|-----------|-----------|
| code_completion@latest | **Example:** Qwen3.6-27B | The latest model optimized for code completion tasks |
| meta-llama@latest | **Example:** Meta-Llama-3_3-70B-Instruct | The latest Llama model |
