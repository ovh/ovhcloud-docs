...
|-----------|-----------|-----------|
| code_completion@latest | **Example:** Qwen3.6-27B | The most recently released model optimized for code completion tasks |
| meta-llama@latest | **Example:** Meta-Llama-3_3-70B-Instruct | The most recently released Llama model |
| gpt-oss@cheapest | **Example:** gpt-oss-20b | The cheapest GPT-OSS model |
...
| qwen@biggest?``input_cost<0.5`` | **Example:** Qwen3-32B | The largest Qwen model whose input token cost is under €0.50 per 1M tokens |
