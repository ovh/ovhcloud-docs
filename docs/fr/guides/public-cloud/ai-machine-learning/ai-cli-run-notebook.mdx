...
:::info
La liste des flavors disponibles dépend de la région sur laquelle vous êtes connecté (`ovhai config set <région>`). Relancez `ovhai capabilities flavor list` après avoir changé de région pour vérifier.
:::
