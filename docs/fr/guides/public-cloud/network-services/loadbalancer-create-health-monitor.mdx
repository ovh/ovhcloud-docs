...
- **Monitoring** : utilisez les outils de surveillance d’OVHcloud pour suivre les performances et l'état de santé de votre Load Balancer et ajustez la configuration au besoin. Consultez le guide « [Surveiller votre Load Balancer Public Cloud avec Prometheus](/guides/public-cloud/network-services/loadbalancer-monitoring-prometheus) ».
