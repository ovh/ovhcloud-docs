...
- Une [instance Public Cloud OVHcloud](/guides/public-cloud/compute/getting-started)
...
Nous vous recommandons de consulter les guides suivants si vous créez une instance Public Cloud pour la première fois : [Comment créer une instance Public Cloud et s'y connecter](/guides/public-cloud/compute/getting-started) ou [Créer une instance depuis l'interface Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
