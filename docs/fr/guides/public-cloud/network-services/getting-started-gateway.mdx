...
<Tabs>
  ...
  <Tab label="API OVHcloud">
    Connectez-vous à l'[API OVHcloud](https://eu.api.ovh.com/console/) et utilisez l'appel suivant pour créer une Gateway ainsi qu'un nouveau réseau privé et un sous-réseau en une seule opération :
