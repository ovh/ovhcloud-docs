...
<Tabs>
  <Tab label="Espace client OVHcloud">
    Consultez le guide « [Créer une instance depuis l’espace client](/guides/public-cloud/compute/getting-started) ». Lors de la création, choisissez à l'étape 5 un mode réseau et un réseau privé pour votre instance.
