...
Le [CLI ovhcloud](https://github.com/ovh/ovhcloud-cli) vous permet de gérer vos ressources Public Cloud depuis votre terminal, y compris les réseaux privés et les interfaces d’instances.

Avant de commencer, [installez et configurez le CLI ovhcloud](https://github.com/ovh/ovhcloud-cli#installation). Définissez votre projet cloud avec `--cloud-project <project_id>` ou configurez-le dans votre profil.
