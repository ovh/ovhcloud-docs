...
Click <ManagerLink to="/#/public-cloud/pci/projects">this link</ManagerLink> to access your Public Cloud project, then go to the <code className="action">AI & Machine Learning</code> category in the left menu and choose <code className="action">AI Deploy</code>.
