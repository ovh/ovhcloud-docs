...
:::info
Los siguientes comandos son los mismos, independientemente del procedimiento seguido anteriormente. Los valores de archivo, bloque y tamaño que aparecen en el ejemplo de resultado corresponden al ejemplo ≤ 2 TB (un disco de 70 GB) utilizado anteriormente en esta guía; si ha seguido el procedimiento > 2 TB, su propio resultado mostrará valores más elevados que reflejan su disco redimensionado, pero los pasos siguen siendo los mismos.
:::
