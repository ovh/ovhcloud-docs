...
También puede [editar la configuración de una instancia](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#editar-la-configuración-de-una-instancia) desde el área de cliente.
