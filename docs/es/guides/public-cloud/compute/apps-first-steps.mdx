...
- Una [instancia de Public Cloud](/guides/public-cloud/compute/getting-started) en su cuenta de OVHcloud.
...
|---|---|
|serviceName *|Su ID de proyecto de Public Cloud|
...
1. Obtenga su URL de un solo uso [siguiendo estos pasos](#detalles-de-conexión-a-la-aplicación).
...
1. Para acceder a la aplicación, siga estos [pasos](#detalles-de-conexión-a-la-aplicación).
2. Haga clic en la URL que devuelve la API.
