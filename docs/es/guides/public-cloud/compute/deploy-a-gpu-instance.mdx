...
Siga los pasos restantes como se detalla en [esta guía](/guides/public-cloud/compute/public-cloud-first-steps#create-instance). Este proceso puede tardar unos minutos.
