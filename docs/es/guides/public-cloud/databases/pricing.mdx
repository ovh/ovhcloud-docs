...
| Service       | Plan       | Flavor | Additional storage | Creation date   |
| ------------- | ---------- | ------ | ------------------ | --------------- |
| PostgreSQL #1 | Production | B3-8   | 100 GB             | 1 April, 00:00  |
| PostgreSQL #2 | Production | B3-32  | None               | 15 April, 00:00 |
| MongoDB #1    | Production | B3-16  | 120 GB             | 1 April, 00:00  |
...
This aggregation mechanism allows a single billing reference to represent the combined usage of multiple services of the same engine and plan.
