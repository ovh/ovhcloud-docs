...
description: "Learn how to move your OVHcloud Public Cloud Database from a single AZ to a 3-AZ region and ensure high availability"
...
![databases - datacentres](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_datacentre.png)
...
To move a database service from a 1-AZ to a 3-AZ region, log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open your Public Cloud project. Click `Databases` in the left navigation bar, select your database service then click the `Backups` tab.

![databases - select engines instances and go to the backups section](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_select_cluster.png)

Choose the backup from which you wish to fork, click on the `...` button and click on the `Duplicate (fork)` button.

![databases - click on the duplicate button](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_backup.png)
...
![databases fork - select backup for the restore point part](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_restore_point.png)

Select a `3-AZ region`.

![databases fork - select your 3-AZ region](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_region.png)

Select a service `plan`.

![databases fork - select your plan](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_plan.png)

Select the `instance` that will host the service.

![databases fork - select the instance](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_instance.png)

Select the `storage` capacity of the service.

![databases fork - select the storage](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_storage.png)
...
![databases fork - select optional fields](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_options.png)

When you have completed your configuration, review your order then click on the `Order` button. 

![databases fork - review](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_fork_summary.png)
...
![databases - delete the 1-AZ service](/images/guides/public-cloud/databases/migrate-from-1az-to-3az/databases_delete_1az.png)
