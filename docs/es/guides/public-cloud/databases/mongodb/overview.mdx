...
pageType: overview
title: MongoDB
description: "Aprovisione y opere una base de datos MongoDB gestionada en OVHcloud Public Cloud - creación del clúster, escalado, copias de seguridad, seguridad e integración."
