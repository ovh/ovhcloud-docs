...
- [Configure your Valkey service](/guides/public-cloud/databases/valkey-prepare-for-incoming-connections) to accept incoming connections
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect with CLI](/guides/public-cloud/databases/valkey-connect-cli) or by using programming languages, such as [PHP](/guides/public-cloud/databases/valkey-connect-php).
