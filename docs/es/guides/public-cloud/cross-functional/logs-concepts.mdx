...
| Public Cloud - Managed Kubernetes Service | Área de cliente de OVHcloud y API | [Managed Kubernetes Service Audit Logs Forwarding](/guides/public-cloud/containers-orchestration/managed-kubernetes/forwarding-audit-logs) |
