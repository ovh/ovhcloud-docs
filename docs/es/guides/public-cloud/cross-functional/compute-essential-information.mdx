...
Al haber registrado su forma de pago, esta se utilizará para cargar el importe calculado para su [facturación a fin de mes](/guides/public-cloud/cross-functional/analyze-billing). Este cálculo se realiza en función del tiempo de uso de cada recurso, en función del precio de los recursos. En las instancias, los precios suelen mostrarse como una tarifa por hora para facilitar la lectura, pero la facturación se calcula al segundo, con un período mínimo de facturación de 1 minuto.
