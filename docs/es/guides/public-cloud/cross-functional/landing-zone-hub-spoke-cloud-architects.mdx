...
- **Enlace directo:** <ManagerLink to="/#/public-cloud/pci/projects">Proyectos Public Cloud</ManagerLink>
...
Genere credenciales de API con el <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">generador de tokens de API de OVHcloud</CreateToken>. Almacene la Application Key, la Application Secret y la Consumer Key de forma segura, nunca en el control de versiones.
