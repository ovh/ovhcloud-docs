...
**Añadido de una interfaz de red privada** <a id="adding-a-private-interface"></a>
...
### Orden de las interfaces tras adjuntar o desenganchar puertos en caliente <a id="interface-order-after-reboot"></a>

:::warning
Adjuntar o desenganchar interfaces de red (puertos) mientras la instancia está en ejecución (en caliente) puede modificar el orden en el que el sistema operativo invitado las detecta en el siguiente reinicio. La interfaz identificada como `eth0` (o cualquier otra interfaz esperada, incluida la interfaz pública) puede cambiar. Compruebe la nueva configuración para evitar cualquier problema de red inesperado.

Si necesita reorganizar varias interfaces en una instancia en ejecución:

1. Desenganche todas las interfaces que desee modificar. Desenganchar la interfaz "Ext-Net" libera definitivamente su dirección IP pública, tal y como se indica en la sección [Desenganchar una interfaz de red](#removing-a-private-interface).
2. Vuelva a adjuntarlas una a una, en el orden en el que desee que aparezcan en el sistema invitado.
3. Realice un *hard reboot* de la instancia para comprobar que el orden de las interfaces es el esperado antes de confiar en él en producción.

:::

### Desenganchar una interfaz de red <a id="removing-a-private-interface"></a>
