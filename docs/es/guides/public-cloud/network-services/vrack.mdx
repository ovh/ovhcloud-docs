...
<Tabs>
  <Tab label="Área de cliente de OVHcloud">
    Consulte la guía "[Cómo crear una instancia de Public Cloud y conectarse a ella](/guides/public-cloud/compute/getting-started)". Durante la creación, elija en el paso 5 un modo de red y una red privada para su instancia.
