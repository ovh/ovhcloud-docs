...
Puede acceder a las API desde [nuestra página web](/links/api) o crear sus scripts PHP o Python para llamarlas.
...
Será redirigido a otra página para validar el pedido; la operación tarda unos minutos.
  ...
  <Tab label="APIv6 de OVHcloud">
    **Paso 1: Activar y gestionar un vRack**
    ...
    Conéctese a las APIv6 de OVHcloud siguiendo la guía "[Primeros pasos con las API de OVHcloud](/guides/manage-and-operate/api/first-steps)".
