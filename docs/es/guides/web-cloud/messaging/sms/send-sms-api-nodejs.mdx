...
<CreateToken rights="GET=/sms&GET=/sms/*&GET=/sms/*/jobs&POST=/sms/*/jobs">página de creación de tokens de OVHcloud</CreateToken> (si accede desde este enlace, tendrá automáticamente los permisos necesarios para seguir los pasos que se explican en esta guía).
