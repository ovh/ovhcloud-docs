...
- Un remitente de SMS activo. Para más información, consulte esta [guía](/guides/web-cloud/messaging/sms/send-sms-control-panel).
...
<img className="thumbnail" alt="Formulario de envío de SMS por URL http2sms" src="/images/web-cloud/messaging/sms/send-sms-http2sms/img_4011.jpg" loading="lazy" />
...
Su navegador mostrará la siguiente información:

- el estado del envío
- el número de créditos restantes en la cuenta SMS
- el/los ID de los SMS enviados
...
Encontrará más información sobre el análisis de los envíos realizados [en el paso 3 de esta guía](#analysis).
...
### Analizar los envíos realizados <a name="analysis"></a>
...
El tamaño máximo de un SMS es de 160 caracteres con codificación de 7 bits (norma GSM 03.38).
