...
Genere las claves para su script (se crean todas a la vez) desde esta página: <CreateToken rights="GET=/sms/&GET=/sms/*/jobs/&POST=/sms/*/jobs/">página de creación de tokens de OVHcloud</CreateToken> (si accede desde este enlace, tendrá automáticamente los permisos necesarios para seguir los pasos que se explican en esta guía).
...
En la <ApiLink section="/sms" regions={["eu"]}>consola de la API</ApiLink> podrá descubrir otras llamadas que le permitirán integrar servicios SMS, tales como permitir la respuesta a los SMS (solo para las cuentas de OVHcloud Francia), envío masivo con un archivo CSV, envío de publicidad, seguimiento de los acuses de recibo...
