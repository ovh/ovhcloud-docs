...
Video Center genera automáticamente el código embed de cada vídeo desde su página de detalle. Haga clic en las pestañas siguientes para mostrar sucesivamente cada una de las **3** etapas.
...
Haga clic en el vídeo que desee integrar para abrir su página de detalle.
...
- **Abrir el fichero HTML de su página**: en su editor de código (VS Code, Dreamweaver, etc.), abra la página en la que desee mostrar el vídeo.
