...
<Tabs>
  <Tab label="Paso 1">
    En la sección `Web Cloud`, haga clic en <ManagerLink to="/#/web-domains/domain">Dominios</ManagerLink>, seleccione el dominio que utilizó para crear los hosts en la [parte 3](#step3) y abra la pestaña **Zona DNS**.
  ...
  <Tab label="Paso 3">
    En el formulario que se abre, seleccione el tipo de registro DNS *A* o *AAAA* según el tipo de IP asociada que desee añadir.
  </Tab>
  <Tab label="Paso 4">
    Introduzca el *subdominio* y la dirección *IPv4* (A) o *IPv6* (AAAA) y luego haga clic en <code className="action">Añadir</code>. Si es necesario, consulte las instrucciones descritas en nuestra documentación "[Editar una zona DNS de OVHcloud](/guides/web-cloud/domains/dns-zone-edit)".
  </Tab>
</Tabs>
...
<Tabs>
  <Tab label="Paso 1">
    En la sección `Web Cloud`, haga clic en <ManagerLink to="/#/web-domains/domain">Dominios</ManagerLink>, seleccione el dominio para el que ha personalizado los servidores DNS y abra la pestaña **Zona DNS**.
  </Tab>
  <Tab label="Paso 2">
    ...
    La zona DNS aparece en modo *texto*:
