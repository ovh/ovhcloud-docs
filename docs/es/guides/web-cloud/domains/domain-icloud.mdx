...
<Tabs>
  ...
  <Tab label="Paso 2">
    ...
    - **TXT**: para el <Tooltip term="spf">SPF</Tooltip> (fusiónelo si ya existe un registro SPF).
...
Para mejorar la entregabilidad de sus correos electrónicos y evitar que sus mensajes lleguen como spam, añada un registro <Tooltip term="dmarc">**DMARC**</Tooltip>.
...
Siga las instrucciones de la página "Add a domain you own to iCloud Mail on iCloud.com" de la [documentación oficial de Apple](https://support.apple.com/es-es/guide/icloud/mma473945269/icloud). Céntrese en la sección "Step 4: Finish setting up the domain".
