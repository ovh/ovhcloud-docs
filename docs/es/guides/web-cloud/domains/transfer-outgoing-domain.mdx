...
Según la extensión, es posible que reciba un correo electrónico de OVHcloud pidiéndole que confirme la transferencia saliente antes de que pueda continuar. Consulte [Confirmar un cambio de titular o una transferencia saliente](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
