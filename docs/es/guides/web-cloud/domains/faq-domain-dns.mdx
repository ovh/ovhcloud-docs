...
No dude en crear un tíquet de asistencia desde el [centro de ayuda](/links/support-contact) si es necesario.
...
:::info
Una vez solicitada la baja, puede acelerar la eliminación creando un tíquet de asistencia desde el [centro de ayuda](/links/support-contact). Se requerirán documentos justificativos para acelerar esta eliminación.
...
Tras haber verificado y confirmado los dos puntos anteriores, si aún no consigue recuperar el e-mail de validación del titular, le invitamos a abrir un tíquet de asistencia desde el [centro de ayuda](/links/support-contact) para solicitar el reenvío de este e-mail.
...
En caso de duda, le invitamos a abrir un tíquet de asistencia desde el [centro de ayuda](/links/support-contact) indicando el nombre de dominio y el alojamiento web en cuestión.
...
Realice un [procedimiento de recuperación de contactos](/links/transversal/procedure-contact-change) para que su nombre de dominio se gestione íntegramente desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. Así no necesitará contactar con la persona que gestionaba anteriormente su nombre de dominio.
...
En caso de error, le invitamos a abrir un tíquet de asistencia desde el [centro de ayuda](/links/support-contact) indicando la siguiente información:
...
<Tabs>
  ...
  <Tab label="Paso 2">
    ...
    **Caso n.º 2** - El nombre de dominio en cuestión no aparece en la lista:
    ...
    En esta situación, si no conoce este otro identificador de cliente, le invitamos a abrir un tíquet de asistencia desde el [centro de ayuda](/links/support-contact) para recuperar la gestión de la zona DNS.
  </Tab>
</Tabs>
