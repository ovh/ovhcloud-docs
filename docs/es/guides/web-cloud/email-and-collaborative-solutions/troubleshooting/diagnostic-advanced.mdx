...
<ZoneTabs>
  <Tab label="Cuenta de correo MX Plan">
    Para un servicio **MX Plan**, acceda a [la página de nuestras guías MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan) y compruebe la configuración de su cliente de correo mediante las guías disponibles en la sección `Configurar una aplicación de correo electrónico en el ordenador` o `Configurar una aplicación de correo electrónico en el móvil`, según el dispositivo que utilice.
  </Tab>
  <Tab label="Email Pro" availableIn={['eu']}>
    Para un servicio **Email Pro**, acceda a [la página de nuestras guías Email Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro) y compruebe la configuración de su cliente de correo mediante las guías disponibles en la sección `Configurar una aplicación de correo electrónico en el ordenador` o `Configurar una aplicación de correo electrónico en el móvil`, según el dispositivo que utilice.
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    Para un servicio **Exchange**, acceda a [la página de nuestras guías Microsoft Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange) y compruebe la configuración de su cliente de correo mediante las guías disponibles en la sección `Configurar una aplicación de correo electrónico en el ordenador` o `Configurar una aplicación de correo electrónico en el móvil`, según el dispositivo que utilice.
  </Tab>
  <Tab label="Zimbra" availableIn={['eu']}>
