...
- **MX Plan**: Zimbra se utiliza como parte de una transición tecnológica del webmail Outlook Web Access (OWA) al webmail de Zimbra para los servicios MX Plan que utilizan el webmail OWA.
...
- No hay ningún archivo almacenado en su volumen de almacenamiento "Briefcase" si cambia al plan Starter.
