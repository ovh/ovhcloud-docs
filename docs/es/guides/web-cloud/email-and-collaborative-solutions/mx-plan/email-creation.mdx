...
En los servicios MX Plan que utilizan el webmail Zimbra u OWA, cuando debe eliminarla, se habla de *reinicialización de la cuenta*.
...
Para crear una dirección de correo, abra la pestaña <code className="action">Correo electrónico</code>. Se mostrará una tabla con todas las cuentas de correo creadas en la solución MX Plan. Haga clic en el botón <code className="action">Crear una dirección de correo electrónico</code>.
...
<Region zones={['eu']}>
Consulte todos nuestros productos de correo electrónico [Zimbra](/links/web/zimbra) o [Exchange](https://www.ovhcloud.com/es-es/emails-exchange/) para completar su MX Plan con el mismo dominio.
</Region>
