...
<img className="thumbnail" alt="Zimbra - inicio de sesión" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/ovhcloud-login-webmail.png" loading="lazy" />

:::info
Tras introducir su dirección de correo electrónico y su contraseña en la página de inicio de sesión del webmail, el sistema le redirige a la ventana de conexión de **Zimbra**, donde deberá volver a introducir sus credenciales. En esta ventana, el campo **Nombre de usuario** ("Username") corresponde a su **dirección de correo electrónico completa**, y no a un nombre de usuario distinto.
:::

<img className="thumbnail" alt="Ventana de conexión de Zimbra" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-login-window.png" loading="lazy" />
