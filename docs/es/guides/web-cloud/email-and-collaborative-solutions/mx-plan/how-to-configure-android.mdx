...
<Tabs>
  <Tab label="Primera configuración:">
    | | |
    |---|---|
    |<img className="thumbnail" alt="MX Plan" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />|Seleccione <code className="action">Añadir una dirección de correo</code>|
  </Tab>
  <Tab label="Configuración existente">
    | | |
    |---|---|
    |<img className="thumbnail" alt="MX Plan" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />|1. Acceda al menú situado en la parte superior izquierda de la pantalla<br/><br/>2. Seleccione <code className="action">Configuración</code><br/><br/>3. Seleccione <code className="action">Añadir una cuenta</code>|
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Paso 5">
    | | |
    |---|---|
    |<img className="thumbnail" alt="MX Plan" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-android/mxplan-android-05.png" loading="lazy" />|Complete la configuración de "**servidor de entrada**"<br/><br/>- **Nombre de usuario**: Su dirección de correo electrónico completa<br/>- **Contraseña**: La contraseña de su dirección de correo<br/>- **Servidor**: introduzca el nombre del servidor indicado más abajo |
  </Tab>
  <Tab label="Paso 6">
    | | |
    |---|---|
    |<img className="thumbnail" alt="MX Plan" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-android/mxplan-android-06.png" loading="lazy" />|Complete la **configuración del servidor saliente**<br/><br/>- **Nombre de usuario**: Su dirección de correo electrónico completa<br/>- **Contraseña**: La contraseña de su dirección de correo<br/>- **Servidor SMTP**: introduzca el nombre del servidor indicado más abajo |
  </Tab>
  <Tab label="Paso 7">
    | | |
    |---|---|
