...
:::warning
Es necesario [crear una organización](#organizations) para poder añadir un dominio al servicio Zimbra.
...
<img className="thumbnail" alt="Zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra-change-offer.png" loading="lazy" />

:::warning
Antes de cambiar a un plan inferior, asegúrese de los siguientes puntos:

- No hay ningún archivo almacenado en su volumen de almacenamiento "Maletín" si cambia al plan Starter.
- El contenido de su cuenta de correo debe ser inferior a 15 Go si cambia al plan Starter.

:::


### Consultar su cuenta de correo <a name="emails-consult"></a>
...
### Redirecciones <a name="redirections"></a>
...
<Tabs>
  <Tab label="Paso 1">
    ...
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_settings01.png" loading="lazy" />
  </Tab>
  <Tab label="Paso 2">
    ...
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_redirection02.png" loading="lazy" />
  </Tab>
  <Tab label="Paso 3">
...
<Tabs>
  <Tab label="Paso 1">
    ...
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_alias01.png" loading="lazy" />
  </Tab>
  <Tab label="Paso 2">
    ...
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_alias02.png" loading="lazy" />
  </Tab>
  <Tab label="Paso 3">
    ...
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_alias03.png" loading="lazy" />
  </Tab>
  <Tab label="Paso 4">
    Indique la dirección del alias y seleccione uno de los dominios asociados al servicio Zimbra.
    
    <img className="thumbnail" alt="zimbra" src="/images/assets/screens/email-clients/zimbra/zimbra_alias04.png" loading="lazy" />
  </Tab>
</Tabs>
