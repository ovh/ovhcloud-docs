...
:::info
Esta guía se dirige a los clientes que dispongan de una solución de correo [Zimbra Pro](/links/web/zimbra). Este servicio estará disponible en beta desde julio de 2025.
:::
...
- Disponer de una dirección de correo electrónico [Zimbra Pro](/links/web/zimbra).
