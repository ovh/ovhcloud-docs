...
2. **[Eliminar la cuenta MX Plan original y reasignar su dirección a la cuenta Zimbra](#step2)**
    - [2.1 - Eliminación de la dirección de correo electrónico MX Plan de origen](#step21)
...
<Tabs>
  <Tab label="Paso 1">
    **Crear un proyecto de migración**
    ...
    <img className="thumbnail" alt="Página de inicio de OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Paso 2">
    **Crear la migración**
    ...
    <img className="thumbnail" alt="Crear la migración de MX Plan a Zimbra en OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Eliminación de la dirección de correo electrónico MX Plan de origen <a name="step21"></a>
...
Si desea disfrutar de ayuda para utilizar y configurar sus soluciones de OVHcloud, puede consultar nuestras distintas [ofertas de soporte](/links/support).
