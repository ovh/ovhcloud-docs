...
<Tabs>
  <Tab label="Primera configuración">
    Seleccione <code className="action">Añadir una dirección de correo electrónico</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Configuración existente">
    ...
    3. Seleccione <code className="action">Añadir una cuenta</code><br/><br/><img className="thumbnail" alt="Añadir una cuenta existente en la aplicación Gmail en Android" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
