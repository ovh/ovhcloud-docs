...
<Tabs>
  ...
  <Tab label="Configuración existente">
    ...
    3. Seleccione <code className="action">Añadir una cuenta</code><br/><br/>![emailpro](/images/assets/screens/email-clients/android/android-existing.png)&#123;thumbnail .h-600&#125;
  </Tab>
</Tabs>
