...
:::info
Para obtener más información sobre la configuración de una dirección de correo electrónico desde la aplicación Outlook en iOS, consulte [el Centro de ayuda de Microsoft](https://support.microsoft.com/es-es/outlook/install-mobile/set-up-the-outlook-app-for-ios).
