...
Acceda a la sección <ManagerLink to="/#/web/email_pro">Email Pro</ManagerLink>. El nombre del servidor puede verse en el recuadro **Conexión** de la pestaña <code className="action">Información general</code>.
...
:::info
Para más información sobre la configuración de una dirección de correo electrónico desde la aplicación Outlook en Android, consulte [el Centro de ayuda de Microsoft](https://support.microsoft.com/es-es/outlook/install-mobile/set-up-email-in-the-outlook-for-android-app).
