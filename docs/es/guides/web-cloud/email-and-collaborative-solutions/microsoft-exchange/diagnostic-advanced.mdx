...
<img className="thumbnail" alt="Diagnóstico Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-tab.png" loading="lazy" />
...
<img className="thumbnail" alt="Diagnóstico Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-01.png" loading="lazy" />

El diagnóstico tardará entre 3 y 10 minutos. Aquí hay un ejemplo de los resultados:

<img className="thumbnail" alt="Diagnóstico Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-02.png" loading="lazy" />
