...
Añadir un dominio a un servicio Exchange es un requisito indispensable para poder utilizar las cuentas de dicho servicio.

<Region zones={['eu']}>

También es posible añadir varios dominios a un servicio Exchange o Email Pro.
...
También es posible añadir varios dominios a un servicio Exchange.
...
- Tener una [solución Exchange](https://www.ovhcloud.com/es-es/emails/).
- Tener uno o más dominios.
- Estar en condiciones de modificar la configuración del dominio ([zona DNS](/guides/web-cloud/domains/dns-zone-edit)).
...
:::warning
Por defecto, todas las cuentas de correo de una plataforma están interconectadas. Todas las direcciones creadas en el servicio de correo podrán ver todas las direcciones de ese servicio en el directorio, incluidas las que tengan un nombre de dominio diferente.

<Region zones={['eu']}>

Para disociar la visualización de los dominios, es necesario contratar otra plataforma [Exchange o Email Pro](https://www.ovhcloud.com/es-es/emails/) para el dominio o dominios en cuestión.

</Region>

<Region zones={['ca']}>

Para disociar la visualización de los dominios, es necesario contratar otra plataforma [Exchange](https://www.ovhcloud.com/es-es/emails-exchange/) para el dominio o dominios en cuestión.
...
Si desea configurar su dirección de correo electrónico en un cliente de correo o un dispositivo periférico, como un smartphone o una tablet, u obtener ayuda sobre las funcionalidades de su servicio de correo, consulte nuestras guías, que encontrará en la página [Exchange](https://www.ovhcloud.com/es-es/emails-exchange/).
