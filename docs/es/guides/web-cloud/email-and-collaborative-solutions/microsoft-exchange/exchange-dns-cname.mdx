...
- Disponer de una solución [Exchange](https://www.ovhcloud.com/es-es/emails-exchange/).
...
En el diagrama siguiente, la plataforma de correo electrónico ([Exchange](https://www.ovhcloud.com/es-es/emails-exchange/) o [Email Pro](https://www.ovhcloud.com/es-es/emails/email-pro/)) se representa mediante el marco verde.

</Region>

<Region zones={['ca']}>

En el diagrama siguiente, la plataforma de correo electrónico ([Exchange](https://www.ovhcloud.com/es-es/emails-exchange/)) se representa mediante el marco verde.
