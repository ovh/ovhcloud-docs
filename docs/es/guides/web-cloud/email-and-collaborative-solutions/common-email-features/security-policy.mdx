...
:::info
Si no encuentra la pestaña <code className="action">Más</code> en el panel de control de su solución <code className="action">MX Plan</code>, significa que su servicio utiliza el webmail Roundcube. La gestión de la política de seguridad no está disponible en los servicios MX Plan que utilizan Roundcube.
...
<Region zones={['ca']}>
Una vez que haya completado esta información, acepte los cambios haciendo clic en el botón <code className="action">Siguiente</code> y luego en <code className="action">Aceptar</code> para el servicio "Correo electrónico". Haga clic en <code className="action">Guardar los cambios</code> para el servicio Exchange.
</Region>

<Region zones={['apac']}>
Una vez que haya completado esta información, acepte los cambios haciendo clic en el botón <code className="action">Siguiente</code> y luego en <code className="action">Aceptar</code> para el servicio "Correo electrónico".
</Region>
