...
<img className="thumbnail" alt="Crear una nueva migración en OVHcloud Mail Migrator, paso 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
