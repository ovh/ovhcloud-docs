...
Si la RAM disponible en su servidor no permite realizar la exportación deseada, utilice la herramienta OVHcloud en el área de cliente, que utiliza recursos externos a su solución. Consulte el apartado "[Guardar y exportar una base de datos desde el área de cliente](#guardar-y-exportar-una-base-de-datos-desde-el-área-de-cliente)" de esta guía.
...
[Guardar y exportar una base de datos desde el área de cliente](#guardar-y-exportar-una-base-de-datos-desde-el-área-de-cliente)
