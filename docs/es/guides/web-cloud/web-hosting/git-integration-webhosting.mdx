...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    A continuación, haga clic en el botón <code className="action">⁝</code> situado a la derecha del nombre de dominio o subdominio correspondiente, y luego en <code className="action">Disociar un dominio</code>.
