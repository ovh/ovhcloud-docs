...
CMS creado en 2005 y dedicado a la creación de sitios web de e-commerce. Fuera de las funcionalidades habituales de las tiendas en línea, este software también puede personalizarse con módulos, temas y modelos. 
...
La mayoría de los CMS necesitan una base de datos para funcionar. Nuestros [planes de hosting](/links/web/hosting) contienen una, a excepción del [Alojamiento gratuito](/links/web/domains-free-hosting).

</Region>

<Region zones={['ca','apac']}>

La mayoría de los CMS necesitan una base de datos para funcionar. Nuestros [planes de hosting](/links/web/hosting) la incluyen.
