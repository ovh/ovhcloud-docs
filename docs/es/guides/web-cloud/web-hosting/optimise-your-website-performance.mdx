...
Si solo está afectada una página y no todo el sitio web, sería conveniente analizar dicha página en particular y comprobar qué consulta o secuencia de comandos podría estar causando la latencia.
