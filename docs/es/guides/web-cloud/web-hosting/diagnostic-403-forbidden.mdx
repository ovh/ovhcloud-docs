...
En caso de desactivación por restricción de acceso FTP en "**CHMOD 000**", contacte obligatoriamente con nuestro [equipo de soporte](/links/support-contact) para conocer la situación antes de continuar con los pasos descritos en esta guía. 
...
Para identificar estos fallos de seguridad, analice los ["logs web"](/guides/web-cloud/web-hosting/logs-and-statistics) de su alojamiento web o utilice un [proveedor especializado](/links/partner) para realizar una auditoría de seguridad de sus sitios web.
