...
- Visite nuestro sitio web <ApiLink>API OVHcloud</ApiLink> (compruebe que está en `https://eu.api.ovh.com` si sus servicios están alojados en Europa y en `https://ca.api.ovh.com` si están alojados fuera de Europa).
...
Para ello, puede permanecer en nuestro sitio web <ApiLink>API OVHcloud</ApiLink> y realizar las siguientes acciones:
