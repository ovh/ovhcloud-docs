...
La edición de los archivos _Markdown_ puede realizarse directamente en el servidor de alojamiento web. Con un [plan de hosting OVHcloud](/links/web/hosting) que incluya acceso SSH (**a partir del plan Pro**), puede utilizar indistintamente [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) o [vim](https://www.vim.org/).
