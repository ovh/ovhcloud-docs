...
<Region zones={['eu']}>
- Tener contratado un [plan de hosting de OVHcloud](/links/web/hosting) (salvo el hosting Cloud Web).
</Region>
...
:::info
La restauración automática puede tardar desde unos minutos hasta unas horas. Si dura **más de 24 horas**, contacte con [el soporte de OVHcloud](/links/support-contact).
