...
A continuación, haga que el archivo **server.js** (indicado en el [apartado 1 de este tutorial](#1-activar-el-motor-de-ejecución-nodejs)) apunte hacia el archivo **index.js** de Ghost:
