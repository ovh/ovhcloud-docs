...
[FluentSMTP](https://es.wordpress.org/plugins/fluent-smtp/) es una alternativa ligera y gratuita. La cuota de envío de su cuenta de correo electrónico se aplica de la misma forma.
...
En todos los casos, los parámetros SMTP son idénticos: servidor `smtp.mail.ovh.ca`, puerto `465` (SSL/TLS) o `587` (STARTTLS), con autenticación mediante la dirección de correo electrónico completa y su contraseña.
