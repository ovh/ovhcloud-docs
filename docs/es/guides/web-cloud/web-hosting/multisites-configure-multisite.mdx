...
<Tabs>
  ...
  <Tab label="Etapa 6">
    :::warning
    La selección de un 'módulo en 1 clic' no está disponible por el momento desde la pestaña <code className="action">Mis sitios</code>. Para instalar un CMS en su sitio web, finalice la adición de su sitio web pasando a la etapa siguiente y, a continuación, acceda a la pestaña <code className="action">Módulos en 1 clic</code> de su alojamiento, siguiendo nuestra guía "[Instalar su sitio web con un 'módulo en 1 clic' (CMS)](/guides/web-cloud/web-hosting/cms-install-1-click-modules)".
    :::
