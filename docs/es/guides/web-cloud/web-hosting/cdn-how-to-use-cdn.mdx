...
<Tabs>
  ...
  <Tab label="Etapa 4">
    :::warning
    Algunas opciones están bloqueadas en CDN Basic y requieren la suscripción a la [CDN Security](/links/web/hosting-options-cdn) o a la [CDN Advanced](/links/web/hosting-options-cdn).
