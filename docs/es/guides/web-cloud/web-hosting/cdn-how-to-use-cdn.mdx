...
Acceda a la pestaña <code className="action">Multisitio</code> de su alojamiento, haga clic en <code className="action">...</code> a la derecha del dominio o subdominio correspondiente y luego en <code className="action">Modificar la CDN</code>. 
