...
<Tabs>
  ...
  <Tab label="Etapa 2">
    ...
    - **Plan**: tipo de producto asociado al alojamiento: <Region zones={['eu']}>Hosting gratuito, Starter, Personal, Startup, Pro, Performance, Agency, Agency Plus o Agency Max.</Region><Region zones={['ca', 'apac']}>Starter, Personal, Startup, Pro, Performance, Agency, Agency Plus o Agency Max.</Region>
