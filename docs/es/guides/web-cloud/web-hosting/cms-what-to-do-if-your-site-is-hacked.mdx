...
- el uso de un plugin o un tema "no oficial", especialmente si utiliza un content management system (CMS) como WordPress, Joomla, PrestaShop o Drupal.
...
También le recomendamos que utilice un [gestor de contraseñas](/guides/account-and-service-management/account-information/manage-ovh-password#utilizar-un-gestor-de-contraseñas).
