...
Si su base de datos se encuentra en una solución [Web Cloud Databases](/links/web/databases), consulte nuestra guía "[Web Cloud Databases - Conectarse a su base de datos](/guides/web-cloud/databases/db-connecting-database-server) ". A continuación, diríjase directamente al [etapa 1.2](#step1.2) de esta guía.
...
- [Primeros pasos con Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
- [Importar su antigua base de datos a su solución Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
