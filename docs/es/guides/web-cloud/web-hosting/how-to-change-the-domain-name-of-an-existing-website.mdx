...
### Etapa 1 - declarar el nuevo dominio en su alojamiento compartido <a name="step1"></a>
...
### Etapa 3 - retirar el antiguo nombre de dominio <a name="step3"></a>
