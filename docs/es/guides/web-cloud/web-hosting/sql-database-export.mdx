...
:::tip
Si va a realizar una copia de seguridad de la base de datos porque está llena, consulte nuestro tutorial "[Qué hacer cuando la base de datos esté llena](/guides/web-cloud/web-hosting/sql-overquota-database)".
:::
