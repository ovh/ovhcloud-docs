...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Si dispone del plan [Cloud Web](/links/web/hosting-cloud-web-offer) con 2 vCores, puede añadir un segundo motor de ejecución (máximo 2 por plan) haciendo clic en el botón <code className="action">Acciones</code> y luego en <code className="action">Añadir un motor de ejecución</code>.
  </Tab>
</Tabs>
