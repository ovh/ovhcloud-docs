...
<Tabs noSync>
  <Tab label="A través del área de cliente de OVHcloud">
    ...
    En la página **Manage Tokens**, haga clic en <code className="action">Añadir un token</code> y complete los campos obligatorios:
...
<Tabs noSync>
  <Tab label="A través del área de cliente de OVHcloud">
    En la página **Manage Tokens**, se muestra la lista de PAT asociados al usuario.

    <img className="thumbnail" alt="Página Manage Tokens con la lista de tokens de acceso personales de un usuario local" src="/images/manage-and-operate/iam/configure-personal-access-token-pat/PAT_Manage_token.png" loading="lazy" />
  </Tab>
  <Tab label="A través de la API">
...
<Tabs noSync>
  <Tab label="A través del área de cliente de OVHcloud">
    Desde la página **Manage Tokens**, haga clic en el botón <code className="action">…</code> al final de la fila del token y seleccione <code className="action">Eliminar</code>.
