...
Autentíquese con un [Personal Access Token, cuenta de servicio o certificado de acceso](/guides/manage-and-operate/kms/okms-authentification-method). Para el uso de la API compatible con HashiCorp Vault KV2, se recomienda un PAT o una cuenta de servicio.
