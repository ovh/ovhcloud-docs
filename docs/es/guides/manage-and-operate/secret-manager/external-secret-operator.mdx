...
description: Descubra cómo configurar External Secret Operator para almacenar los secretos de Kubernetes en el Secret Manager de OVHcloud
...
Esta guía explica cómo configurar el External Secret Operator de Kubernetes para utilizar el Secret Manager de OVHcloud como proveedor.

## Requisitos

- Una [cuenta de cliente de OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation).
- Haber [pedido un dominio OKMS](/guides/manage-and-operate/kms/quick-start) o [creado un primer secreto](/guides/manage-and-operate/secret-manager/secret-manager-ui).
...
También necesitará la `region` y el `okms-id` del dominio OKMS que desee utilizar. Este ID y esta región se encuentran en el <ManagerLink to="/#/dedicated/security/kms">dashboard de su dominio OKMS</ManagerLink> o mediante la [CLI OVHcloud](https://github.com/ovh/ovhcloud-cli):
...
#### Instalación del External Secret Operator (ESO) en su clúster de Kubernetes
...
#### Configuración del External Secret Operator
...
#### Uso del External Secret Operator
...
Para obtener más información sobre cómo gestionar el External Secret Operator, consulte la documentación dedicada, utilizando el proveedor HashiCorp Vault: [https://external-secrets.io/latest/](https://external-secrets.io/latest/).
