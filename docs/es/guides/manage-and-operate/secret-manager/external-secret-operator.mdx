...
- Un [método de autenticación configurado](/guides/manage-and-operate/kms/okms-authentification-method) para el plano de datos OKMS (esta guía utiliza un Personal Access Token).
