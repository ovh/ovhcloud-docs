...
- Un [método de autenticación configurado](/guides/manage-and-operate/kms/okms-authentification-method) para el plano de datos OKMS.
...
Autentíquese con un [Personal Access Token, cuenta de servicio o certificado de acceso](/guides/manage-and-operate/kms/okms-authentification-method). Para el uso de la API REST, se recomienda un PAT o una cuenta de servicio.

Para probar las llamadas a la API de forma interactiva, utilice la [interfaz Swagger OKMS](/guides/manage-and-operate/kms/okms-authentification-method#use-the-okms-swagger-ui) en `https://<region>.okms.ovh.net/swagger/`.
...
- [Métodos de autenticación OKMS](/guides/manage-and-operate/kms/okms-authentification-method)
