...
- Conocer su `okmsId` y su endpoint regional, ambos devueltos por <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> y mostrados en la pestaña **Información general** del <ManagerLink to="/#/okms/key-management-service">dashboard de su dominio OKMS</ManagerLink>.
