...
| **Plano de control (API de OVHcloud)** | <ApiLink section="/okms" version="v2">`/v2/okms`</ApiLink> | Pedir dominios, gestionar las credenciales, configurar el registro de logs |
...
:::info
Su `okmsId` y su endpoint regional se obtienen mediante la siguiente llamada a la API:

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

Ambos aparecen también en la pestaña **Información general** del <ManagerLink to="/#/okms/key-management-service">dashboard de su dominio OKMS</ManagerLink>.
:::
...
### Configurar la autenticación <a id="set-up-authentication"></a>
...
### Utilizar la interfaz Swagger de OKMS <a id="use-the-okms-swagger-ui"></a>
...
También puede abrirla desde el enlace Swagger del <ManagerLink to="/#/okms/key-management-service">dashboard de su dominio OKMS</ManagerLink>.
...
### Derechos IAM para OKMS <a id="iam-rights-for-okms"></a>
