...
Un Hardware Security Module (HSM) es un dispositivo físico especializado diseñado para generar, almacenar y utilizar claves criptográficas de forma segura. Las claves protegidas por HSM nunca abandonan el hardware: las operaciones criptográficas se ejecutan en un equipo dedicado y resistente a manipulaciones, lo que refuerza la confidencialidad y la integridad de las claves.

OVHcloud utiliza HSM Thales Luna, certificados FIPS 140-3 Level 3 y Common Criteria EAL4+.

Las claves creadas con el nivel de protección HSM se replican en tres HSM físicos distintos. Su ubicación exacta depende de la región seleccionada para el OKMS.

#### Regiones 3-AZ

En las regiones 3-AZ, los tres HSM se distribuyen en todas las zonas de disponibilidad.

#### Regiones 1-AZ

En las regiones 1-AZ, dos HSM se encuentran en la región y un tercer HSM remoto se despliega en una región vecina distinta.

Ubicaciones de los HSM remotos:

- **EU-WEST-GRA** (próximamente): EU-WEST-RBX
- **EU-WEST-RBX** (próximamente): EU-WEST-SBG
- **EU-WEST-SBG** (próximamente): EU-WEST-GRA
