...
Las API disponibles en el <ApiLink>portal de API de OVHcloud</ApiLink> le permiten adquirir, gestionar, actualizar y configurar productos de OVHcloud sin utilizar una interfaz gráfica como el área de cliente.
...
- Estar en la página web de las <ApiLink>API de OVHcloud</ApiLink>.
...
En la página de las <ApiLink>API de OVHcloud</ApiLink>, haga clic en <code className="action">Explore the OVH API</code> para ver la lista de API. 
...
Para ello, haga clic en el siguiente enlace: <CreateToken>página de creación de tokens de OVHcloud</CreateToken>.
...
El token **CK** puede utilizarse para delegar permisos. Para más información, consulte la siguiente guía: [Cómo gestionar la cuenta de un cliente de OVHcloud a través de las API](/guides/manage-and-operate/api/api-right-delegation) (guía en inglés).
...
Para consultar y revocar las claves, puede utilizar el <ApiLink>portal API</ApiLink> o el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>:
...
[Cómo gestionar la cuenta de un cliente de OVHcloud a través de las API](/guides/manage-and-operate/api/api-right-delegation) (guía en inglés)
