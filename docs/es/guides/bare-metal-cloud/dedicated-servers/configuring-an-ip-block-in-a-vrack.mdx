...
A continuación, debemos crear una nueva ruta IP para el vRack. Añadiremos una nueva regla de tráfico (`1 vrack`) modificando el archivo, como se indica a continuación:
