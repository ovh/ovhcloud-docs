...
<Tabs>
  ...
  <Tab label="A través de la API de OVHcloud">
    En la <ApiLink>página API de OVHcloud</ApiLink>, haga clic en <code className="action">Login</code>, situado en la esquina superior derecha. En la siguiente página, introduzca su ID de cliente de OVHcloud.
