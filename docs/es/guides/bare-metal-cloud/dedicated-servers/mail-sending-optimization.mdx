...
Para saber además si Gmail, Yahoo y otros grandes proveedores de correo entregan el mensaje en la bandeja de entrada o en spam, puede utilizar [Email Spam Tester](https://email-spam-tester.com/es/).
