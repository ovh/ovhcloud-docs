...
Introduzca el ID de su vRack (por ejemplo, `pn-9000000`) como *path parameter* `serviceName` e indique el bloque IPv6 en el *request body*:
...
Active SLAAC en el *request body*:
...
Utilice la siguiente llamada para definir una subred de este tipo:
