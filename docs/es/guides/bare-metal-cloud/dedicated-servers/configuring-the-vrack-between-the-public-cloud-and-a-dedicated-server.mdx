...
**Esta guía explica cómo configurar la red privada entre una [instancia de Public Cloud](/guides/public-cloud/compute/getting-started) y un [servidor dedicado](https://www.ovhcloud.com/es-es/bare-metal/).**

## Requisitos

* Haber creado una [instancia de Public Cloud de OVHcloud.](/guides/public-cloud/compute/getting-started)
...
Si necesita ayuda, consulte la guía [Crear una instancia de Public Cloud](/guides/public-cloud/compute/getting-started). Al crear una instancia, podrá especificar, en el paso 5, una red privada en la que integrar su instancia.
