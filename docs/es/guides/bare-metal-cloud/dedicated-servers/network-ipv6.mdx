...
Como el ifcfg ya no está actualizado, NetworkManager ya no crea nuevos perfiles en este formato de forma predeterminada. El archivo de configuración se encuentra ahora en `/etc/NetworkManager/system-connections/`.
  ...
  <Tab label="Windows Server 2019 y versiones posteriores">
    ...
    **2. Abrir la configuración de red de su servidor**
    ...
    Abra el menú Inicio de Windows, escriba `ncpa.cpl` y haga clic en el resultado de búsqueda sugerido.

    <img className="thumbnail" alt="Ventana Conexiones de red en el panel de control de Windows" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_network_connections.png" loading="lazy" />
    ...
    **Step 4: Disable randomized IPv6 interface identifiers**
    ...
    Open the Start menu, search for <code className="action">Windows PowerShell</code>, right-click it and select <code className="action">Run as administrator</code>.

    <img className="thumbnail" alt="Run PowerShell as Administrator" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_powershell_admin.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="Disable randomized identifiers" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_powershell_randomize_identifiers.png" loading="lazy" />
...
En cualquier caso, no dude en ponerse en contacto con [nuestro equipo de soporte](/links/support-contact) para solicitar una revisión de su configuración. Será necesario proporcionar:
