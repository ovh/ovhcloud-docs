...
Para empezar, inicie sesión en su cuenta So you Start y haga clic en <code className="action">Direcciones IP públicas</code> en el panel de control principal.
