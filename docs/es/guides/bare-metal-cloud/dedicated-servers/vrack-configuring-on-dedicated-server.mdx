...
Una vez que haya activado el vRack en su cuenta, seleccione el vRack en la lista para ver la lista de servicios compatibles. Haga clic en cada uno de los servidores que quiera añadir al vRack y, seguidamente, en el botón <code className="action">Añadir</code>.
