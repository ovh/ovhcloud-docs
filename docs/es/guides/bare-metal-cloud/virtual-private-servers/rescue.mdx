...
Puede editar directamente los archivos que se encuentran en `/mnt`. Para ejecutar comandos del propio VPS, acceda al sistema montado con el siguiente comando. Estos comandos utilizarán entonces los binarios y los archivos de configuración del VPS, y no los del entorno de rescate:
