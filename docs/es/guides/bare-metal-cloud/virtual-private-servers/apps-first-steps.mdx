...
:::info
Si el enlace ya ha caducado, conéctese a su VPS vía SSH con el nombre de usuario y ejecute el comando `sudo whmlogin` para generar uno nuevo.
:::
...
WHM utiliza por defecto el usuario root para la autenticación. El enlace de un solo uso incluido en el correo electrónico permite acceder a la configuración inicial y establecer la contraseña root. En los accesos posteriores a WHM, introduzca `root` como nombre de usuario y la contraseña que haya definido.
