...
- Acceso a la <ApiLink>API de OVHcloud</ApiLink> (opcional).
...
<Tabs>
  ...
  <Tab label="A través de la API de OVHcloud">
    Acceda a la página de las <ApiLink>API OVHcloud</ApiLink>:
...
- [Aplicación persistente en Red Hat y derivados (Rocky Linux, AlmaLinux, etc.)](#persistentredhat)
- [Aplicación persistente en Fedora 43 y versiones posteriores](#persistentfedora)
...
#### Aplicación persistente en Debian y derivados (Ubuntu, Crunchbang, SteamOS, etc.) <a name="persistentdebian"></a>
...
#### Aplicación persistente en Red Hat y sus derivados (Rocky Linux, AlmaLinux, etc.) <a name="persistentredhat"></a>

Existen dos métodos para configurar su red según el sistema operativo instalado en su servidor:

- **para Rocky Linux y AlmaLinux (8/9)**: utilice el método basado en el archivo *network-scripts*;
...
#### Aplicación persistente en Fedora 43 y versiones posteriores <a name="persistentfedora"></a>
