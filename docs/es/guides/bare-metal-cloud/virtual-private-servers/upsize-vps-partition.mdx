...
- **bad magic number in superblock**: No continúe. Para solucionar este problema, consulte el apartado [Cómo solucionar los errores «bad magic number in superblock»](/guides/bare-metal-cloud/virtual-private-servers/upsize-vps-partition#cómo-solucionar-los-errores-bad-magic-number-in-superblock) de esta guía.
