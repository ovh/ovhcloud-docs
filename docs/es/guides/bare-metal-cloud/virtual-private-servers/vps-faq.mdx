...
La mejor opción es abrir nuestra <ApiLink>consola de API</ApiLink> y comprobar si tu licencia puede ser trasladada a un VPS diferente. Encuentra las bases en nuestra guía sobre [cómo empezar con la API de OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Accede a la <ApiLink>consola de API de OVHcloud</ApiLink> y utiliza la siguiente llamada:
