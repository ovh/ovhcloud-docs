...
Public connectivity is currently provided through an additional Managed Dedicated Cloud - SecNumCloud, a temporary solution until dedicated public connectivity is available.
...
No specific cancellation fees applied: deleting the service will stop the billing immediately. Any associated OVHcloud credits cannot be transferred. Export your data, images, configurations, and logs before deletion, as it is irreversible.

The default subscription period for the service is 12 months. Data can be exported before the end of this period.

## Data retention after contract termination

After service decommission or contract termination, OVHcloud permanently deletes all data, images, volumes, configurations and logs on the service. Export all necessary data before deletion, as restoration is not possible afterwards. At the end of the service, OVHcloud performs a secure erase. This deletion will be subject to 21 calendar days' notice.
