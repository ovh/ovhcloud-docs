...
**Busque el logotipo de OVHcloud en su bandeja de entrada**

Varios servicios de correo, entre ellos Gmail, Yahoo y Apple Mail con una dirección iCloud.com, muestran el logotipo de OVHcloud junto al nombre del remitente en los correos enviados por OVHcloud desde una dirección que termina con `ovhcloud.com`. En Gmail, aparece además una marca de verificación azul.

<img className="thumbnail" alt="Logotipo de OVHcloud mostrado junto al nombre del remitente" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Este logotipo lo muestra su servicio de correo, no el mensaje: un correo fraudulento no puede reproducirlo. Todavía no todos los servicios de correo lo muestran, así que su ausencia por sí sola no prueba nada: en ese caso, apóyese en las comprobaciones descritas a continuación.

Verifique a continuación si el correo que ha recibido también es visible en la página <ManagerLink to="/#/communication">Mis mensajes</ManagerLink> de su área de cliente de OVHcloud. Allí encontrará copias de los correos oficiales enviados por OVHcloud.
...
<img className="thumbnail" alt="Outlook Windows - identificar la versión" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
