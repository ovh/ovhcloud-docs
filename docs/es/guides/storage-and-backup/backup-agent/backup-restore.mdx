...
Consulta este guía para más información: [Backup Agent - Restore a Bare Metal server with Veeam Backup Agent (EN)](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/agent-bare-metal-recovery).
