...
**Esta guía le ayudará a comprender el funcionamiento del producto Backup Agent y sus ventajas para sus servicios Bare Metal.**
...
Descubra cómo navegar en la VSPC a través de [esta guía](/guides/storage-and-backup/backup-agent/vspc-presentation).

Cuando adquiere el producto, recibe un correo electrónico confirmando la entrega del servicio así como las credenciales de acceso a su tenant en la VSPC. Esta cuenta es de solo lectura y le dará acceso a visualizaciones de sus copias de seguridad y de sus agentes.
...
Una vez que el agente haya realizado copias de seguridad, podrá restaurar sus datos de dos formas: restauración de archivos (FLR) o restauración del servidor.

## Puntos clave

Varios puntos fuertes están presentes en esta oferta:

- Primera política de copia de seguridad automática con 30 días de retención.
- Posibilidad de ampliar la retención hasta 365 días.
...
Le invitamos a leer nuestras otras guías para descubrir el producto.
