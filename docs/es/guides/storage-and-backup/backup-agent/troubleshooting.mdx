...
- Un servidor Bare Metal en el que Backup Agent esté instalado. Consulte nuestra guía "[Cómo configurar su primera copia de seguridad](/guides/storage-and-backup/backup-agent/first-configuration)" para más información.
...
Puede encontrar los registros de su Backup Agent en la carpeta: `C:\ProgramData\Veeam\` o `/var/log`.
...
Debe descargar el agente desde su <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> e instalarlo en su nuevo sistema operativo.
