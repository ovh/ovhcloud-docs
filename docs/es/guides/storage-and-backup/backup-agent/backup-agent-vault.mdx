...
- Sus datos de copia de seguridad se envían automáticamente a un Vault creado en **Gravelines (GRA)**, denominado **backup-vault-gra-1**.
...
- El servidor Bare Metal en **RBX** envía sus datos a **backup-vault-gra-1** en **Gravelines (GRA)**.
- El servidor Bare Metal en **GRA** envía sus datos a **backup-vault-sbg-1** en **Strasbourg (SBG)**.
