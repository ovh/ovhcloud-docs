...
Además, en cualquier momento puede crear snapshots manuales, que podrá conservar sin limitación de tiempo o eliminar cuando desee. Esta funcionalidad está disponible en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> o a través de la siguiente llamada a la <ApiLink>API</ApiLink>:
