...
- Tener acceso a la página de las <ApiLink>API de OVHcloud.</ApiLink>
...
Todas las rutas API utilizadas en esta guía están disponibles en la <ApiLink section="/storage">sección */storage*</ApiLink> de la consola API.
