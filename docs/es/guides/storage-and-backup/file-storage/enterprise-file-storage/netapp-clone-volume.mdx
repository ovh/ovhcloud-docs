...
:::info
Puede crear un volumen y un snapshot de tipo «manual» gracias a la <ApiLink>API OVHcloud</ApiLink> o desde su <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>.
