...
- Tener acceso a la [interfaz vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection).
...
<img className="thumbnail" alt="desplegar una máquina virtual" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm01.png" loading="lazy" />
...
<img className="thumbnail" alt="elección de creación" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="ubicación de la máquina virtual" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="elección de los recursos" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="elección del almacenamiento" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="elección de compatibilidad" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="elección del SO invitado" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="elección de la red" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="elección del archivo ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="conectar ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="resumen de la máquina virtual" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="inicio de la máquina virtual" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm12.png" loading="lazy" />

La consola se abrirá en una nueva pestaña y, tras completarse la instalación, podrá utilizar su máquina virtual.

<img className="thumbnail" alt="consola de la máquina virtual" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm13.png" loading="lazy" />
