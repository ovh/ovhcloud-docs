...
<img className="thumbnail" alt="edición de los recursos" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png" loading="lazy" />

En este menú, puede aumentar los recursos de su máquina virtual. 

<img className="thumbnail" alt="edición de los recursos" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir CPU" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir memoria" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir almacenamiento" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir la red" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir una unidad de CD / DVD" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png" loading="lazy" />
...
<img className="thumbnail" alt="añadir dispositivos" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png" loading="lazy" />
