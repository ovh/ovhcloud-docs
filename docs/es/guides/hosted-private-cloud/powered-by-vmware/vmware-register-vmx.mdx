...
En su [interfaz vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection), sitúese en la vista <code className="action">Almacenamiento</code>.
