...
<Tabs>
  ...
  <Tab label="Krok 4">
    :::warning
    Niektóre opcje są zablokowane dla CDN Basic i wymagają zamówienia usługi [CDN security](/links/web/hosting-options-cdn) lub [CDN Advanced](/links/web/hosting-options-cdn).
