...
<Tabs>
  ...
  <Tab label="Krok 3">
    Jeśli dysponujesz pakietem [Cloud Web](/links/web/hosting-cloud-web-offer) z 2 vCores, możesz dodać drugi framework (maksymalnie 2 na ofertę), klikając przycisk <code className="action">Operacje</code>, a następnie <code className="action">Dodaj framework</code>.
  </Tab>
</Tabs>
