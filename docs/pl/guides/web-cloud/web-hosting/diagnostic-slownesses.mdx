...
Do obsługi Content Management System (CMS), takich jak WordPress, Joomla!, PrestaShop lub Drupal, strona, do której używasz z przeglądarki internetowej, może generować wewnętrzne dodatkowe zapytania na hostingu. Twój hosting nie będzie odsyłał do przeglądarki, dopóki wszystkie zapytania wewnętrzne nie zostaną ukończone.
...
Aby poznać klaster i filer, w których znajduje się Twój hosting współdzielony, zapoznaj się z naszym przewodnikiem "[Hosting www - Poznaj klaster i filer](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)".
...
:::info
OVHcloud oferuje kilka [oferty CDN](/links/web/hosting-options). Jeśli chcesz korzystać z tej usługi lub ją włączyć dla Twojego hostingu, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, a następnie zapoznaj się z naszym przewodnikiem dotyczącym [korzystania z usługi CDN OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
