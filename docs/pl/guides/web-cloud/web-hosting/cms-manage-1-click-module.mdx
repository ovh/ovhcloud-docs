...
<Region zones={['eu']}>
- Posiadanie [oferty hostingu WWW Cloud](/links/web/hosting) umożliwiającej instalację modułu za pomocą 1 kliknięcia (jedynie [darmowy hosting](/guides/web-cloud/web-hosting/activate-start10m) nie jest objęty tą funkcją).
</Region>
