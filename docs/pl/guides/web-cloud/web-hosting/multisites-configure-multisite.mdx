...
Kliknij przycisk <code className="action">Zatwierdź</code>, aby rozpocząć dodawanie domeny. Może to potrwać do godziny. Efekty modyfikacji domeny staną się widoczne po upływie 4-24 godzin ze względu na niezbędny czas propagacji.
