...
Edycja plików _Markdown_ może odbywać się bezpośrednio na serwerze hostingowym. W ofercie [hostingu OVHcloud](/links/web/hosting) z dostępem SSH (**od oferty Pro**) możesz korzystać z [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) lub [vim](https://www.vim.org/).
