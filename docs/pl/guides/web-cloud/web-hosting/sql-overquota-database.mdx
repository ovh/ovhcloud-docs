...
Jeśli Twoja baza danych znajduje się w rozwiązaniu [Web Cloud Databases](/links/web/databases), zapoznaj się z naszym przewodnikiem "[Web Cloud Databases - Logowanie do bazy danych](/guides/web-cloud/databases/db-connecting-database-server)", następnie przejdź bezpośrednio do [etap 1.2](#step1.2) niniejszego przewodnika.
...
- [Import Twojej starej bazy danych do Twojej oferty Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
