...
W tym celu wejdź na stronę <ApiLink>API OVHcloud</ApiLink> i wykonaj następujące czynności:
...
Po odtworzeniu kopii zapasowej bazy danych należy utworzyć nową bazę danych. W tym celu zapoznaj się z przewodnikiem "[Tworzenie bazy danych na hostingu WWW OVHcloud](/guides/web-cloud/web-hosting/sql-create-database)".
