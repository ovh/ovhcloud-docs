...
Możesz również korzystać z API OVHcloud z Twojego hostingu za pomocą oficjalnego wrappera. W tym celu dodaj plik o nazwie *composer.json* zawierający listę zależności, których potrzebujesz. Oto przykład tego pliku za pomocą wrappera API OVHcloud:
