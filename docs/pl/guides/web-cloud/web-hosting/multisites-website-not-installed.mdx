...
<Tabs>
  ...
  <Tab label="Etap 2">
    Kliknij menu <code className="action">Domeny</code>, wybierz daną nazwę domeny i otwórz zakładkę **Strefa DNS**.
