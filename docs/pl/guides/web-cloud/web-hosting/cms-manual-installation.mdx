...
Jeśli nie korzystasz już z klienta FTP, możesz użyć programu Filezilla. W dokumentacji OVHcloud dotyczącej korzystania z tej usługi znajdziesz link do pobrania za darmo oraz samouczek dotyczący korzystania z niego [FileZilla wraz z hostingiem OVHcloud](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
...
Większość systemów CMS potrzebuje do działania bazy danych. Nasza oferta [hosting](/links/web/hosting) zawiera listę usług, z wyjątkiem [darmowy hosting](/links/web/domains-free-hosting).

</Region>

<Region zones={['ca','apac']}>

Większość systemów CMS potrzebuje do działania bazy danych. Nasza oferta [hosting](/links/web/hosting) zawiera listę usług.
...
- Aby zalogować się do bazy danych powiązanej z hostingiem, zapoznaj się z [tym przewodnikiem](/guides/web-cloud/web-hosting/sql-create-database#dostęp-do-interfejsu-phpmyadmin).
