...
- **Upewnij się, że Twój skrypt rzeczywiście używa funkcji "mail()"**: weryfikacje i statystyki na tej stronie dotyczą wyłącznie wiadomości e-mail wysyłanych za pomocą "mail()". Jeśli Twój skrypt lub ustawienia wysyłki Twojej strony WWW wskazują serwer SMTP, wiadomości e-mail przechodzą przez ten serwer i nie pojawiają się tutaj. Zapoznaj się z [sekcją SMTP](#SMTP) niniejszego przewodnika.
