...
Jeśli chcesz zarządzać kontami e-mail zawartymi w Twojej ofercie MX Plan lub w ofercie [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/), zapoznaj się z naszą dokumentacją dotyczącą [E-maili współdzielonych - MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan).
:::
