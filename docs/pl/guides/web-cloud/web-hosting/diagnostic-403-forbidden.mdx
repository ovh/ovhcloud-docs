...
Aby zidentyfikować luki w zabezpieczeniach, przeanalizuj ["logi www"](/guides/web-cloud/web-hosting/logs-and-statistics) Twojego hostingu lub skorzystaj z pomocy [wyspecjalizowanego usługodawcy](/links/partner) w celu przeprowadzenia audytu bezpieczeństwa Twoich stron WWW.
