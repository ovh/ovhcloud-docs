...
<Region zones={['eu']}>
- Posiadanie [hostingu OVHcloud](/links/web/hosting), z wyjątkiem hostingu Cloud Web.
</Region>
...
Wybór silnika *php* pozwala aktywować lub dezaktywować akcelerator PHP ("PHP-FPM"). Akcelerator został dostosowany do infrastruktury OVHcloud w celu zwiększenia prędkości wykonywania skryptów PHP. 
