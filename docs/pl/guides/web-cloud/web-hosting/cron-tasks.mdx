...
<Tabs>
  ...
  <Tab label="Krok 4">
    ...
    Możesz przełączyć między dwoma trybami podczas konfiguracji. Pamiętaj również o [ograniczeniach podczas planowania zadania na hostingu WWW](#ograniczenia-zaplanowanych-zadań-na-twoim-hostingu).
