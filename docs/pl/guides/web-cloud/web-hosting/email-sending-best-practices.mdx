...
We wszystkich przypadkach ustawienia SMTP są takie same: serwer `smtp.mail.ovh.ca`, port `465` (SSL/TLS) lub `587` (STARTTLS), z uwierzytelnianiem przy użyciu pełnego adresu e-mail i jego hasła.
