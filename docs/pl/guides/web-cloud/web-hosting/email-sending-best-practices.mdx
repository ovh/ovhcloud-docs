...
Obie metody wysyłają wiadomości e-mail z Twojej witryny. Różnią się miejscem, z którego wiadomość e-mail jest wysyłana, sposobem ograniczania wysyłki oraz sposobem, w jaki możesz ją monitorować.
...
| **Tożsamość nadawcy** | Adres `From:` jest deklarowany przez skrypt. Upewnij się, że Twój rekord SPF autoryzuje serwery OVHcloud. | Adres `From:` musi być zgodny z uwierzytelnionym kontem. Wiadomość e-mail jest podpisywana DKIM, jeżeli DKIM jest włączony dla Twojej domeny. |
