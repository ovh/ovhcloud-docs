...
Możesz uruchomić Twoją stronę WWW (bloga, sklep internetowy czy stronę prezentującą Twoją działalność) na [hostingu OVHcloud](/links/web/hosting), o ile jest ona kompatybilna z [konfiguracją infrastruktury OVHcloud](https://webhosting-infos.hosting.ovh.net).
...
Sposób połączenia strony z bazą zależy od typu strony (np. rodzaju CMS-a), którą chcesz uruchomić. Operacja ta wymaga konfiguracji Twojej strony WWW, a nie samego rozwiązania OVHcloud. Zalecamy zatem skontaktowanie się z administratorem strony lub [wyspecjalizowanym w tym zakresie webmasterem](/links/partner).
...
Przypominamy, że w przypadku trudności podczas uruchamiania Twojej strony na hostingu możesz skontaktować się z [wyspecjalizowanym webmasterem](/links/partner) lub administratorem usługi (np. zainstalowanego CMS).
