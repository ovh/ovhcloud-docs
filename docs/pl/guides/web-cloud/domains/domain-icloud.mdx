...
Aby aktywować nazwę domeny w usłudze iCloud, postępuj zgodnie z instrukcjami na stronie "Add a domain you own to iCloud Mail on iCloud.com" w [oficjalnej dokumentacji Apple](https://support.apple.com/pl-pl/guide/icloud/mma473945269/icloud). Zwróć szczególną uwagę na sekcję "Step 3: Update the records with your domain registrar", aby poznać rekordy DNS, które należy dodać do Twojej strefy DNS OVHcloud.
