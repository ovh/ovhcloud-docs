...
<Tabs>
  ...
  <Tab label="SPF">
    **S**ender **P**olicy **F**ramework <br/><br/>
    ...
    <Region zones={['ca', 'apac']}>
    Pozwala zapobiegać przypadkom podszywania się pod adresy e-mail używające Twojej nazwy domeny (*spoofing*). Na przykład rejestracja `v=spf1 include:mx.ovh.ca ~all` wskazuje, że jedynie serwery poczty elektronicznej powiązane z Twoją ofertą mail OVHcloud mogą być uznane za zgodne z prawem przez serwer poczty przychodzącej. Możesz wprowadzić ten wpis w formie pola TXT lub w systemie automatycznej konfiguracji. 
    </Region>
