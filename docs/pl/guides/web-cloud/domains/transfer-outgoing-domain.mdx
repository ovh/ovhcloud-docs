...
W zależności od rozszerzenia możesz otrzymać od OVHcloud wiadomość e-mail dotyczącą transferu wychodzącego. Potwierdzenie przyspiesza proces, a odrzucenie anuluje transfer. Jeśli nie podejmiesz żadnego działania, transfer zostaje sfinalizowany automatycznie, zwykle po 5 dniach. Zapoznaj się z artykułem [Potwierdzanie zmiany abonenta lub transferu wychodzącego](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
...
[Potwierdzanie zmiany abonenta lub transferu wychodzącego](/guides/web-cloud/domains/confirm-holder-change-or-transfer)
