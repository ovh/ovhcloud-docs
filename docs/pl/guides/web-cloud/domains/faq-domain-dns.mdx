...
W razie potrzeby utwórz zgłoszenie do działu wsparcia w [Centrum pomocy](/links/support-contact).
...
:::info
Po złożeniu wniosku o anulowanie możesz przyspieszyć usunięcie, tworząc zgłoszenie do działu wsparcia w [Centrum pomocy](/links/support-contact). W celu przyspieszenia usunięcia konieczne będzie dostarczenie dokumentów potwierdzających.
...
Po potwierdzeniu powyższych dwóch punktów, jeśli nadal nie możesz odnaleźć e-maila weryfikacyjnego, zalecamy utworzenie zgłoszenia do działu wsparcia w [Centrum pomocy](/links/support-contact) w celu ponownego wysłania e-maila.
...
W razie wątpliwości zalecamy utworzenie zgłoszenia do działu wsparcia w [Centrum pomocy](/links/support-contact), podając nazwę domeny i odpowiedni hosting.
...
Wykonaj [procedurę odzyskania kontaktu](/links/transversal/procedure-contact-change), aby Twoja nazwa domeny była w pełni zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. W ten sposób nie będziesz musiał kontaktować się z osobą, która wcześniej zarządzała Twoją nazwą domeny.
...
Jeśli wystąpi błąd, zalecamy utworzenie zgłoszenia do działu wsparcia w [Centrum pomocy](/links/support-contact), podając następujące informacje:
...
<Tabs>
  ...
  <Tab label="Krok 2">
    ...
    **Przypadek 2** — Odpowiednia nazwa domeny nie pojawia się na liście:
    ...
    W tej sytuacji, jeśli nie znasz identyfikatora tego innego konta klienta, zalecamy utworzenie zgłoszenia do działu wsparcia w [Centrum pomocy](/links/support-contact), aby odzyskać zarządzanie strefą DNS.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Krok 2">
    **Przypadek 1** — Nazwa domeny nie pojawia się na liście:
    ...
    - Nazwa domeny jest zarejestrowana w OVHcloud: Możesz wykonać [procedurę odzyskania kontaktu](/links/transversal/procedure-contact-change), aby Twoja nazwa domeny była zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
    ...
    **Przypadek 2** — Nazwa domeny pojawia się na liście:
    ...
    Możesz następnie wykonać [procedurę odzyskania kontaktu](/links/transversal/procedure-contact-change), aby Twoja nazwa domeny była w pełni zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
  </Tab>
</Tabs>
