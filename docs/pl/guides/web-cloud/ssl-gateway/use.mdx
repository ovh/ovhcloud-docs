...
<img className="thumbnail" alt="przycisk Sunrise" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG" loading="lazy" />

- Następnie kliknij na <code className="action">SSL Gateway</code>, aby wyświetlić informacje o usłudze.

<img className="thumbnail" alt="przycisk SSL Gateway" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/5.PNG" loading="lazy" />

- Wybierz usługę, którą chcesz skonfigurować.

<img className="thumbnail" alt="strona handlowa" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/6.PNG" loading="lazy" />

- Pojawi się strona do zarządzania usługą.

<img className="thumbnail" alt="konfiguracja globalna" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/7.PNG" loading="lazy" />

- Opis informacji

<img className="thumbnail" alt="część informacje" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/8.PNG" loading="lazy" />
...
<img className="thumbnail" alt="część konfiguracja" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/9.PNG" loading="lazy" />
...
<img className="thumbnail" alt="karta Domeny" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/10.PNG" loading="lazy" />
...
<img className="thumbnail" alt="dodawanie domeny free" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/11.PNG" loading="lazy" />

<img className="thumbnail" alt="dodawanie domeny advanced" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/12.PNG" loading="lazy" />
...
<img className="thumbnail" alt="karta serwery" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/13.PNG" loading="lazy" />
...
<img className="thumbnail" alt="dodawanie IP/PORT advanced (wewnętrzne)" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/15.PNG" loading="lazy" />
...
<img className="thumbnail" alt="karta zadania" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/13-bis.PNG" loading="lazy" />
...
<img className="thumbnail" alt="tylko http" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/14.PNG" loading="lazy" />
...
<img className="thumbnail" alt="karta metryki" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/17.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Ponowne generowanie SSL" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/16.PNG" loading="lazy" />
