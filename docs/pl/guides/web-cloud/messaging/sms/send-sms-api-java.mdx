...
Utwórz identyfikatory skryptu (wszystkie klucze naraz) na tej stronie: <CreateToken rights="GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs">strona tworzenia tokenów OVHcloud</CreateToken> (ten adres URL automatycznie zapewni Ci odpowiednie uprawnienia na potrzeby kroków opisanych w tym przewodniku).
