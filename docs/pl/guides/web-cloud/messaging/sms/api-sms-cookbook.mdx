...
<Api version="v1" section="/sms" method="POST" route={"/sms/\{serviceName\}/receivers"} regions={['eu']} />
...
<Api version="v1" section="/sms" method="GET" route={"/sms/\{serviceName\}/outgoing"} regions={['eu']} />

Aby pobrać wszystkie szczegóły każdej wiadomości, użyj:

<Api version="v1" section="/sms" method="GET" route={"/sms/\{serviceName\}/outgoing/\{id\}"} regions={['eu']} />
...
<Api version="v1" section="/sms" method="GET" route={"/sms/\{serviceName\}/blacklists"} regions={['eu']} />
...
<Api version="v1" section="/sms" method="PUT" route={"/sms/\{serviceName\}"} regions={['eu']} />

W podejściu `Pull` możesz zdecydować się na przeglądanie otrzymanych odpowiedzi, wywołując następującą metodę:

<Api version="v1" section="/sms" method="GET" route={"/sms/\{serviceName\}/incoming"} regions={['eu']} />
...
<Api version="v1" section="/order" method="POST" route={"/order/sms/\{serviceName\}/credits"} regions={['eu']} />
...
<Api version="v1" section="/order" method="GET" route={"/order/sms/\{serviceName\}/credits"} regions={['eu']} />
...
<Api version="v1" section="/sms" method="POST" route={"/sms/\{serviceName\}/users"} regions={['eu']} />

Następnie skonfigurowanie jego ustawień (callback, limit, IP itp.):

<Api version="v1" section="/sms" method="PUT" route={"/sms/\{serviceName\}/users/\{login\}"} regions={['eu']} />

Na koniec możesz sprawdzić stan zużycia użytkownika:

<Api version="v1" section="/sms" method="GET" route={"/sms/\{serviceName\}/users/\{login\}"} regions={['eu']} />
...
<Api version="v1" section="/sms" method="POST" route={"/sms/\{serviceName\}/transferCredits"} regions={['eu']} />
