...
- Aktywny nadawca SMS. Więcej informacji znajdziesz w tym [przewodniku](/guides/web-cloud/messaging/sms/send-sms-control-panel).
...
<img className="thumbnail" alt="Formularz wysyłki SMS przez URL http2sms" src="/images/web-cloud/messaging/sms/send-sms-http2sms/img_4011.jpg" loading="lazy" />
...
Twoja przeglądarka wyświetli następujące informacje:

- status wysyłki
- liczbę kredytów pozostałych na koncie SMS
- ID wysłanych SMS-ów
...
Więcej informacji na temat analizy wykonanych wysyłek znajdziesz [w etapie 3 tego przewodnika](#analysis).
...
Aby uzyskać więcej informacji na temat dozwolonych znaków w kodowaniu 7-bitowym, zapoznaj się z [załącznikiem](#zalacznik) na dole tego przewodnika.
:::
...
### Etap 3: Analiza wysyłki <a name="analysis"></a>
