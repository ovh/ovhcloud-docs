...
:::info
Po wprowadzeniu adresu e-mail i hasła na stronie logowania do interfejsu webmail nastąpi przekierowanie do okna logowania **Zimbra**, w którym należy ponownie wprowadzić dane logowania. W tym oknie pole **Nazwa użytkownika** ("Username") odpowiada Twojemu **pełnemu adresowi e-mail**, a nie odrębnej nazwie użytkownika.
:::

<img className="thumbnail" alt="Okno logowania Zimbra" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-login-window.png" loading="lazy" />
...
<Tabs>
  <Tab label="Nagłówek">
    ...
    - **UDW**: Kliknij <code className="action">DW/UDW</code> po prawej stronie pola <code className="action">Do</code>, aby wyświetlić to pole. Niewidoczna kopia węglowa to pole odbiorcy, które umożliwia przesłanie wiadomości e-mail bez widzenia przez innych adresatów osoby w "**UDW**".<br/>
