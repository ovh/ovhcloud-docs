...
:::info
Przykład: Jeśli chcesz zmodyfikować domyślną stopkę wiadomości wysyłanych do abonentów listy mailingowej, musisz wysłać wiadomość na adres `nazwa_twojej_LM-edit.bottom@mydomain.ovh`. Otrzymasz wówczas nową wiadomość informującą, jak spersonalizować stopkę.
