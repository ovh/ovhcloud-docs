...
W usługach MX Plan korzystających z interfejsu webmail Zimbra lub OWA mówimy o *resecie konta*, kiedy musisz go usunąć.
...
Aby uzyskać nowy adres e-mail, przejdź do zakładki <code className="action">E-maile</code>. Tabela, która się wyświetla zawiera wszystkie konta e-mail utworzone w ramach Twojej usługi MX Plan. Kliknij przycisk <code className="action">Stwórz adres e-mail</code>.
...
<Region zones={['eu']}>
Zapoznaj się z wszystkimi ofertami e-mail od OVHcloud [Zimbra](https://www.ovhcloud.com/pl/emails/zimbra-emails/) lub [Exchange](https://www.ovhcloud.com/pl/emails-exchange/), aby uzupełnić ofertę MX Plan dla tej samej domeny.
</Region>
