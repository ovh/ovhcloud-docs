...
<Tabs>
  <Tab label="Pierwsza konfiguracja">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />|Wybierz <code className="action">Dodaj adres e-mail</code>|
  </Tab>
  <Tab label="Istniejąca konfiguracja">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />|1. Przejdź do menu w lewym górnym rogu ekranu<br/><br/>2.Wybierz <code className="action">Ustawienia</code><br/><br/>3.Wybierz <code className="action">Dodaj konto</code>|
  </Tab>
</Tabs>
