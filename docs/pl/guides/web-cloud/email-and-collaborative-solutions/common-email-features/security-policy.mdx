...
:::info
Jeśli nie wyświetla się zakładka <code className="action">Więcej</code> w panelu zarządzania usługą <code className="action">MX Plan</code>, oznacza to, że Twoja usługa korzysta z interfejsu webmail Roundcube. Zarządzanie polityką bezpieczeństwa nie jest dostępne w usługach MX Plan korzystających z Roundcube.
...
<Region zones={['ca']}>
Po uzupełnieniu tych informacji możesz zatwierdzić zmiany, klikając <code className="action">Dalej</code>, a następnie <code className="action">Zatwierdź</code> w przypadku oferty "MX Plan". W przypadku oferty Exchange kliknij <code className="action">Zapisz zmiany</code>.
</Region>

<Region zones={['apac']}>
Po uzupełnieniu tych informacji możesz zatwierdzić zmiany, klikając <code className="action">Dalej</code>, a następnie <code className="action">Zatwierdź</code> w przypadku oferty "MX Plan".
</Region>
