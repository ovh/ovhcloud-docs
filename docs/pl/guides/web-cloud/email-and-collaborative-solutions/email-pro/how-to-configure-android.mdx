...
<Tabs>
  <Tab label="Pierwsza konfiguracja">
    Wybierz <code className="action">Dodaj adres e-mail</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Istniejąca konfiguracja">
    ...
    3. Wybierz <code className="action">Dodaj konto</code><br/><br/><img className="thumbnail" alt="Dodawanie istniejącego konta w aplikacji Gmail na Androidzie" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
