...
<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-tab.png" loading="lazy" />
...
<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-01.png" loading="lazy" />

Procedura diagnostyczna zajmie około 3 do 10 minut. Oto przykład:

<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-02.png" loading="lazy" />
