...
<Region zones={['ca']}>
- Posiadanie usługi **MX Plan** lub **Exchange**.
</Region>

<Region zones={['apac']}>
- Posiadanie usługi **MX Plan**.
</Region>
...
<ZoneTabs>
  <Tab label="Konto e-mail MX Plan">
    W przypadku oferty **MX Plan** przejdź do [strony naszych przewodników MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan) i sprawdź konfigurację Twojego programu pocztowego za pomocą dostępnych przewodników w sekcji `Konfigurowanie aplikacji poczty e-mail na komputerze` lub `Konfigurowanie aplikacji poczty e-mail na telefonie komórkowym`, w zależności od używanego urządzenia.
  </Tab>
  <Tab label="E-mail Pro" availableIn={['eu']}>
    W przypadku oferty **E-mail Pro** przejdź do [strony naszych przewodników E-mail Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro) i sprawdź konfigurację Twojego programu pocztowego za pomocą dostępnych przewodników w sekcji `Konfigurowanie aplikacji poczty e-mail na komputerze` lub `Konfigurowanie aplikacji poczty e-mail na telefonie komórkowym`, w zależności od używanego urządzenia.
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    W przypadku oferty **Exchange** przejdź do [strony naszych przewodników Microsoft Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange) i sprawdź konfigurację Twojego programu pocztowego za pomocą dostępnych przewodników w sekcji `Konfigurowanie aplikacji poczty e-mail na komputerze` lub `Konfigurowanie aplikacji poczty e-mail na telefonie komórkowym`, w zależności od używanego urządzenia.
  </Tab>
  <Tab label="Zimbra" availableIn={['eu']}>
