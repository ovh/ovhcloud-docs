...
- <code className="action">1</code> **Kosz (trash)**: zawiera ona elementy, które usunąłeś. Aby uniknąć gromadzenia e-maili w tym folderze, zalecamy regularne usuwanie kosza.
...
Z karty <code className="action">Konta e-mail</code>, kliknij przycisk <i className="icons-elipsis icons-border-rounded icons-masterbrand-blue"></i> po prawej stronie konta, które chcesz zmienić, po czym kliknij <code className="action">Zmień</code>.
  ...
  <Tab label="E-mail Pro" availableIn={['eu']}>
    Oferta E-mail Pro posiada unikalną pojemność 15 GB. Jeśli potrzebujesz większej przestrzeni dyskowej, zmień ofertę proponującą więcej przestrzeni dyskowej. W tym celu przeczytaj sekcję [zmiana oferty, aby zwiększyć jej wydajność](#switchingoffer) tego przewodnika.<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
...
<ZoneTabs>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows) (za darmo)<br/><br/>>
