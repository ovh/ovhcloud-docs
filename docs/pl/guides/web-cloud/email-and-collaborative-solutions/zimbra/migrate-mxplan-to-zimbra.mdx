...
2. **[Usunięcie pierwotnego konta MX Plan i przypisanie jego adresu do konta Zimbra](#step2)**
    - [2.1 - Usunięcie pierwotnego adresu e-mail MX Plan](#step21)
...
<Tabs>
  <Tab label="Krok 1">
    **Tworzenie projektu migracji**
    ...
    <img className="thumbnail" alt="Strona główna OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Krok 2">
    **Tworzenie migracji**
    ...
    <img className="thumbnail" alt="Tworzenie migracji z MX Plan do Zimbra w OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Usunięcie pierwotnego adresu e-mail MX Plan <a name="step21"></a>
