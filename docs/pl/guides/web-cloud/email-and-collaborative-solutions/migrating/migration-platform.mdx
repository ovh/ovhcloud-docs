...
- Jeśli musisz przenieść **konto Exchange lub Zimbra PRO** do konta **E-mail Pro** lub **Zimbra STARTER**, musisz upewnić się, że Twoje konta e-mail nie przekraczają 15 Go – jest to pojemność wspólna dla E-mail Pro i Zimbra STARTER. Funkcje współpracy, synchronizacja kalendarzy i kontaktów nie są dostępne w E-mail Pro ani Zimbra STARTER i nie mogą być przeniesione.
