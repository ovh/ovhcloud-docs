...
<img className="thumbnail" alt="Tworzenie nowej migracji w OVHcloud Mail Migrator, krok 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
