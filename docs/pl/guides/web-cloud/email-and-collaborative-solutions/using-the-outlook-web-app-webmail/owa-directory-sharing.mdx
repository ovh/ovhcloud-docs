...
<Region zones={['eu']}>
:::info
Choć ten przewodnik dotyczy usług Exchange, z instrukcji można skorzystać również w przypadku kont [Email Pro](https://www.ovhcloud.com/pl/emails/email-pro/).
:::
</Region>

<Region zones={['ca']}>
:::info
Ten przewodnik dotyczy usług Exchange.
:::
</Region>
