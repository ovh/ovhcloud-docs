...
W każdej chwili możesz również tworzyć ręczne snapshoty, przechowywać je bez ograniczeń czasowych lub je usuwać. Funkcja ta jest dostępna w Panelu <ManagerLink to="/">klienta OVHcloud</ManagerLink> lub za pośrednictwem <ApiLink>następującego wywołania API</ApiLink>:
