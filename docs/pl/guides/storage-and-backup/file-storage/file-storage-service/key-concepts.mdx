...
description: Understand the core concepts of OVHcloud File Storage Service, including NFS shares, access control, architecture, data protection, and how it compares to block and object storage.
...
:::info
For step-by-step provisioning and mounting, see [File Storage Service – Getting Started](/guides/storage-and-backup/file-storage/file-storage-service/getting-started).
:::
...
For API steps to manage snapshots, see [File Storage Service – Managing Share Snapshots](/guides/storage-and-backup/file-storage/file-storage-service/create-snapshot).
