...
<Tabs>
  <Tab label="Przez API">
    ...
    Aby uzyskać URN usługi, użyj następującego wywołania API: <Api version="v2" section="/iam" method="GET" route={"/iam/resource"} />
...
[Zarządzanie kontami usługowymi OVHcloud (EN)](/guides/manage-and-operate/api/manage-service-account)
