...
- Połączenie z <ApiLink>API OVHcloud</ApiLink>
- Posiadanie wolumenu Enterprise File Storage z kopią zapasową `manual`

[[cpnav:storage-enterprise-file-storage]]

:::info
Możesz utworzyć wolumen i snapshot typu `manual` za pomocą <ApiLink>API OVHcloud</ApiLink> lub w <ManagerLink to="/">panelu klienta OVHcloud</ManagerLink>.
