...
description: Dowiedz się, jak przeprowadzić ewaluację wydajności Cloud Disk Array
...
Odwiedź nasz dedykowany kanał na Discordzie: [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud). Zadawaj pytania, przesyłaj opinie i kontaktuj się bezpośrednio z zespołem, który tworzy nasze usługi przechowywania i tworzenia kopii zapasowych.
