...
Znajdziesz dzienniki swojego agenta w folderze: `C:\ProgramData\Veeam\` lub `/var/log`.
...
Musisz pobrać agenta ze swojego <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> i zainstalować go na swoim nowym systemie operacyjnym.
...
<Tabs>
  <Tab label="Windows">
    ...
    **Eksportowanie dzienników**
    ...
    2. Przejdź do menu <code className="action">Help</code> > <code className="action">Export Logs</code>.
    3. Wybierz katalog docelowy dla archiwum dzienników.
    4. Kliknij <code className="action">Export</code>, aby wygenerować archiwum.
