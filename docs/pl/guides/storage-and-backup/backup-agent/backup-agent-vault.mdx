...
- Dane kopii zapasowej są automatycznie wysyłane do Vault utworzonego w **Gravelines (GRA)**, o nazwie **backup-vault-gra-1**.
...
- Serwer Bare Metal w **RBX** wysyła swoje dane do **backup-vault-gra-1** w **Gravelines (GRA)**.
- Serwer Bare Metal w **GRA** wysyła swoje dane do **backup-vault-sbg-1** w **Strasburgu (SBG)**.
