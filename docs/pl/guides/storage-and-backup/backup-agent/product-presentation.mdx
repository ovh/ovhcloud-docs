...
Gdy agent wykona kopie zapasowe, będziesz mógł przywrócić swoje dane na dwa sposoby: przywracanie plików (FLR) lub przywracanie serwera.

## Kluczowe aspekty

Istnieje kilka kluczowych zalet tej oferty:

- Pierwsza automatyczna zasada kopii zapasowych z 30-dniowym okresem przechowywania.
- Możliwość wydłużenia okresu przechowywania do 365 dni.
