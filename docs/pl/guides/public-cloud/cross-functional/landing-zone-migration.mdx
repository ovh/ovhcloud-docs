...
![Landing zone architecture diagram](/images/guides/public-cloud/cross-functional/landing-zone-migration/landing_zone_architecture.png)
...
See [this documentation](/guides/network/ovhcloud-connect/occ-direct-control-panel-setup).
