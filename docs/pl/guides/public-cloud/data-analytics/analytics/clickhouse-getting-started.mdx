...
Find detailed hourly and monthly rates for OVHcloud Public Cloud services — including virtual instances, managed databases, and Analytics solutions with ClickHouse plans — on the [ClickHouse pricing page](https://www.ovhcloud.com/pl/public-cloud/prices/#analytics).
