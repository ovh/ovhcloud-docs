...
Następnie wykonaj pozostałe etapy zgodnie z instrukcjami zawartymi w [tym przewodniku](/guides/public-cloud/compute/public-cloud-first-steps#create-instance). Może to potrwać kilka minut.
