...
:::info
Poniższe polecenia są takie same niezależnie od zastosowanej wcześniej procedury. Wartości pliku, bloku i rozmiaru pokazane w przykładowym wyniku odpowiadają przykładowi dla partycji do 2 TB (dysk 70 GiB) użytemu wcześniej w tym przewodniku. Jeśli zastosowano procedurę dla partycji powyżej 2 TB, wynik będzie zawierał większe wartości odzwierciedlające zmieniony rozmiar dysku, ale same kroki są identyczne.
:::
