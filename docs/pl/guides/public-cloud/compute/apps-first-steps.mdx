...
- Instancja [Public Cloud](/guides/public-cloud/compute/getting-started) na Twoim koncie OVHcloud.
...
|Parametr|Opis|
|---|---|
|serviceName *|Twój identyfikator projektu Public Cloud|
|instanceId *|Jest to UID Twojej instancji|
...
1. Uzyskaj URL jednorazowego użytku [zgodnie z tymi krokami](#szczegóły-logowania-do-aplikacji).
...
1. Pobierz URL dostępu do Twojej aplikacji, [wykonując te kroki](#szczegóły-logowania-do-aplikacji).
2. Kliknij link zwrócony przez API.
