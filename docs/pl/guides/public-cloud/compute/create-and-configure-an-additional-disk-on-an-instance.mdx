...
- Posiadanie instancji [Public Cloud](/guides/public-cloud/compute/getting-started) na koncie OVHcloud
...
:::info
Każdy typ woluminu jest również dostępny w wersji zaszyfrowanej (**LUKS**). Wolumeny te zapewniają poufność danych. Są one dostępne w Panelu klienta OVHcloud, jak również z narzędziami przedstawionymi w następnej sekcji, wskazując typ:`<volume_type>-luks`.

:::

:::warning
**Wpływ szyfrowania (LUKS) na wydajność.** Wolumeny zaszyfrowane mają o około 10% niższą wydajność w porównaniu z równoważnymi wolumenami niezaszyfrowanymi.
