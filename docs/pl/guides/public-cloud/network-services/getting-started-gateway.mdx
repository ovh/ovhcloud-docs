...
<Tabs>
  ...
  <Tab label="API OVHcloud">
    Połącz się z [API OVHcloud](https://eu.api.ovh.com/console/) i użyj poniższego wywołania, aby utworzyć Gateway wraz z nową siecią prywatną i podsiecią w jednej operacji:
