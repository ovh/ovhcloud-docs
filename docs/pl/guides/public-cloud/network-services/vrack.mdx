...
<Tabs>
  <Tab label="Panel klienta OVHcloud">
    Aby uzyskać pomoc, zapoznaj się z przewodnikiem [Tworzenie instancji w Panelu klienta OVHcloud](/guides/public-cloud/compute/getting-started). Przy tworzeniu instancji wybierz tryb sieciowy w kroku 5, a następnie prywatną sieć.
