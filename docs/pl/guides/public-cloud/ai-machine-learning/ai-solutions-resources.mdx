...
- Access to the <ManagerLink to="/#/public-cloud/pci/projects">OVHcloud Control Panel</ManagerLink> or [the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed on your computer
