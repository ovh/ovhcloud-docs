...
| Public Cloud - Databases | OVHcloud Control Panel & API | [Public Cloud Databases - Set up logs forwarding for Public Cloud Databases](/guides/public-cloud/databases/logs-to-customers) |
| Public Cloud - Analytics | OVHcloud Control Panel & API | [Public Cloud Analytics - Set up logs forwarding for Analytics](/guides/public-cloud/data-analytics/analytics/logs-to-customers) |
...
| Web Cloud - Microsoft Private Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Web Cloud - Microsoft Trusted Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
