...
- Aby uzyskać dostęp do sekretów za pomocą REST API lub API zgodnego z HashiCorp Vault KV2, skonfiguruj [metodę uwierzytelniania](/guides/manage-and-operate/kms/okms-authentification-method) dla swojej domeny OKMS (Personal Access Token, konto usługi lub certyfikat dostępu).
...
Użytkownik z odpowiednimi uprawnieniami IAM może uzyskać dostęp do zawartości sekretu. Skonfiguruj uwierzytelnianie i polityki IAM zgodnie z opisem w [Metodach uwierzytelniania OKMS](/guides/manage-and-operate/kms/okms-authentification-method).
...
Secret Manager jest dostępny za pośrednictwem dwóch różnych zestawów API. Oba operują na tych samych obiektach — sekret utworzony jedną metodą jest dostępny za pomocą drugiej.

Przed wywołaniem któregokolwiek z API skonfiguruj [metodę uwierzytelniania](/guides/manage-and-operate/kms/okms-authentification-method) oraz wymaganą [politykę IAM](/guides/manage-and-operate/kms/okms-authentification-method#iam-rights-for-okms) dla swojej domeny OKMS. W przypadku korzystania z REST API zalecane jest użycie Personal Access Token lub konta usługi.
...
- [Korzystanie z Secret Manager z REST API](/guides/manage-and-operate/secret-manager/rest-api)
- [Korzystanie z Secret Manager z API zgodnym z HashiCorp Vault KV2](/guides/manage-and-operate/secret-manager/kv2-api)
