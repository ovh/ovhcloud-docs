...
- Skonfigurowana [metoda uwierzytelniania](/guides/manage-and-operate/kms/okms-authentification-method) dla warstwy danych OKMS (w tym przewodniku używany jest Personal Access Token).
- Klaster [Managed Kubernetes Service](/links/public-cloud/kubernetes).
...
Utwórz [lokalnego użytkownika IAM](/guides/account-and-service-management/account-information/ovhcloud-users-management) z uprawnieniami dostępu do swojej domeny lub użyj [konta usługi](/guides/manage-and-operate/api/manage-service-account). Pełną konfigurację i szablony polityk IAM opisano w [Metodach uwierzytelniania OKMS](/guides/manage-and-operate/kms/okms-authentification-method).
