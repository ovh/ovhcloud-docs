...
Uwierzytelnij się za pomocą [Personal Access Token, konta usługi lub certyfikatu dostępu](/guides/manage-and-operate/kms/okms-authentification-method). W przypadku korzystania z API zgodnego z HashiCorp Vault KV2 zalecane jest użycie PAT lub konta usługi.
