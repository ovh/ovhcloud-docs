...
Hardware Security Module (HSM) to wyspecjalizowane urządzenie fizyczne przeznaczone do bezpiecznego generowania, przechowywania i używania kluczy kryptograficznych. Klucze chronione przez HSM nigdy nie opuszczają sprzętu: operacje kryptograficzne są wykonywane na dedykowanym sprzęcie odpornym na manipulacje, co wzmacnia poufność i integralność kluczy.

OVHcloud korzysta z HSM Thales Luna, certyfikowanych zgodnie z FIPS 140-3 Level 3 oraz Common Criteria EAL4+.

Klucze utworzone z poziomem ochrony HSM są replikowane na trzech różnych fizycznych HSM. Ich dokładna lokalizacja zależy od regionu wybranego dla OKMS.

#### Regiony 3-AZ

W regionach 3-AZ trzy HSM są rozmieszczone we wszystkich strefach Availability Zone.

#### Regiony 1-AZ

W regionach 1-AZ dwa HSM znajdują się w regionie, a trzeci zdalny HSM jest wdrażany w odrębnym pobliskim regionie.

Lokalizacje zdalnych HSM:

- **EU-WEST-GRA** (wkrótce): EU-WEST-RBX
- **EU-WEST-RBX** (wkrótce): EU-WEST-SBG
- **EU-WEST-SBG** (wkrótce): EU-WEST-GRA
