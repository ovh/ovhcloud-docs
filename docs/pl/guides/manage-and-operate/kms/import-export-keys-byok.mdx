...
- `okmsId` oraz regionalny endpoint, zwracane przez <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> i wyświetlane w zakładce **Informacje ogólne** w <ManagerLink to="/#/okms/key-management-service">dashboardzie Twojej domeny OKMS</ManagerLink>.
