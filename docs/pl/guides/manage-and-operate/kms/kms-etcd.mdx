...
| `--kmip-addr` | Adres serwera KMIP. Dostępny w <ManagerLink to="/#/dedicated/security/kms">dashboardzie Twojej domeny OKMS</ManagerLink>. (np. `eu-west-rbx.okms.ovh.net:5696`). | `""` (wymagane) |
