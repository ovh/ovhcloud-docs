...
| **Płaszczyzna kontrolna (API OVHcloud)** | <ApiLink section="/okms" version="v2">`/v2/okms`</ApiLink> | Zamawianie domen, zarządzanie danymi uwierzytelniającymi, konfiguracja rejestrowania logów |
...
:::info
Twój `okmsId` oraz Twój regionalny endpoint są zwracane przez następujące wywołanie API:

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

Oba są również widoczne w zakładce **Informacje ogólne** w <ManagerLink to="/#/okms/key-management-service">dashboardzie Twojej domeny OKMS</ManagerLink>.
:::
...
### Konfiguracja uwierzytelniania <a id="set-up-authentication"></a>
...
### Korzystanie z interfejsu Swagger OKMS <a id="use-the-okms-swagger-ui"></a>
...
Możesz ją również otworzyć z poziomu linku Swagger na <ManagerLink to="/#/okms/key-management-service">dashboardzie Twojej domeny OKMS</ManagerLink>.
...
### Uprawnienia IAM dla OKMS <a id="iam-rights-for-okms"></a>
