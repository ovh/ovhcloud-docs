...
<img className="thumbnail" alt="Edycja zasobów" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png" loading="lazy" />

W tym menu możesz zwiększyć zasoby przypisane do maszyny wirtualnej. 

<img className="thumbnail" alt="Edycja zasobów" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie CPU" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie pamięci" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie zasobów dyskowych" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie sieci" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie napędu CD / DVD" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodawanie urządzeń peryferyjnych" src="/images/hosted-private-cloud/powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png" loading="lazy" />
