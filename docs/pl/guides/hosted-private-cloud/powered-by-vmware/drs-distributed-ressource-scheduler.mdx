...
<img className="thumbnail" alt="zasada działania DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="aktywacja DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="automatyzacja DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="dodatkowe opcje DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="zaawansowane opcje DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### Reguły DRS

W karcie `Konfiguruj` można zarządzać regułami VM/hosta.

<img className="thumbnail" alt="reguły DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
<img className="thumbnail" alt="tworzenie reguł DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
