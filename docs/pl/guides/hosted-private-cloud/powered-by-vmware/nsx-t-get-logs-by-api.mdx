...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="infos" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/export-log-bundle.mp4" />
