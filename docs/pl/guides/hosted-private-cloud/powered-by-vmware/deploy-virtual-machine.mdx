...
- Dostęp do [interfejsu vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection)
...
<img className="thumbnail" alt="wdrożenie maszyny wirtualnej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm01.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór sposobu tworzenia" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="lokalizacja maszyny wirtualnej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór zasobów" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór pamięci masowej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór kompatybilności" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór systemu operacyjnego gościa" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór sieci" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór pliku ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="podłączanie pliku ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="podsumowanie maszyny wirtualnej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="uruchamianie maszyny wirtualnej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm12.png" loading="lazy" />
...
<img className="thumbnail" alt="konsola maszyny wirtualnej" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm13.png" loading="lazy" />
