...
<img className="thumbnail" alt="brama Private Cloud" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/gatewayPCC.jpg" loading="lazy" />
...
<img className="thumbnail" alt="zmiana hasła" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/selectChangePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="skanowanie kodu QR" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/scanQRcode.png" loading="lazy" />
...
<img className="thumbnail" alt="logowanie 2FA" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/2FAtoken.png" loading="lazy" />
...
Aplikacje te muszą wcześniej uzyskać autoryzację poprzez politykę dostępu do vCenter, którą możesz skonfigurować w [Panelu klienta](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#bezpieczeństwo).
