...
If you prefer to automate or integrate Windows licence management into your workflows, you can use the <ApiLink>OVHcloud API</ApiLink> to list, assign, update or remove licences on your virtual machines.
