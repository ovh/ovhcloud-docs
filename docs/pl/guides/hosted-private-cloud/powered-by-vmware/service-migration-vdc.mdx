...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="add a Virtual Datacenter" src="/images/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc/add-vDC.mp4" />
