...
**Zwróć uwagę na logo OVHcloud w swojej skrzynce odbiorczej**

Kilka usług pocztowych, w tym Gmail, Yahoo i Apple Mail z adresem iCloud.com, wyświetla logo OVHcloud obok nazwy nadawcy w wiadomościach wysłanych przez OVHcloud z adresu kończącego się na `ovhcloud.com`. W Gmailu pojawia się przy nim również niebieski znacznik wyboru.

<img className="thumbnail" alt="Logo OVHcloud wyświetlane obok nazwy nadawcy" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Logo to wyświetla Twoja poczta, a nie sama wiadomość: fałszywa wiadomość nie może go podrobić. Nie wszystkie usługi pocztowe już je wyświetlają, więc sam jego brak niczego nie dowodzi: w takim przypadku opieraj się na weryfikacjach opisanych poniżej.

Następnie sprawdź, czy otrzymana wiadomość e-mail jest również widoczna na stronie <ManagerLink to="/#/communication">Moje wiadomości</ManagerLink>. Znajdziesz tam kopie wszystkich oficjalnych wiadomości wysłanych przez OVHcloud.
...
<img className="thumbnail" alt="Outlook Windows - identyfikacja wersji" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
