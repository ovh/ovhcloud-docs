...
- **Kontakt administracyjny** zarządza kwestiami administracyjnymi i technicznymi usługi. Ma uprawnienia do modyfikowania wszystkich kontaktów i może wprowadzać zmiany w informacjach abonenta usługi, takich jak nazwy domeny.
...
#### Jestem kontaktem technicznym <a name="technique"></a>
