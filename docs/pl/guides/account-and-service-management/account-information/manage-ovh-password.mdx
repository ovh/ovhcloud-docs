...
Hasło do Panelu klienta OVHcloud umożliwia dostęp do wszystkich Twoich usług i danych. Hasło musi być wystarczająco silne i musi być regularnie odnawiane, aby usługi i dane były bezpieczne.
...
Więcej informacji znajdziesz w sekcji [Sprawdź również](#sprawdź-również) na końcu tego przewodnika.

### Użycie managera haseł 

Specjalne oprogramowanie umożliwia zapisywanie i zabezpieczanie hasła dostępu do konta OVHcloud.
...
Jeśli Twoje hasło zostało wykradzione, rekomendujemy [jego natychmiastową zmianę](#zmiana-hasła).
