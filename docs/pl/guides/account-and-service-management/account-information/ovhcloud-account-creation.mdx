...
Po założeniu konta zostaniesz automatycznie zalogowany do strony głównej konta, zwanej "Dashboardem".
...
:::tip
Zanotuj swój identyfikator klienta, ponieważ będziesz potrzebował go przy każdym logowaniu do konta.

**Porada: Użyj managera haseł**

Specjalne oprogramowanie umożliwia zapisywanie i zabezpieczanie danych dostępowych do konta OVHcloud (login i hasło).<br/>
