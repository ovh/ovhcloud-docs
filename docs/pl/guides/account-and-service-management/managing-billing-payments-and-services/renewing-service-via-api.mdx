...
Aby użyć <ApiLink section="/service" method="GET" route={"/service/\{serviceId\}/renew"}>API do odnowienia usługi</ApiLink>, będziesz potrzebował `serviceId`. Informacja ta jest dostępna poprzez API, za pomocą `serviceInfos`:
