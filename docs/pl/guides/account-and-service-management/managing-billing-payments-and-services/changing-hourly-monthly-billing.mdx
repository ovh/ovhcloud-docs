...
Otwórz <ApiLink>interfejsu API OVHcloud</ApiLink> zgodnie z [odpowiednim przewodnikiem](/guides/manage-and-operate/api/first-steps) i postępuj zgodnie z poniższymi krokami.
