...
- Dostęp do <ApiLink>API OVHcloud</ApiLink> (opcjonalnie).
...
<Tabs>
  ...
  <Tab label="Za pośrednictwem API OVHcloud">
    Przejdź na stronę <ApiLink>API</ApiLink> OVHcloud:
...
- [Konfiguracja trwała dla systemu Red Hat i pochodnych (Rocky Linux, AlmaLinux, itp.)](#persistentredhat).
- [Konfiguracja trwała dla Fedora 43 i nowszych wersjach](#persistentfedora).
...
#### Konfiguracja trwała dla Red Hat i jego pochodnych (Rocky Linux, AlmaLinux, itp.) <a name="persistentredhat"></a>

Istnieją dwie metody konfiguracji Twojej sieci zgodnie z systemem operacyjnym zainstalowanym na Twoim serwerze:

- **Rocky Linux & AlmaLinux (8/9)**: należy użyć metody opartej na pliku *network-scripts*;
...
#### Konfiguracja trwała dla Fedora 43 i nowszych wersji <a name="persistentfedora"></a>
