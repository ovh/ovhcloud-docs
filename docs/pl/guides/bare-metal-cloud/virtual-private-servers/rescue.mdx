...
Pliki w katalogu `/mnt` możesz edytować bezpośrednio. Aby uruchomić polecenia samego serwera VPS, przejdź do zamontowanego systemu za pomocą następującego polecenia. Polecenia te będą wtedy korzystać z plików binarnych i plików konfiguracyjnych VPS, a nie środowiska Rescue:
