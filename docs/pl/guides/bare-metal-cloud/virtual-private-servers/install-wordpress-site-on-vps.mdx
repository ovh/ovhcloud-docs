...
To access your website from a browser, first link the domain name of your WordPress website to the IP address of your VPS or dedicated server. To do this, edit the `A` record of the active DNS zone so that it targets that IP address, as described in our guide on "[Editing an OVHcloud DNS zone](/guides/web-cloud/domains/dns-zone-edit)".
