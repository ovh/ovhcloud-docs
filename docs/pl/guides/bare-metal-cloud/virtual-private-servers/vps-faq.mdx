...
Najlepszą opcją jest zalogowanie się do naszego <ApiLink>API console</ApiLink> za pomocą danych identyfikacyjnych konta klienta i sprawdzenie, czy licencja może zostać przeniesiona na inny VPS. [Pierwsze kroki z API OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Otwórz <ApiLink>OVHcloud API console</ApiLink> i użyj następującego wywołania:
