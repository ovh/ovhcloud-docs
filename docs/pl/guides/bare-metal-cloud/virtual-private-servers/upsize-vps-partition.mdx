...
- `bad magic number in superblock`: nie kontynuuj. Procedura rozwiązania tego problemu została wyjaśniona w części tego przewodnika: [Jak usunąć błędy bad magic number in superblock](/guides/bare-metal-cloud/virtual-private-servers/upsize-vps-partition#jak-naprawiać-błędy-bad-magic-number-in-superblock);
