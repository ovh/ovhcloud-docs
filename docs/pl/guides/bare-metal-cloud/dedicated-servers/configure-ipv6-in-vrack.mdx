...
Wprowadź identyfikator swojego vRack (np. `pn-9000000`) jako *path parameter* `serviceName` i podaj blok IPv6 w *request body*:
...
Aby zdefiniować taką podsieć, użyj następującego wywołania:
