...
[[cpnav:network-security-dashboard]]
...
Zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, kliknij <code className="action">Sieć</code> w menu po lewej stronie ekranu, a następnie <code className="action">Publiczne adresy IP</code>. Upewnij się, że `Tryb zaawansowany` jest włączony, aby sprawdzić stan infrastruktury anty-DDoS i konfigurację jej komponentów
