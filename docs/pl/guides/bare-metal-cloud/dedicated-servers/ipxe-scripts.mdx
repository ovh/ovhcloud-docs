...
Za pośrednictwem <ApiLink>API OVHcloud</ApiLink> możesz również zdefiniować własne skrypty.
...
Na przykład poniższy skrypt ładuje (chainload) menu startowe [netboot.xyz](https://netboot.xyz/):
...
W każdej chwili możesz ponownie przełączyć się na dysk lub na tryb Rescue w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> (zapoznaj się z naszym przewodnikiem "[Włącz i użyj trybu Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)") lub przez <ApiLink>API OVHcloud</ApiLink>.
