...
<Tabs>
<Tab label="AlmaLinux & Rocky Linux (8)">
...
<Tab label="Fedora 43+, AlmaLinux & Rocky Linux (9/10)">
...
Następnie musisz utworzyć nową trasę IP dla sieci vRack. Dodasz nową regułę ruchu (`1 vrack`), modyfikując plik w sposób pokazany poniżej:
