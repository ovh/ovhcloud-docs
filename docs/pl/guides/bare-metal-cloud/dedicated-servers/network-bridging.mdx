...
<Tabs>
  ...
  <Tab label="Za pośrednictwem API OVHcloud">
    Na <ApiLink>stronie API OVHcloud</ApiLink> kliknij na <code className="action">Login</code> w prawym górnym rogu. Na następnej stronie wpisz Twój identyfikator klienta OVHcloud.
