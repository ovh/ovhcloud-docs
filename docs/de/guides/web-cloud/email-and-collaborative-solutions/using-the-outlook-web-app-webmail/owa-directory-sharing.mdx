...
<Region zones={['eu']}>
:::info
Obwohl sich diese Anleitung auf unsere Exchange Dienste bezieht, können Sie den Anweisungen auch für Ihre [Email Pro Accounts](https://www.ovhcloud.com/de/emails/email-pro/) folgen.
:::
</Region>

<Region zones={['ca']}>
:::info
Diese Anleitung bezieht sich auf unsere Exchange Dienste.
:::
</Region>
