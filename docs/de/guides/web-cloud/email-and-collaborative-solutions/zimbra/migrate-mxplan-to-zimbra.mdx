...
2. **[Den ursprünglichen MX Plan Account löschen und seine Adresse dem Zimbra Account zuweisen](#step2)**
    - [2.1 - Löschen der ursprünglichen MX Plan E-Mail-Adresse](#step21)
...
<Tabs>
  <Tab label="Schritt 1">
    **Migrationsprojekt erstellen**
    ...
    <img className="thumbnail" alt="Startseite des OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Schritt 2">
    **Migration erstellen**
    ...
    <img className="thumbnail" alt="Erstellen der Migration von MX Plan zu Zimbra im OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Löschen der ursprünglichen MX Plan E-Mail-Adresse <a name="step21"></a>
