...
<ZoneTabs>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    Klicken Sie auf <code className="action">Microsoft</code>, dann <code className="action">Exchange</code> und wählen Sie den betreffenden Dienst aus. Gehen Sie auf den Tab <code className="action">E-Mail Accounts</code>. Hier werden die bestehenden E-Mail-Accounts angezeigt. Sie können in der Spalte `Größe` den laufenden Verbrauch Ihrer E-Mail-Account einsehen.<br/><br/>
...
- <code className="action">3</code> **Gespeicherte E-Mails mit großen Anhängen**: E-Mails mit angehängten Dateien verbrauchen deutlich mehr Speicherplatz auf dem Account. Wir empfehlen, diese stattdessen lokal auf Ihrem Computer oder in einem Cloud-Speicher abzulegen.
...
<ZoneTabs>
  ...
  <Tab label="E-Mail Pro" availableIn={['eu']}>
    Das Angebot E-Mail Pro verfügt über eine fixe Account-Kapazität von 15 GB. Wenn Sie mehr Speicherplatz benötigen, kann das nur über einen Wechsel des E-Mail-Dienstes erreicht werden. Lesen Sie hierzu den Abschnitt [zur Migration von Accounts](#switchingoffer) in dieser Anleitung.<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
...
<ZoneTabs>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows) (kostenlos)<br/><br/>>
