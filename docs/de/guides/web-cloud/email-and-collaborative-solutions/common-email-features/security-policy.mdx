...
:::info
Wenn der Tab <code className="action">Mehr</code> nicht im Verwaltungsbereich von <code className="action">MX Plan</code> zu sehen ist, bedeutet das, dass Ihr Dienst das Roundcube Webmail verwendet. Bei MX Plan Diensten mit Roundcube gibt es keine Verwaltung der Sicherheitsrichtlinie.
...
<Region zones={['ca']}>
Wenn Sie alle Informationen angegeben haben, bestätigen Sie die Änderungen für "E-Mail"-Lösungen, indem Sie auf <code className="action">Weiter</code> und dann auf <code className="action">Bestätigen</code> klicken. Klicken Sie für Exchange auf <code className="action">Änderungen speichern</code>.
</Region>

<Region zones={['apac']}>
Wenn Sie alle Informationen angegeben haben, bestätigen Sie die Änderungen für "E-Mail"-Lösungen, indem Sie auf <code className="action">Weiter</code> und dann auf <code className="action">Bestätigen</code> klicken.
</Region>
