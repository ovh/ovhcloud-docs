...
Gehen Sie zum Bereich <ManagerLink to="/#/web/email_pro">E-Mail Pro</ManagerLink> zu gelangen. Der Servername wird im Bereich **Verbindung** auf der Seite <code className="action">Allgemeine Informationen</code> angezeigt.
...
:::info
Weitere Informationen zum Einrichten einer E-Mail-Adresse über die Outlook-App auf iOS finden Sie im [Microsoft Help Center](https://support.microsoft.com/de-de/outlook/install-mobile/set-up-the-outlook-app-for-ios).
