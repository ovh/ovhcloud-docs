...
<Tabs>
  <Tab label="Erste Konfiguration">
    ...
    <img className="thumbnail" alt="EmailPro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Vorhandene Konfiguration">
    ...
    <img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
