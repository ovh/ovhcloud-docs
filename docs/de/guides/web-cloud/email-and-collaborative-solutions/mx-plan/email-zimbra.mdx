...
:::info
Nachdem Sie Ihre E-Mail-Adresse und Ihr Passwort auf der Webmail-Anmeldeseite eingegeben haben, werden Sie zum **Zimbra** Anmeldefenster weitergeleitet, in dem Sie Ihre Zugangsdaten erneut eingeben müssen. In diesem Fenster entspricht das Feld **Benutzername** ("Username") Ihrer **vollständigen E-Mail-Adresse** und nicht einem separaten Benutzernamen.
:::

<img className="thumbnail" alt="Zimbra Anmeldefenster" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-login-window.png" loading="lazy" />
...
>
> Platzhalterzeichen (*Wildcards*) können im Eingabefeld eingegeben werden, wobei der Vergleichsoperator "**Entspricht der Platzhalter-Bedingung / Entspricht nicht der Platzhalter-Bedingung**" verwendet wird. Die verfügbaren Wildcards sind `*` und `?`.
>
...
- **Gesendete Mails im Ordner "Gesendet" des Stellvertreters speichern**: Wenn der delegierte Account eine E-Mail von Ihrer E-Mail-Adresse aus versendet, wird diese E-Mail im Ordner "Gesendet" des Delegationsaccounts abgelegt.
