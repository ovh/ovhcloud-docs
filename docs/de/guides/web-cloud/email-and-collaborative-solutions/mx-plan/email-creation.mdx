...
Bei MX Plan Diensten mit Zimbra oder OWA Webmail wird das Löschen eines Accounts als *Zurücksetzen des Accounts* bezeichnet.
...
<Region zones={['eu']}>
Sehen Sie sich alle unsere E-Mail-Angebote [Zimbra](/links/web/zimbra) oder [Exchange](https://www.ovhcloud.com/de/emails-exchange/) an, um Ihr MX Plan Angebot für dieselbe Domain zu vervollständigen.
</Region>
