...
<img className="thumbnail" alt="Erstellen einer neuen Migration im OVHcloud Mail Migrator, Schritt 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
