...
<img className="thumbnail" alt="Exchange-Diagnose" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-tab.png" loading="lazy" />
...
<img className="thumbnail" alt="Exchange-Diagnose" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-01.png" loading="lazy" />

Der Diagnosevorgang dauert etwa 3 bis 10 Minuten. Hier ein Beispiel für die Ergebnisse:

<img className="thumbnail" alt="Exchange-Diagnose" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-02.png" loading="lazy" />
