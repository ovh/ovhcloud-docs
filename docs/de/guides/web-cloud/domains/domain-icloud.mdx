...
<Tabs>
  ...
  <Tab label="Schritt 2">
    ...
    - **TXT**: für <Tooltip term="spf">SPF</Tooltip> (zusammenführen, falls bereits ein SPF-Eintrag vorhanden ist).
...
- Pro Domainname darf es nur **einen einzigen SPF-Eintrag** geben. Wenn bereits ein OVHcloud SPF-Eintrag vorhanden ist (z. B.: `v=spf1 include:mx.ovh.ca ~all`), führen Sie ihn mit dem von Apple bereitgestellten Eintrag zusammen (z. B.: `v=spf1 include:mx.ovh.ca include:icloud.com ~all`).
