...
Je nach Endung erhalten Sie möglicherweise eine E-Mail von OVHcloud, in der Sie aufgefordert werden, den ausgehenden Transfer zu bestätigen, bevor er fortgesetzt werden kann. Siehe [Bestätigung eines Inhaberwechsels oder eines ausgehenden Transfers](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
