...
<Tabs>
  ...
  <Tab label="SVCB">
    **S**er**V**i**C**e **B**inding<br/><br/>
    ...
    - **Alias-Modus**: Dieser Modus wird aktiviert, wenn Sie eine Priorität von 0 angeben. Im Gegensatz zu CNAME-DNS-Einträgen ermöglicht er es, einen Domainnamen von seiner eigenen DNS-Zone (Apex) zu einem anderen Domainnamen oder Subdomain zu leiten.
