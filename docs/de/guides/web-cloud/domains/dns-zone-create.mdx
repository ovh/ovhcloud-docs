...
Öffnen Sie im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> den Bereich `Web Cloud` und klicken Sie auf <code className="action">DNS-Zone</code>. Klicken Sie anschließend auf den Button <code className="action">Bestellen</code>.
