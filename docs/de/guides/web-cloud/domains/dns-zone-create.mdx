---
title: OVHcloud DNS-Zone für einen Domainnamen erstellen
...
Auf der angezeigten Seite geben Sie den Domainnamen ein (z. B. *domain.tld*), für den Sie eine OVHcloud DNS-Zone erstellen möchten. Warten Sie einige Augenblicke, während das Tool Prüfungen bezüglich des Domainnamens durchführt.

<img className="thumbnail" alt="Eingabe des Domainnamens zur Erstellung seiner DNS-Zone" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/dns-zone/adding-a-dns-zone.png" loading="lazy" />
...
Sobald die OVHcloud DNS-Zone einsatzbereit ist, aktivieren Sie diese, indem Sie die entsprechenden DNS-Server deklarieren. Ermitteln Sie hierfür zuerst die Namen der OVHcloud **DNS-Server**, auf denen die DNS-Zone für Ihren Domainnamen erstellt wurde.

Suchen Sie in der Tabelle die Spalten **Typ** und **Ziel**, ermitteln Sie die beiden Zeilen vom Typ **NS** und notieren Sie die beiden Werte in der Spalte **Ziel**.
