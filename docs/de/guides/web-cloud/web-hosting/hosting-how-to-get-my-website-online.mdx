...
Gehen Sie in Ihrem OVHcloud Kundencenter auf den Tab <code className="action">Multisite</code>, um zu überprüfen, in welchem Ordner die neue Website veröffentlicht wird. Achten Sie in der angezeigten Tabelle auf das für die gewünschte Domain angegebene <code className="action">Wurzelverzeichnis</code>. Platzieren Sie die Dateien in diesem Verzeichnis.
