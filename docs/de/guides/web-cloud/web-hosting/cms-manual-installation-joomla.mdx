...
- *Select the database type*: Wählen Sie aus den angebotenen Optionen den Typ Ihrer Datenbank aus. Wenn Sie eine im Webhosting inkludierte Datenbank verwenden, können Sie den Wert **MySQLi** beibehalten.
