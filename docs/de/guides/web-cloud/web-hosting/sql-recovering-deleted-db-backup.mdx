...
- Öffnen Sie die korrekte Webseite für Ihre <ApiLink>OVHcloud API</ApiLink> (`https://eu.api.ovh.com` wenn Ihre Dienste in Europa gehostet werden oder `https://ca.api.ovh.com`, wenn sie außerhalb Europas gehostet werden).
...
Führen Sie dazu auf <ApiLink>OVHcloud API</ApiLink> folgende Aktionen aus:
