...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Andernfalls wechseln Sie zum Tab <code className="action">Multisite</code>. Notieren Sie den Namen des `Wurzelverzeichnis`, das in der Zeile der betreffenden Webseite angezeigt wird: Dies ist das Verzeichnis, in dem sich die Dateien des 1-Klick-Moduls auf dem FTP-Server befinden.
  </Tab>
</Tabs>
