...
In allen Fällen sind die SMTP-Einstellungen dieselben: Server `smtp.mail.ovh.ca`, Port `465` (SSL/TLS) oder `587` (STARTTLS), mit Authentifizierung über die vollständige E-Mail-Adresse und deren Passwort.
