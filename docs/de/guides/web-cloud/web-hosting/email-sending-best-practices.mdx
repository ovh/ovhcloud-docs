...
Beide Methoden versenden E-Mails von Ihrer Website aus. Sie unterscheiden sich darin, von welchem Server die E-Mail ausgeht, wie der Versand begrenzt wird und wie Sie ihn nachverfolgen können.
...
| **Absenderidentität** | Die Adresse `From:` wird vom Skript angegeben. Stellen Sie sicher, dass Ihr SPF-Eintrag die OVHcloud Server autorisiert. | Die Adresse `From:` muss mit dem authentifizierten Account übereinstimmen. Die E-Mail wird mit DKIM signiert, wenn DKIM für Ihre Domain aktiviert ist. |
