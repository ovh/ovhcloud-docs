...
Wenn Ihr [Webhosting](/links/web/hosting) über diese Option verfügt, lesen Sie unsere Anleitung „[Automatische Tasks mit einem Webhosting verwenden](/guides/web-cloud/web-hosting/cron-tasks)“ für weitere Informationen.
