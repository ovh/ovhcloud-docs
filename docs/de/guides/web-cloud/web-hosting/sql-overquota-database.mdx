...
- [Importieren Sie Ihre alte Datenbank nach Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
...
Sie können jedoch die Statusänderung erzwingen, um den Vorgang zu beschleunigen. Hierzu können Sie beantragen, dass die Bots die Quota Ihres Dienstes neu berechnen.
