...
Um dies zu korrigieren, lesen Sie unsere Anleitung „[Die URL einer Website mit mod_rewrite über die .htaccess Datei umschreiben](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)“ oder wenden Sie sich an einen [spezialisierten Dienstleister](/links/partner), wenn Sie dabei Schwierigkeiten haben.
...
Falls nötig, lesen Sie unsere Anleitung „[Webhosting - Website auf HTTPS umstellen](/guides/web-cloud/web-hosting/ssl-activate-https-website)“ oder wenden Sie sich an einen [spezialisierten Dienstleister](/links/partner), wenn Sie Hilfe benötigen.
