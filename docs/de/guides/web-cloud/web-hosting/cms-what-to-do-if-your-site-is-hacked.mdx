...
- Installation von "inoffiziellen" Plugins oder Themes, insbesondere wenn Sie ein Content Management System (CMS) wie WordPress, Joomla!, PrestaShop oder Drupal verwenden.
...
:::warning
OVHcloud setzt Sicherheitsroboter ein, die von Ihrem Hosting ausgehende Angriffe erkennen können. Diese deaktivieren Ihr Hosting und informieren Sie per E-Mail, dass Ihr Hosting deaktiviert wurde.
