...
<Tabs>
  ...
  <Tab label="Schritt 4">
    :::warning
    Einige Optionen sind für CDN Basic nicht verfügbar und erfordern die Aktivierung von [CDN Security](/links/web/hosting-options-cdn) oder [CDN Advanced](/links/web/hosting-options-cdn).
