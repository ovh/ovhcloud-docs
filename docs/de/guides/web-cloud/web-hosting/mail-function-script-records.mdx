...
- **Stellen Sie sicher, dass Ihr Skript tatsächlich die "mail()"-Funktion verwendet**: Die Prüfungen und Statistiken auf dieser Seite betreffen ausschließlich E-Mails, die über "mail()" versendet werden. Wenn Ihr Skript oder die E-Mail-Einstellungen Ihrer Website einen SMTP-Server angeben, laufen die E-Mails über diesen Server und erscheinen hier nicht. Lesen Sie dazu den [Abschnitt SMTP](#SMTP) dieser Anleitung.
