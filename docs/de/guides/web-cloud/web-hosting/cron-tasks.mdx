...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="cron control panel" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/cron/add-scheduling-basic-mod-step-2.mp4" />
