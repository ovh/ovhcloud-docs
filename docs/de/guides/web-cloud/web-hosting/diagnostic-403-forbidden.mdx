...
Um diese Sicherheitslücken zu identifizieren, analysieren Sie die [Web-Logs](/guides/web-cloud/web-hosting/logs-and-statistics) Ihres Hostings oder wenden Sie sich an einen einen [spezialisierten Dienstleister](/links/partner), um eine Sicherheitsüberprüfung Ihrer Webseiten durchzuführen.
