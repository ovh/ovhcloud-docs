...
- Sie sind in der <ApiLink>OVHcloud API</ApiLink> eingeloggt.
- Sie haben Ihre [Zugangsdaten für die OVHcloud API eingerichtet - EN](/guides/manage-and-operate/api/first-steps).

## In der praktischen Anwendung

Um die <ApiLink section="/service" method="GET" route={"/service/\{serviceId\}/renew"}>Verlängerungs-API</ApiLink> zu verwenden, benötigen Sie die `serviceId`. Diese Information finden Sie in der API `serviceInfos`, zum Beispiel:
