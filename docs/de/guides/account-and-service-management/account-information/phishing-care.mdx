...
**Achten Sie in Ihrem Posteingang auf das OVHcloud Logo**

Mehrere E-Mail-Dienste, darunter Gmail, Yahoo und Apple Mail mit einer iCloud.com-Adresse, zeigen das OVHcloud Logo neben dem Namen des Absenders an, wenn die E-Mail von OVHcloud über eine Adresse versendet wurde, die mit `ovhcloud.com` endet. In Gmail erscheint daneben ein blaues Häkchen.

<img className="thumbnail" alt="OVHcloud Logo neben dem Namen des Absenders" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Dieses Logo wird von Ihrem E-Mail-Dienst angezeigt, nicht von der Nachricht: Eine betrügerische E-Mail kann es nicht nachbilden. Noch nicht jeder E-Mail-Dienst zeigt es an, sein Fehlen allein ist also kein Beweis: Prüfen Sie in diesem Fall anhand der unten beschriebenen Punkte.

Prüfen Sie anschließend, ob die empfangene E-Mail auch auf der Seite <ManagerLink to="/#/communication">Meine Kommunikation</ManagerLink> in Ihrem OVHcloud Kundencenter sichtbar ist. Dort finden Sie Kopien aller offiziellen E-Mails, die von OVHcloud gesendet wurden.
...
<img className="thumbnail" alt="Outlook Windows - Version identifizieren" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
