...
Sobald der Agent Backups erstellt hat, können Sie Ihre Daten auf zwei Arten wiederherstellen: Dateiwiederherstellung (FLR) oder Serverwiederherstellung.

## Wichtige Aspekte

Es gibt mehrere entscheidende Vorteile dieser Lösung:

- Erste automatische Backup-Richtlinie mit 30 Tagen Aufbewahrung.
- Möglichkeit, die Aufbewahrung auf bis zu 365 Tage zu verlängern.
...
- Die VSPC-Infrastruktur in den OVHcloud Rechenzentren gehostet wird und keine Daten an Veeam-Server sendet.
- Der Speicher basiert auf der [OVHcloud Object Storage](https://www.ovhcloud.com/de/public-cloud/object-storage/), in OVHcloud Rechenzentren gehostet.
