...
- Ihre Backup-Daten werden automatisch an einen Vault gesendet, der in **Gravelines (GRA)** erstellt wurde und **backup-vault-gra-1** heißt.
...
- Der Bare Metal Server in **RBX** sendet seine Daten an **backup-vault-gra-1** in **Gravelines (GRA)**.
- Der Bare Metal Server in **GRA** sendet seine Daten an **backup-vault-sbg-1** in **Strasbourg (SBG)**.
