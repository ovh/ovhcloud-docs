...
Sie finden Ihre Agent-Protokolle im Ordner: `C:\ProgramData\Veeam\` oder `/var/log`.
...
Sie müssen den Agent von Ihrem <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> herunterladen und auf Ihrem neuen Betriebssystem installieren.
