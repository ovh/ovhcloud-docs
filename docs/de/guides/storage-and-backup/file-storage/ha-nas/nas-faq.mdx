...
Sie können auch jederzeit manuelle Snapshots erstellen, zeitlich unbegrenzt speichern oder löschen. Diese Funktion ist in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder über folgenden <ApiLink>API-Aufruf</ApiLink> verfügbar:
