...
- Sie sind zur Verwendung der <ApiLink>OVHcloud API</ApiLink> eingeloggt.
...
Alle für diese Anleitung verwendeten API-Routen sind im <ApiLink section="/storage">Bereich `/storage`</ApiLink> der API-Konsole verfügbar.
