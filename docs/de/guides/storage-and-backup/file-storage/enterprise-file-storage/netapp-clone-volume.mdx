...
- Sie können sich in die <ApiLink>OVHcloud API-Oberfläche</ApiLink> einloggen.
- Sie verfügen über ein Enterprise File Storage Volume mit einem `manuellen` Snapshot.

[[cpnav:storage-enterprise-file-storage]]

:::info
Sie können ein Volume und einen Snapshot vom Typ `Manual` über die <ApiLink>OVHcloud API</ApiLink> oder über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> erstellen.
