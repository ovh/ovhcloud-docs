...
pageType: overview
title: Block Storage
description: "Bestellung, Anbindung, Größenanpassung und Snapshots von Block Storage Volumes in der OVHcloud Public Cloud - High Performance, Classic und Shared Block Storage."
