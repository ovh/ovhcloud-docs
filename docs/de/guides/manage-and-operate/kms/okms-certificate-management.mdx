...
Um mit Ihrer OKMS-Domain zu kommunizieren, benötigen Sie ein Zugriffszertifikat. Dies ist eine von drei [OKMS-Authentifizierungsmethoden](/guides/manage-and-operate/kms/okms-authentification-method); Zertifikate sind **für KMIP erforderlich** und werden empfohlen, wenn mTLS-Client-Authentifizierung benötigt wird. Für die Nutzung der REST-API ist ein Personal Access Token (PAT) oder ein Service Account in der Regel einfacher einzurichten.
