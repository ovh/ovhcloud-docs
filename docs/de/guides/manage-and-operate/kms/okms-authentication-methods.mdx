...
| **Steuerungsebene (OVHcloud API)** | <ApiLink section="/okms" version="v2">`/v2/okms`</ApiLink> | Domains bestellen, Zugangsdaten verwalten, Protokollierung konfigurieren |
...
:::info
Ihre `okmsId` und Ihr regionaler Endpoint werden beide durch den folgenden API-Aufruf zurückgegeben:

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

Beide werden auch im Tab **Allgemeine Informationen** im <ManagerLink to="/#/okms/key-management-service">Dashboard Ihrer OKMS-Domain</ManagerLink> angezeigt.
:::
...
### Authentifizierung einrichten <a id="set-up-authentication"></a>
...
### Die OKMS Swagger-Oberfläche verwenden <a id="use-the-okms-swagger-ui"></a>
...
### IAM-Rechte für OKMS <a id="iam-rights-for-okms"></a>
