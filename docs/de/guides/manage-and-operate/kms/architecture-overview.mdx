...
Ein Hardware Security Module (HSM) ist ein spezialisiertes physisches Gerät, das für die sichere Generierung, Speicherung und Nutzung kryptografischer Schlüssel ausgelegt ist. HSM-geschützte Schlüssel verlassen die Hardware nie: Kryptografische Operationen laufen auf dedizierter, manipulationssicherer Ausrüstung und stärken so die Vertraulichkeit und Integrität der Schlüssel.

OVHcloud verwendet Thales Luna HSMs, die nach FIPS 140-3 Level 3 und Common Criteria EAL4+ zertifiziert sind.

Schlüssel, die mit dem Schutzlevel HSM erstellt werden, werden auf drei verschiedenen physischen HSMs repliziert. Ihr genauer Standort hängt von der für das OKMS ausgewählten Region ab.
...
In 1-AZ-Regionen befinden sich zwei HSMs in der Region, und ein drittes Remote-HSM wird in einer benachbarten Region bereitgestellt.
