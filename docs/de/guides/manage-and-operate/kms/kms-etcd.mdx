...
| `--kmip-addr` | Adresse des KMIP-Servers. Verfügbar im <ManagerLink to="/#/dedicated/security/kms">Dashboard Ihrer OKMS-Domain</ManagerLink>. (z. B. `eu-west-rbx.okms.ovh.net:5696`). | `""` (erforderlich) |
