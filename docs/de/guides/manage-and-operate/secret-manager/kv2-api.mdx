...
Authentifizieren Sie sich mit einem [Personal Access Token, Service Account oder Zugriffszertifikat](/guides/manage-and-operate/kms/okms-authentification-method). Für die Nutzung der HashiCorp Vault KV2-kompatiblen API wird ein PAT oder ein Service Account empfohlen.
