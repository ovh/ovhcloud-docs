...
description: Konfigurieren Sie den External Secret Operator, um Kubernetes-Secrets im OVHcloud Secret Manager zu speichern
...
Diese Anleitung erklärt, wie Sie den Kubernetes External Secret Operator einrichten, um den OVHcloud Secret Manager als Provider zu verwenden.
...
### Einrichten des Secret Managers
...
Sie benötigen außerdem die `region` und die `okms-id` der OKMS-Domain, die Sie verwenden möchten. Diese ID und diese Region finden Sie im <ManagerLink to="/#/dedicated/security/kms">Dashboard der OKMS-Domain</ManagerLink> oder über die [OVHcloud CLI](https://github.com/ovh/ovhcloud-cli):
...
#### Installation des External Secret Operator (ESO) auf Ihrem Kubernetes-Cluster
...
#### Konfigurieren des External Secret Operator
...
#### Verwenden des External Secret Operator
...
Weitere Informationen zur Verwaltung des External Secret Operator finden Sie in der dedizierten Dokumentation zum HashiCorp Vault-Provider: [https://external-secrets.io/latest/](https://external-secrets.io/latest/).
