...
- Eine für die OKMS-Datenebene konfigurierte [Authentifizierungsmethode](/guides/manage-and-operate/kms/okms-authentification-method) (in diesem Leitfaden wird ein Personal Access Token verwendet).
- Ein [Managed Kubernetes Service](/links/public-cloud/kubernetes)-Cluster.
...
Erstellen Sie einen [lokalen IAM-Benutzer](/guides/account-and-service-management/account-information/ovhcloud-users-management) mit Zugriffsrechten auf Ihre Domain, oder verwenden Sie ein [Service Account](/guides/manage-and-operate/api/manage-service-account). Siehe [OKMS-Authentifizierungsmethoden](/guides/manage-and-operate/kms/okms-authentification-method) für die vollständige Einrichtung und IAM-Richtlinienvorlagen.
