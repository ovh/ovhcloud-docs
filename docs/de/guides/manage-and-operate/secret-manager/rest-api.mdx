...
- Eine für die OKMS-Datenebene konfigurierte [Authentifizierungsmethode](/guides/manage-and-operate/kms/okms-authentification-method).
...
Authentifizieren Sie sich mit einem [Personal Access Token, Service Account oder Zugriffszertifikat](/guides/manage-and-operate/kms/okms-authentification-method). Für die Nutzung der REST-API wird ein PAT oder ein Service Account empfohlen.

Um API-Aufrufe interaktiv zu testen, verwenden Sie die [OKMS Swagger UI](/guides/manage-and-operate/kms/okms-authentification-method#use-the-okms-swagger-ui) unter `https://<region>.okms.ovh.net/swagger/`.
...
- [OKMS-Authentifizierungsmethoden](/guides/manage-and-operate/kms/okms-authentification-method)
