...
- Um über die REST- oder HashiCorp Vault KV2-kompatible API auf Secrets zuzugreifen, konfigurieren Sie eine [Authentifizierungsmethode](/guides/manage-and-operate/kms/okms-authentification-method) für Ihre OKMS-Domain (Personal Access Token, Service Account oder Zugriffszertifikat).
...
Ein Benutzer mit den erforderlichen IAM-Berechtigungen kann auf den Inhalt eines Secrets zugreifen. Konfigurieren Sie die Authentifizierung und IAM-Richtlinien wie in [OKMS-Authentifizierungsmethoden](/guides/manage-and-operate/kms/okms-authentification-method) beschrieben.
...
Der Secret Manager ist über zwei verschiedene API-Sätze zugänglich. Beide bearbeiten dieselben Objekte — ein mit einer Methode erstelltes Secret ist über die andere zugänglich.

Bevor Sie eine der APIs aufrufen, konfigurieren Sie eine [Authentifizierungsmethode](/guides/manage-and-operate/kms/okms-authentification-method) und die erforderliche [IAM-Richtlinie](/guides/manage-and-operate/kms/okms-authentification-method#iam-rights-for-okms) für Ihre OKMS-Domain. Für die Nutzung der REST-API wird ein Personal Access Token oder ein Service Account empfohlen.
...
- [Secret Manager mit der REST-API nutzen](/guides/manage-and-operate/secret-manager/rest-api)
- [Secret Manager mit der HashiCorp Vault KV2-kompatiblen API nutzen](/guides/manage-and-operate/secret-manager/kv2-api)
