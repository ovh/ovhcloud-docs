...
Dateien unter `/mnt` können Sie direkt bearbeiten. Um Befehle des VPS selbst auszuführen, wechseln Sie mit dem folgenden Befehl in das eingebundene System. Diese Befehle verwenden dann die Programme und Konfigurationsdateien des VPS und nicht diejenigen der Rescue-Umgebung:
