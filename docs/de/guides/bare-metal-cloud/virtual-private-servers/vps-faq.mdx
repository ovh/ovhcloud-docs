...
Die beste Option besteht darin, sich mit Ihren Login-Daten in unserer <ApiLink>API-Konsole</ApiLink> einzuloggen und zu prüfen, ob Ihre Lizenz auf einen anderen VPS übertragen werden kann. Weitere Informationen finden Sie in unserer Anleitung zu [den ersten Schritten mit der OVHcloud API](/guides/manage-and-operate/api/first-steps).
