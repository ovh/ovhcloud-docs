...
Click the `DNS zone` tab. In the table, identify the row with the value `A`, open the actions menu <code className="action">⋮</code> on that row and click <code className="action">Edit the entry</code>.
