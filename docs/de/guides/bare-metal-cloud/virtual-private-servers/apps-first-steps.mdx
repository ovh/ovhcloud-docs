...
:::info
Wenn der Link bereits abgelaufen ist, loggen Sie sich mit dem Benutzernamen über SSH auf Ihrem VPS ein und führen Sie den Befehl `sudo whmlogin` aus, um einen neuen zu erzeugen.
:::
...
WHM verwendet standardmäßig den Root-Benutzer für die Authentifizierung. Der Single-Use-Link in der E-Mail ermöglicht den Zugriff auf die Erstkonfiguration und das Festlegen Ihres Root-Passworts. Bei der nächsten Anmeldung bei WHM geben Sie `root` als Benutzernamen und das von Ihnen festgelegte Passwort ein.
