...
Über die <ApiLink>OVHcloud API</ApiLink> können Sie auch personalisierte Skripte definieren.
...
Zum Beispiel lädt das folgende Skript das Startmenü von [netboot.xyz](https://netboot.xyz/) per Chainloading nach:
...
Sie können nun im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder über die <ApiLink>OVHcloud API</ApiLink> auf Disk- oder [Rescue-Modus](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) umstellen.
