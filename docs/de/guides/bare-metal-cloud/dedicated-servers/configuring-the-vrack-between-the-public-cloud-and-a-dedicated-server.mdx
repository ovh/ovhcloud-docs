...
**Diese Anleitung erklärt, wie Sie eine [Public Cloud Instanz](/guides/public-cloud/compute/getting-started) und einen [dedizierten Server](https://www.ovhcloud.com/de/bare-metal/) über vRack verbinden.**
...
Wenn Sie Hilfe benötigen, folgen Sie dieser Anleitung: [Erste Public Cloud Instanz erstellen](/guides/public-cloud/compute/getting-started). Bei der Erstellung einer Instanz können Sie in Schritt 5 einen Netzwerkmodus und anschließend ein privates Netzwerk auswählen, in das Ihre Instanz integriert werden soll.
