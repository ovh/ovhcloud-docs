...
[Konfigurieren Ihrer Netzwerkkarte für die OVHcloud Link Aggregation in Debian 9 bis 11](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-ifupdown)

[Konfigurieren Ihrer Netzwerkkarte für die OVHcloud Link Aggregation in SLES 15](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-sles15)
