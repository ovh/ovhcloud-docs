---
title: Konfigurieren des NIC-Teamings für die OVHcloud Link Aggregation (OLA) unter Windows Server 2019
description: Konfigurieren Sie das NIC-Teaming für die OVHcloud Link Aggregation (OLA) auf Ihrem Windows Server 2019 Server
