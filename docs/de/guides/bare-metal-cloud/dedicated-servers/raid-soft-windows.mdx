---
title: Dedicated Server - Software-Mirror (RAID) unter Windows konfigurieren
description: Erstellen Sie die Disk-Konfiguration Ihres Software-Mirrors auf einem Windows Dedicated Server nach einem Austausch neu.
