...
Melden Sie sich zunächst bei Ihrem So you Start Kundencenter an und klicken Sie im Haupt-Dashboard auf <code className="action">Öffentliche IP-Adressen</code>.
