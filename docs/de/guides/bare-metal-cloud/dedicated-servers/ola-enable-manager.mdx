...
- [Konfigurieren Ihrer Netzwerkkarte für die OVHcloud Link Aggregation in Debian 9 über ifupdown](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-ifupdown).
- ### OLA-Status prüfen.
