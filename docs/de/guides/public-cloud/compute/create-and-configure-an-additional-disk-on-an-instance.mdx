...
:::info
Jeder Volume-Typ ist auch als verschlüsselte Version verfügbar (**LUKS**). Diese Volumes gewährleisten die Vertraulichkeit der Daten. Sie sind über das OVHcloud Kundencenter sowie mit den im nächsten Abschnitt beschriebenen Tools verfügbar, indem Sie den `<volume_type>-luks`-Typ angeben.

:::

:::warning
**Leistungseinbußen bei verschlüsselten Volumes (LUKS).** Verschlüsselte Volumes weisen im Vergleich zu gleichwertigen unverschlüsselten Volumes Leistungseinbußen von etwa 10% auf.
