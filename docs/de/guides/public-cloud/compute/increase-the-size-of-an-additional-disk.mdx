...
:::info
Die nachfolgenden Befehle sind unabhängig davon, welchem der beiden oben beschriebenen Verfahren Sie gefolgt sind, identisch. Die im Beispiel angezeigten Datei-, Block- und Größenangaben entsprechen dem zuvor in diesem Guide verwendeten Beispiel für Partitionen bis 2 TB (einer 70-GiB-Disk). Wenn Sie stattdessen das Verfahren für Partitionen über 2 TB angewendet haben, zeigt Ihre Ausgabe entsprechend größere Werte für Ihre vergrößerte Disk an, die Schritte selbst bleiben jedoch identisch.
:::
