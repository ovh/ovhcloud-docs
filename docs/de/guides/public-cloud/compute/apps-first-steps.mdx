...
1. Verbinden Sie sich mit der <ApiLink>API Konsole</ApiLink>.
2. Verwenden Sie anschließend <ApiLink section="/cloud" method="POST" route={"/cloud/project/\{serviceName\}/instance/\{instanceId\}/applicationAccess"}>diesen API Call</ApiLink>.
...
|---|---|
|serviceName *|Dies ist Ihre Public Cloud Projekt-ID.|
|instanzId *|Dies ist die UUID Ihrer Instanz.|
