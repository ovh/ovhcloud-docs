...
**Monatliche Abrechnung für eine ausgesetzte (*shelved*) Instanz:** Eine Instanz, die den gesamten Monat über ausgesetzt bleibt, wird nicht berechnet (mit Ausnahme des Snapshots). Sobald die Instanz auch nur kurzzeitig reaktiviert wird, gilt die vollständige Monatsabrechnung.
...
<Tabs>
  ...
  <Tab label="Im Horizon-Interface">
    ...
    Klicken Sie auf das Menü <code className="action">Compute</code> auf der linken Seite und wählen Sie <code className="action">Instanzen</code> aus. Wählen Sie <code className="action">Shelve Instance</code> in der Drop-down-Liste für die betreffende Instanz aus.
...
<Tabs>
  ...
  <Tab label="Im Horizon-Interface">
    Klicken Sie im Horizon-Interface auf das Menü <code className="action">Compute</code> auf der linken Seite und wählen Sie anschließend <code className="action">Instanzen</code> aus. Wählen Sie <code className="action">Unshelve Instance</code> in der Drop-down-Liste für die betreffende Instanz aus.
...
<Tabs>
  ...
  <Tab label="Im Horizon-Interface">
    Klicken Sie im Horizon-Interface auf das Menü <code className="action">Compute</code> auf der linken Seite und wählen Sie anschließend <code className="action">Instanzen</code> aus. Wählen Sie <code className="action">Suspend Instance</code> in der Drop-down-Liste für die betreffende Instanz aus.
...
<Tabs>
  <Tab label="Im Horizon-Interface">
    Klicken Sie im Horizon-Interface auf das Menü <code className="action">Compute</code> auf der linken Seite und wählen Sie anschließend <code className="action">Instanzen</code> aus. Wählen Sie <code className="action">Pause Instance</code> in der Drop-down-Liste für die betreffende Instanz aus.
