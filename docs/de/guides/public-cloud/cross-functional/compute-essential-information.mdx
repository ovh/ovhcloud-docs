...
Da Ihr Zahlungsmittel hinterlegt ist, wird der berechnete Betrag [am Ende des Monats abgebucht](/guides/public-cloud/cross-functional/analyze-billing). Diese Berechnung erfolgt auf der Grundlage der Nutzungszeit der einzelnen Ressourcen und des Preises der Ressourcen. Bei Instanzen werden die Preise aus Gründen der Lesbarkeit in der Regel als Stundensatz angegeben, die Abrechnung erfolgt jedoch sekundengenau, mit einer Mindestabrechnungsdauer von 1 Minute.
