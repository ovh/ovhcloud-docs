...
:::info
AI Endpoints is covered by the **[OVHcloud Public Cloud Special Conditions](https://contract.eu.ovhapis.com/1.0/pdf/Conditions_particulieres_OVH_Stack-de.pdf)** (see Appendix 10 – "Specific Conditions – AI Endpoints").
:::
