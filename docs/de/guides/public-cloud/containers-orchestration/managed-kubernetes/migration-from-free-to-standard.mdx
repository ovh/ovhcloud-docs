...
description: Learn how to migrate your OVHcloud MKS cluster from Free to Standard offer, understand plan differences, and follow best practices for a secure and smooth transition.
...
- **kubectl**: You'll need the kubectl command-line tool installed to interact with your Kubernetes clusters. Refer to the [official Kubernetes documentation](https://kubernetes.io/de/docs/tasks/tools/) for installation instructions.
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, go to the `Public Cloud` section and select the Public Cloud project concerned.
