...
To adjust the storage space of your cluster, log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open your Public Cloud project. Click <code className="action">Data Analysis</code> or <code className="action">Analytics</code> in the left navigation bar, then select your engine instance.
