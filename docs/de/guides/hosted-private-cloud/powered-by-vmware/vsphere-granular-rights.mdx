...
- Sie haben bereits einen [Benutzer](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection) in Ihrem Hosted Private Cloud-Dienst erstellt.
