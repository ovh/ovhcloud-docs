...
Gehen Sie im [vSphere Interface](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection) in die Ansicht <code className="action">Storage</code>.
