...
>
> <video className="thumbnail" autoPlay loop muted playsInline aria-label="VM Creation Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-create-VM.mp4" />
