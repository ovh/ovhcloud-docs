...
- Una [istanza Web Cloud Databases](/links/web/databases) (inclusa in un'offerta di [Hosting Web](/links/web/hosting) Performance, Agency, Agency Plus o Agency Max).
...
- I servizi Web Cloud Databases Web Hosting (noti anche come servizi SQL Privati), istanze SGBD dedicate raggiungibili tramite la rete Web Hosting ([vedi gli annunci](/guides/web-cloud/databases/db-eos-eol)).
