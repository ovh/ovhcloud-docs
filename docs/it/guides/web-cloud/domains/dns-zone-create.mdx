...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, apri la sezione `Web Cloud` e clicca su <code className="action">Zone DNS</code>. Clicca quindi sul pulsante <code className="action">Ordina</code>.
