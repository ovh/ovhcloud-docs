...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    ...
    - **TXT**: per l'<Tooltip term="spf">SPF</Tooltip> (uniscilo se esiste già un record SPF).
...
Per migliorare la deliverability delle tue email ed evitare che i tuoi messaggi finiscano nello spam, aggiungi un record <Tooltip term="dmarc">**DMARC**</Tooltip>.
...
Segui le istruzioni della pagina "Add a domain you own to iCloud Mail on iCloud.com" della [documentazione ufficiale Apple](https://support.apple.com/it-it/guide/icloud/mma473945269/icloud). Concentrati sulla sezione "Step 4: Finish setting up the domain".
