...
Il codice embed è generato automaticamente da Video Center per ogni video, dalla sua pagina di dettaglio. Clicca sui tab sottostanti per visualizzare ognuno dei **3** passaggi.
...
Clicca sul video che vuoi integrare per aprire la sua pagina di dettaglio.
...
- **Aprire il file HTML della tua pagina**: nel tuo editor di codice (VS Code, Dreamweaver, ecc.), apri la pagina in cui vuoi visualizzare il video.
