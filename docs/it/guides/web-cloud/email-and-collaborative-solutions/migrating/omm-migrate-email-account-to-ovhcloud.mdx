...
<img className="thumbnail" alt="Creazione di una nuova migrazione in OVHcloud Mail Migrator, passaggio 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
