...
Nell'ambito della nostra offerta [**Hosted Exchange**](https://www.ovhcloud.com/it/emails/hosted-exchange/), il record CNAME viene utilizzato come codice di conferma (token) che sarà visibile nella zona DNS del dominio da convalidare. con lo scopo di verificare che l’utente della piattaforma email sia il gestore del dominio aggiunto.

</Region>

<Region zones={['eu']}>

Nel diagramma che segue, la piattaforma di posta elettronica ([Exchange](https://www.ovhcloud.com/it/emails-exchange/) o [Email Pro](https://www.ovhcloud.com/it/emails/email-pro/)) è rappresentata dal frame verde.

</Region>

<Region zones={['ca']}>

Nel diagramma che segue, la piattaforma di posta elettronica ([Exchange](https://www.ovhcloud.com/it/emails-exchange/)) è rappresentata dal frame verde.
