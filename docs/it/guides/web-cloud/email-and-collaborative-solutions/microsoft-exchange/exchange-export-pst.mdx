...
Questa funzionalità è disponibile per <Region zones={['eu']}>Hosted Exchange, Private Exchange e Trusted Exchange</Region><Region zones={['ca']}>Hosted Exchange</Region>. Si applica alle singole caselle email: i gruppi, gli account condivisi e gli account risorsa non possono essere esportati.
...
- Disporre di un servizio <Region zones={['eu']}>[Hosted Exchange](/links/web/emails-hosted-exchange), [Private Exchange](/links/web/emails-private-exchange) o [Trusted Exchange](/links/web/emails-trusted-exchange)</Region><Region zones={['ca']}>[Hosted Exchange](/links/web/emails-hosted-exchange)</Region>.
