...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="2fa-exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/manage-2fa-exchange/2fa-exchange.mp4" />
