...
:::warning
È necessario [creare un'organizzazione](#organizations) per poter aggiungere un dominio al servizio Zimbra.
...
### Consultare il proprio account email <a name="emails-consult"></a>
...
### Reindirizzamenti <a name="redirections"></a>
