...
2. **[Eliminare l'account MX Plan originale e riassegnare il suo indirizzo all'account Zimbra](#step2)**
    - [2.1 - Eliminazione dell'indirizzo e-mail MX Plan di origine](#step21)
...
<Tabs>
  <Tab label="Step 1">
    **Creare un progetto di migrazione**
    ...
    <img className="thumbnail" alt="Pagina iniziale di OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Step 2">
    **Creare la migrazione**
    ...
    <img className="thumbnail" alt="Creazione della migrazione da MX Plan a Zimbra in OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Eliminazione dell'indirizzo e-mail MX Plan di origine <a name="step21"></a>
