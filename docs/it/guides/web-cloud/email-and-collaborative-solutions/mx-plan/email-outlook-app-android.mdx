...
<img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add01.png" loading="lazy" />
...
<img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add02.png" loading="lazy" />
...
<Tabs>
  <Tab label="Step 1">
    ...
    <img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step01.png" loading="lazy" />
  </Tab>
  <Tab label="Step 2">
    Selezionare il protocollo di ricezione, **IMAP**(consigliato) o **POP3**.
    
    <img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step02.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step021.png" loading="lazy" />
    :::
...
<img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-delete-account-01.png" loading="lazy" />
...
<img className="thumbnail" alt="outlook android" src="/images/assets/screens/email-clients/outlook/outlook-app-android-delete-account-02.png" loading="lazy" />
