...
:::info
Dopo aver inserito il tuo indirizzo email e la password nella pagina di accesso alla webmail, vieni reindirizzato alla finestra di accesso **Zimbra**, dove devi inserire nuovamente le tue credenziali. In questa finestra, il campo **Nome utente** ("Username") corrisponde al tuo **indirizzo email completo** e non a un nome utente distinto.
:::

<img className="thumbnail" alt="Finestra di accesso Zimbra" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-login-window.png" loading="lazy" />
