...
- **MX Plan**: Zimbra viene utilizzato nel quadro di una transizione tecnologica dalla webmail Outlook Web Access (OWA) a quella di Zimbra per i servizi MX Plan che utilizzano la webmail OWA.
