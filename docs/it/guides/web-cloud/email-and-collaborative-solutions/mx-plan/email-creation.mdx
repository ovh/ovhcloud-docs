...
Sui servizi MX Plan che utilizzano la webmail Zimbra o OWA, si parla di *reinizializzazione dell'account* quando si deve eliminarlo.
...
<Region zones={['eu']}>
Consulta tutte le nostre soluzioni email [Zimbra](/links/web/zimbra) o [Exchange](https://www.ovhcloud.com/it/emails-exchange/) per completare la soluzione MX Plan sullo stesso dominio.
</Region>
