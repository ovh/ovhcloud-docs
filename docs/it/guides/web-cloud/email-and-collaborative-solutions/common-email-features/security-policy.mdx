...
:::info
Se non vedi l'elemento <code className="action">Più</code> nel pannello di gestione della tua offerta <code className="action">MX Plan</code>, significa che il tuo servizio utilizza la webmail Roundcube. La politica di sicurezza non è gestita sui servizi MX Plan che utilizzano Roundcube.
...
<Region zones={['ca']}>
Una volta completate le informazioni, clicca su <code className="action">Seguente</code> > <code className="action">Conferma</code> per applicare le modifiche relativamente alla soluzione "MX Plan". Clicca su <code className="action">Salva le modifiche</code> per la soluzione Exchange.
</Region>

<Region zones={['apac']}>
Una volta completate le informazioni, clicca su <code className="action">Seguente</code> > <code className="action">Conferma</code> per applicare le modifiche relativamente alla soluzione "MX Plan".
</Region>
