...
:::info
Se non vedi l'elemento <code className="action">Plus</code> nel pannello di gestione della tua offerta <code className="action">MX Plan</code>, significa che il tuo servizio utilizza la webmail Roundcube. La politica di sicurezza non è gestita sui servizi MX Plan che utilizzano Roundcube.
