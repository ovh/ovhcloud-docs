...
<Tabs>
  ...
  <Tab label="Step 3">
    ...
    - **Server di posta in uscita SMTP**:<br/>- **Host Name SMTP**: inserisci `pro?.mail.ovh.net` (sostituisci bene "?" con il numero del tuo server)<br/>- **Porta SMTP**: 587<br/>- **Username SMTP**: il tuo indirizzo email completo<br/>- **Password SMTP**: quello del tuo indirizzo email<br/>- **Sicurezza della porta**: STARTTLS
...
:::info
Per ulteriori informazioni sulla configurazione di un indirizzo e-mail dall'applicazione Outlook su iOS, vedere [Microsoft Help Center](https://support.microsoft.com/it-it/outlook/install-mobile/set-up-the-outlook-app-for-ios).
