...
<Tabs>
  <Tab label="Prima configurazione">
    Seleziona <code className="action">Aggiungi un indirizzo email</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Configurazione esistente">
    ...
    3. Seleziona <code className="action">Aggiungi un account</code><br/><br/><img className="thumbnail" alt="Aggiunta di un account esistente nell'applicazione Gmail su Android" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
