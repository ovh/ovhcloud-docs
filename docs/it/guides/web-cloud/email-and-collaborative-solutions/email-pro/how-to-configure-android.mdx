...
<Tabs>
  ...
  <Tab label="Configurazione esistente">
    ...
    3. Seleziona <code className="action">Aggiungi un account</code><br/><br/>![emailpro](/images/assets/screens/email-clients/android/android-existing.png)&#123;thumbnail .h-600&#125;
  </Tab>
</Tabs>
