...
Accedi alla sezione <ManagerLink to="/#/web/email_pro">Email Pro</ManagerLink>. Il nome del server è visibile nel riquadro **Connessione** della scheda <code className="action">Informazioni generali</code>.
...
<img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add01.png" loading="lazy" />
...
<img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add02.png" loading="lazy" />
...
<Tabs>
  <Tab label="Step 1">
    ...
    <img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step01.png" loading="lazy" />
  </Tab>
  <Tab label="Step 2">
    Selezionare il protocollo di ricezione, **IMAP**(consigliato) o **POP3**.
    
    <img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step02.png" loading="lazy" />
    ...
    ><img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step021.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3 - IMAP">
    ...
    - **Server di posta in uscita SMTP**:<br/>- **Host Name SMTP**: inserisci pro?.mail.ovh.net (sostituisci "?" con il numero del tuo server).<br/>- **Porta**: 587<br/>- **Tipo di sicurezza**: STARTTLS<br/>- **Username SMTP**: indirizzo email completo<br/>- **Password SMTP**: password del tuo account email
...
<img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-delete-account-01.png" loading="lazy" />
...
<img className="thumbnail" alt="outlook android email pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-delete-account-02.png" loading="lazy" />
...
:::info
Per ulteriori informazioni sulla configurazione di un indirizzo e-mail dall'applicazione Outlook su Android, vedere [Microsoft Help Center](https://support.microsoft.com/it-it/outlook/install-mobile/set-up-email-in-the-outlook-for-android-app).
