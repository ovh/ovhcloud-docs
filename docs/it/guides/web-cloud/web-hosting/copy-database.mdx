...
- di un database presente su un server [Web Cloud Databases](/links/web/databases) (incluso con i nostri [hosting](/links/web/hosting) **Performance**, **Agency**, **Agency Plus** e **Agency Max** o [ordinato separatamente](/links/web/databases)).
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina <ManagerLink to="/#/web/private_database">Web Cloud Databases</ManagerLink>, poi seleziona la soluzione interessata.
