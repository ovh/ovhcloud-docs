...
Per modificare i file _Markdown_ è possibile accedere direttamente al server di hosting Web. Con un'offerta di [hosting Web OVHcloud](/links/web/hosting) che include un accesso SSH (**a partire dall'offerta Pro**), puoi utilizzare indifferentemente [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) o [vim](https://www.vim.org/).
