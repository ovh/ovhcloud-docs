...
Se il tuo database è presente su una soluzione [Web Cloud Databases](/links/web/databases), consulta la nostra guida "[Web Cloud Databases - Accedere al tuo database](/guides/web-cloud/databases/db-connecting-database-server)", quindi passa direttamente allo [step 1.2](#step1.2) della presente guida.
...
- [Iniziare a utilizzare l'offerta Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
