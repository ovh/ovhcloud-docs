...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    Se disponi dell'offerta [Cloud Web](/links/web/hosting-cloud-web-offer) con 2 vCore, puoi aggiungere un secondo programma d'esecuzione (massimo 2 per offerta) cliccando sul pulsante <code className="action">Azioni</code> e poi su <code className="action">Aggiungi un programma d'esecuzione</code>.
  </Tab>
</Tabs>
