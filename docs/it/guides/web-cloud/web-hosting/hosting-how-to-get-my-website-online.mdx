...
La creazione della connessione non è legata ai servizi OVHcloud ma dipende esclusivamente dalla configurazione del sito Internet da pubblicare: se hai bisogno di aiuto per effettuare l'operazione ti consigliamo quindi di rivolgerti a [uno specialista del settore](/links/partner). 
...
In caso di difficoltà durante la pubblicazione del tuo sito Internet, ti consigliamo di rivolgerti a [uno specialista del settore](/links/partner) o contattare il fornitore del servizio (ad esempio, del CMS installato). 
