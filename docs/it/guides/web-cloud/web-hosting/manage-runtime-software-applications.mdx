...
Per prima cosa, **assicurati che il tuo progetto sia tecnicamente compatibile con il tuo hosting Cloud Web**. La lista dei linguaggi compatibili è disponibile all'indirizzo [https://www.ovhcloud.com/it/web-hosting/cloud-web-offer/](/links/web/hosting-cloud-web-offer) 
