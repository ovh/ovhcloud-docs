...
In caso di disattivazione tramite restrizione di accesso FTP in "**CHMOD 000**", contatta obbligatoriamente i nostri [team di supporto](/links/support-contact) per fare il punto sulla situazione prima di proseguire gli step descritti in questa guida. 
...
Per identificare queste falle di sicurezza, analizza i ["log web"](/guides/web-cloud/web-hosting/logs-and-statistics) del tuo hosting web o rivolgiti a un [fornitore specializzato](/links/partner) per effettuare un audit di sicurezza dei tuoi siti Web.
