...
- Verifica che il tuo nuovo dominio punti verso il giusto indirizzo IP del tuo hosting condiviso. Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, clicca su <code className="action">Web cloud</code>, clicca su <code className="action">Hosting</code>, seleziona il tuo hosting e recupera **l'IPv4** nella scheda <code className="action">Informazioni generali</code>.
