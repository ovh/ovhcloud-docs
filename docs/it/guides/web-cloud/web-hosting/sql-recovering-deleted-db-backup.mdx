...
- Accedi al nostro sito <ApiLink>API OVHcloud</ApiLink> (verifica di essere su `https://eu.api.ovh.com` se i tuoi servizi sono ospitati in Europa e su `https://ca.api.ovh.com` se i tuoi servizi sono ospitati al di fuori dell'Europa).
...
Per farlo, resta sul nostro sito <ApiLink>API OVHcloud</ApiLink> ed effettua le seguenti operazioni:
