...
<Tabs>
  ...
  <Tab label="Drupal">
    ...
    - Fare clic su "Invia nuova password" o "Email nuova password".
...
<Tabs>
  ...
  <Tab label="PrestaShop">
    Segui gli step della sezione "[You do not have access to your email address](https://help-center.prestashop.com/hc/en-us/articles/10799006732818-Recover-your-admin-password)" della documentazione ufficiale di PrestaShop.
  </Tab>
  <Tab label="Joomla!">
