...
Se hai attivato un hosting Web **Performance**, **Agency**, **Agency Plus** o **Agency Max**, puoi attivare gratuitamente un server di database [Web Cloud Databases](/links/web/databases).

Per maggiori informazioni sul suo utilizzo, consulta la nostra documentazione "[Iniziare a utilizzare Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Se il tuo piano di [hosting Web](/links/web/hosting) dispone di questa opzione, consulta la nostra guida "[Crea task automatizzati (CRON) sul tuo hosting Web](/guides/web-cloud/web-hosting/cron-tasks)" per maggiori dettagli.
