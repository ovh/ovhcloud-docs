...
:::warning
Per ottimizzare la presa in carico di determinati caratteri speciali, attiva la "modalità solo testo" nel tuo client e-mail, come qui su Microsoft Outlook:
...
Ecco un esempio di e-mail che comprende dei campi facoltativi:
