...
|Feature|Description|Available formats|Migration model|Available documentation|
|---|---|---|---|---|
| **Anti-DDoS** | The anti-DDoS is a set of equipment and means put in place to absorb distributed denial of service attacks. It includes an analysis of traffic, the "aspiration" towards a specialized network and mitigation, ensured by VAC technology developed by OVHcloud. | N/A | **Incoming**: The Anti-DDoS is a component of our infrastructure, enabled by default. No action is required.<br /><br />**Outgoing**: Order and configure an anti-DDoS with the new provider. | [OVHcloud anti-DDoS protection](https://www.ovhcloud.com/it/security/anti-ddos/)<br /><br />[Anti-DDoS Technology](https://www.ovhcloud.com/it/security/anti-ddos/) |
...
OVHcloud partners are listed with the keyword "Cloud Migration" in the [dedicated directory](https://partner.ovhcloud.com/it/directory/).
