...
Per utilizzare l'<ApiLink section="/service" method="GET" route={"/service/\{serviceId\}/renew"}>API di rinnovo</ApiLink>, è necessario avere il `serviceId`. Puoi ottenere questo dato con l’API `serviceInfos`, come nel seguente esempio:
