...
Accedi alla <ApiLink>interfaccia API OVHcloud</ApiLink> in base alla [guida appropriata](/guides/manage-and-operate/api/first-steps) e segui gli step seguenti.
