...
**Cerca il logo OVHcloud nella tua posta in arrivo**

Diversi servizi di posta, tra cui Gmail, Yahoo e Apple Mail con un indirizzo iCloud.com, mostrano il logo OVHcloud accanto al nome del mittente per le e-mail che OVHcloud invia da un indirizzo che termina con `ovhcloud.com`. In Gmail compare anche un segno di spunta blu.

<img className="thumbnail" alt="Logo OVHcloud visualizzato accanto al nome del mittente" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Questo logo è mostrato dal tuo servizio di posta, non dal messaggio: un'e-mail fraudolenta non può riprodurlo. Non tutti i servizi di posta lo mostrano ancora, quindi la sua assenza da sola non prova nulla: in questo caso, affidati alle verifiche descritte di seguito.

Verifica poi se l'e-mail che hai ricevuto è visibile anche nella pagina <ManagerLink to="/#/communication">I miei messaggi</ManagerLink>. Troverai le copie delle e-mail ufficiali inviate da OVHcloud.
...
<img className="thumbnail" alt="Outlook Windows - identificare la versione" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
