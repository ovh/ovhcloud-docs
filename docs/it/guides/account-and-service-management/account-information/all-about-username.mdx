...
description: "Scopri come ottimizzare la sicurezza del tuo account OVHcloud, gestire e modificare le tue informazioni personali (cambiare l'indirizzo email, cambiare l'indirizzo postale, aggiornare le informazioni dell'account) e delegare l'accesso al tuo account"
...
Clicca sulla specializzazione `tipo di account` quando modifichi il tuo profilo. Un menu a tendina ti permette di definire il tipo di account corrispondente alla tua situazione.
