...
<Tabs noSync>
  <Tab label="Attraverso il Spazio Cliente OVHcloud">
    ...
    Nella pagina **Manage Tokens**, clicca su <code className="action">Aggiungere un token</code>, quindi compila i campi obbligatori:
...
<Tabs noSync>
  <Tab label="Attraverso il Spazio Cliente OVHcloud">
    Nella pagina **Manage Tokens**, vengono elencati tutti i PAT associati all'utente.

    <img className="thumbnail" alt="Pagina Manage Tokens con l'elenco dei token di accesso personali di un utente locale" src="/images/manage-and-operate/iam/configure-personal-access-token-pat/PAT_Manage_token.png" loading="lazy" />
  </Tab>
  <Tab label="Attraverso l'API OVHcloud">
...
<Tabs noSync>
  <Tab label="Attraverso il Spazio Cliente OVHcloud">
    Dalla pagina **Manage Tokens**, clicca sul pulsante <code className="action">…</code> alla fine della riga del token, quindi seleziona <code className="action">Eliminare</code>.
