...
- Un [metodo di autenticazione configurato](/guides/manage-and-operate/kms/okms-authentification-method) per il piano dati OKMS.
...
Autenticati con un [Personal Access Token, service account o certificato di accesso](/guides/manage-and-operate/kms/okms-authentification-method). Per l'utilizzo dell'API REST, si consiglia un PAT o un service account.

Per testare le chiamate API in modo interattivo, utilizza la [Swagger UI OKMS](/guides/manage-and-operate/kms/okms-authentification-method#use-the-okms-swagger-ui) all'indirizzo `https://<region>.okms.ovh.net/swagger/`.
...
- [Metodi di autenticazione OKMS](/guides/manage-and-operate/kms/okms-authentification-method)
