...
- Un [metodo di autenticazione configurato](/guides/manage-and-operate/kms/okms-authentification-method) per il piano dati OKMS (questa guida utilizza un Personal Access Token).
