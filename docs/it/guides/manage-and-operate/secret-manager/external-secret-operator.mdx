...
description: Scopri come configurare External Secret Operator per archiviare i secret Kubernetes sul Secret Manager di OVHcloud
...
Questa guida spiega come configurare l'External Secret Operator di Kubernetes per utilizzare il Secret Manager di OVHcloud come provider.
...
Avrai bisogno anche della `region` e dell'`okms-id` del dominio OKMS che desideri utilizzare. Questo ID e questa regione sono disponibili nella <ManagerLink to="/#/dedicated/security/kms">dashboard del tuo dominio OKMS</ManagerLink> o tramite la [CLI OVHcloud](https://github.com/ovh/ovhcloud-cli):
...
#### Installazione dell'External Secret Operator (ESO) sul tuo cluster Kubernetes
...
#### Configurazione dell'External Secret Operator
...
#### Utilizzo dell'External Secret Operator
...
Per ulteriori informazioni sulla gestione dell'External Secret Operator, consulta la documentazione dedicata, utilizzando il provider HashiCorp Vault: [https://external-secrets.io/latest/](https://external-secrets.io/latest/).
