...
- Per accedere ai segreti tramite l'API REST o l'API compatibile con HashiCorp Vault KV2, configura un [metodo di autenticazione](/guides/manage-and-operate/kms/okms-authentification-method) per il tuo dominio OKMS (Personal Access Token, service account o certificato di accesso).
...
A user with the necessary IAM rights can access the content of a secret. Configura l'autenticazione e le policy IAM come descritto in [Metodi di autenticazione OKMS](/guides/manage-and-operate/kms/okms-authentification-method).
...
Il Secret Manager è accessibile tramite due diversi set di API. Entrambi operano sugli stessi oggetti: un segreto creato con un metodo è accessibile con l'altro.

Prima di chiamare una delle API, configura un [metodo di autenticazione](/guides/manage-and-operate/kms/okms-authentification-method) e la [policy IAM](/guides/manage-and-operate/kms/okms-authentification-method#iam-rights-for-okms) richiesta per il tuo dominio OKMS. Per l'utilizzo dell'API REST, si consiglia un Personal Access Token o un service account.
...
- [Utilizzare Secret Manager con l'API compatibile con HashiCorp Vault KV2](/guides/manage-and-operate/secret-manager/kv2-api)
