...
Autenticati con un [Personal Access Token, service account o certificato di accesso](/guides/manage-and-operate/kms/okms-authentification-method). Per l'utilizzo dell'API compatibile con HashiCorp Vault KV2, si consiglia un PAT o un service account.
