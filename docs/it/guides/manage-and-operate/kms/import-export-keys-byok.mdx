...
- Conoscere il tuo `okmsId` e il tuo endpoint regionale, entrambi restituiti da <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> e visualizzati nella scheda **Informazioni generali** del <ManagerLink to="/#/okms/key-management-service">dashboard del tuo dominio OKMS</ManagerLink>.
