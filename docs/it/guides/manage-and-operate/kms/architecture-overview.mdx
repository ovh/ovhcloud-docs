...
Un Hardware Security Module (HSM) è un dispositivo fisico specializzato progettato per generare, archiviare e utilizzare chiavi crittografiche in modo sicuro. Le chiavi protette da HSM non lasciano mai l'hardware: le operazioni crittografiche vengono eseguite su apparecchiature dedicate e resistenti alle manomissioni, rafforzando così la riservatezza e l'integrità delle chiavi.

OVHcloud utilizza HSM Thales Luna, certificati FIPS 140-3 Level 3 e Common Criteria EAL4+.

Le chiavi create con il livello di protezione HSM sono replicate su tre HSM fisici distinti. La loro posizione esatta dipende dalla regione selezionata per l'OKMS.

#### Regioni 3-AZ

Nelle regioni 3-AZ, i tre HSM sono distribuiti su tutte le zone di disponibilità.

#### Regioni 1-AZ

Nelle regioni 1-AZ, due HSM si trovano nella regione e un terzo HSM remoto è distribuito in una regione vicina distinta.

Posizioni degli HSM remoti:

- **EU-WEST-GRA** (in arrivo): EU-WEST-RBX
- **EU-WEST-RBX** (in arrivo): EU-WEST-SBG
- **EU-WEST-SBG** (in arrivo): EU-WEST-GRA
