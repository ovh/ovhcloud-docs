...
| **Piano di controllo (API OVHcloud)** | <ApiLink section="/okms" version="v2">`/v2/okms`</ApiLink> | Ordinare domini, gestire le credenziali, configurare il logging |
...
:::info
Il tuo `okmsId` e il tuo endpoint regionale vengono entrambi restituiti dalla seguente chiamata API:

<Api version="v2" section="/okms" method="GET" route={"/okms/resource"} />

Entrambi sono visibili anche nella scheda **Informazioni generali** del <ManagerLink to="/#/okms/key-management-service">dashboard del tuo dominio OKMS</ManagerLink>.
:::
...
### Configurare l'autenticazione <a id="set-up-authentication"></a>
...
### Utilizzare l'interfaccia Swagger OKMS <a id="use-the-okms-swagger-ui"></a>
...
### Diritti IAM per OKMS <a id="iam-rights-for-okms"></a>
