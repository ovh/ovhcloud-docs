...
| `--kmip-addr` | Indirizzo del server KMIP. Disponibile nella <ManagerLink to="/#/dedicated/security/kms">dashboard del tuo dominio OKMS</ManagerLink>. (ad esempio: `eu-west-rbx.okms.ovh.net:5696`). | `""` (obbligatorio) |
