...
description: Find out how to retrieve your OVHcloud managed products logs in Logs Data Platform
...
- A [Logs Data Platform](https://www.ovhcloud.com/it/identity-security-operations/logs-data-platform/) account
...
Our ambition is to make all OVHcloud products compatible with OVHcloud Service Logs. We will endeavour to update this table as new availability evolves.
...
| Bare Metal Cloud - Dedicated Servers | OVHcloud Control Panel & API | [OVHcloud Dedicated Servers Logs Forwarding](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-logs-to-customers) |
| Public Cloud | OVHcloud Control Panel & API | [Introduction to Public Cloud Logs](/guides/public-cloud/cross-functional/logs-concepts) |
...
| Public Cloud - Databases | OVHcloud Control Panel & API | [Set up logs forwarding for Public Cloud Databases](/guides/public-cloud/databases/logs-to-customers) |
| Public Cloud - Analytics | OVHcloud Control Panel & API | [Set up logs forwarding for Analytics](/guides/public-cloud/data-analytics/analytics/logs-to-customers) |
| Hosted Private Cloud - Managed VMware vSphere | OVHcloud Control Panel & API | [Logs Data Platform - Collect VMware on OVHcloud logs](/guides/hosted-private-cloud/powered-by-vmware/vmware-ldp) |
| Web Cloud - Web Hosting | OVHcloud Control Panel & API | [Web Hosting - How to enable and manage logs](/guides/web-cloud/web-hosting/enable-ldp-web-hosting) |
| Web Cloud - Managed Hosting for WordPress | OVHcloud Control Panel & API | [Managed Hosting for WordPress - Retrieving and analysing your logs](/guides/web-cloud/managed-hosting/wordpress-logs) |
| Web Cloud - Web Cloud Databases | OVHcloud Control Panel & API | [Web Cloud Databases - How to manage logs](/guides/web-cloud/databases/db-retrieve-logs) |
| Web Cloud - Private Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Web Cloud - Trusted Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
...
Lets take the same example again, where you have a tech stack made of several OVHcloud products. But in this case you have multiple teams, each one working on a different component. For security reasons you want the team `A` to access the Load Balancer logs but not the Public Cloud Databases logs.
...
- All the Public Cloud Databases *applicative* logs are sent to another data stream (blue arrow).
...
- you can grant your Database Administrator Team to see only the data stream containing your Public Cloud Databases logs.
