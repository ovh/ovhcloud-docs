...
Successivamente, dobbiamo creare una nuova route IP per il vRack. Aggiungeremo una nuova regola di traffico (`1 vrack`) modificando il file, come indicato di seguito:
