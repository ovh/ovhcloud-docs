...
**Questa guida ti mostra come configurare una rete privata tra un'[istanza Public Cloud](/guides/public-cloud/compute/getting-started) e un [Server dedicato](https://www.ovhcloud.com/it/bare-metal/).**

## Prerequisiti

* Aver creato un'[istanza Public Cloud OVHcloud](/guides/public-cloud/compute/getting-started)
...
Per maggiori informazioni, consulta la guida [Creare un'istanza Public Cloud](/guides/public-cloud/compute/getting-started). Durante la creazione di un'istanza, è possibile scegliere, allo Step 5, una modalità di rete, seguita da una rete privata in cui integrare l'istanza.
