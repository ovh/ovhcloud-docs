...
Sostituisci il netboot con **Avviare da hard disk** nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> (vedi [Step 1](#step-1-riavvia-il-server-in-modalità-rescue)). 
