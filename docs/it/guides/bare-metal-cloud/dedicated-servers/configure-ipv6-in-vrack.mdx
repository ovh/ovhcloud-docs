...
Inserisci l'ID del tuo vRack (ad esempio `pn-9000000`) nel *path parameter* `serviceName` e indica il blocco IPv6 nel *request body*:
...
Utilizza la seguente chiamata per definire tale subnet:
