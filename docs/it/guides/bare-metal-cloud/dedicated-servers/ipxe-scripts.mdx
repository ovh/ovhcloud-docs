...
Tramite l'<ApiLink>API OVHcloud</ApiLink> è possibile definire gli script personalizzati.
...
Ad esempio, lo script seguente carica in cascata il menu di avvio di [netboot.xyz](https://netboot.xyz/):
...
In qualsiasi momento è possibile reinstallare il disco o la modalità Rescue dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> (consulta la guida [Attiva e utilizza la modalità Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)) o tramite l'<ApiLink>API OVHcloud</ApiLink>.
