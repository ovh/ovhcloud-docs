...
È possibile modificare direttamente i file presenti in `/mnt`. Per eseguire i comandi del VPS stesso, è necessario accedere al sistema montato con il comando seguente. Questi comandi utilizzeranno quindi i binari e i file di configurazione del VPS e non quelli dell'ambiente di rescue:
