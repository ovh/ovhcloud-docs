...
- Accesso all'<ApiLink>API OVHcloud</ApiLink> (facoltativo)
...
<Tabs>
  ...
  <Tab label="Tramite le API OVHcloud">
    Accedi alla pagina delle <ApiLink>API OVHcloud</ApiLink>:
...
- [Applicazione persistente su Red Hat e derivati (Rocky Linux, AlmaLinux, ecc.)](#persistentredhat)
- [Applicazione persistente su Fedora 43 e versioni successive](#persistentfedora)
...
#### Applicazione persistente su Red Hat e suoi derivati (Rocky Linux, AlmaLinux, ecc.) <a name="persistentredhat"></a>

Esistono due metodi per configurare la tua rete in base al sistema operativo installato sul tuo server:

- **per Rocky Linux e AlmaLinux (8/9)**: utilizzare il metodo basato sul file *network-scripts*;
...
#### Applicazione persistente su Fedora 43 e versioni successive <a name="persistentfedora"></a>
