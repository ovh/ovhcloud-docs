...
L'opzione migliore è aprire la nostra <ApiLink>console API</ApiLink> e verificare se la tua licenza può essere spostata su un diverso VPS. Trova le basi nella nostra guida su [come iniziare con l'API di OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Accedi alla <ApiLink>console API di OVHcloud</ApiLink> e utilizza la seguente chiamata:
