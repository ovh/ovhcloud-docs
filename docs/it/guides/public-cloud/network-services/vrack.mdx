...
<Tabs>
  <Tab label="Spazio Cliente OVHcloud">
    Consulta la guida "[Creare un'istanza dallo spazio cliente](/guides/public-cloud/compute/getting-started)". Durante la creazione, scegli al passo 5 un tipo di rete e una rete privata per la tua istanza.
