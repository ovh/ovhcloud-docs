...
Verrai reindirizzato su un'altra pagina per confermare l'ordine; l'operazione richiede alcuni minuti.
    ...
    Per continuare dallo Spazio Cliente OVHcloud, prosegui dal [passo 2: Creare una rete privata nel vRack](#create-pn-in-vrack), scheda **Dallo Spazio Cliente OVHcloud**.
  </Tab>
...
Nel campo **Nome della rete privata**, definisci un nome per la tua rete privata.
    ...
    **Opzioni gateway di rete**
    ...
    - **Assegna una Gateway e collegati alla rete privata**: Seleziona questa opzione se hai l'intenzione di creare delle istanze con una rete privata esclusivamente. Per ulteriori informazioni, consulta le seguenti guide: [Creare una rete privata con una Gateway](/guides/public-cloud/network-services/create-private-network-gateway) e [Creare una prima istanza Public Cloud e collegarvisi](/guides/public-cloud/compute/getting-started).
...
Seleziona l'interfaccia da eliminare e conferma:
  ...
  <Tab label="Dalla CLI OpenStack">
    ...
    **Aggiunta di un'interfaccia di rete privata**
    ...
    Per collegare una nuova interfaccia, esegui il seguente comando:
...
Per rimuovere un'interfaccia di rete, identifica prima la porta Neutron creata.
...
Una volta identificata la porta, esegui il comando seguente:
