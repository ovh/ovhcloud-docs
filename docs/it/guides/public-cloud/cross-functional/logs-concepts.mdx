...
| :----------- | :----------- | :--------- |
| Public Cloud - Compute | Spazio Cliente OVHcloud e API | Presto disponibile |
| Public Cloud - Block Storage | Spazio Cliente OVHcloud e API | Presto disponibile |
| Public Cloud - Network | Spazio Cliente OVHcloud e API | Presto disponibile |
