...
Genera credenziali API con il <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">generatore di token API OVHcloud</CreateToken>. Conserva l'Application Key, l'Application Secret e la Consumer Key in modo sicuro — mai nel controllo di versione.
