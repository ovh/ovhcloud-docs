...
Per creare un backup del volume è necessario scollegarlo dall'istanza. Per ulteriori informazioni su questa opzione, consultare la guida [Creare un backup di un volume](/guides/public-cloud/compute/volume-backup).
...
Clicca sul pulsante <code className="action">...</code> per eliminare uno Snapshot o <code className="action">Creare un volume</code> a partire dallo Snapshot corrispondente. Per maggiori informazioni, consulta la guida [Creare un volume a partire da un backup](/guides/public-cloud/compute/storage-create-volume-from-backup).
