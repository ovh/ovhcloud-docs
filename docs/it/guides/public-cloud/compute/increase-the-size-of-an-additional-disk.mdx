...
:::info
I comandi seguenti sono identici, indipendentemente dalla procedura seguita sopra. I valori di file, blocco e dimensione indicati nell'esempio di risultato corrispondono all'esempio ≤ 2 TB (un disco da 70 GB) utilizzato in precedenza in questa guida — se hai seguito la procedura > 2 TB, il tuo risultato mostrerà valori più elevati che riflettono il disco ridimensionato, ma i passaggi restano identici.
:::
