...
:::info
È possibile creare un volume e uno Snapshot di tipo `manual` tramite l'<ApiLink>API OVHcloud</ApiLink> o dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
