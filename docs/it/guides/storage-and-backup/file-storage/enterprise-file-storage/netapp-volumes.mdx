...
- Avere accesso alla pagina delle <ApiLink>API OVHcloud</ApiLink>
...
Tutte le rotte API utilizzate per questa guida sono disponibili nella <ApiLink section="/storage">sezione */storage*</ApiLink> della console API.
