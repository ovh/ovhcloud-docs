...
- I tuoi dati di backup vengono automaticamente inviati verso un Vault creato a **Gravelines (GRA)**, chiamato **backup-vault-gra-1**.
...
- Il server Bare Metal a **RBX** invia i suoi dati verso **backup-vault-gra-1** a **Gravelines (GRA)**.
- Il server Bare Metal a **GRA** invia i suoi dati verso **backup-vault-sbg-1** a **Strasbourg (SBG)**.
