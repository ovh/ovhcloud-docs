...
Nella tua [interfaccia vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection), posizionati nella vista <code className="action">Storage</code>.
