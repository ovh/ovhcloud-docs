...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT10v2.mp4" />
