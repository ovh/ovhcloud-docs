...
The response covers the service as a whole, along with a breakdown for your farms, frontends and servers, each giving a total and a count per status.

The different statuses can be:

- `ok`: Operating normally.
- `warn`: Operating in a degraded state.
- `error`: Not operating.
