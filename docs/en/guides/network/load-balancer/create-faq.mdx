...
The response gives the overall status of the service, along with a breakdown of your farms, frontends and servers, each with a total and a count per status.
