...
|-----------|----------|-------------|
| `ovhSubsidiary` | Yes | The subsidiary of the country whose catalog you want to consult, for example : FR (String of characters) |

The accepted values, and the currency each one returns prices in, depend on your commercial zone:
...
:::info
The `EU` value appears in the enumeration of this parameter in the API schema, but it is not accepted by this call.
:::
