...
- Have access to the <ApiLink>OVHcloud API</ApiLink>.
...
Route management is only available through the <ApiLink>OVHcloud API</ApiLink>. It is only valid for the **http** and **tcp** protocols, and the path <code className="action">/ipLoadbalancing/&#123;serviceName&#125;/&#123;protocol&#125;/route/</code> exposes the dedicated route API.
