...
| Protection changes are not applied | The draft was not saved. | Confirm the <code className="action">Apply changes</code> button was clicked on the <code className="action">Protection</code> tab. IP list changes must be saved with <code className="action">Save</code> on the <code className="action">Advanced</code> tab. |
