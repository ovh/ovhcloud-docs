...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="L3 Rules" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-rules.mp4" />

The following schema shows the mix of L2 and L3.
