...
The snapshots are visible on the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. To see them, go to the Object Storage section, where you will find the Object Storage bucket you have created. By clicking on the bucket you will see the list of objects, including all the snapshots beginning with `/backup/demo/deployment/stash-demo`, as defined in the `Repository`.
