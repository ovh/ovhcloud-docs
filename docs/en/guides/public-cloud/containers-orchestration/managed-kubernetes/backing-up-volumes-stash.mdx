...
To verify the backups were created, open the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), navigate to your Public Cloud project, and check the **Snapshots** or **Volume Backups** section. You should see the snapshots listed there, confirming the backup was successful.
