...
To verify the backups were created, open the <ManagerLink to="/#/pci/projects">OVHcloud Control Panel</ManagerLink>, navigate to your Public Cloud project, and check the **Snapshots** or **Volume Backups** section. You should see the snapshots listed there, confirming the backup was successful.
