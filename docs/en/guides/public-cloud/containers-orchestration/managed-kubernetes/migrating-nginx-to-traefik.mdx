...
description: Learn how to migrate from NGINX Ingress Controller to Traefik on your OVHcloud MKS cluster with zero downtime
...
- [Exposing applications using a Load Balancer on MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/expose-applications-using-load-balancer)
- [Getting the source IP behind the LoadBalancer](/guides/public-cloud/containers-orchestration/managed-kubernetes/getting-source-ip-behind-loadbalancer)
...
We recommend reducing your DNS TTL to 300 seconds (5 minutes) before starting the migration. For detailed DNS switch instructions, see [How to perform a DNS switch](/guides/public-cloud/containers-orchestration/managed-kubernetes/migrate-iolb-to-public-cloud-loadbalancer#how-to-perform-a-dns-switch).
