...
- The <ApiLink>OVHcloud API</ApiLink>.
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud API">
    ...
    If you go to the <ApiLink>Cloud section of the API Explorer</ApiLink>, you will see the available `/cloud/project/{serviceName}/kube` endpoint.
  </Tab>
  <Tab label="Via the NodePools CRD">
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), navigate to the **Public Cloud** section, select your project, then click <code className="action">Managed Kubernetes Service</code> in the left sidebar. Click on the name of the relevant cluster to open its **Overview** tab, which displays the cluster status, API URL, and `kubectl` configuration file.
  </Tab>
  <Tab label="Via the OVHcloud API">
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), navigate to the **Public Cloud** section, select your project, then click <code className="action">Managed Kubernetes Service</code> in the left sidebar. Click on the name of the relevant cluster, then open the <code className="action">Node pools</code> tab to see the list of active node pools.
  </Tab>
  <Tab label="Via the OVHcloud API">
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), navigate to the **Public Cloud** section, select your project, then click <code className="action">Managed Kubernetes Service</code> in the left sidebar. Click on the name of the relevant cluster, then open the <code className="action">Node pools</code> tab.
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    In the *Node pools* tab, click on the button <code className="action">Add a node pool</code>. A configuration wizard opens — fill in the fields to create a new node pool.
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    ...
    A confirmation dialog appears. Type `DELETE` into the field, then click the <code className="action">Delete</code> button to confirm the deletion.
  </Tab>
  <Tab label="Via the OVHcloud API">
