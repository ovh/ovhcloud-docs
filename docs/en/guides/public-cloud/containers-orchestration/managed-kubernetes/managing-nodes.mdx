...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    Click on the name of the relevant cluster to open its **Overview** tab, which displays the cluster status, API URL, and `kubectl` configuration file.
  </Tab>
  <Tab label="Via the OVHcloud API">
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    Click on the name of the relevant cluster, then open the <code className="action">Node pools</code> tab to see the list of active node pools.
  </Tab>
  <Tab label="Via the OVHcloud API">
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    Click on the name of the relevant cluster, then open the <code className="action">Node pools</code> tab.
