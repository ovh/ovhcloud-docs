...
Log in to the API Explorer using your OVHcloud NIC handle. Go to https://api.ovh.com/ and click "Login". Authenticate with your OVHcloud credentials.
