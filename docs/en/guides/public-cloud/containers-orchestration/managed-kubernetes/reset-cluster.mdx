...
Click on your Kubernetes cluster name to open its details page. Go to the **Service** tab of the administration UI, then click on **Reset your cluster**.
...
In the reset dialog, select either **Delete nodes** or **Keep and reinstall nodes** depending on your needs. You can also choose the minor version of the cluster and the private network attached.
