...
[[cpnav:publiccloud-users-roles|en]]
...
For this guide, our Object Storage container is named `popeye` and its region is `GRA`. You can verify and configure the container name in the <ManagerLink to="/#/pci/projects">OVHcloud Control Panel</ManagerLink> under **Public Cloud** > your project > **Object Storage**.
...
1. In the <ManagerLink to="/#/pci/projects">OVHcloud Control Panel</ManagerLink>, navigate to **Public Cloud** > your project, then click **Users & Roles** in the left-hand menu.
