...
In the form that appears, enter an IPv4 range in the **IP/CIDR range** field and optionally fill in the **Description** field. Then click the <code className="action">✔️</code> button to confirm.
