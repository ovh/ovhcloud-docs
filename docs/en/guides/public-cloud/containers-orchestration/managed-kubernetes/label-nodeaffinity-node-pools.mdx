...
Now, your Kubernetes cluster is up and running. In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), navigate to the **Public Cloud** section, select your project, then click **Managed Kubernetes Service** in the left sidebar under **Containers & Orchestration**. Click your cluster name to open its details page, then click the <code className="action">Node pools</code> tab.
