...
<Tabs>
  ...
  <Tab label="OVHcloud Control Panel">
    In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/), go to the **Public Cloud** section and select your project. In the left sidebar under **Containers & Orchestration**, click **Managed Kubernetes Service**, then click **Create a cluster**.
