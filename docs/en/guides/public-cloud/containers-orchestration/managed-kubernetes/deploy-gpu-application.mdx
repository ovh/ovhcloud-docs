...
:::info
We recommend using the latest driver version released by Nvidia with the `*-5.15.0-*-generic-ubuntu.22.04` pattern: https://catalog.ngc.nvidia.com/orgs/nvidia/-/containers/driver/-/tags
