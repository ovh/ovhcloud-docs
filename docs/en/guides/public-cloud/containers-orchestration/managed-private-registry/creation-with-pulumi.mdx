...
In concrete terms, you have to generate these credentials via the <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">OVH token generation page</CreateToken> with the following rights: **GET**, **POST**, **PUT** and **DELETE** on `/*`.
