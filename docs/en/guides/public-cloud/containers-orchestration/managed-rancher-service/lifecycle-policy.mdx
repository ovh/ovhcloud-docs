...
description: A complete guide including lifecycle policy, release calendar, and supported versions for OVHcloud Managed Rancher Service
...
- **Rancher 2.14.x** -> MKS 1.33 to 1.35
