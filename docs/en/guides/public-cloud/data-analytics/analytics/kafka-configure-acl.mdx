...
description: Learn how to configure Access Control Lists (ACLs)
...
- A [Kafka cluster running](/guides/public-cloud/databases/kafka-getting-started) on OVHcloud Public Cloud [accepting incoming connections](/guides/public-cloud/databases/kafka-capabilities) with at least one topic
...
By default the admin user has access to all topics with admin privileges. You can define some additional ACLs for all users / topics, by clicking on the `Add an ACL` button from the `ACL` tab:

![Enable ACLs](/images/guides/public-cloud/data-analytics/analytics/kafka-configure-acl/kafka_acl.v2.png)
...
![Define ACLs](/images/guides/public-cloud/data-analytics/analytics/kafka-configure-acl/kafka_add_entry1.v2.png)
