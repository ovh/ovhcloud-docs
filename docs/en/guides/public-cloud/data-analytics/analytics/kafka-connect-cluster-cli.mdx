...
description: Learn how to connect to a Kafka cluster using the CLI
...
- A [Kafka cluster running](/guides/public-cloud/databases/kafka-getting-started) on OVHcloud Public Cloud [accepting incoming connections](/guides/public-cloud/databases/kafka-capabilities)
...
The server CA (*Certificate Authority*) certificate can be downloaded from the `Dashboard` tab:

![Kafka server certificate](/images/guides/public-cloud/data-analytics/analytics/kafka-connect-cluster-cli/kafka_get_server_certificate.v2.png)
{/* CP-STEPS-END:download-server-certificate */}

##### User certificate and access key

{/* CP-STEPS-START:download-user-certificate */}
The user certificate and the user access key can be downloaded from the `Users` tab:

![User informations](/images/guides/public-cloud/data-analytics/analytics/kafka-connect-cluster-cli/kafka_user_certificate_and_access_key.v2.png)
