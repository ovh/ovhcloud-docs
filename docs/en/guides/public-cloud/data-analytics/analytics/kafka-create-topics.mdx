...
description: Learn how to create Kafka topics
...
To create Kafka topics, first go to the `Topics` tab then click on the `Add a topic` button:

![Add a topic](/images/guides/public-cloud/data-analytics/analytics/kafka-create-topics/kafka_topics.v2.png)
...
![Create a topic](/images/guides/public-cloud/data-analytics/analytics/kafka-create-topics/kafka_create_topic.v2.png)
