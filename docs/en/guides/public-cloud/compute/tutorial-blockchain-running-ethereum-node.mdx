...
description: Deploy a full Ethereum node with Nethermind (EL) and Lighthouse (CL) on an OVHcloud Public Cloud instance using block storage for chain data
...
- A [Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) with at least 2 vCores and 30 GB of RAM (e.g. R2-30), running **Ubuntu 24.04 LTS**
- A [Block Storage volume](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance) of at least 2 TB, using the **High-Speed Gen2** type, attached to your instance
...
Once you have [created and attached your Block Storage volume](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance) to the instance, connect to your instance via SSH:
...
<img className="thumbnail" alt="lsblk output showing the attached volume" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/lsblk_output.png" loading="lazy" />
...
<img className="thumbnail" alt="fdisk partitioning" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/fdisk_partition.png" loading="lazy" />
...
<img className="thumbnail" alt="ext4 formatting" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/mkfs_ext4.png" loading="lazy" />
...
<img className="thumbnail" alt="Verify mount" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/mount_verify.png" loading="lazy" />
...
<img className="thumbnail" alt="blkid output" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/blkid_output.png" loading="lazy" />
...
<img className="thumbnail" alt="Adding Nethermind repository" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/nethermind_add_repo.png" loading="lazy" />
...
<img className="thumbnail" alt="Updating packages" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/nethermind_apt_update.png" loading="lazy" />
...
<img className="thumbnail" alt="Installing Nethermind" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/nethermind_install.png" loading="lazy" />
...
<img className="thumbnail" alt="Downloading Lighthouse" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/lighthouse_download.png" loading="lazy" />
...
<img className="thumbnail" alt="Extracting Lighthouse" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/lighthouse_extract.png" loading="lazy" />
...
<img className="thumbnail" alt="JWT secret created" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/jwt_secret.png" loading="lazy" />
...
<img className="thumbnail" alt="Nethermind running" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/nethermind_running.png" loading="lazy" />
...
<img className="thumbnail" alt="screen sessions" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/screen_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Lighthouse starting" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/lighthouse_start.png" loading="lazy" />

After initial setup, Lighthouse should begin syncing with the network.

<img className="thumbnail" alt="Lighthouse syncing" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/lighthouse_syncing.png" loading="lazy" />
...
<img className="thumbnail" alt="EL and CL synchronisation" src="/images/public-cloud/compute/tutorial-blockchain-running-ethereum-node/el_cl_sync.png" loading="lazy" />
...
[Creating a Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance)
