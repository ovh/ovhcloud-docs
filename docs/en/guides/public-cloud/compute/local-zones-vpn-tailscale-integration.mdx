...
- [Two Public Cloud instances](/guides/public-cloud/compute/getting-started) deployed in different [OVHcloud Local Zones](/links/public-cloud/local-zones) (we will use Prague and Madrid for this example).
