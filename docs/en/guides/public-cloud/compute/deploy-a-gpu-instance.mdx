...
Next, follow the remaining steps as detailed in [this guide](/guides/public-cloud/compute/public-cloud-first-steps#create-instance). This process may take a few minutes.
