...
:::warning
Attaching or detaching interfaces while the instance is running can change the interface order seen by the guest operating system after a reboot. If you reorganise several interfaces, see the "Interface order after hot-attaching or hot-detaching ports" section of the [Configuring vRack for Public Cloud](/guides/public-cloud/network-services/vrack#interface-order-after-reboot) guide. Validate the new interface order with a [hard reboot](#reboot-an-instance) before relying on it in production.
:::
...
### Access the instance console <a id="console"></a>
