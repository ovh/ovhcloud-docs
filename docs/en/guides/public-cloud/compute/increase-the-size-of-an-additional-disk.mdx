...
:::info
The commands below are the same regardless of which procedure you followed above. The file, block and size values shown in the sample output correspond to the 2TB-or-smaller example (a 70GiB disk) used earlier in this guide. If you followed the procedure for partitions over 2TB instead, your own output will show larger figures reflecting your resized disk, but the steps themselves are identical.
:::
