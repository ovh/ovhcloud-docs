...
:::info
The commands below are the same regardless of which procedure you followed above. The file, block and size values shown in the sample output correspond to the ≤2TB example (a 70GiB disk) used earlier in this guide — if you followed the >2TB procedure instead, your own output will show larger figures reflecting your resized disk, but the steps themselves are identical.
:::
