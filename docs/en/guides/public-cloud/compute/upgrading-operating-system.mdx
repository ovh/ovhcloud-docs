...
Therefore, OVHcloud strongly recommends [backing up your instance](/guides/public-cloud/compute/save-an-instance) and conducting extensive testing on your applications to make sure they work on the new operating system version prior to following this tutorial.
:::
...
However, you must carefully review packages that are no longer needed on the system. Otherwise, the `sudo apt-get --purge autoremove` command might break the system. 
:::
