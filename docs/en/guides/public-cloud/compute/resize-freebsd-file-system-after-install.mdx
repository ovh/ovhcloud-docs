...
**The purpose of this guide is to explain how to resize your file system after installing FreeBSD or resizing the service.**

By doing this, your system will be able to take advantage of all the disk space.
...
You have now resized your file system. If you have a ZFS file system, it is configured to expand automatically. Use this command to verify:
