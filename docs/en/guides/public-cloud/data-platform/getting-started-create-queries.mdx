...
[<span aria-hidden="true">↪</span> Learn more about how the Analytics Manager works.](/guides/public-cloud/data-platform/analytics-manager-queries-visual-builder#choice-of-table)
