...
:::info
The SQLite file will be stored in the **appservice** folder of the S3<sup>1</sup> bucket (Lakehouse Manager section). We highly recommend backing up this file regularly.
:::
