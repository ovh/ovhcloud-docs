...
description: In this tutorial, you will learn how to create and edit your first charts, and add them to your dashboards
...
:::info
Learn more about custom charts in the [**Technical Guide**](https://docs.dataplatform.ovh.net/#/en/technical/sdk/app/custom-chart)!
:::
...
:::info
Learn more about dynamic parameters in the [**Technical Guide**](https://docs.dataplatform.ovh.net/#/en/technical/sdk/app/dynamic_parameters/index)!
:::

 

You have learned how to use existing components. You are now ready to take on [creating your own custom components and use them to make unique dynamic parameters and charts!](/guides/public-cloud/data-platform/tutorials-app-development-custom-components)
