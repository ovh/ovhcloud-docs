...
description: Understand and edit the configuration files of a Data Platform application, from the global config to a dashboard
...
- `config`: This folder holds most of the application configuration. In this folder, you can define and update your configuration files for dashboards, menus, styles, translations etc... The most important file here is `global.json`, it allows you to declare and use all of these configuration files. (explained right after)
...
Next, learn how to create and edit charts.
