...
Select the template *ReactJS - Getting Started* from the store. This template produces a complete BI dashboard.
...
:::info
Your first dashboard is now complete. You can also improve its appearance. In our *Getting Further guide series*, we have released more tutorials for you to check out: [click here to learn more about the app builder's capabilities](/guides/public-cloud/data-platform/tutorials-customize-first-app)!
:::
