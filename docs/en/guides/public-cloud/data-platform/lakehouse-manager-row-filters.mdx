...
| To do this | You need |
|---|---|
| See, create, edit, duplicate and delete row filters | The *Row filter* permissions (read, write, bind, delete) in the [Identity Access Manager](/guides/public-cloud/data-platform/iam-roles-conditions), listed under *Data Manager* |
