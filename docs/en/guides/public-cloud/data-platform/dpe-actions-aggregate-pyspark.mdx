...
description: Each destination attribute needs to be mapped to a source attribute. When multiple source tables are selected
...
- [Configure an Aggregate PySpark action](/guides/public-cloud/data-platform/dpe-actions-aggregate-pyspark#configure-an-aggregate-pyspark-action)
  - [Transfer raw data into a primary table](/guides/public-cloud/data-platform/dpe-actions-aggregate-pyspark#transfer-raw-data-into-a-primary-table)
  - [Join a referential to a primary table](/guides/public-cloud/data-platform/dpe-actions-aggregate-pyspark#join-a-referential-to-a-primary-table)
  - [Configure the action's preferences](/guides/public-cloud/data-platform/dpe-actions-aggregate-pyspark#configure-the-action39s-preferences)
- [Use the Advanced mode](/guides/public-cloud/data-platform/dpe-actions-aggregate#use-the-advanced-mode)
...
<img className="thumbnail" alt="Transfer raw data into a primary table — Py agg ui" src="/images/public-cloud/data-platform/product/dpe/actions/aggregate-pyspark/picts/py-agg-ui.png" loading="lazy" />
...
<img className="thumbnail" alt="Transfer raw data into a primary table — Py agg ui2" src="/images/public-cloud/data-platform/product/dpe/actions/aggregate-pyspark/picts/py-agg-ui2.png" loading="lazy" />
...
<img className="thumbnail" alt="Join a referential to a primary table — Py agg ui3" src="/images/public-cloud/data-platform/product/dpe/actions/aggregate-pyspark/picts/py-agg-ui3.png" loading="lazy" />
...
<img className="thumbnail" alt="Configure the action's preferences — Py settings" src="/images/public-cloud/data-platform/product/dpe/actions/aggregate-pyspark/picts/py-settings.png" loading="lazy" />
