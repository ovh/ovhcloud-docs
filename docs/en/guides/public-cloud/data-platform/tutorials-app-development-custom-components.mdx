...
The component is displayed but not yet functional: its behavior is defined in the next section.
...
The final code is available [here](https://github.com/forepaas/getting-started/tree/release/advanced/src/components/DynamicParameterCheckbox).
...
The final code is available [here](https://github.com/forepaas/getting-started/tree/release/advanced/src/components/ChartMap).
