...
Start by picking the template that suits your use case the most. If no template fits your needs perfectly, you can add services to the Project later. To make sure all your needs are covered we suggest that you **pick the End-to-end template**.
