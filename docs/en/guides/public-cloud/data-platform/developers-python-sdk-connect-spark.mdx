...
:::info
Note that not all Data Platform connectors are compatible with PySpark. Some compatible connectors are: Snowflake, PostgreSQL, MySQL, Amazon S3, File-Upload and Data Platform Bucket but this list is evolving constantly.
:::
