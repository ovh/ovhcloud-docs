---
title: Datasets
description: the Platform supports Standard as well as External Datasets to manage your tables. By default you will be given one standard dataset named defaultdataset
