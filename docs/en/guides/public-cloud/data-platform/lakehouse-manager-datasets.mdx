...
- **Buckets**: S3<sup>1</sup>-compatible object storage for unstructured files, independent from the Lakehouse. See [Buckets](/guides/public-cloud/data-platform/lakehouse-manager-buckets).
