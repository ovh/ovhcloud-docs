...
description: This guide will walk you through enabling Multi-Factor Authentication (MFA) on your account
...
<img className="thumbnail" alt="profile" src="/images/public-cloud/data-platform/product/organisations/picts/mfa-auth-app-setup.png" loading="lazy" />
...
<img className="thumbnail" alt="2FA Activated" src="/images/public-cloud/data-platform/product/organisations/picts/mfa-auth-app-done.png" loading="lazy" />
...
<img className="thumbnail" alt="2FA Activated" src="/images/public-cloud/data-platform/product/organisations/picts/mfa-auth-sms.png" loading="lazy" />
...
<img className="thumbnail" alt="2FA Activated" src="/images/public-cloud/data-platform/product/organisations/picts/mfa-final-modal.png" loading="lazy" />
...
<img className="thumbnail" alt="2FA Activated" src="/images/public-cloud/data-platform/product/organisations/picts/mfa-without-backup.png" loading="lazy" />
