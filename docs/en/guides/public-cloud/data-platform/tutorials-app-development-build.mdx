...
:::info
Open [localhost:3333](http://localhost:3333) to check your app. If you see no error but a blank screen, don't worry! You still need to adjust the app configuration before seeing the panels. The blank screen means your app is up & running.
:::
