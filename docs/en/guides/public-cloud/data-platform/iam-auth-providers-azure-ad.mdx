...
description: Do you have an Azure Active Directory in your company? If you want to use it to login to your Data Platform apps, this guide is for you
lastUpdated: 2026-09-14
---

## Objective

This guide explains how to use Azure Active Directory to log in to your Data Platform applications.
...
If you haven't done so already, [add a new](/guides/public-cloud/data-platform/iam-auth-providers#add-an-authentication-provider) *Azure AD* authentication provider. Else, just edit it.
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-app-registration.png" loading="lazy" />

#### *Name*

The name is purely descriptive: it will be useful to find your configuration within your Azure AD.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-name.png" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-supported-account.png" loading="lazy" />

#### *Redirect URL*

Select *Web*.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-web.png" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-reply-url.png" loading="lazy" />

Once this is done, click on **Register**.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-register.png" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-clientid.png" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-secret-new.png" loading="lazy" />

Fill in the description and expiration date of your choice and click on **Add**.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-secret-new2.png" loading="lazy" />

Once the client secret is created, copy and save its **Value**.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-secret-value.png" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-add-permission.jpeg" loading="lazy" />

Select *Delegated permissions*.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-add-permission2.jpeg" loading="lazy" />
...
<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-add-permission3.jpg" loading="lazy" />

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-add-permission4.jpg" loading="lazy" />

Finally, click on **Grant admin consent for your-app** and confirm.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-grant-admin-consent.jpeg" loading="lazy" />

When all permissions have been correctly added, your screen should look like this.

<img className="thumbnail" alt="App registration" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-grant-admin-consent2.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Configuration on the Data Platform Identity Access Manager — Azure Identity Access Manager" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-iam.png" loading="lazy" />
...
- **Debug Mode**: When this is turned on, this enables you to see the authentication logs in the [Control Center](/guides/public-cloud/data-platform/landing-page-control-center).

<img className="thumbnail" alt="Fill in the basic information — Azure config1" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-config1.png" loading="lazy" />

### Fill in Azure configuration

Now locate the **Azure Configuration** panel.

<img className="thumbnail" alt="Fill in Azure configuration — Azure config2" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-config2.png" loading="lazy" />
...
<img className="thumbnail" alt="Set live — Auth active" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/auth-active.png" loading="lazy" />
...
<img className="thumbnail" alt="Set live — Azure final" src="/images/public-cloud/data-platform/product/iam/project-iam/auth-provider/picts/azure-final.png" loading="lazy" />

[Make Azure AD visible on your apps' login page](/guides/public-cloud/data-platform/iam-application-authentication#display-an-authentication-provider-on-an-application-login-page)
