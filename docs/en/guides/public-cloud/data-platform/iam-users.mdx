...
- [<span aria-hidden="true">↪</span> Add users to a group](/guides/public-cloud/data-platform/iam-groups#assign-users-or-service-accounts-to-a-group)
- [<span aria-hidden="true">↪</span> Assign a role to a user](/guides/public-cloud/data-platform/iam-organization#resources-managed-by-the-organization-iam)
...
- [<span aria-hidden="true">↪</span> Add users to a group](/guides/public-cloud/data-platform/iam-groups#assign-users-or-service-accounts-to-a-group)
- [<span aria-hidden="true">↪</span> Assign a role to a user](/guides/public-cloud/data-platform/iam-roles-conditions#bind-a-role-to-a-user-service-account-or-group)
...
[<span aria-hidden="true">↪</span> Generate API & secret keys for users](/guides/public-cloud/data-platform/tutorials-generate-api-keys)
