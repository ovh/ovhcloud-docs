...
:::info
This article is about actions that use Data Platform's proprietary Python data processing engine. To use Apache Spark clusters, see [Aggregate PySpark action](/guides/public-cloud/data-platform/dpe-actions-aggregate-pyspark).
:::
