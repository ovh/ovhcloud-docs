...
:::info
The options *Build the table, load the table once, and generate Load action for later* can be disabled and each step can be done individually as well. This can be explored in detail in the [Tables](/guides/public-cloud/data-platform/lakehouse-manager-tables) guide.
:::
...
[<span aria-hidden="true">↪</span> Learn more about Tables](/guides/public-cloud/data-platform/lakehouse-manager-tables)
...
[<span aria-hidden="true">↪</span> Learn more about custom actions](/guides/public-cloud/data-platform/dpe-actions-custom).
...
Click on **New action** and select the *Aggregate action* template from the Platform Store.
...
[<span aria-hidden="true">↪</span> Learn more about Aggregate actions](/guides/public-cloud/data-platform/dpe-actions-aggregate)
...
[<span aria-hidden="true">↪</span> Learn more about Actions in the Product Documentation](/guides/public-cloud/data-platform/landing-page-dpe-actions)
...
[<span aria-hidden="true">↪</span> Learn more about configuring the execution preferences.](/guides/public-cloud/data-platform/dpe-jobs-preferences)
