...
description: "Custom mappings allow you to automatically assign existing Data Platform groups or roles (or auto-create them if they don't exist) to users signing in"
