...
description: In this article we will go through the steps required to create an action that allows you to handle events
...
[Creating a data model in the Lakehouse Manager](/guides/public-cloud/data-platform/landing-page-lakehouse-manager)
...
[Creating an API / Secret Key](/guides/public-cloud/data-platform/tutorials-generate-api-keys)
