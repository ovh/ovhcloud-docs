...
This guide explains how to use [Auth0](https://auth0.com/) to log in to your Data Platform applications.
...
Scroll down to the **Allowed Callback URLs** section in the Settings page of the application.
