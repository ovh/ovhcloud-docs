...
Following the related documentation on how to [authorise the suitable IP addresses](/guides/public-cloud/databases/mysql-prepare-for-incoming-connections#configure-your-mysql-instance-to-accept-incoming-connections), add your Kubernetes cluster node IPs to the authorised list.
