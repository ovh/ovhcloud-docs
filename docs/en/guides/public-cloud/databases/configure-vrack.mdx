...
The first step is to create the virtual network that will be used in your vRack. To proceed, consult this [guide](/guides/public-cloud/network-services/vrack).
...
Follow this [guide](/guides/public-cloud/compute/getting-started) to create a new Public Cloud Instance
...
If you want to test the access from an existing instance, read this tutorial to connect it to the vRack: [Configuring vRack for Public Cloud](/guides/public-cloud/network-services/vrack#instance-integration).
:::
