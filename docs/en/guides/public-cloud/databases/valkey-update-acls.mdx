...
As explained on this page: [Valkey Capabilities, Users & roles](/guides/public-cloud/databases/valkey-capabilities#users-and-roles), the users' ACLs cannot be updated via the OVHcloud Control Panel.
