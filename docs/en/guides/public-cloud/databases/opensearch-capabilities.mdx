...
For detailed information about node types and pricing, please refer to the [Public Cloud pricing page](/links/public-cloud/prices).
...
By default, you can create up to 50 service users per service. If you need more than 50 users, contact OVHcloud Support to request a limit increase.
