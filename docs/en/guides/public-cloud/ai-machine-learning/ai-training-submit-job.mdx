...
Click <ManagerLink to="/#/public-cloud/pci/projects">this link</ManagerLink> to access your Public Cloud project, then go to the <code className="action">AI Training</code> section, located under `AI & Machine Learning`.
