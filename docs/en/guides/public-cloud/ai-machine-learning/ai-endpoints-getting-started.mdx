...
Click <ManagerLink to="/#/public-cloud/pci/projects">this link</ManagerLink> to access your Public Cloud project, then go to the <code className="action">AI & Machine Learning</code> category in the left menu and choose <code className="action">AI Endpoints</code>.
...
For your convenience, you can monitor your estimated consumption and model usage in the <code className="action">AI Endpoints</code> section of the `AI & Machine Learning` category in your <ManagerLink to="/#/public-cloud/pci/projects">Public Cloud project</ManagerLink> left-hand vertical menu.
