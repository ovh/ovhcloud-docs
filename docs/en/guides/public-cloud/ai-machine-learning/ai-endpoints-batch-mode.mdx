...
- **Entries:** Maximum 50,000 entries (requests) per batch/file
...
If your workload exceeds the file size or entry limits, split it into multiple batches. Batches beyond the concurrency limit will need to wait until a slot becomes available.
