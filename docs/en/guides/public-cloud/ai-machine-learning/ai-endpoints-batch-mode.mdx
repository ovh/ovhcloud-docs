---
title: AI Endpoints - Using the Batch API
...
<img className="thumbnail" alt="AI Endpoints batch mode workflow diagram" src="/images/public-cloud/ai-machine-learning/endpoints-guide-10-batch-mode/batch-mode-workflow.png" loading="lazy" />
...
<img className="thumbnail" alt="Diagram of the four batch job lifecycle stages" src="/images/public-cloud/ai-machine-learning/endpoints-guide-10-batch-mode/batch-mode-lifecycle.png" loading="lazy" />
...
The `v1/batches` endpoint is still under development and all features may not be available.
...
- We accept batch requests only for our **LLMs and embeddings** models currently.
