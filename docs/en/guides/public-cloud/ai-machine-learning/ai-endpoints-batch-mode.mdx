...
<img className="thumbnail" alt="Batch mode workflow" src="/images/public-cloud/ai-machine-learning/endpoints-guide-10-batch-mode/batch-mode-workflow.png" loading="lazy" />

## Objective

This documentation provides an overview of the `v1/batches` route on [AI Endpoints](https://www.ovhcloud.com/en-gb/public-cloud/ai-endpoints/), including:
...
<img className="thumbnail" alt="Batch lifecycle" src="/images/public-cloud/ai-machine-learning/endpoints-guide-10-batch-mode/batch-mode-lifecycle.png" loading="lazy" />
...
- We accept batch requests only for our **LLMs and embeddings** models at the moment.
