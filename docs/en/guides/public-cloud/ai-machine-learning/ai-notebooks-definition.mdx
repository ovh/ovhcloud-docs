...
<Tabs>
  ...
  <Tab label="Using CLI / AI API / SDK">
    ...
    Click <ManagerLink to="/#/public-cloud/pci/projects">this link</ManagerLink> to access your Public Cloud project, then click on the <code className="action">AI & Machine Learning</code> category in the left-hand vertical menu to access the <code className="action">AI Notebooks</code> section.
