...
- Access to the <ManagerLink to="/#/public-cloud/pci/projects">OVHcloud Control Panel</ManagerLink> and the [OVHcloud API](/guides/manage-and-operate/api/first-steps)
