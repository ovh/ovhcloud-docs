...
Once you have created your first Public Cloud project and validated a payment method, you can create further projects programmatically using the `ovh_cloud_project` Terraform resource. Refer to the [Terraform guide for OVHcloud Public Cloud](/guides/public-cloud/cross-functional/how-to-use-terraform#creating-a-public-cloud-project) for details.

Project creation is not currently supported via the OVHcloud API or the OVHcloud CLI.
:::
