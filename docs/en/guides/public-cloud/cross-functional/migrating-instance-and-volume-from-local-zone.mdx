...
Part 1 ended on the target region, so source the OpenRC file for the source Local Zone again: the command below and Step 6 run against it, and Step 8 switches back to the target region.
