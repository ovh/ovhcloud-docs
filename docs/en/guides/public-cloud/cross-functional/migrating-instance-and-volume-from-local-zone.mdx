...
Check the source volume's storage class first, and reuse it for the new volume unless you deliberately want to change it — the storage class affects both performance and billing:
