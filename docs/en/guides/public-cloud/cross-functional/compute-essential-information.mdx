...
Since your payment method has been saved, it will be used to debit the amount calculated for your [billing at the end of the month](/guides/public-cloud/cross-functional/analyze-billing). This calculation is based on each resource's usage time and price. For instances, prices are usually displayed as an hourly rate for readability, but billing is calculated per second, with a minimum billing period of 1 minute.
