...
Building a hub and spoke landing zone is a complex, multi-team undertaking. [OVHcloud Professional Services](/links/professional-services) can assist with architecture design review, assisted deployment, and operational readiness assessment.
:::
...
For the current complete list see the [OVHcloud Public Cloud regions availability page](/links/public-cloud/regions-pci).
...
For a detailed walkthrough of OVHcloud IAM, see [Securing & Structuring Public Cloud Projects](/guides/public-cloud/cross-functional/security-structure-best-practices).
...
2. **OVH Gateway** on the WAN network — provides NAT and Internet routing for all outbound spoke traffic. See the [Private Network with Gateway guide](/guides/public-cloud/network-services/create-private-network-gateway) for setup steps.
...
OVHcloud managed services (Managed Databases, Managed Kubernetes) also support native log forwarding to LDP — see [Forwarding logs from OVHcloud products to Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding).
