...
Generate API credentials using the <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">OVHcloud API token generator</CreateToken>. Store the Application Key, Application Secret, and Consumer Key securely — never in source control.
