...
Instances deployed in a [Local Zone](/guides/public-cloud/compute/local-zones-capabilities-limitations) cannot contact SMTP servers at all — this goes beyond port 25, and there is no option to unblock it for this deployment mode.
