...
```bash
kubectl --kubeconfig $KUBECONFIG_PROD scale deploy/nextcloud --replicas=1 -n nextcloud
```
...
{/* TODO: add the link to the Terraform script that automates this deployment. */}
