...
description: Learn how to set up a Quantum Emulators Notebook
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 01" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 02" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-02.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 03" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-03.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 04" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-04.png" loading="lazy" />

**5\. Live-code editor**

Choose the code editor you want.

<img className="thumbnail" alt="Create a Notebook Control Panel manager 05" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-05.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 06" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-06.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 07" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-07.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 10" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-08b.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook Control Panel manager 11" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-09.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook ovhai CLI" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-ovhai-CLI.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a Notebook API token authentication" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-API-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Accessing a Notebook Control Panel manager 1" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-UI-1.png" loading="lazy" />

You can also access the Notebook from its dedicated page:

<img className="thumbnail" alt="Accessing a Notebook Control Panel manager 2" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-UI-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Access a Notebook ovhai CLI" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-ovhai-CLI.png" loading="lazy" />
...
<img className="thumbnail" alt="Access a Notebook API" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-API.png" loading="lazy" />
...
<img className="thumbnail" alt="Notebook Authentication Credentials" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/notebook-authentication-creds.png" loading="lazy" />

**Using an Access Token**

Click the `Login with token` button and enter your access token to log in to your Quantum Notebook.

<img className="thumbnail" alt="Notebook Authentication Token" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/notebook-authentication-token.png" loading="lazy" />
...
<img className="thumbnail" alt="Stop a Notebook Control Panel manager" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/stopping-a-notebook-using-UI.png" loading="lazy" />
...
<img className="thumbnail" alt="Stop a Notebook API" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/stopping-a-notebook-using-API.png" loading="lazy" />
...
<img className="thumbnail" alt="Restart a Notebook Control Panel manager" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/restarting-a-notebook-using-UI.png" loading="lazy" />
...
<img className="thumbnail" alt="Restart a Notebook API" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/restarting-a-notebook-using-API.png" loading="lazy" />
...
<img className="thumbnail" alt="Delete a Notebook Control Panel manager" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/deleting-a-notebook-using-UI.png" loading="lazy" />
...
<img className="thumbnail" alt="Delete a Notebook API" src="/images/guides/public-cloud/quantum-computing/emulators/getting-started/deleting-a-notebook-using-API.png" loading="lazy" />
