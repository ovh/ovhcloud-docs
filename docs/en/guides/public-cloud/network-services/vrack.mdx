...
The [ovhcloud CLI](https://github.com/ovh/ovhcloud-cli) allows you to manage Public Cloud resources from your terminal, including private networks and instance interfaces.
