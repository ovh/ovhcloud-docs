...
<Tabs>
  ...
  <Tab label="OVHcloud API">
    Log in to the [OVHcloud API](https://eu.api.ovh.com/console/) and use the following call to create a gateway together with a new private network and subnet in a single operation:
