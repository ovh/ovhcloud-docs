...
An OVHcloud [Gateway](https://www.ovhcloud.com/en-gb/public-cloud/gateway/) provides secure outbound connectivity for instances attached to a private network, and enables [Floating IP](https://www.ovhcloud.com/en-gb/public-cloud/floating-ip/) assignment for public service exposure.
...
- **For API:** OVHcloud API credentials ([First steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps))
- **For CLI:** [ovhcloud-cli](https://github.com/ovh/ovhcloud-cli) installed and configured with your credentials
...
<Tabs>
  ...
  <Tab label="Via the CLI OVHcloud">
