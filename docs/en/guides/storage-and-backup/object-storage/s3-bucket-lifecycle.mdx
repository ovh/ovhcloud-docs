...
| AbortIncompleteMultipartUpload                      | no       | A lifecycle action that applies a delete operation on parts of an incomplete multipart upload. <br/><br/>⚠️ this attribute is mutually exclusive with Filter.Tag, Filter.ObjectSizeGreaterThan, Filter.ObjectSizeLessThan i.e if you filter objects by tags and/or size, you have to configure another rule to delete incomplete multipart uploads|
