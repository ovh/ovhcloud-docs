...
- **Swift S3 API**: An environment [prepared for the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) with `python-openstackclient` and `awscli` installed
...
- **OVHcloud CLI**: The [OVHcloud CLI](/guides/public-cloud/cross-functional/ovhcloud-cli) installed and configured
...
<Tabs>
  ...
  <Tab label="Via the Swift S3 API">
    ...
    **Configure the AWS client**
    ...
    :::info
    Virtual hosted-style and path-style access are both supported, but virtual hosted-style is recommended as path-style access was deprecated after September 30, 2020.
    :::
  </Tab>
  <Tab label="Via the Swift client">
    ...
    For the full list of Swift commands, refer to the [OpenStack documentation](http://docs.openstack.org/cli-reference/content/swiftclient_commands.html).
  </Tab>
  <Tab label="Via the OVHcloud CLI">
    Ensure the OVHcloud CLI is installed and configured with your credentials. For setup instructions, refer to the [OVHcloud CLI documentation](/guides/public-cloud/cross-functional/ovhcloud-cli).
  </Tab>
</Tabs>
