...
You can enter the name of your bucket (optional) and then **select your offer**.
  ...
  <Tab label="Via the OVHcloud CLI">
    ...
    ```shell
    ovhcloud cloud storage object create <region> --name <bucket_name>
    ```

    To create a bucket with versioning and encryption enabled:

    ```shell
    ovhcloud cloud storage object create <region> --name <bucket_name> --versioning-status enabled --encryption-sse-algorithm AES256
    ```

    To create a bucket with Object Lock enabled:

    ```shell
    ovhcloud cloud storage object create <region> --name <bucket_name> --object-lock-status enabled --object-lock-rule-mode compliance --object-lock-rule-period P30D
    ```
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud CLI">
    **Deleting objects**
    ...
    ```shell
    # Delete an object
    ovhcloud cloud storage object object delete <bucket_name> <object_name>

    # Delete all objects in a bucket
    ovhcloud cloud storage object bulk-delete <bucket_name> --all

    # Delete objects matching a prefix
    ovhcloud cloud storage object bulk-delete <bucket_name> --prefix <prefix>

    # Delete specific objects
    ovhcloud cloud storage object bulk-delete <bucket_name> --objects "file1.txt,file2.txt"
    ```
    ...
    **Deleting a bucket**
    ...
    ```shell
    ovhcloud cloud storage object delete <bucket_name>
    ```
    ...
    **Deleting objects with versioning enabled**
    ...
    ```shell
    ovhcloud cloud storage object object version delete <bucket_name> <object_name> <version_id>
    ```

    To delete all versions of an object, combine the version list and deletion:

    ```shell
    ovhcloud cloud storage object bulk-delete <bucket_name> --objects "myfile.txt:<version_id_1>,myfile.txt:<version_id_2>"
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud CLI">
    ...
    **Setting tags when creating a bucket**
    ...
    ```shell
    ovhcloud cloud storage object create <region> --name <bucket_name> --tag myKey=myKeyValue --tag otherKey=otherValue
    ```

    **Updating tags on an existing bucket**

    ```shell
    ovhcloud cloud storage object edit <bucket_name> --tag myKey=myKeyValue
    ```
  </Tab>
</Tabs>
