...
<img className="thumbnail" alt="connection" src="/images/storage-and-backup/object-storage/pca-sftp/image2.png" loading="lazy" />
...
<img className="thumbnail" alt="connection" src="/images/storage-and-backup/object-storage/pca-sftp/image3.png" loading="lazy" />
...
<img className="thumbnail" alt="connection" src="/images/storage-and-backup/object-storage/pca-sftp/conf1.png" loading="lazy" />
...
<img className="thumbnail" alt="connection" src="/images/storage-and-backup/object-storage/pca-sftp/conf2.png" loading="lazy" />

- Uncheck "Preserve timestamp".

<img className="thumbnail" alt="connection" src="/images/storage-and-backup/object-storage/pca-sftp/conf3.png" loading="lazy" />
