...
:::warning
To order a product through Terraform, your account needs to have a default payment method defined. This can be done in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or with the following API call: <Api version="v1" section="/me" method="GET" route={"/me/payment/method"} />
