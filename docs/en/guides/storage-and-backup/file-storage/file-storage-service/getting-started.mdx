...
<Tabs>
  ...
  <Tab label="Via the OVHcloud API">
    ...
    **NOTE:** Replace `<my-share-name>` with your chosen share name.
    ...
    :::info
    To create an encrypted share, use the `standard-1az-luks` type instead of `standard-1az`. This automatically generates a dedicated encryption key — do not modify or delete it, as doing so would make the share's data permanently unrecoverable.
    :::
