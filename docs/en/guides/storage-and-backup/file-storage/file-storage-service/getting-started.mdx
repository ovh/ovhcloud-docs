...
<Tabs>
  ...
  <Tab label="Via Terraform">
    ...
    **3\. Retrieve information about your private network**
    ...
    :::info
    Replace `<YOUR_PRIVATE_NETWORK_ID>` with the OVHcloud ID of your private network, returned by <ApiLink section="/cloud" method="GET" route={"/cloud/project/\{serviceName\}/network/private"}>listing your private networks</ApiLink>. It differs from the regional OpenStack network ID shown in the previous tabs.
    :::
