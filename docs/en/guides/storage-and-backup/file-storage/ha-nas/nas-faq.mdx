...
You can also create manual snapshots at any time, save them without any time limit, or delete them. This feature is available in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or via the following <ApiLink>API</ApiLink> call:
