...
Read this guide for more information: [Backup Agent - Restore a Bare Metal server with Veeam Backup Agent](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/agent-bare-metal-recovery).
