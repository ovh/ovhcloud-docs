...
- Your backup data is automatically sent to a Vault created in **Gravelines (GRA)**, named **backup-vault-gra-1**.
...
- The Bare Metal server in **RBX** sends its data to **backup-vault-gra-1** in **Gravelines (GRA)**.
- The Bare Metal server in **GRA** sends its data to **backup-vault-sbg-1** in **Strasbourg (SBG)**.
