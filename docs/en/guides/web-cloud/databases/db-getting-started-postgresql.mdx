...
All this information is available in the <ManagerLink to="/#/web/private_database">OVHcloud Control Panel</ManagerLink>.
...
Web Cloud Databases offers several PostgreSQL extensions to add extra features to your databases. You can enable and disable them from the OVHcloud Control Panel.

For the list of available extensions, refer to the "[Enabling PostgreSQL extensions](/guides/web-cloud/databases/db-enable-postgresql-extensions#available-extensions)" guide.
...
[Enabling PostgreSQL extensions](/guides/web-cloud/databases/db-enable-postgresql-extensions)
