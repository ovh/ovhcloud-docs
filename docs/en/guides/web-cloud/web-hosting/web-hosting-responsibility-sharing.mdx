...
description: "Shared responsibility between OVHcloud and the customer for the use of the Web hosting service"
...
| Choose if a one click module needs to be installed on the Web Hosting plan | RA |  |
...
| Ensure that the content provided by the customer through the service respects the law & OVHcloud terms and conditions | RA |  |
...
| Comply with the Web Hosting lifecycle policy of software used to provide the service |  | RA |
