...
If your database is hosted on a [Web Cloud Databases](/links/web/databases) solution, please refer to our guide on “[Web Cloud Databases - Logging in to your database](/guides/web-cloud/databases/db-connecting-database-server)”, then skip to [step 1.2](#step1.2) of this guide.
...
- [First steps with Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
- [Import your old database into your Web Cloud Databases solution](/guides/web-cloud/databases/db-restore-import-database)
