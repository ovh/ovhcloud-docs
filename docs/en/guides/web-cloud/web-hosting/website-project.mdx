...
If you have a **Performance**, **Agency**, **Agency Plus** or **Agency Max** web hosting plan, you can activate a [Web Cloud Databases](/links/web/databases) database server for free.
...
If your [web hosting plan](/links/web/hosting) has this option, please refer to our guide on "[Using automated tasks on a web hosting plan](/guides/web-cloud/web-hosting/cron-tasks)" for further details.
