...
:::info
OVHcloud offers Web Cloud Databases database servers. If you would like to use this solution with your website, you can find all of our documentation for this product on our dedicated page: [Web Cloud Databases](/guides/web-cloud/databases/landing-page-databases).
:::
...
Since your domain name is not yet with OVHcloud, you will need to add a "TXT" type DNS record with the OVHcontrol token, and change the "A" record for your domain name. This is done in your domain name's active DNS zone with your current provider.
...
- You can find all of our configuration guides in the section `Email client configuration` of [our documentation on the Email Pro offer](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro).
</Region>

<Region zones={['eu', 'ca']}>
#### For Exchange email accounts:

- You can find all of our configuration guides in the `Exchange configuration on computer` and `Exchange configuration on smartphone` sections of [our Exchange documentation](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange).
</Region>
