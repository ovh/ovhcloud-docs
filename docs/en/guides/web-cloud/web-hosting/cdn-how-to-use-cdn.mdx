...
In terms of SEO (search engine optimisation), the website loading speed is more important than the geolocation of the IP addresses.
...
<Tabs>
  ...
  <Tab label="Step 4">
    :::warning
    Some options are locked on CDN Basic and require you to sign up to [CDN Security](/links/web/hosting-options-cdn) or [CDN Advanced](/links/web/hosting-options-cdn).
