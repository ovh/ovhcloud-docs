...
<summary><Region zones={['eu']}>Enable SFTP on a **Free hosting**, **Starter**, **Personal**, or **Startup** web hosting offer</Region><Region zones={['ca', 'apac']}>Enable SFTP on a **Starter**, **Personal**, or **Startup** web hosting offer</Region></summary>
