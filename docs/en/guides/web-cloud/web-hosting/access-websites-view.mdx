...
<Tabs>
  ...
  <Tab label="Step 2">
    ...
    - **Domain name**: shows the main domain name of the website, as configured in the “Multisite” tab of your hosting plan.
    - **Diagnostic**: informs you whether your domain name is correctly pointing to the associated web hosting plan. For more details, refer to the “[Diagnose your domain names](/guides/web-cloud/web-hosting/multisites-configure-multisite#diagnostic-domain)” section of our guide “Hosting multiple websites on your Web Hosting plan”.
    ...
    - The **Domain name**, **Diagnostic**, **Root folder**, **Git**, **Separate logs**, **CDN**, **SSL** and **Firewall** columns redirect to the <code className="action">Multisite</code> tab.
