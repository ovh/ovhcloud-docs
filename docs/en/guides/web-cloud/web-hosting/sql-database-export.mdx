...
:::tip
If you are backing up your database because it is full, please read our tutorial "[What should I do when my database is full?](/guides/web-cloud/web-hosting/sql-overquota-database)".
:::
