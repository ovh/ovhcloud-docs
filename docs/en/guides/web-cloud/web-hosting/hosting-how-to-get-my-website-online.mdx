...
How this connection is established will depend on the type of website you are publishing. This process is dictated by how your website is configured, rather than OVHcloud. As a result, we recommend getting in touch with your website's publisher or another specialist (such as [a service provider](/links/partner)) if you need assistance with this procedure.
...
As a reminder, if you encounter any difficulties publishing your website, we recommend contacting [a specialised provider](/links/partner) and/or the publisher of the service (the CMS you have set up, for example).
