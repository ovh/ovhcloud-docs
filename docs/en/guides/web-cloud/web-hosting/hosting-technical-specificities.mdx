...
To find out more, read the details of our [Web Hosting plans](/links/web/hosting) and our guide "[Getting started with your Web Cloud Databases solution](/guides/web-cloud/databases/db-getting-started)".
...
Only [Web Cloud Databases](/links/web/databases) database servers allow external servers to connect to them. This is because you have previously authorized your external server's IP address on your database server. If necessary, please refer to our guide on "[Getting started with your Web Cloud Databases solution](/guides/web-cloud/databases/db-getting-started)".
