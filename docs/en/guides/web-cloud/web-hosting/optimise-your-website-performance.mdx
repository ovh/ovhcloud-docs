...
You can find more information regarding which plan to choose from on [this page](/links/web/hosting-best-web).
...
To switch to use PHP-FPM in the _stable_ version or to get details on more advanced options of your web hosting plan, please consult [this guide](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
One useful tool for analysis is the [Network Monitor](https://developer.mozilla.org/en-US/docs/Tools/Network_Monitor) which is directly integrated in the Mozilla Firefox browser and lets you analyze a web page's loading time in detail.
