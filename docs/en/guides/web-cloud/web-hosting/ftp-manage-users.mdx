...
<Tabs>
  ...
  <Tab label="Step 5">
    ...
    In this second window, you only need to set and confirm the password for the new FTP user in the two fields. Follow the password policy listed just below the 2 fields.
