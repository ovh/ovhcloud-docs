...
If you are using a database of a **Web Cloud Databases** solution, please refer to our guide on [Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::info
OVHcloud offers several [CDN options](/links/web/hosting-options). If you would like to use or activate one for your web hosting plan, log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> then read our guide on [Using the OVHcloud CDN](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
:::tip
Regardless of the loading speed, optimising your website will improve its search engine ranking (SEO).
