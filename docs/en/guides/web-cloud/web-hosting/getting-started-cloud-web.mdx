...
<Tabs>
  ...
  <Tab label="Step 3">
    If you have the [Cloud Web](/links/web/hosting-cloud-web-offer) offer with 2 vCores, you can add a second runtime environment (maximum 2 per plan) by clicking on the <code className="action">Actions</code> button, then on <code className="action">Add a runtime software application</code>.
  </Tab>
</Tabs>
