...
<Region zones={['eu']}>
- An [OVHcloud web hosting plan](/links/web/hosting), with the exception of a Cloud Web hosting plan
</Region>
...
On the right-hand side of <code className="action">Global PHP version</code> located almost in the center of the page, click the <code className="action">...</code> button, then <code className="action">Modify configuration</code>.
    ...
    If neither a *.ovhconfig* file nor a *.htaccess* file configures a PHP version, the default preconfigured PHP version applies to your web hosting plan.
