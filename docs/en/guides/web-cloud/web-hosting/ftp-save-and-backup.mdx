...
<Region zones={['eu']}>
- A [Web Hosting plan](/links/web/hosting) (please note that this does not work with Cloud Web).
</Region>
<Region zones={['ca', 'apac']}>
- A [Web Hosting plan](/links/web/hosting).
</Region>
...
There are several stages to this procedure. Ensure that you have your FTP user password, which provides you with access to your storage space. 
