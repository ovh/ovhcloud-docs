...
To identify these security vulnerabilities, analyse the [web logs](/guides/web-cloud/web-hosting/logs-and-statistics) of your web hosting plan, or contact a [specialised provider](/links/partner) to perform a security audit on your websites.
