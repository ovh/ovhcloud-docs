...
:::info
The following URL lets you automatically obtain the correct rights for this guide: [https://auth.eu.ovhcloud.com/api/createToken?GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs](https://auth.eu.ovhcloud.com/api/createToken?GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs).
:::
...
The API console will let you discover other methods ([https://api.ovh.com/console/#/sms](https://api.ovh.com/console/#/sms)) to facilitate the integration of services such as: SMS responses, bulk sending with a CSV file, mail merge, delivery receipt tracking, etc.
