...
<CreateToken rights="GET=/sms&GET=/sms/*&GET=/sms/*/jobs&POST=/sms/*/jobs">OVHcloud token creation page</CreateToken> (this URL will automatically give you the correct rights for the steps described in this guide).
