...
The following API lets you update some domain name setup, including the name server type.
...
This call retrieves the technical details of the name server, like the `host` or the associated `ip` if it is a **glue record** (cf. [glue records declaration](#glue-records-declaration)).
