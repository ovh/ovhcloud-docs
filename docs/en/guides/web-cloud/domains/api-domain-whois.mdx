...
Beyond the disclosure of data on the Whois, OVHcloud lets you obfuscate the email addresses
...
The following API returns the email obfuscation rules that apply on a domain name.
...
The following API retrieves the obfuscation configuration applied on a domain name.
...
The following API updates the email obfuscation configuration applied on a domain name.
