...
For an OVHcloud email solution, the minimum SPF record is simply the **Include OVH email servers** box ticked — this produces `v=spf1 include:mx.ovh.ca ~all` (see [OVHcloud SPF configuration for shared email offers](#ovhcloudspfvalue)).
