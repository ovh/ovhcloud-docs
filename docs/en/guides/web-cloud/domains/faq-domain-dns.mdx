...
Do not hesitate to create a support ticket from the [Help Centre](/links/support-contact) if needed.
...
:::info
Once cancellation is requested, you can expedite the deletion by creating a support ticket from the [Help Centre](/links/support-contact). Supporting documents will need to be provided to accelerate this deletion.
...
After confirming the two points above, if you still cannot retrieve the holder validation email, we recommend opening a support ticket from the [Help Centre](/links/support-contact) to request the email to be resent.
...
If in doubt, we recommend opening a support ticket from the [Help Centre](/links/support-contact) specifying the domain name and the concerned web hosting.
...
Perform a [contact recovery procedure](/links/transversal/procedure-contact-change) to have your domain name fully managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. This way, you will no longer need to contact the person who previously managed your domain name.
...
If you encounter an error, we recommend opening a support ticket from the [Help Centre](/links/support-contact), specifying the following information:
...
<Tabs>
  ...
  <Tab label="Step 2">
    ...
    **Case #2** - The concerned domain name does not appear in the list:
    ...
    In this situation and if you do not know this other customer account ID, we recommend opening a support ticket from the [Help Centre](/links/support-contact) to regain management of the DNS zone.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Step 2">
    **Case #1** - The domain name does not appear in the list:
    ...
    - The domain name is registered with OVHcloud: You can perform a [contact recovery procedure](/links/transversal/procedure-contact-change) so that your domain name is managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
    ...
    **Case #2** - The domain name appears in the list:
    ...
    You can then perform a [contact recovery procedure](/links/transversal/procedure-contact-change) so that your domain name is fully managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
  </Tab>
</Tabs>
