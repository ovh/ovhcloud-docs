...
Once you have made your choices, click <code className="action">Continue</code>.
  ...
  <Tab label="Step 6">
    ...
    For details on how to confirm or decline the request from the email you receive, see [Confirming a change of holder or an outgoing transfer](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
  </Tab>
</Tabs>
...
- If the current holder's email address is obsolete or inaccessible, you can **in this case** contact our support team by creating a ticket from your [OVHcloud Help Centre](/links/support-contact).
...
[Confirming a change of holder or an outgoing transfer](/guides/web-cloud/domains/confirm-holder-change-or-transfer)
