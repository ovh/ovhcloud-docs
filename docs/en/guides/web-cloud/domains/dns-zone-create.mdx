...
In the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, open the `Web Cloud` section and click <code className="action">DNS zones</code>. Then click the <code className="action">Order</code> button.
