...
These conventions change nothing in the way you phrase your requests: you never have to remember or type these names. Describe what you want in plain language ("list my domain names", "show the status of the mydomain.ovh zone") and the agent picks the matching tool itself. Knowing them only helps you understand which tool the agent announces before calling it, and point it in the right direction when it cannot find an operation.
