...
- You have an active <Tooltip term="dnsZone">DNS zone</Tooltip> for your domain name. If you need further guidance, please refer to our guide on "[Creating an OVHcloud DNS zone](/guides/web-cloud/domains/dns-zone-create)".
...
- The email servers (DNS records of type <Tooltip term="mxRecord">*MX*</Tooltip>) to which your subdomain must redirect the emails it receives. This allows you to view them on your custom email address(es) with your subdomain.
- Information related to the security/authentication of your services (web hosting, web server, email, etc.) associated with one of your subdomains (DNS records of type <Tooltip term="spf">*SPF*</Tooltip>, <Tooltip term="dkim">*DKIM*</Tooltip>, <Tooltip term="dmarc">*DMARC*</Tooltip>, etc.).

:::info
Modifying a DNS zone associated with a domain name will take between **4** and **24** hours to <Tooltip term="dnsPropagation">propagate</Tooltip> fully.
