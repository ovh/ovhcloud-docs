...
The embed code is generated automatically by Video Center for each video, from its detail page. Click the tabs below to display each of the **3** steps in turn.
...
Click the video you want to embed to open its detail page.
...
- **Open the HTML file of your page**: in your code editor (VS Code, Dreamweaver, etc.), open the page where you want to display the video.
