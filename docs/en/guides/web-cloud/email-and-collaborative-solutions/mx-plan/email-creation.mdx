...
On MX Plan services using the Zimbra or OWA webmail, deleting an account is referred to as *resetting an account*.
...
<Region zones={['eu']}>
See all of our email solutions, [Zimbra](/links/web/zimbra) or [Exchange](https://www.ovhcloud.com/en-gb/emails-exchange/), to complete your MX Plan solution on the same domain name.
</Region>
