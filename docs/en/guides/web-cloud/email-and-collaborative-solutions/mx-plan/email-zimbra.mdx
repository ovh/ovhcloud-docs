...
:::info
After entering your email address and password on the webmail login page, you are redirected to the **Zimbra** login window, where you need to enter your credentials again. In this window, the **Username** field corresponds to your **full email address**, not a separate username.
:::

<img className="thumbnail" alt="Zimbra login window" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-login-window.png" loading="lazy" />
...
- **Send as**: The delegate can send an email with your email address, it will appear as if you had sent it yourself. The recipient will not see the delegate's email address.
