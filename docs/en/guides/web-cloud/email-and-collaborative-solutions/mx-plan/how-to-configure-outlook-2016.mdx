...
Email addresses from the **MX Plan** and [Zimbra Starter](/links/web/zimbra) offer can be configured on a compatible email client. This allows you to send and receive messages from your preferred application.
...
- Have an OVHcloud email solution already configured, from the following:
    ...
    <Region zones={['eu']}>
    - [Zimbra](/links/web/zimbra) Starter (**only**).
    </Region>
