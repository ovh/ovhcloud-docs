...
The email addresses from the **MX Plan** and [Zimbra Starter](/links/web/zimbra) offers can be configured on a compatible email client. This allows you to send and receive messages from your preferred application.
...
- You have an OVHcloud email solution such as:
    ...
    <Region zones={['eu']}>
    - [Zimbra](/links/web/zimbra) Starter.
    </Region>
