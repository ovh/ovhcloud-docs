...
:::warning
Filter management depends on the webmail your MX Plan service uses:

- **Roundcube**: from the OVHcloud Control Panel, as described below.
- **OWA**: from the webmail. Follow our guide on [Creating inbox rules in OWA (MX Plan)](/guides/web-cloud/email-and-collaborative-solutions/using-the-outlook-web-app-webmail/creating-inbox-rules-in-owa-mx-plan).
- **Zimbra**: from the webmail. See the [Filters](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra#filters) section of our Zimbra webmail guide.

To find out which webmail your service uses, follow our guide on [Getting started with the MX Plan solution](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities#instructions).
...
:::warning
In our example, we will mention [SPAM] as it appears in the subject line of an email. It is added automatically when the receiving server’s anti-spam solution delivers emails that it considers unwanted directly to the inbox. This is the case with MX Plan services using the Roundcube webmail.
