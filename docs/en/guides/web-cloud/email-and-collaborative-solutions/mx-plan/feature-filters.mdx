...
- **OWA**: from the webmail itself. Follow our guide on [Creating inbox rules in OWA (MX Plan)](/guides/web-cloud/email-and-collaborative-solutions/using-the-outlook-web-app-webmail/creating-inbox-rules-in-owa-mx-plan).
- **Zimbra**: from the webmail itself. See the [Filters](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra#filters) section of our Zimbra webmail guide.
