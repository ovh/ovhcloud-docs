...
<Tabs>
  <Tab label="First configuration">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />|Select <code className="action">Add Email Address</code>|
  </Tab>
  <Tab label="Existing configuration">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />|1. Go to the menu at the top left of the screen<br/><br/>2.Select <code className="action">Settings</code><br/><br/>3.Select <code className="action">Add Account</code>|
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Step 5">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-android/mxplan-android-05.png" loading="lazy" />|Complete the "**Incoming server settings**"<br/><br/>- **Username**: Your full email address<br/>- **Password**: Your email password<br/>- **Server**: enter the server name listed below |
  </Tab>
  <Tab label="Step 6">
    | | |
    |---|---|
    |<img className="thumbnail" alt="mxplan" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-android/mxplan-android-06.png" loading="lazy" />|Complete the "**Outgoing server settings**"<br/><br/>- **Username**: Your full email address<br/>- **Password**: Your email password<br/>- **SMTP server**: enter the server name listed below |
  </Tab>
  <Tab label="Step 7">
    | | |
    |---|---|
