...
Once you have configured your accounts, you can start using them straight away. To do this, OVHcloud offers a web application, available [here](https://www.ovhcloud.com/en-gb/mail/). You will need to enter your email address and password to log in.
