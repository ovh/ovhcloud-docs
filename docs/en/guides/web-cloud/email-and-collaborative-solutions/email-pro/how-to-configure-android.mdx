...
<Tabs>
  <Tab label="First configuration">
    Select <code className="action">Add email address</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Existing configuration">
    ...
    3. Select <code className="action">Add account</code>.<br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
