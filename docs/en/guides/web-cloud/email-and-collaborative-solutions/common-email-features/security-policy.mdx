...
:::info
If you do not see the <code className="action">More</code> tab appear in the control panel of your <code className="action">MX Plan</code> service, this means that your service uses the Roundcube webmail. Security policy management is not available on MX Plan services using Roundcube.
...
<Region zones={['ca']}>
Once this information has been entered, you can save these changes for the Email solution by clicking on <code className="action">Next</code>, then <code className="action">Confirm</code>. For the Exchange solution, click <code className="action">Save changes</code>.
</Region>

<Region zones={['apac']}>
Once this information has been entered, you can save these changes by clicking on <code className="action">Next</code>, then <code className="action">Confirm</code>.
</Region>
...
- **Prevent password change**: Allows you to enforce a minimum lifetime for your Exchange accounts’ passwords. This means that users will have to wait a certain number of days before they can change their passwords.
- **Maximum password duration**: Allows you to enforce a maximum lifetime for your Exchange accounts’ passwords. This means that users will be forced to change their passwords once this time limit is reached.
...
- **Minimum password length**: Allows you to set a minimum size for password length when a user wants to change it.
