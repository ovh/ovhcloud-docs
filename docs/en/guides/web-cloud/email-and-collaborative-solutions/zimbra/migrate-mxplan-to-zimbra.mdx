...
2. **[Delete the original MX Plan account and reassign its address to the Zimbra account](#step2)**
    - [2.1 - Deletion of the original MX Plan email address](#step21)
...
<Tabs>
  <Tab label="Step 1">
    **Create a migration project**
    ...
    <img className="thumbnail" alt="OVHcloud Mail Migrator home page" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Step 2">
    **Create the migration**
    ...
    <img className="thumbnail" alt="Creating the MX Plan to Zimbra migration in the OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Deletion of the original MX Plan email address <a name="step21"></a>
