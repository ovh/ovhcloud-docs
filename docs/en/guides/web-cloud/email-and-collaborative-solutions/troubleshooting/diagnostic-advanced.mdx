...
<ZoneTabs>
  <Tab label="MX Plan email account">
    For an **MX Plan** solution, go to [the MX Plan guides page](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan) and check your email client configuration using the guides available in the `Setting up an email application on your computer` or `Setting up an email application on your mobile device` section, depending on the device you are using.
  </Tab>
  <Tab label="Email Pro" availableIn={['eu']}>
    For an **Email Pro** solution, go to [the Email Pro guides page](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro) and check your email client configuration using the guides available in the `Setting up an email application on your computer` or `Setting up an email application on your mobile device` section, depending on the device you are using.
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    For an **Exchange** solution, go to [the Microsoft Exchange guides page](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange) and check your email client configuration using the guides available in the `Setting up an email application on your computer` or `Setting up an email application on your mobile device` section, depending on the device you are using.
  </Tab>
  <Tab label="Zimbra" availableIn={['eu']}>
