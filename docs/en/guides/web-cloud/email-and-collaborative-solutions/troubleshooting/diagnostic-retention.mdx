...
- An OVHcloud email solution:
    <Region zones={['eu']}>
    - **MX Plan** ([Zimbra and OWA only](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities)), available as part of our [web hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/) or included in a [free hosting](https://www.ovhcloud.com/en-gb/domains/free-web-hosting/)
    </Region>
    <Region zones={['ca']}>
    - **MX Plan** ([Zimbra and OWA only](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities)), available as part of our [web hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/)
    </Region>
    <Region zones={['eu', 'ca']}>
