...
<img className="thumbnail" alt="Android Exchange" src="/images/assets/screens/email-clients/android/emailpro-android-00.png" loading="lazy" />
...
<Tabs>
  <Tab label="First configuration">
    ...
    <img className="thumbnail" alt="Android Exchange" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Existing configuration">
    ...
    <img className="thumbnail" alt="Android Exchange" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
