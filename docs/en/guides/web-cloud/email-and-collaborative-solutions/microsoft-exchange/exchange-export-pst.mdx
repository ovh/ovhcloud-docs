...
This feature is available for <Region zones={['eu']}>Hosted Exchange, Private Exchange and Trusted Exchange</Region><Region zones={['ca']}>Hosted Exchange</Region>. It applies to individual mailboxes: groups, shared accounts and resource accounts cannot be exported.
...
- A <Region zones={['eu']}>[Hosted Exchange](/links/web/emails-hosted-exchange), [Private Exchange](/links/web/emails-private-exchange) or [Trusted Exchange](/links/web/emails-trusted-exchange)</Region><Region zones={['ca']}>[Hosted Exchange](/links/web/emails-hosted-exchange)</Region> service
