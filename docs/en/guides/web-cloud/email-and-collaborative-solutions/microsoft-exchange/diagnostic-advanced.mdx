...
<img className="thumbnail" alt="Exchange Diagnostic" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-01.png" loading="lazy" />

The diagnostic routine will take approximately 3 to 10 minutes to complete. Below is an example output of the results:

<img className="thumbnail" alt="Exchange Diagnostic" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/exchange-diagnostic-02.png" loading="lazy" />
...
This error indicates a general email sending failure which may have several causes:
