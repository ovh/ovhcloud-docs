...
> **PoC demo — Region EU only block.** This paragraph is wrapped in `<Region zones={['eu']}>` and only renders when the visitor is in the Europe zone.

</Region>

<Region zones={['ca', 'apac']}>

> **PoC demo — non-EU block.** This paragraph only renders for Canada/US and Asia/Pacific zones.
