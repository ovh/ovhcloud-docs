...
In the diagram below, the email service ([Exchange](https://www.ovhcloud.com/en-gb/emails-exchange/) or [Email Pro](https://www.ovhcloud.com/en-gb/emails/email-pro/)) is represented by the contents of the green frame.

</Region>

<Region zones={['ca']}>

In the diagram below, the email service ([Exchange](https://www.ovhcloud.com/en-gb/emails-exchange/)) is represented by the contents of the green frame.
