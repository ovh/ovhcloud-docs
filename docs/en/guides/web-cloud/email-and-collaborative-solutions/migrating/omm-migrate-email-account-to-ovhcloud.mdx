...
<img className="thumbnail" alt="Creating a new migration in the OVHcloud Mail Migrator, step 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
