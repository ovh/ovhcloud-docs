...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open the management section of your [vRack](/links/network/vrack). Verify the Additional IP address used by the Nutanix Cluster.
