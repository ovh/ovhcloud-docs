...
<Tabs>
  ...
  <Tab label="IPv6">
    :::warning
    By default, the IPv6 block delivered with your Dedicated Cloud is not activated, so you will need to open a [support request](/links/support-contact) to request its activation.
    :::
