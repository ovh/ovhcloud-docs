...
[[cpnav:privatecloud-vmware-vsphere|en]]
...
<code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX.XXX.XXX.XXX</code> > <code className="action">Users</code> > <code className="action">Modify</code> then enable the <code className="action">NSX Interface</code> button.
...
Click: <code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX-XXX-XXX-XXX</code> > <code className="action">Users</code> > <code className="action">Modify</code>.
...
All that is left to do is modify the rights for each desired Datacenter by clicking: <code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX-XXX-XXX-XXX</code> > <code className="action">Users</code> > <code className="action">View/Edit the rights for each DC</code> > <code className="action">Modify</code>.
...
Still from your Hosted Private Cloud tree, click <code className="action">Managed VMware vSphere</code> > <code className="action">PCC-XXX-XXX-XXX-XXX</code>.
<br/><br/>
