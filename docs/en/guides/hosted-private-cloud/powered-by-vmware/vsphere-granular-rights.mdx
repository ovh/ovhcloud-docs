...
In addition to [global datacenter rights](/guides/hosted-private-cloud/powered-by-vmware/vsphere-global-rights), you can assign granular rights to users on specific objects in your Hosted Private Cloud vSphere inventory (for example, a VM or datastore). This guide explains how to add and remove these rights through the OVHcloud API.
