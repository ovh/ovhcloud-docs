...
2. Fill in the fields with the `objectRightId` corresponding to the right you want to view.

3. Confirm the request. The response returns information about the right granted to the user on the vSphere object:
