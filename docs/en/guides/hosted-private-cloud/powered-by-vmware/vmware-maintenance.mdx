...
- You have access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or the <ApiLink>API console for your services</ApiLink>.
...
Select your infrastructure under <code className="action">Managed VMware vSphere</code> then click on the <code className="action">Operations</code> tab.
...
Chat on the Discord dedicated channel: [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud) or join our [community of users](/links/community).
