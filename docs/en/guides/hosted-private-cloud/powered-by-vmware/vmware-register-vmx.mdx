...
In your [vSphere interface](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection), go to the <code className="action">Storage</code> view.
