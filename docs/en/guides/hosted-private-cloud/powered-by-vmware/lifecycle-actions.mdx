...
- a [Hosted Private Cloud solution powered by VMware](/links/hosted-private-cloud/enterprise)
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>
- Access to the <ApiLink>OVHcloud API</ApiLink>. If required, please refer to our guide on [Getting started with OVHcloud](/guides/manage-and-operate/api/first-steps) APIs.
...
Open the OVHcloud APIv6, referring to our guide on [Getting started with the OVHcloud API](/guides/manage-and-operate/api/first-steps) if needed.
...
Click on the <code className="action">Hosted Private Cloud</code> tab and select your service from the <code className="action">Managed VMware vSphere</code> list.
