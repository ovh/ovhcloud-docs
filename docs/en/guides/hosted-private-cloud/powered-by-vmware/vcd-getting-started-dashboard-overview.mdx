...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Datacenters Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_datacenter.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Applications Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_application.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Network Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_networking.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Content Hub Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_content-hub.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Administration Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_administration.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Monitoring Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_monitor.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="More options Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_more.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Overview Magnifier" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_loupe.mp4" />
