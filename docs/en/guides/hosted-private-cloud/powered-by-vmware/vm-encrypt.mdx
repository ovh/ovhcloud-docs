...
Click <code className="action">Managed VMware vSphere</code> in the services bar on the left-hand side, then select the VMware service concerned.
...
If you are having problems configuring your external KMS, please contact our [support teams](/links/support-contact) or consider using an OVHcloud KMS (OKMS).
