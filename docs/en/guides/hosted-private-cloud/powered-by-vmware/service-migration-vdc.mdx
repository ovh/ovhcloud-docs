...
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> (<code className="action">Managed VMware vSphere</code> in the <code className="action">Hosted Private Cloud</code> section)
...
- **Step 1.1:** [Choose between the different VMware on OVHcloud ranges](#step-11-choose-between-the-different-vmware-on-ovhcloud-ranges)
- **Step 1.2:** [Select your hosts (compute)](#step-12-select-your-hosts-compute)
- **Step 1.3:** [Select your datastores (storage)](#step-13-select-your-datastores-storage)
...
- **Step 2.1:** [Add a new destination vDC](#step-21-add-a-new-destination-vdc)
- **Step 2.2:** [Add new hosts and Datastores](#step-22-add-new-hosts-and-datastores)
- **Step 2.3:** [Convert a datastore to a global datastore](#step-23-convert-a-datastore-to-a-global-datastore)
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="add a Virtual Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/service-migration-vdc/add-vDC.mp4" />
...
- **Step 3.1:** [Check inherited characteristics (Certifications, KMS, access restrictions)](#step-31-check-inherited-characteristics-certifications-kms-access-restrictions)
  - **Step 3.1.1:** [Certifications](#step-311-certifications)
  - **Step 3.1.2:** [Key Management Server (KMS)](#step-312-key-management-server-kms)
  - **Step 3.1.3:** [Access restrictions](#step-313-access-restrictions)
- **Step 3.2:** [Assign users rights](#step-32-assign-users-rights)
- **Step 3.3:** [Activate Veeam Managed Backup & Zerto Disaster Recovery Options](#step-33-activate-veeam-managed-backup--zerto-disaster-recovery-options)
- **Step 3.4:** [Check your network (vRack, Public IP)](#step-34-check-your-network-vrack-public-ip)
  - **Step 3.4.1:** [vRack](#step-341-vrack)
  - **Step 3.4.2:** [Public network](#step-342-public-network)
...
- **Step 4.1:** [Reconfigure VMware High Availability (HA)](#step-41-reconfigure-vmware-high-availability-ha)
- **Step 4.2:** [Reconfigure VMware Distributed Resource Scheduler (DRS)](#step-42-reconfigure-vmware-distributed-resource-scheduler-drs)
- **Step 4.3:** [Rebuild resource pools](#step-43-rebuild-resource-pools)
- **Step 4.4:** [Recreate Datastores Clusters (if relevant)](#step-44-recreate-datastores-clusters-if-relevant)
- **Step 4.5:** [Enable vSAN (if relevant)](#step-45-enable-vsan-if-relevant)
- **Step 4.6:** [Recreate vSphere networking](#step-46-recreate-vsphere-networking)
- **Step 4.7:** [Check inventory organisation (if relevant)](#step-47-check-inventory-organisation-if-relevant)
- **Step 4.8:** [Migrate NSX-V to NSX (if applicable)](#step-48-migrate-nsx-v-to-nsx-if-applicable)
  - **Step 4.8.1:** [NSX Distributed Firewall](#step-481-nsx-distributed-firewall)
  - **Step 4.8.2:** [NSX Distributed Logical Router](#step-482-nsx-distributed-logical-router)
  - **Step 4.8.3:** [NSX Edges](#step-483-nsx-edges)
    - **Step 4.8.3.1:** [Create T1 and segments](#step-4831-create-t1-and-segments)
    - **Step 4.8.3.2:** [DHCP](#step-4832-dhcp)
    - **Step 4.8.3.3:** [DNS](#step-4833-dns)
    - **Step 4.8.3.4:** [NAT Rules](#step-4834-nat-rules)
    - **Step 4.8.3.5:** [NSX Load Balancing](#step-4835-nsx-load-balancing)
    - **Step 4.8.3.6:** [T0 T1 Gateway Firewall](#step-4836-t0-t1-gateway-firewall)
    - **Step 4.8.3.7:** [VPN](#step-4837-vpn)
      - **Step 4.8.3.7.1:** [IPSec](#step-48371-ipsec)
      - **Step 4.8.3.7.2:** [SSL VPN](#step-48372-ssl-vpn)
    - **Step 4.8.3.8:** [Reconfiguration of the Initial IP Block](#step-4838-reconfiguration-of-the-initial-ip-block)
- **Step 4.9:** [Extend Zerto Disaster Recovery Protection (if relevant)](#step-49-extend-zerto-disaster-recovery-protection-if-relevant)
  - **Step 4.9.1:** [VPG as Source](#step-491-vpg-as-source)
  - **Step 4.9.2:** [VPG as Destination](#step-492-vpg-as-destination)
...
- **Step 5.1:** [Storage Motion](#step-51-storage-motion)
- **Step 5.2:** [vMotion](#step-52-vmotion)
...
- **Step 6.1:** [Reconfigure Veeam Managed Backup (if relevant)](#step-61-reconfigure-veeam-managed-backup-if-relevant)
- **Step 6.2:** [Reconfigure Zerto Disaster Recovery (if relevant)](#step-62-reconfigure-zerto-disaster-recovery-if-relevant)
- **Step 6.3:** [Recreate Affinity rules](#step-63-recreate-affinity-rules)
- **Step 6.4:** [Reconfigure the Private Gateway (if relevant)](#step-64-reconfigure-the-private-gateway-if-relevant)
- **Step 6.5:** [Put hosts in maintenance mode](#step-65-put-hosts-in-maintenance-mode)
- **Step 6.6:** [Remove old datastores](#step-66-remove-old-datastores)
- **Step 6.7:** [Remove old hosts](#step-67-remove-old-hosts)
- **Step 6.8:** [Remove vDC](#step-68-remove-vdc)
