...
You can check that the flow has been opened using the following API call: <Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/vrops/outgoingFlow/\{outgoingFlowId\}"} />
