...
In the user edit window, several checkboxes correspond to the global permissions.

1. Tick or untick the options according to the rights you want to grant to the user.
...
The user edit window offers the following checkboxes:
...
2. On the **Manage user rights by datacentre** page, locate the datacenter row. Click the <code className="action">...</code> menu (or <code className="action">Modify rights</code>) to edit the rights.
...
| Right       | Description                    |
|-------------|--------------------------------|
| Operator    | Reserved for OVHcloud admins   |
| None        | No access                      |
