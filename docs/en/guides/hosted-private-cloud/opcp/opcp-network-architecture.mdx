...
description: Understand how OPCP integrates into your network, learn the distinction between the data plane and the out-of-band (OOB) administration network, and identify which flows to allow depending on your service model.
...
<img className="thumbnail" alt="OPCP MINIPOD/FABRIC topology - 3 controllers" src="/images/hosted-private-cloud/opcp/opcp-network-architecture/opcp-3controllers-setup.png" loading="lazy" />
