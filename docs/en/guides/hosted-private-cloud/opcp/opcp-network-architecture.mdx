...
description: Understand how OPCP integrates into your network: data plane vs. out-of-band (OOB) administration network, and which flows to allow per service model.
