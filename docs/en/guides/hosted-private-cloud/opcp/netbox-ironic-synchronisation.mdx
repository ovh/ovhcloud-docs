---
title: How the Ironic to NetBox synchronisation works
...
Because NetBox is kept in sync with Ironic, it reflects the same reality as the OpenStack/Ironic view of your nodes. The node states described in [Node lifecycle](/guides/hosted-private-cloud/opcp/node-lifecycle) are therefore mirrored into NetBox.
...
How the position is determined, when automatic placement applies, and when manual positioning is kept as a fallback are explained in detail in the [How to handle the NetBox rack elevation](/guides/hosted-private-cloud/opcp/how-to-handle-rack-elevation) guide.
...
- [How to handle the NetBox rack elevation](/guides/hosted-private-cloud/opcp/how-to-handle-rack-elevation)
