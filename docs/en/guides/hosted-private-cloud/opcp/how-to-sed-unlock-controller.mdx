...
- An active [OPCP](https://www.ovhcloud.com/en-gb/hosted-private-cloud/onprem-cloud-platform/) platform.
- The SED password for the target server, provided by OVH team upon delivery.
