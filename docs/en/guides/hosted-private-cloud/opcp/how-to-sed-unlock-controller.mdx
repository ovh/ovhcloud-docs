...
There are three ways to trigger the unlock, depending on the access you have to the target server:
...
- An active [OPCP](https://www.ovhcloud.com/en-gb/hosted-private-cloud/onprem-cloud-platform/) service with SED drives configured.
...
Once connected, you can trigger the unlock from the PBA shell.
