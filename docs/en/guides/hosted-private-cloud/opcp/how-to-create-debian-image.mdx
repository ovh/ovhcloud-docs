---
title: Building a custom Debian image for OPCP
description: Find out how to create a custom Debian image for On-Prem Cloud Platform
lastUpdated: 2026-07-03
---

## Objective

This guide focuses on building customized Debian disk images for both OpenStack Ironic (bare metal) and Nova (compute) using [diskimage-builder](https://github.com/openstack/diskimage-builder).
