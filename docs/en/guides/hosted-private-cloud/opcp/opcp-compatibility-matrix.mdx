...
| Platform | Ironic software RAID | Ironic Active/Backup bonding | Ironic LACP (802.3ad) | Neutron trunking |
|---|---|---|---|---|
| [Debian 12](/guides/hosted-private-cloud/opcp/how-to-create-debian-image) | No | Yes | Yes | Yes |
| [Debian 13](/guides/hosted-private-cloud/opcp/how-to-create-debian-image) | No | Yes | Yes | Yes |
