...
description: Reference of OS images and platforms validated for OPCP Core bare metal provisioning — Ironic features, hardware qualification, and available documentation
...
|---|---|---|---|---|---|---|---|---|---|
| **Debian 12** | Yes | Yes | No | Yes | Yes | Yes | Yes | [Guide](/guides/hosted-private-cloud/opcp/how-to-create-image) | [Guide](/guides/hosted-private-cloud/opcp/how-to-setup-instance-from-api) |
| **Debian 13** | Yes | Yes | No | Yes | Yes | Yes | Yes | [Guide](/guides/hosted-private-cloud/opcp/how-to-create-image) | [Guide](/guides/hosted-private-cloud/opcp/how-to-setup-instance-from-api) |
...
The following platforms are known to work on top of a qualified base OS, without requiring direct Ironic-level qualification:

| Base OS | Compatible platforms |
|---|---|
| Debian 12 / Debian 13 | Proxmox |

## Go further

- [OPCP - How to create a custom OS image](/guides/hosted-private-cloud/opcp/how-to-create-image)
- [How to setup an instance using the OpenStack API](/guides/hosted-private-cloud/opcp/how-to-setup-instance-from-api)
