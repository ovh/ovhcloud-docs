...
| **CentOS Stream 8** | Yes | Yes | Yes | Yes |
...
| **CentOS Stream 8** | [Guide](/guides/hosted-private-cloud/opcp/how-to-create-centos-image) | No | Yes | Yes | Yes |
| **CentOS Stream 9** | [Guide](/guides/hosted-private-cloud/opcp/how-to-create-centos-image) | No | Yes | Yes | Yes |

### Certified OPCP third-party solutions

Certified OPCP third-party solutions are vendor software stacks validated to run on OPCP Core. Unlike the image build guides above, their deployment procedure is written and maintained by the vendor, not by OVHcloud.

| Solution | Guide | Ironic software RAID | Ironic Active/Backup bonding | Ironic LACP (802.3ad) | Neutron trunking | Maintained by |
|---|---|---|---|---|---|---|
| **Scality RING** | [Guide](/guides/hosted-private-cloud/opcp/how-to-deploy-scality-ring) | Yes | Yes | Yes | Yes | Scality |
