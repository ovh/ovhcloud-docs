...
| Solution | Category | Base OS | Guide | Maintained by |
|---|---|---|---|---|
| **Scality RING** | Object & file storage | Rocky Linux, RHEL | [Guide](/guides/hosted-private-cloud/opcp/how-to-deploy-scality-ring) | Scality |
