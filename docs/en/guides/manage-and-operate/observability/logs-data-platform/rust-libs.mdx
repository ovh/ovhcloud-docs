...
description: Send logs from your Rust applications to Logs Data Platform with gelf_logger or log4rs-gelf.
lastUpdated: 2024-08-07
---

## Objective

This guide will explain how to push your logs to Logs Data Platform using Rust with two different libraries. Use the one you prefer.
...
You could also look at the [generated API documentation](https://docs.rs/gelf_logger/*).
