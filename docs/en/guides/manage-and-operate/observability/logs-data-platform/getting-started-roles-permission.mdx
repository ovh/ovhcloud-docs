...
Role management can be automated by using the <ApiLink section="/dbaas/logs">OVHcloud API</ApiLink>.
...
Don't hesitate to <ApiLink section="/dbaas/logs">explore the API</ApiLink>, and try it with the provided console.
