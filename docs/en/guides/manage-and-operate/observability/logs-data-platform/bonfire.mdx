...
description: Query your Graylog searches from a command-line interface with Bonfire.
...
To avoid repeating arguments on the command line, you can create a config file (./bonfire.cfg or ~/.bonfire.cfg) to store where you want to connect:
