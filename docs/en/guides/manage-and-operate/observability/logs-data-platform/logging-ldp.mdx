...
description: Send logs from your Python 3.x applications to Logs Data Platform with logging-ldp.
...
- a facility to ensure fields suit the [LDP naming conventions](/guides/manage-and-operate/observability/logs-data-platform/field-naming-conventions).

## Requirements

To complete this guide you will need:

- Python 3, we recommend installing [pip](https://pip.pypa.io/en/stable/installing/).
