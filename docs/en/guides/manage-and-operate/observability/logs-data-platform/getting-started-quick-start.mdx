...
Creating a Logs Data Platform account is free: with its pay-as-you-go pricing you pay only for what you use.

To configure your account you have two choices:

- Use a username/password pair
- Use OVHcloud IAM to enable [IAM identities](/guides/account-and-service-management/account-information/ovhcloud-users-management) and [IAM policies](/guides/manage-and-operate/observability/logs-data-platform/iam-access-management).
...
- [Manage IAM Policies](/guides/manage-and-operate/observability/logs-data-platform/iam-access-management) to allow other users of the platform to view your dashboards or explore your streams themselves, rather than doing it for them.
