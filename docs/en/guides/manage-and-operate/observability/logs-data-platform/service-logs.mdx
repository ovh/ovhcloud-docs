...
You can also manage your logs subscription from a data stream point of view. To do so, click the <code className="action">Data stream</code> tab. In the table listing your streams you can see a `Subscriptions` column displaying how many logs subscriptions target a given stream.
