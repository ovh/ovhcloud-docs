...
description: Send logs from your Python 2.x applications to Logs Data Platform with Djehouty.
...
- Python 2, we recommend installing [pip](https://pip.pypa.io/en/stable/installing/).
