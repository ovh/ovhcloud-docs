...
- An [authentication method configured](/guides/manage-and-operate/kms/okms-authentification-method) for the OKMS data plane (this guide uses a Personal Access Token).
