...
Authenticate using a [Personal Access Token, service account, or access certificate](/guides/manage-and-operate/kms/okms-authentification-method). For HashiCorp Vault KV2 compliant API usage, a PAT or service account is recommended.
