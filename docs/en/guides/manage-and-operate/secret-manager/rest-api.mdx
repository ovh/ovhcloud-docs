...
- An [authentication method configured](/guides/manage-and-operate/kms/okms-authentification-method) for the OKMS data plane.
...
Authenticate using a [Personal Access Token, service account, or access certificate](/guides/manage-and-operate/kms/okms-authentification-method). For REST API usage, a PAT or service account is recommended.
