...
- [OVH provider](https://registry.terraform.io/providers/ovh/ovh/latest) that interacts with <ApiLink>OVHcloud API portal</ApiLink>. You can refer to [this guide](/guides/manage-and-operate/api/first-steps) to learn more on how to use the API portal. Furthermore, the OVH provider evolves as fast as the OVHcloud offering, be sure to follow the [releases](https://github.com/ovh/terraform-provider-ovh/releases).
- [OpenStack provider](https://registry.terraform.io/providers/terraform-provider-openstack/openstack/lastest) : the open standard cloud computing platform that OVHcloud is using to power its Public Cloud service. For more information, check [this page](/links/public-cloud/openstack).
...
- [Hashicorp vSphere provider](https://registry.terraform.io/providers/hashicorp/vsphere/latest) to automate the operations of [VMware on OVHcloud solutions](/links/hosted-private-cloud/enterprise).
...
- [Creating a private registry (Harbor) through Terraform](/guides/public-cloud/containers-orchestration/managed-private-registry/creation)
