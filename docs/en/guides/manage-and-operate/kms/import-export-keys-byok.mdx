...
- Your `okmsId` and your regional endpoint, both returned by <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> and displayed in the **General information** tab of your <ManagerLink to="/#/okms/key-management-service">OKMS domain dashboard</ManagerLink>.
