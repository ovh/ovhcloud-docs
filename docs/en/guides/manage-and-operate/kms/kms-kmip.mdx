...
- An [access certificate created](/guides/manage-and-operate/kms/okms-certificate-management) and [IAM policy configured](/guides/manage-and-operate/kms/okms-authentification-method) for KMIP access. KMIP only supports certificate-based authentication — see [OKMS authentication methods](/guides/manage-and-operate/kms/okms-authentification-method).
