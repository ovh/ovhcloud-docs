...
- An [authentication method configured](/guides/manage-and-operate/kms/okms-authentification-method) for the OKMS data plane (Personal Access Token, service account, or access certificate).
...
Authenticate using a [Personal Access Token, service account, or access certificate](/guides/manage-and-operate/kms/okms-authentification-method). For REST API usage, a PAT or service account is recommended. Access certificates are required for [KMIP](/guides/manage-and-operate/kms/kms-kmip) integrations.

To test API calls interactively, use the [OKMS Swagger UI](/guides/manage-and-operate/kms/okms-authentification-method#use-the-okms-swagger-ui) at `https://<region>.okms.ovh.net/swagger/`.
