...
| `--kmip-addr`   | Address of the KMIP server. Available in your <ManagerLink to="/#/okms/key-management-service">OKMS domain dashboard</ManagerLink>. (e.g., `eu-west-rbx.okms.ovh.net:5696`). | `""` (required)                  |
