...
<img className="thumbnail" alt="Creating an application" src="/images/manage-and-operate/api/api-right-delegation/createapp.png" loading="lazy" />

Once logged in, you will get your `Application Key` and `Application Secret`, later refered as `AK` and `AS`.

<img className="thumbnail" alt="Application Key and Application Secret" src="/images/manage-and-operate/api/api-right-delegation/ak-as.png" loading="lazy" />
...
<img className="thumbnail" alt="sequence diagram" src="/images/manage-and-operate/api/api-right-delegation/sequence01.png" loading="lazy" />
...
<img className="thumbnail" alt="rights confirmation" src="/images/manage-and-operate/api/api-right-delegation/validate-ck.png" loading="lazy" />
...
<img className="thumbnail" alt="sequence diagram" src="/images/manage-and-operate/api/api-right-delegation/sequence02.png" loading="lazy" />
