...
The APIs available at <ApiLink>OVHcloud API</ApiLink> allow you to buy, manage, update and configure OVHcloud products without using a graphical interface like the OVHcloud Control Panel.
...
A new section of the OVHcloud APIs is available under the prefix **/v2** on [https://api.eu.ovhcloud.com/v2](https://api.eu.ovhcloud.com/console/?branch=v2). 
...
You can see the list of versions available on the OVHcloud API console. To do this, open the [console](https://api.eu.ovhcloud.com/console/?section=%2Fiam&branch=v2#servers).
