...
In your <ManagerLink to="/#/public-cloud/pci/projects">Public Cloud project</ManagerLink>, go to the `Project Management` section and click on <code className="action">Quota & Regions</code>. Click on <code className="action">Contact Support</code>.
