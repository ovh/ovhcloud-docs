...
| Dashboards and alerts | Manual creation of dashboards and alert rules via the Grafana interface | JSON | **Inbound**: Import JSON files via API or interface. <br/> **Outgoing**: Export dashboards/alerts to JSON for migration. | [Dashboards - Capabilities and limitations](/guides/public-cloud/databases/grafana-capabilities) |
