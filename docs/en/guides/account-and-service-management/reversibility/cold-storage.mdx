...
- **Specific functionalities** whose migration cannot be guaranteed, as they are tied to the OVHcloud environment or involve specific developments.
...
|Feature|Description|Available formats|Migration model|Available documentation|
|---|---|---|---|---|
| **Anti-DDoS** | The anti-DDoS is a set of equipment and means put in place to absorb distributed denial of service attacks. It includes an analysis of traffic, the "aspiration" towards a specialized network, and mitigation, ensured by VAC technology developed by OVHcloud. | N/A | **Incoming**: The Anti-DDoS is a component of our infrastructure, enabled by default. No action is required.<br/><br/>**Outgoing**: Order and configure an anti-DDoS with the new provider. | [OVHcloud anti-DDoS protection](https://www.ovhcloud.com/en-gb/security/anti-ddos/)<br/><br/>[Anti-DDoS Technology](https://www.ovhcloud.com/en-gb/security/anti-ddos/) |
...
No termination fees apply. Data migration incurs no additional charge by default. Billing stops when the service is terminated. However, restoring data triggers a pricing change based on the current pricing of the target storage medium.
...
To retrieve their data, customers must first unarchive it, then download it from the restored bucket.<br/>
