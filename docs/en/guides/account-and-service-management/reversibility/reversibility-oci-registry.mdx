...
| Functionality | Description | Formats | Migration model | Documentation available |
| --- | --- | --- | --- | --- |
| **Managed via the OVHcloud Control Panel** | OVHcloud-specific graphical interface and API for service management | N/A | **Inbound**: N/A<br/>**Outbound**: Scripts/API to rewrite for the target, manual management required. | <ApiLink section="/allDom" regions={["eu"]}>OVHcloud API</ApiLink>|
