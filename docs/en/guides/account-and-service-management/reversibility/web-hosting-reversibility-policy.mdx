...
Billing is per year. No specific cancellation fee applies: deletion of the service will stop billing on the anniversary date. It is the customer’s responsibility to export their files, databases and configurations before deletion, as deletion is irreversible.
