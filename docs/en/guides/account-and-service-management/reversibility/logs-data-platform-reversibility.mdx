...
| Graylog Dashboards | Configuration of dashboards and searches saved by the client on the graylog interface | JSON | **Incoming**: use of Graylog APIs or Graylog User Interface. <br/>**Outgoing**: Use of Graylog APIs. | [Graylog documentation](https://go2docs.graylog.org/4-0/home.htm) |
