...
First, your service account must be able to access the required APIs. OVHcloud provides rights for each API call. To find out what permissions are required, you can go to the OVHcloud API console:
