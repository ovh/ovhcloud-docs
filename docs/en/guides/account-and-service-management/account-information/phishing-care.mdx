...
**Look for the OVHcloud logo in your inbox**

Several email services, including Gmail, Yahoo and Apple Mail with an iCloud.com address, display the OVHcloud logo next to the sender's name for emails sent by OVHcloud from an address ending with `ovhcloud.com`. In Gmail, a blue checkmark appears alongside it.

<img className="thumbnail" alt="OVHcloud logo displayed next to the sender's name" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

This logo is displayed by your email service, not by the message: a fraudulent email cannot reproduce it. Not every email service displays it yet, so its absence alone proves nothing: in that case, rely on the checks described below.

Next, check whether the email you received is also visible on the <ManagerLink to="/#/communication">My messages</ManagerLink> page. You will find copies of all official emails sent by OVHcloud there.
...
<img className="thumbnail" alt="Outlook Windows - identifying the version" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
