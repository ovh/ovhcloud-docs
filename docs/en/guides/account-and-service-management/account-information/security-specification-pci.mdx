...
You are authorized to perform vulnerability scans on the service you have subscribed to. OVHcloud does not need to be notified in advance.  
...
You need to activate and manage your tokens in order to access the Keystone API by following this [guide](/guides/public-cloud/cross-functional/managing-tokens).
