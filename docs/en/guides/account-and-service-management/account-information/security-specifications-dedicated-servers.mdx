...
| --- | --- | --- |
| Control Plane | Logs on all interactions made via API calls, launched by admin, technical or billing contacts, on the services they have access to. |- <ApiLink section="/me" method="GET" route={"/me/api/logs/self"} regions={["eu"]}>List of API calls done with your account</ApiLink><br/>- <ApiLink section="/me" method="GET" route={"/me/api/logs/services"} regions={["eu"]}>List of API calls done on services you have access to</ApiLink> |
| Service | List of tasks launched on a given server | <ApiLink section="/dedicated/server" method="GET" route={"/dedicated/server/\{serviceName\}/task"}>Dedicated Servers ToDos</ApiLink>|
| Service | List of interventions launched on a given server | <ApiLink section="/dedicated/server" method="GET" route={"/dedicated/server/\{serviceName\}/intervention"}>Technical interventions history</ApiLink> |
...
| --- | --- | --- |
| Control Plan and service | Manipulating customer accounts and services on which the account has service management rights | <ApiLink section="/dedicated/server">API calls for Dedicated Servers</ApiLink> |
...
- <ApiLink section="/dedicated/installationTemplate" method="GET" route={"/dedicated/installationTemplate/templateInfos"}>List of operating systems available at OVHcloud</ApiLink>
- <ApiLink section="/dedicated/server" method="GET" route={"/dedicated/server/osAvailabilities"}>List of operating systems available for a given business reference</ApiLink>
- <ApiLink section="/dedicated/server" method="GET" route={"/dedicated/server/\{serviceName\}/install/compatibleTemplates"}>List of operating systems available for a given server</ApiLink>
