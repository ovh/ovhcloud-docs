...
If you keep a Premier range host billed on an hourly basis for an entire month, the hourly price for the resource, as shown on [this page](/links/hosted-private-cloud/enterprise-hosts), will be applied. The hourly cost is no longer included in the monthly price.
...
Billing is based on the pricing table available on [this page](/links/hosted-private-cloud/enterprise-images-licenses). 
