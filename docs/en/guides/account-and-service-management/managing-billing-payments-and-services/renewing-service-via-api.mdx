...
To use the <ApiLink section="/service" method="GET" route={"/service/\{serviceId\}/renew"}>renewal API</ApiLink>, you will need your `serviceId`. You can get this information via the `serviceInfos` API, for example:
