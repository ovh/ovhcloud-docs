...
<Tabs>
  ...
  <Tab label="Windows Server 2019 and later">
    ...
    **Step 2: Open your server's network configuration**
    ...
    Open the Windows Start menu, type `ncpa.cpl`, then click the suggested search result.

    <img className="thumbnail" alt="Network Connections window in the Windows control panel" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_network_connections.png" loading="lazy" />
...
In any case, feel free to [contact our support team](/links/support-contact) and ask to review your configurations. You will need to provide:
