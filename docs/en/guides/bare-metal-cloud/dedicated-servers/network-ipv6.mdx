...
<Tabs>
  ...
  <Tab label="Windows Server 2019 and later">
    ...
    **Step 2: Open your server's network configuration**
    ...
    Click on the Windows Start menu and enter "ncpa.cpl" to trigger a search, click on the suggested search result. 

    <img className="thumbnail" alt="Network control panel" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_network_connections.png" loading="lazy" />
