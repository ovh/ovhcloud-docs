...
<Tabs>
  ...
  <Tab label="Via the OVHcloud API">
    On the <ApiLink>OVHcloud API page</ApiLink>, click on <code className="action">Login</code> in the top right-hand corner. On the next page, enter your OVHcloud credentials.
