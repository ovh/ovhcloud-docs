...
Go to the <ApiLink>API console</ApiLink> and use the API call below to change the announcement of the IP block.

<Api version="v1" section="/vrack" method="GET" route={"/vrack"} />

This API allows you to retrieve the list of vRack services. If you can't identify the service concerned with these references, they can be found in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
