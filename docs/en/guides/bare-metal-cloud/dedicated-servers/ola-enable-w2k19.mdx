---
title: How to configure NIC teaming for OVHcloud Link Aggregation (OLA) on Windows Server 2019
description: Configure NIC teaming for OVHcloud Link Aggregation (OLA) on your Windows Server 2019 server
