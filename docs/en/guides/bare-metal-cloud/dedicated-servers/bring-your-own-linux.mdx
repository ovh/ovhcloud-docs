...
| customizations/enableLacpBonding | Enable LACP to aggregate multiple network interfaces (if applicable)⁵ | ❌ |
...
⁵ For when this option applies and what it configures, see [Understanding link aggregation on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/link-aggregation-overview).
