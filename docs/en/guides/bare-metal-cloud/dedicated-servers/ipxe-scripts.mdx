...
With the <ApiLink>OVHcloud API</ApiLink>, you can define custom scripts.
...
You can now switch back to disk or rescue boot from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> (see our guide on [Activating and using rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)), or the <ApiLink>OVHcloud API</ApiLink>.
