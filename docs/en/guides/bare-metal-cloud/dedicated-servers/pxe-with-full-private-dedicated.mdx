...
The only significant difference is that [private networks](/guides/network/ovhcloud-connect/introduction) do not have access to everything that does not belong to your infrastructure.<br/>
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="iPXE in action" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/animation.mp4" />
