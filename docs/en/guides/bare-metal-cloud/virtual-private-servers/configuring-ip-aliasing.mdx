...
:::info
Across different distribution releases, the proper procedure to configure your network interface, as well as the file names, may change. We recommend consulting the manuals and knowledge resources of the respective OS versions if you experience any issues.
:::
...
<Tabs>
  <Tab label="Debian 11">
    **Step 1: Disable automatic network configuration**
    ...
    Creating this configuration file prevents your network configuration from changing automatically.
  ...
  <Tab label="Debian 12+, Ubuntu 22.04+">
    ...
    **Step 2: Edit the configuration file**
    ...
    Edit the file with the content below, replacing `NETWORK_INTERFACE` and `ADDITIONAL_IP` with your own values:
  ...
  <Tab label="Fedora / AlmaLinux (10) / Rocky Linux (10)">
    Fedora 43 & later, AlmaLinux & Rocky Linux (10)
