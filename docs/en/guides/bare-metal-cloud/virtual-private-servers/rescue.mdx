...
You can edit files under `/mnt` directly. To run commands from your VPS itself, switch into the mounted system with the following command. Those commands will then use the binaries and configuration files of the VPS rather than those of the rescue environment:
