...
Once downloaded, open your server <code className="action">Settings</code>, go to the <code className="action">File Manager</code> tab, and upload the `.jar` file to the `serverfiles` directory using <code className="action">Upload files</code> or drag and drop.

### Step 4 — Run the installer

Open the <code className="action">Terminal</code> tab from your server <code className="action">Settings</code> and run the appropriate command for your mod loader.
...
2. Open the <code className="action">File Manager</code> tab from your server <code className="action">Settings</code>.
