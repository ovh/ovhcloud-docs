...
Choose the game you want to host from the available list (40+ games) and click <code className="action">Select</code>. The configuration may vary depending on the game.
