...
description: Deploy and manage game servers on your OVHcloud VPS or dedicated server with the Game Panel. Supports 140+ titles including Minecraft, ARK, CS2, and Rust.
...
From your <ManagerLink to="/#/dedicated/vps">VPS management page</ManagerLink>, locate the game management feature linked to your server and click <code className="action">Open Panel</code> to access the Game Panel interface.
...
Choose the game you want to host from the available list (140+ games) and click <code className="action">Select</code>. The configuration may vary depending on the game.
...
- **View connected players** in real time (for supported games).
...
Depending on the game, you can configure options by clicking the <code className="action">Settings</code> button. The following tabs are available:
