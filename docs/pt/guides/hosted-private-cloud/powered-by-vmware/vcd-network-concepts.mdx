...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Public VCF as-a-ServiceControl Panel Network Overview Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-network-concepts/vcd_network_overview.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Public VCF as-a-Service Network IP Prefixe 02" src="/images/hosted-private-cloud/powered-by-vmware/vcd-network-concepts/vcd_network_ipspace.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Public VCF as-a-Service Network Datacenter Groups Overview Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-network-concepts/vcd_network_datacenter-groups_overview.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Public VCF as-a-Service Network Edge Overview Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-network-concepts/vcd_network_edge_overview.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Public VCF as-a-Service Network vApp Network Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-network-concepts/vcd_network_vapp.mp4" />
