...
Na sua [interface vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection), coloque-se na vista <code className="action">Storage</code>.
