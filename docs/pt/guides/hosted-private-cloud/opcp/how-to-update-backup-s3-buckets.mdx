...
- An operational [OPCP](https://www.ovhcloud.com/en-gb/hosted-private-cloud/onprem-cloud-platform/) infrastructure.
...
### 5. Verify the backup storage location
...
### 6. Re-initialize the Velero backup repositories
...
### 7. Trigger a first backup for each schedule
...
### 8. Verify the backups and the recreated repositories
...
### 10. Check that data has been written to the new buckets
