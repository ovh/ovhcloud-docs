...
![dashboard](/images/guides/hosted-private-cloud/opcp/node-lifecycle/01-log-to-horizon.png)
...
![server-status](/images/guides/hosted-private-cloud/opcp/node-lifecycle/02-server-status.png)
...
![node-lifecyle](/images/guides/hosted-private-cloud/opcp/node-lifecycle/03-node-lifecycle.png)
...
![server-manageable](/images/guides/hosted-private-cloud/opcp/node-lifecycle/03-server-status-to-manageable.png)
...
![server-available](/images/guides/hosted-private-cloud/opcp/node-lifecycle/03-server-status-to-available.png)
...
![Maintenance-on](/images/guides/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-on.png)
...
![Maintenance-reason](/images/guides/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-reason.png)

Once your maintenance operations are complete, you can disable maintenance:

![Maintenance-off](/images/guides/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-off.png)
