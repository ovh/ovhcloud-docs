...
- Conhecer o seu `okmsId` e o seu endpoint regional, ambos devolvidos por <ApiLink section="/okms" version="v2" method="GET" route={"/okms/resource"}>GET /okms/resource</ApiLink> e apresentados no separador **Informações gerais** do <ManagerLink to="/#/okms/key-management-service">dashboard do seu domínio OKMS</ManagerLink>.
