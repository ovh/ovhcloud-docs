...
| `--kmip-addr` | Endereço do servidor KMIP. Disponível no <ManagerLink to="/#/dedicated/security/kms">dashboard do seu domínio OKMS</ManagerLink>. (por exemplo: `eu-west-rbx.okms.ovh.net:5696`). | `""` (obrigatório) |
