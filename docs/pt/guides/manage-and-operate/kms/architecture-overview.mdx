...
As chaves criadas com o nível de proteção HSM são replicadas em três HSM físicos distintos. A sua localização exata depende da região selecionada para o OKMS.
