...
Para comunicar com o seu domínio OKMS, necessita de um certificado de acesso. Este é um dos três [métodos de autenticação OKMS](/guides/manage-and-operate/kms/okms-authentification-method); os certificados são **obrigatórios para KMIP** e recomendados quando é necessária autenticação de cliente mTLS. Para utilizar a API REST, um Personal Access Token (PAT) ou uma conta de serviço é normalmente mais simples de configurar.
