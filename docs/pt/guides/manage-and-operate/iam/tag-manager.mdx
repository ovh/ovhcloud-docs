...
![Tag Manager](/images/guides/manage-and-operate/iam/iam-tag-manager/tag-manager-01.png)
...
![Tag Manager](/images/guides/manage-and-operate/iam/iam-tag-manager/tag-manager-02.png)
...
![Tag Manager](/images/guides/manage-and-operate/iam/iam-tag-manager/baremetal-tag-01.png)

The tag management interface allows you to add or remove tags from the resource.

![Tag Manager](/images/guides/manage-and-operate/iam/iam-tag-manager/baremetal-tag-02.png)
