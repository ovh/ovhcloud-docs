...
- Um [método de autenticação configurado](/guides/manage-and-operate/kms/okms-authentification-method) para o plano de dados OKMS (este guia utiliza um Personal Access Token).
