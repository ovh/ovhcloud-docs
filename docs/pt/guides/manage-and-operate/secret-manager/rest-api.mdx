...
Autentique-se com um [Personal Access Token, conta de serviço ou certificado de acesso](/guides/manage-and-operate/kms/okms-authentification-method). Para utilizar a API REST, recomenda-se um PAT ou uma conta de serviço.
