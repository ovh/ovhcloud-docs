...
Following the related documentation on how to [authorize the suitable IP addresses](/guides/public-cloud/databases/postgresql-prepare-for-incoming-connections#configure-your-postgresql-instance-to-accept-incoming-connections), add your IPs to the authorized list.
