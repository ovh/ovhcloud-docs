...
<Tabs>
  <Tab label="Área de Cliente OVHcloud">
    Consulte o guia "[Criar uma instância a partir da Área de Cliente](/guides/public-cloud/compute/getting-started)". Durante a criação, escolha na etapa 5 um modo de rede e uma rede privada para a sua instância.
