...
We recommend consulting the following guides if you are creating an instance for the first time: [How to create a Public Cloud instance and connect to it](/guides/public-cloud/compute/getting-started) or [Creating an Instance via the Horizon interface](/guides/public-cloud/compute/create-instance-in-horizon).
