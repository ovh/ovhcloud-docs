...
| :----------- | :----------- | :--------- |
| Public Cloud - Compute | Área de cliente OVHcloud e API | [Compreender os logs da API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Block Storage | Área de cliente OVHcloud e API | [Compreender os logs da API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Network | Área de cliente OVHcloud e API | [Compreender os logs da API OpenStack](/guides/public-cloud/compute/openstack-api-logs) |
| Public Cloud - Managed Kubernetes Service | Área de cliente OVHcloud e API | [Managed Kubernetes Service Audit Logs Forwarding](/guides/public-cloud/containers-orchestration/managed-kubernetes/forwarding-audit-logs) |
