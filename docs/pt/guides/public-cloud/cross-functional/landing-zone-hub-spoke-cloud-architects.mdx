...
- **Link direto:** <ManagerLink to="/#/public-cloud/pci/projects">Projetos Public Cloud</ManagerLink>
...
Gere identificadores de API com o <CreateToken rights="GET=/*&POST=/*&PUT=/*&DELETE=/*">gerador de tokens API OVHcloud</CreateToken>. Armazene a Application Key, a Application Secret e a Consumer Key de forma segura — nunca no controlo de versões.
