...
:::info
Os comandos abaixo são idênticos, independentemente do procedimento seguido acima. Os valores de ficheiro, bloco e tamanho apresentados no exemplo de resultado correspondem ao exemplo ≤ 2 TB (um disco de 70 GB) utilizado anteriormente neste guia — se seguiu o procedimento > 2 TB, o seu próprio resultado apresentará valores mais elevados, refletindo o disco redimensionado, mas os passos permanecem os mesmos.
:::
