...
:::info
Os comandos abaixo são idênticos, independentemente do procedimento seguido acima. Os valores de ficheiro, bloco e tamanho apresentados no exemplo de resultado correspondem ao exemplo de partições até 2 TB (um disco de 70 GB) utilizado anteriormente neste guia. Se seguiu o procedimento para partições superiores a 2 TB, o seu próprio resultado apresentará valores mais elevados, refletindo o disco redimensionado, mas os passos permanecem os mesmos.
:::
