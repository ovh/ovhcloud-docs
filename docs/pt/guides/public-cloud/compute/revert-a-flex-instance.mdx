...
Também pode [editar a configuração da instância](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#editar-a-configuração-de-uma-instância) a partir da Área de Cliente.
