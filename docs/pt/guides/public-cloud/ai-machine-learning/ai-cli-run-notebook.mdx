...
:::info
The list of available flavors depends on the region you are logged into (`ovhai config set <region>`). Run `ovhai capabilities flavor list` again after switching region to check.
:::
