...
Irá aparecer uma tabela. Esta última apresenta a zona DNS do seu nome de domínio na OVHcloud. É constituída por vários registos, todos simbolizados por uma linha da tabela.
