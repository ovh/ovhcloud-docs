...
<Tabs>
  ...
  <Tab label="Etapa 2">
    ...
    - **TXT**: para o <Tooltip term="spf">SPF</Tooltip> (junte-o caso já exista um registo SPF).
...
Para melhorar a entregabilidade dos seus e-mails e evitar que as suas mensagens sejam recebidas como spam, adicione um registo <Tooltip term="dmarc">**DMARC**</Tooltip>.
...
Siga as instruções da página "Add a domain you own to iCloud Mail on iCloud.com" da [documentação oficial da Apple](https://support.apple.com/pt-pt/guide/icloud/mma473945269/icloud). Concentre-se na secção "Step 4: Finish setting up the domain".
