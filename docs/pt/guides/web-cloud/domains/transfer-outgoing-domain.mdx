...
Consoante a extensão, poderá receber um e-mail da OVHcloud a solicitar que confirme a transferência de saída antes de esta poder prosseguir. Consulte [Confirmar uma alteração de titular ou uma transferência de saída](/guides/web-cloud/domains/confirm-holder-change-or-transfer).
