...
- Ter uma <Tooltip term="dnsZone">zona DNS</Tooltip> ativa para o seu nome de domínio. Se necessário, consulte o guia "[Criar uma zona DNS OVHcloud](/guides/web-cloud/domains/dns-zone-create)";
...
- Os servidores de e-mail (registos DNS do tipo <Tooltip term="mxRecord">*MX*</Tooltip>) para os quais o subdomínio deve reencaminhar os e-mails que recebe. Isto permite-lhe consultá-los no(s) seu(s) endereço(s) de e-mail(s) personalizado(s) com o seu subdomínio.
- Informações relacionadas com a segurança / autenticação dos seus serviços (alojamento web, servidor web, e-mail, etc.) associados a um dos seus subdomínios (registos DNS do tipo <Tooltip term="spf">*SPF*</Tooltip>, <Tooltip term="dkim">*DKIM*</Tooltip>, <Tooltip term="dmarc">*DMARC*</Tooltip>, etc.).

:::info
A modificação de uma zona DNS associada a um nome de domínio implica um prazo de <Tooltip term="dnsPropagation">propagação</Tooltip> de **4** a **24** para que esta última seja efetiva.
