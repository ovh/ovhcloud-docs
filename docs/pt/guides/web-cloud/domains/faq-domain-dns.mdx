...
Não hesite em criar um ticket de assistência a partir do [centro de ajuda](/links/support-contact) se necessário.
...
:::info
Depois de solicitada a rescisão, pode acelerar a eliminação criando um ticket de assistência a partir do [centro de ajuda](/links/support-contact). Serão necessários documentos comprovativos para acelerar esta eliminação.
...
Depois de ter verificado e confirmado os dois pontos acima, se ainda não conseguir recuperar o e-mail de validação do titular, convidamo-lo a abrir um ticket de assistência a partir do [centro de ajuda](/links/support-contact) para solicitar o reenvio deste e-mail.
...
Em caso de dúvida, convidamo-lo a abrir um ticket de assistência a partir do [centro de ajuda](/links/support-contact) indicando o nome de domínio e o alojamento web em questão.
...
Efetue um [procedimento de recuperação de contactos](/links/transversal/procedure-contact-change) para que o seu nome de domínio seja integralmente gerido na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Assim, já não precisará de contactar a pessoa que geria anteriormente o seu nome de domínio.
...
Em caso de erro, convidamo-lo a abrir um ticket de assistência a partir do [centro de ajuda](/links/support-contact) indicando as seguintes informações:
...
<Tabs>
  ...
  <Tab label="Passo 2">
    ...
    **Caso n.º 2** - O nome de domínio em questão não aparece na lista:
    ...
    Nesta situação, se não conhecer este outro identificador de cliente, convidamo-lo a abrir um ticket de assistência a partir do [centro de ajuda](/links/support-contact) para recuperar a gestão da zona DNS.
  </Tab>
</Tabs>
