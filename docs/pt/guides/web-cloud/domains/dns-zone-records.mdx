...
<Tabs>
  ...
  <Tab label="AAAA">
    4 letras **A**, pois este registo está codificado em quatro vezes mais bits que o registo histórico de apontamento **A**.<br/><br/>
  ...
  <Tab label="NS">
    **N**ame **S**erver<br/><br/>
    ...
    Define os servidores DNS associados à sua zona DNS. Por exemplo, se os registos NS da sua zona DNS mostrarem os servidores *dnsXX.ovh.ca* e *nsXX.ovh.ca*, deverá utilizar estes últimos no separador <code className="action">Servidores DNS</code> da sua Área de Cliente OVHcloud. Para mais informações, consulte o nosso manual "[Modificar os servidores DNS de um nome de domínio OVHcloud](/guides/web-cloud/domains/dns-server-edit)".
    </Region>
...
<Tabs>
  ...
  <Tab label="RP">
    **R**esponsible **P**erson<br/><br/>
    Este registo permite indicar o endereço de correio eletrónico da pessoa responsável pelo nome de domínio. Este registo pode também ser combinado com um registo DNS do tipo TXT para fornecer informações adicionais.
