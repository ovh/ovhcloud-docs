...
O primeiro passo é recuperar todos os ficheiros relativos ao seu site WordPress. Isto inclui os ficheiros WordPress, bem como a sua base de dados. A seguir, consulte o nosso guia "[Efetuar o backup do seu site WordPress](/guides/web-cloud/web-hosting/how-to-backup-your-wordpress)".
