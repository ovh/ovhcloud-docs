...
:::info
- Lembre-se de que o host de ligação para o seu espaço de alojamento é `ftp.cluster0XX.hosting.ovh.net` (substitua os `XXX` pelo seu número de cluster).
...
Para adicionar este ficheiro:

1. Aceda ao espaço FTP do seu alojamento web.
...
A transferência de ficheiros permite-lhe colocar o seu website no seu espaço de alojamento web. Por padrão, você deve colocar seus ficheiros no diretório (pasta) `www`. Pode transferir os seus ficheiros através de vários métodos.
