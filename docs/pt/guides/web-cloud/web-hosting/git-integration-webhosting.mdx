...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    Em seguida, clique no botão <code className="action">⁝</code> à direita do nome de domínio ou subdomínio relevante, em seguida, em <code className="action">Desassociar um nome de domínio</code>.
