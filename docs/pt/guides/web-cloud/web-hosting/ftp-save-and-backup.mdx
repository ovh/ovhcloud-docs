...
<Region zones={['eu']}>
- Ter um [alojamento web](/links/web/hosting) (não funciona com um alojamento Cloud Web).
</Region>
<Region zones={['ca', 'apac']}>
- Ter um [alojamento web](/links/web/hosting).
</Region>
...
:::tip
Se utilizar um programa para aceder ao seu espaço de armazenamento FTP, recomendamos que consulte a documentação oficial do software para efetuar as operações corretas.
