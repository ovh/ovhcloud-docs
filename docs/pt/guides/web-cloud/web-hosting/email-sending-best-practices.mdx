...
Ambos os métodos enviam e-mails a partir do seu site. Diferem no servidor de onde o e-mail parte, na forma como o envio é limitado e na forma como o pode seguir.
...
| **Identidade do remetente** | O endereço `From:` é declarado pelo script. Verifique se o seu registo SPF autoriza os servidores OVHcloud. | O endereço `From:` deve corresponder à conta autenticada. O e-mail é assinado com DKIM se o DKIM estiver ativado para o seu domínio. |
