...
O [FluentSMTP](https://pt.wordpress.org/plugins/fluent-smtp/) é uma alternativa leve e gratuita. A quota de envio da sua conta de e-mail aplica-se da mesma forma.
...
Em todos os casos, os parâmetros SMTP são idênticos: servidor `smtp.mail.ovh.ca`, porta `465` (SSL/TLS) ou `587` (STARTTLS), com autenticação pelo endereço de e-mail completo e a respetiva palavra-passe.
