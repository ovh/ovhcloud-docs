...
| **Identidade do remetente** | O endereço `From:` é declarado pelo script. Verifique se o seu registo SPF autoriza os servidores OVHcloud. | O endereço `From:` deve corresponder à conta autenticada. O e-mail é assinado com <Tooltip term="dkim">DKIM</Tooltip> se o DKIM estiver ativado para o seu domínio. |
