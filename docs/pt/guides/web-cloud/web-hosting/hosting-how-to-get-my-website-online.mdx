...
Criar esta associação depende do site a ser publicado. A associação é inerente à configuração do site, e não à OVHcloud. Portanto, recomendamos que contacte o editor do seu site ou um profissional, como [um fornecedor especializado](/links/partner), caso necessite de ajuda para realizar estas operações.
...
Relembramos que, se encontrar dificuldades durante a publicação do site, será melhor recorrer a [um fornecedor especializado](/links/partner) e/ou contactar o editor do serviço (do CMS instalado, por exemplo).
