...
- de uma base de dados presente num servidor [Web Cloud Databases](/links/web/databases) (incluída nos nossos [alojamentos](/links/web/hosting) **Performance**, **Agency**, **Agency Plus** e **Agency Max** ou [encomendada em separado](/links/web/databases)).
