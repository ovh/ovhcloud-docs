...
Para corrigir isto, consulte o nosso tutorial "[Reescrever o URL de acesso ao meu site graças ao mod_rewrite através do ficheiro .htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)" ou recorra a um [fornecedor especializado](/links/partner) se encontrar dificuldades.
...
Se necessário, consulte o nosso tutorial "[Alojamento web - Passar o seu website em HTTPS](/guides/web-cloud/web-hosting/ssl-activate-https-website)" ou recorra a um [fornecedor especializado](/links/partner) se encontrar dificuldades.
