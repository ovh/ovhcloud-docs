...
- PrestaShop: O editor deste programa não propõe, à data, documentação para alterar o domínio de acesso ao seu website. Sugerimos que contacte diretamente o editor sobre este assunto. Para mais informações, clique em [aqui](https://help-center.prestashop.com) para aceder à sua página oficial.
