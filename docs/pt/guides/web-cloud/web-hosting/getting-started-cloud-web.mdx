...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Se dispõe da oferta [Cloud Web](/links/web/hosting-cloud-web-offer) com 2 vCores, pode adicionar um segundo motor de execução (máximo de 2 por oferta) clicando no botão <code className="action">Ações</code> e, depois, em <code className="action">Adicionar um tempo de execução para o aplicativo de software</code>.
  </Tab>
</Tabs>
