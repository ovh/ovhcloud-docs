...
Para restaurar todo ou parte do seu espaço de armazenamento FTP, consulte o [nosso guia](/guides/web-cloud/web-hosting/ftp-save-and-backup) sobre o assunto.
...
Para identificar estas falhas de segurança, analise os ["logs web"](/guides/web-cloud/web-hosting/logs-and-statistics) do seu alojamento web ou recorra a um [fornecedor especializado](/links/partner) para realizar uma auditoria de segurança dos seus websites.
