...
<Region zones={['eu']}>
- Dispor de um serviço de [alojamento web OVHcloud](/links/web/hosting), com exceção de um serviço de alojamento Cloud Web.
</Region>
<Region zones={['ca', 'apac']}>
- Dispor de um serviço de [alojamento web OVHcloud](/links/web/hosting).
</Region>
