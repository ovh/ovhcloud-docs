...
A edição dos ficheiros _Markdown_ pode ser feita diretamente no servidor de alojamento web. Com uma oferta de [alojamento web OVHcloud](/links/web/hosting) que inclua acesso SSH (**a partir da oferta Pro**), pode utilizar indiferentemente [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) ou [vim](https://www.vim.org/).
...
Adicione algumas linhas respeitando a sintaxe _Markdown_:
