...
<Tabs>
  ...
  <Tab label="Etapa 6">
    :::warning
    A escolha de um 'módulo 1 clique' não está disponível de momento a partir do separador <code className="action">Meus sites</code>. Para instalar um CMS no seu site, finalize a adição do seu site passando à etapa seguinte e, em seguida, aceda ao separador <code className="action">Modulos "1 clique"</code> do seu alojamento, seguindo o nosso guia "[Instalar o seu website com um 'módulo 1 clique' (CMS)](/guides/web-cloud/web-hosting/cms-install-1-click-modules)".
    :::
