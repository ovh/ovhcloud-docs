...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Para criar um novo utilizador FTP, clique no botão <code className="action">Criar utilizador</code> à direita. Dependendo da resolução do seu ecrã, o botão pode ser localizado na parte inferior da página.
