...
Este guia explica de forma não exaustiva as funcionalidades disponíveis com o comando `scp`. Não hesite em trocar impressões com nossa [comunidade de utilizadores](https://community.ovhcloud.com/). se desejar aprofundar os seus conhecimentos sobre esta encomenda.
