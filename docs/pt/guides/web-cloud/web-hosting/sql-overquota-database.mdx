...
Se a base de dados estiver presente numa solução [Web Cloud Databases](/links/web/databases), consulte o guia "[Web Cloud Databases - Ligar-se à base de dados](/guides/web-cloud/databases/db-connecting-database-server)" e, em seguida, passe diretamente para a [etapa 1.2](#step1.2) deste guia.
...
Para se conectar à base de dados via phpMyAdmin, clique nos separadores abaixo para visualizar cada uma das **4** etapas.
...
- [Primeiros passos com a oferta Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
- [Importar a sua antiga base de dados para o serviço Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
