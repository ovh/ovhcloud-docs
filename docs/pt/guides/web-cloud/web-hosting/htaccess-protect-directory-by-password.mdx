...
description: Descubra como proteger um diretório ou o acesso à administração do seu website através de uma autenticação com os ficheiros .htaccess e .htpasswd
...
Para alterar a versão de PHP dos seus websites no seu alojamento web, consulte o guia "[Alojamento web: ambiente, versão PHP, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)".
...
Volte para a pasta raiz onde criou o ficheiro "crypt.php". Clique em <code className="action">Editar</code> e coloque as seguintes linhas:
...
Para mais informações sobre o assunto, consulte a [documentação oficial Apache](https://httpd.apache.org/docs/2.4/en/misc/password_encryptions.html).
:::
