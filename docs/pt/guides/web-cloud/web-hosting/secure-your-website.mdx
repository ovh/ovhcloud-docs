...
- ter os [detalhes de login](/guides/web-cloud/web-hosting/ftp-connection#1-recuperar-as-informacoes-de-acesso) para aceder ao espaço de armazenamento do seu plano de hospedagem
...
- altere regularmente a palavra-passe do administrador do seu computador (para mais informações sobre a escolha das palavras-passe, siga as instruções deste [guia](/guides/account-and-service-management/account-information/all-about-username#criar-uma-password-sólida-e-única)).
...
Atualize as [informações da sua conta de cliente](/guides/account-and-service-management/account-information/all-about-username#modificar-as-minhas-informações-pessoais) e adicione um **e-mail de segurança**.<br/>
...
Certifique-se de que o seu site está atualizado, quer ao nível do conteúdo, quer ao nível dos componentes técnicos (CMS, extensões, versões de PHP e dependências).

Se estiver a utilizar um CMS, consulte a sua documentação oficial para atualizar:
...
Este passo requer a ligação ao seu [espaço FTP](/guides/web-cloud/web-hosting/ftp-connection). Implica competências técnicas para reconhecer eventuais ficheiros maliciosos no seu alojamento. Se tiver dificuldades em efetuar esta verificação, não hesite em contactar os nossos [parceiros](/links/partner).
