...
<Tabs>
  ...
  <Tab label="Etapa 4">
    :::warning
    Algumas opções estão bloqueadas no CDN Basic e requerem a subscrição do [CDN security](/links/web/hosting-options-cdn) ou do [CDN Advanced](/links/web/hosting-options-cdn).
