...
- 404: Not Found: o ficheiro que o visitante está a tentar ver não existe.
...
Também pode reencaminhar um erro para um script **C**ommon **G**ateway **I**nterface (**CGI**). Pode codificar um script em **CGI** para, por exemplo, efetuar as seguintes ações:
