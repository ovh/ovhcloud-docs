...
<Region zones={['ca']}>
:::info
A OVHcloud oferece outras ofertas de e-mail para além da oferta "MX Plan". Por exemplo, pode combinar endereços de e-mail "MX Plan" de contas ["Exchange"](/links/web/emails-hosted-exchange).
...
:::info
A OVHcloud oferece servidores de base de dados Web Cloud Databases. Se pretender utilizar esta oferta com o seu website, consulte toda a nossa documentação sobre este produto na [nossa página dedicada](/guides/web-cloud/databases/landing-page-databases).
...
Depois de migrar os seus antigos endereços de e-mail para a OVHcloud, reconfigure os seus softwares de e-mail com a ajuda de todos os nossos guias sobre o assunto.
...
- Encontre os nossos guias de ajuda à configuração nas secções `Configuration on computador` e `Configuration no smartphone` de [o nosso manual na oferta Email Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro).
</Region>

<Region zones={['eu', 'ca']}>
#### Para as contas de e-mail "Exchange" :

- Encontre os nossos guias de ajuda à configuração nas secções `Configuration Exchange no computador` e `Configuration Exchange no smartphone` de [a nossa documentação sobre a oferta Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange).
</Region>
