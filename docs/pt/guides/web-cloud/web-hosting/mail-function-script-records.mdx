...
Se deseja gerir os endereços de e-mail incluídos na sua oferta MX Plan ou na sua oferta de [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/), consulte a nossa documentação sobre os [E-mails partilhados - MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan).
:::
