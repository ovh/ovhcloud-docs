...
Se dispõe de um alojamento web **Performance**, **Agency**, **Agency Plus** ou **Agency Max**, pode ativar gratuitamente um servidor de base de dados [Web Cloud Databases](/links/web/databases).
...
Se a sua oferta de [alojamento web](/links/web/hosting) dispõe desta opção, consulte o guia "[Criar tarefas automatizadas (CRON) no seu alojamento Web](/guides/web-cloud/web-hosting/cron-tasks)" para mais pormenores.
