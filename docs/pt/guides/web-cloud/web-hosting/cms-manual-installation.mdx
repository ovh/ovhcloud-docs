...
**Grav** é um CMS moderno e flexível baseado em PHP. É concebido sem base de dados e utiliza ficheiros Markdown para armazenamento e gestão de conteúdo. Grav distingue-se pelo seu sistema de gestão de pacotes que facilita a instalação e atualização de plugins e temas para o seu website.
...
A maioria dos CMS precisam de uma base de dados para funcionar. As nossas ofertas de [alojamento web](/links/web/hosting) incluem-no, com exceção de [alojamento gratuito](/links/web/domains-free-hosting).

</Region>

<Region zones={['ca','apac']}>

A maioria dos CMS precisam de uma base de dados para funcionar. As nossas ofertas de [alojamento web](/links/web/hosting) incluem-no.
...
- Para aceder à base de dados associada ao alojamento web, consulte o [guia](/guides/web-cloud/web-hosting/sql-create-database#aceder-à-interface-phpmyadmin).
