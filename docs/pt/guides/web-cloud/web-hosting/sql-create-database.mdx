...
:::info
Se lhe for pedido e qualquer que seja a base de dados [Start SQL](/links/web/hosting-options-startsql) adicionada ou incluída no seu alojamento web OVHcloud, o número de **porta** a utilizar é o **3306**.
:::
