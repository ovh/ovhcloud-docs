...
No separador <code className="action">Módulos "1 clique"</code> do seu alojamento, clique no botão <code className="action">Adicionar um módulo</code> para adicionar um novo "módulo em 1 clique".
...
Para realizar esta instalação, certifica-se que a <code className="action">Instalação em modo avançado</code> selecionada. De seguida, clique no botão <code className="action">Seguinte</code>:
