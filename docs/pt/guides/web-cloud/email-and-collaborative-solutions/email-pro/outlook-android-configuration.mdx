...
<Tabs>
  <Tab label="Etapa 1">
    ...
    <img className="thumbnail" alt="Outlook e-mail pro" src="/images/assets/screens/email-clients/outlook/outlook-app-android-add-step01.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 2">
...
:::info
Para obter mais informações sobre a configuração de um endereço de e-mail a partir da aplicação Outlook no Android, consulte [Central de Ajuda da Microsoft](https://support.microsoft.com/pt-pt/outlook/install-mobile/set-up-email-in-the-outlook-for-android-app).
