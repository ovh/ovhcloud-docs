...
<Tabs>
  <Tab label="Primeira configuração">
    Selecione <code className="action">Adicionar um endereço de e-mail</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/assets/screens/email-clients/android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Configuração existente">
    ...
    3. Selecione <code className="action">Adicionar uma conta</code><br/><br/><img className="thumbnail" alt="Adicionar uma conta existente na aplicação Gmail no Android" src="/images/assets/screens/email-clients/android/android-existing.png" loading="lazy" />
  </Tab>
</Tabs>
