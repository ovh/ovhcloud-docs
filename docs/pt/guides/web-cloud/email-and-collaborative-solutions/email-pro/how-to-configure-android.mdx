...
<Tabs>
  ...
  <Tab label="Configuração existente">
    ...
    3. Selecione <code className="action">Adicionar uma conta</code><br/><br/>![emailpro](/images/assets/screens/email-clients/android/android-existing.png)&#123;thumbnail .h-600&#125;
  </Tab>
</Tabs>
