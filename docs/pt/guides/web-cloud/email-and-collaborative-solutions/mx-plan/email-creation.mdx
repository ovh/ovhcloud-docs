...
Nos serviços MX Plan que utilizam o webmail Zimbra ou OWA, fala-se de *reinicialização de conta* quando tem de a eliminar.
...
- **Password**: Indique uma palavra-passe e introduza-a novamente para confirmar. Por razões de segurança, recomendamos que não utilize duas vezes a mesma palavra-passe, selecione uma palavra-passe que não tenha qualquer relação com as suas informações pessoais (evite as referências ao seu apelido, nome e data de nascimento, por exemplo) e que a renove regularmente.
...
<Region zones={['eu']}>
Consulte o conjunto das nossas ofertas e-mail [Zimbra](/links/web/zimbra) ou [Exchange](https://www.ovhcloud.com/pt/emails-exchange/) para completar a sua oferta MX Plan no mesmo domínio.
</Region>
