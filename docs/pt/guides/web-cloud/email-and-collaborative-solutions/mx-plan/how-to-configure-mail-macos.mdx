...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    <Region zones={['eu']}>
    - **Servidor de receção**: `imap.mail.ovh.net` ou `ssl0.ovh.net`
    - **Servidor de envio**: `smtp.mail.ovh.net` ou `ssl0.ovh.net`
    </Region>

    <Region zones={['ca', 'apac']}>
    - **Servidor de receção**: `imap.mail.ovh.ca`
    - **Servidor de envio**: `smtp.mail.ovh.ca`
    </Region>
...
- Para as caixas <code className="action">Nome do host</code> e <code className="action">Porta</code>, consulte os valores da rubrica "[Lembrança dos parâmetros POP, IMAP e SMTP](#popimap-settings)". **Verifique se o tipo de servidor (IMAP, POP e SMTP) corresponde ao tipo da sua conta**.
...
|Nome de utilizador|Introduza o endereço de e-mail **completo**|
|Palavra-passe|Introduza a palavra-passe do endereço de e-mail|
|Servidor (entrada)|pop.mail.ovh.ca|
|Porta|995|
|Tipo de segurança|SSL/TLS|
...
|Nome de utilizador|Introduza o endereço de e-mail **completo**|
|Palavra-passe|Introduza a palavra-passe do endereço de e-mail|
|Servidor (entrada)|imap.mail.ovh.ca|
|Porta|993|
|Tipo de segurança|SSL/TLS|
