...
- **MX Plan** : Zimbra é utilizado no âmbito de uma transição tecnológica do webmail Outlook Web Access (OWA) para o de Zimbra para os serviços MX Plan que utilizam o webmail OWA.
...
- Nenhum ficheiro está armazenado no seu volume de armazenamento "Briefcase" se mudar para a oferta Starter.
...
Caso haja uma alteração de palavra-passe, terá de introduzir a nova palavra-passe no seu software de e-mail.
