...
<Region zones={['eu']}>
:::info
Embora este guia se refira aos nossos serviços Exchange, as instruções aplicam-se igualmente às contas [Email Pro](https://www.ovhcloud.com/pt/emails/email-pro/).
:::
</Region>

<Region zones={['ca']}>
:::info
Este guia refere-se aos nossos serviços Exchange.
:::
</Region>
