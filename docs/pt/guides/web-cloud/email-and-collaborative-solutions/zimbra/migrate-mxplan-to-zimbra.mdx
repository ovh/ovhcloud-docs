...
<Tabs>
  ...
  <Tab label="Etapa 2">
    **Ligar-se ao projeto e criar a migração**
    ...
    - **Conta de destino**:
        - **Tipo de conta**: Selecione `OVHcloud` e, em seguida, escolha `Zimbra`. Clique em <code className="action">Ligar-se</code> para se identificar com a sua conta OVHcloud e selecionar o serviço Zimbra e o endereço de destino (exemplo: `contact2@mydomain.ovh`). Introduza depois a palavra-passe desta conta de e-mail.
