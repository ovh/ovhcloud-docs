...
2. **[Eliminar a conta MX Plan de origem e reatribuir o seu endereço à conta Zimbra](#step2)**
    - [2.1 - Eliminação do endereço de e-mail MX Plan de origem](#step21)
...
<Tabs>
  <Tab label="Etapa 1">
    **Criar um projeto de migração**
    ...
    <img className="thumbnail" alt="Página inicial do OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-01.png" loading="lazy" />
  ...
  <Tab label="Etapa 2">
    **Criar a migração**
    ...
    <img className="thumbnail" alt="Criar a migração do MX Plan para o Zimbra no OVHcloud Mail Migrator" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
...
#### 2.1 - Eliminação do endereço de e-mail MX Plan de origem <a name="step21"></a>
