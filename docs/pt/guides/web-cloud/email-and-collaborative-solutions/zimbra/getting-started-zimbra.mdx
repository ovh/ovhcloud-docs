...
:::warning
É necessário [criar uma organização](#organizations) para poder adicionar um domínio ao serviço Zimbra.
...
### Consultar a conta de e-mail <a name="emails-consult"></a>
