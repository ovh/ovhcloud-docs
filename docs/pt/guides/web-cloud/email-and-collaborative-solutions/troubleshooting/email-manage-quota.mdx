...
- <code className="action">1</code> **A Lixeira (trash)**: esta contém os elementos que eliminou. Para evitar a acumulação de e-mails nesta pasta, aconselhamos que esvazie a lixeira regularmente.
...
No separador <code className="action">Contas de e-mail</code>, clique no botão <code className="action">...</code> à direita da conta a modificar e, a seguir, em <code className="action">Alterar</code>.
  ...
  <Tab label="E-mail Pro" availableIn={['eu']}>
    A oferta E-mail Pro dispõe de uma capacidade única de 15 GB. Se precisar de um armazenamento maior, deverá passar para uma oferta com mais espaço. Para isso, leia a secção [mudar de oferta para aumentar a sua capacidade](#switchingoffer) deste guia.<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
...
O papel do software de e-mail será converter os seus e-mails em ficheiros, de modo a poder armazená-los no seu computador. No entanto, é necessário configurar a função de ficheiro do seu software de e-mail. Os e-mails serão colocados numa pasta "local" e não diretamente no servidor da sua conta de e-mail.
...
Configuração de uma conta E-mail Pro em **macOS**:<br/><br/>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows) (gratuito)<br/><br/>
...
Depois de instalar o seu software de correio, siga as instruções abaixo para preparar a pasta do ficheiro no seu software de correio eletrónico.

<Tabs>
  <Tab label="Outlook">
    No Outlook, certifique-se de que, na sua coluna da esquerda, a pasta "ficheiro" ou "no meu computador" está presente para poder introduzir os elementos que deseja manter localmente no seu computador. Consulte a documentação da Microsoft para preparar a sua pasta de ficheiro:<br/><br/>
    - [Ficheiro no Outlook para Windows](https://support.microsoft.com/pt-pt/office/arquivar-no-outlook-para-windows-25f75777-3cdc-4c77-9783-5929c7b47028)<br/>
  ...
  <Tab label="Thunderbird">
    ...
    - [Ficheiro de mensagens](https://support.mozilla.org/pt-PT/kb/mensagens-arquivadas)<br/>
  </Tab>
</Tabs>
