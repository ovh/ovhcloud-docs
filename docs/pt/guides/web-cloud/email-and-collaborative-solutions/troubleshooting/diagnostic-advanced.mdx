...
<Region zones={['ca']}>
- Dispor de uma oferta **MX Plan** ou **Exchange**.
</Region>

<Region zones={['apac']}>
- Dispor de uma oferta **MX Plan**.
</Region>
...
<ZoneTabs>
  <Tab label="Conta de e-mail MX Plan">
    Para uma oferta **MX Plan**, aceda à [página dos nossos guias MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan) e verifique a configuração do seu software de e-mail através dos guias disponíveis na secção `Configurar uma aplicação de e-mail no seu computador` ou `Configurar uma aplicação de e-mail no seu smartphone`, em função do dispositivo utilizado.
  </Tab>
  <Tab label="E-mail Pro" availableIn={['eu']}>
    Para uma oferta **E-mail Pro**, aceda à [página dos nossos guias E-mail Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/landing-page-email-pro) e verifique a configuração do seu software de e-mail através dos guias disponíveis na secção `Configurar uma aplicação de e-mail no seu computador` ou `Configurar uma aplicação de e-mail no seu smartphone`, em função do dispositivo utilizado.
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    Para uma oferta **Exchange**, aceda à [página dos nossos guias Microsoft Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/landing-page-microsoft-exchange) e verifique a configuração do seu software de e-mail através dos guias disponíveis na secção `Configurar uma aplicação de e-mail no seu computador` ou `Configurar uma aplicação de e-mail no seu smartphone`, em função do dispositivo utilizado.
  </Tab>
  <Tab label="Zimbra" availableIn={['eu']}>
