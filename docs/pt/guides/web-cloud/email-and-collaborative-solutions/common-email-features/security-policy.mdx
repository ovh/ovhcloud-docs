...
:::info
Se não vê o separador <code className="action">Plus</code> no painel de gestão da sua oferta <code className="action">MX Plan</code>, isso significa que o seu serviço utiliza o webmail Roundcube. A gestão da política de segurança não está disponível nos serviços MX Plan que utilizam o Roundcube.
