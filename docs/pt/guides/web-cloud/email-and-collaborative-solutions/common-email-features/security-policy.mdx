...
:::info
Se não vê o separador <code className="action">Mais</code> no painel de gestão da sua oferta <code className="action">MX Plan</code>, isso significa que o seu serviço utiliza o webmail Roundcube. A gestão da política de segurança não está disponível nos serviços MX Plan que utilizam o Roundcube.
...
<Region zones={['ca']}>
Depois de preencher estas informações, valide estas alterações clicando em <code className="action">Seguinte</code> e, a seguir, em <code className="action">Validar</code>, relativamente à oferta "MX Plan". Clique em <code className="action">Registar as modificações</code>, relativamente à oferta Exchange.
</Region>

<Region zones={['apac']}>
Depois de preencher estas informações, valide estas alterações clicando em <code className="action">Seguinte</code> e, a seguir, em <code className="action">Validar</code>, relativamente à oferta "MX Plan".
</Region>
