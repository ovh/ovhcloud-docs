...
Adicionar um domínio a um serviço Exchange é indispensável para poder utilizar as suas contas incluídas neste último.

<Region zones={['eu']}>

Também é possível adicionar vários domínios a um serviço Exchange ou E-mail Pro.
...
Também é possível adicionar vários domínios a um serviço Exchange.

**Saiba como adicionar um domínio à plataforma Exchange.**
...
- Dispor de uma solução [Exchange](https://www.ovhcloud.com/pt/emails-exchange/).
- Dispor de um ou vários domínios.
- Ter a possibilidade de alterar a configuração do domínio [zona DNS](/guides/web-cloud/domains/dns-zone-edit).
...
:::warning
Por predefinição, todas as contas de e-mail de uma plataforma estão interligadas. Todos os endereços criados no serviço de e-mail poderão ver todos os endereços desse serviço no diretório, incluindo aqueles que possuem um nome de domínio diferente.

<Region zones={['eu']}>

Para desassociar a apresentação dos domínios, é necessário encomendar outra plataforma [Exchange ou E-mail Pro](https://www.ovhcloud.com/pt/emails/) para o(s) domínio(s) em questão.

</Region>

<Region zones={['ca']}>

Para desassociar a apresentação dos domínios, é necessário encomendar outra plataforma [Exchange](https://www.ovhcloud.com/pt/emails-exchange/) para o(s) domínio(s) em questão.
...
Se pretender configurar o seu endereço de e-mail num software de mensagens ou num dispositivo como um smartphone ou um tablet, ou obter ajuda relativamente às funcionalidades do seu serviço de e-mail, consulte a nossa documentação, acessível a partir da página [Exchange](https://www.ovhcloud.com/pt/emails-exchange/).
...
Se pretender retirar um domínio associado ao seu serviço Exchange, deve certificar-se de que este não está associado a contas de e-mail, alias, recursos, contas partilhadas (apenas em Exchange), grupos, contactos externos ou rodapés sempre configurados. Neste caso, será necessário associar **as contas a outro domínio** na sua plataforma ou **eliminar**.
