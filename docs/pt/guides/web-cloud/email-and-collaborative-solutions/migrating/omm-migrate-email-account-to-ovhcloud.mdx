...
<img className="thumbnail" alt="Criar uma nova migração no OVHcloud Mail Migrator, passo 1" src="/images/assets/screens/email-clients/omm/omm-create-migration-02.png" loading="lazy" />
