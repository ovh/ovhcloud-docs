...
<img className="thumbnail" alt="botão sunrise" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG" loading="lazy" />

- Clique de seguida em <code className="action">SSL Gateway</code> para poder consultar o serviço.

<img className="thumbnail" alt="botão ssl gateway" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/5.PNG" loading="lazy" />

- Selecione a oferta que deseja configurar.

<img className="thumbnail" alt="página comercial" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/6.PNG" loading="lazy" />

- Chegará então à página de gestão da sua oferta.

<img className="thumbnail" alt="configuração global" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/7.PNG" loading="lazy" />

- Descrição das informações.

<img className="thumbnail" alt="secção informações" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/8.PNG" loading="lazy" />
...
<img className="thumbnail" alt="secção configuração" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/9.PNG" loading="lazy" />
...
<img className="thumbnail" alt="separador Domínios" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/10.PNG" loading="lazy" />
...
<img className="thumbnail" alt="adicionar domínio free" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/11.PNG" loading="lazy" />

<img className="thumbnail" alt="adicionar domínio advanced" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/12.PNG" loading="lazy" />
...
<img className="thumbnail" alt="separador servidores" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/13.PNG" loading="lazy" />
...
<img className="thumbnail" alt="adicionar IP/PORTA advanced (interno)" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/15.PNG" loading="lazy" />
...
<img className="thumbnail" alt="separador tarefas" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/13-bis.PNG" loading="lazy" />
...
<img className="thumbnail" alt="separador métricas" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/17.PNG" loading="lazy" />
