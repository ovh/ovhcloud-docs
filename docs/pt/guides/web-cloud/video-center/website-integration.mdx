...
O código embed é gerado automaticamente pelo Video Center para cada vídeo, na sua página de detalhe. Clique nos separadores abaixo para visualizar cada uma das **3** etapas.
...
Clique no vídeo que pretende integrar para abrir a sua página de detalhe.
...
- **Abrir o ficheiro HTML da sua página**: no seu editor de código (VS Code, Dreamweaver, etc.), abra a página onde pretende apresentar o vídeo.
