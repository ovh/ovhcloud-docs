...
Se a RAM disponível no servidor não permitir realizar a exportação desejada, utilize a ferramenta OVHcloud na Área de Cliente, que utiliza recursos externos à sua solução. Consulte a secção "[Salvaguardar e exportar uma base de dados a partir da Área de Cliente](#salvaguardar-e-exportar-uma-base-de-dados-a-partir-da-área-de-cliente)" deste guia.
...
[Salvaguardar e exportar uma base de dados a partir da Área de Cliente](#salvaguardar-e-exportar-uma-base-de-dados-a-partir-da-área-de-cliente)
