...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    :::info
    Ao desmarcar esta caixa, bloqueia também o acesso ao **phpMyAdmin** através da ligação disponível na sua Área de Cliente OVHcloud, e isto para toda a sua solução Web Cloud Databases.
    :::
