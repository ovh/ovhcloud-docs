---
title: Começar com MySQL e MariaDB
...
Este motor é open source, e a sua casa mãe é nada mais nada menos que a Oracle.

### O que é uma base de dados MariaDB?
...
- Dispor de uma [instância Web Cloud Databases](/links/web/databases) (incluída numa oferta de [alojamento web](/links/web/hosting) Performance, Agency, Agency Plus ou Agency Max)
...
Temos à sua disposição um guia que será útil: [Web Cloud Databases - primeira utilização](/guides/web-cloud/databases/db-getting-started).
...
#### Ligação a partir de um software (SQuirreL SQL)
