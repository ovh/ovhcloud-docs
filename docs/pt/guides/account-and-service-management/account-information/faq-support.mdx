...
Se identificar uma falha no seu serviço e já confirmou que está ativo/renovado, consulte esta página para verificar possíveis incidentes em andamento nas nossas infraestruturas: [https://www.status-ovhcloud.com/](https://www.status-ovhcloud.com/).
...
:::tip
Para plataformas de hospedagem web, pode consultar [este guia](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer) para verificar seu cluster e seu filer de hospedagem para verificar se estão afetados por um incidente em andamento ou passado.
...
Se confirmou em [esta página](https://www.status-ovhcloud.com/) ou via equipe de suporte que seu serviço está afetado por um incidente em andamento e deseja receber atualizações por e-mail, você pode se inscrever em um incidente específico para receber atualizações.
