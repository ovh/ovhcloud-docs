...
**Procure o logótipo da OVHcloud na sua caixa de entrada**

Vários serviços de e-mail, entre eles o Gmail, o Yahoo e o Apple Mail com um endereço iCloud.com, apresentam o logótipo da OVHcloud junto ao nome do remetente nos e-mails enviados pela OVHcloud a partir de um endereço que termina com `ovhcloud.com`. No Gmail, aparece ainda um visto azul.

<img className="thumbnail" alt="Logótipo da OVHcloud apresentado junto ao nome do remetente" src="/images/account-and-service-management/account-information/phishing-care/gmail-icloud-logo.png" loading="lazy" />

Este logótipo é apresentado pelo seu serviço de e-mail, não pela mensagem: um e-mail fraudulento não o consegue reproduzir. Nem todos os serviços de e-mail o apresentam ainda, pelo que a sua ausência só por si não prova nada: nesse caso, baseie-se nas verificações descritas abaixo.

Verifique em seguida se o e-mail que recebeu também está visível na página <ManagerLink to="/#/communication">As minhas mensagens</ManagerLink>. Ali encontrará cópias dos e-mails oficiais enviados pela OVHcloud.
...
<img className="thumbnail" alt="Outlook Windows - identificar a versão" src="/images/assets/screens/email-clients/outlook/outlook-windows-identify01.png" loading="lazy" />
