...
Assim que o agente tiver efetuado cópias de segurança, poderá restaurar os seus dados de duas formas: restauração de ficheiros (FLR) ou restauração do servidor.

## Pontos importantes

Vários pontos fortes estão presentes nesta oferta:

- Primeira política de cópia de segurança automática com 30 dias de retenção.
- Possibilidade de aumentar a retenção até 365 dias.
...
As cópias de segurança são realizadas offsite, através da configuração Vault por defeito, com um ponto de armazenamento localizado numa zona geograficamente distinta da do servidor Bare Metal. Este mecanismo de anti-afinidade reforça a resiliência dos dados de cópia de segurança.
