...
Pode encontrar os registos do seu Backup Agent na pasta: `C:\ProgramData\Veeam\` ou `/var/log`.
...
<summary>Quero alterar a palavra-passe de acesso à Veeam Service Provider Console (VSPC).</summary>


A alteração da palavra-passe é feita por meio do link "Esqueceu a palavra-passe?" disponível na console VSPC.
...
Tem de transferir o agente a partir do seu <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> e instalá-lo no seu novo sistema operativo.
