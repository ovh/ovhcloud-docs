...
- Os seus dados de backup são automaticamente enviados para um Vault criado em **Gravelines (GRA)**, denominado **backup-vault-gra-1**.
...
- O servidor Bare Metal em **RBX** envia os seus dados para **backup-vault-gra-1** em **Gravelines (GRA)**.
- O servidor Bare Metal em **GRA** envia os seus dados para **backup-vault-sbg-1** em **Strasbourg (SBG)**.
