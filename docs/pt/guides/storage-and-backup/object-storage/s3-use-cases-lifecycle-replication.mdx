...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    **Step 1 - Enable versioning on both buckets**
    ...
    Click <code className="action">Object Storage</code> in the left-hand menu, then click the name of your source bucket (`compliance-primary-<region>`) from the <code className="action">My containers</code> tab.
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    **Step 1 - Enable versioning on both buckets**
    ...
    Click <code className="action">Object Storage</code> in the left-hand menu.
