...
- Ter os dados de utilizador (*OS_USERNAME*) e os projetos (*OS_PROJECT_NAME* ou *OS_TENANT_NAME*) disponíveis para o descarregar o ficheiro "OpenRC" no menu [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etapa-1-recuperar-as-variáveis) da sua <ManagerLink to="/">Área de Cliente Public Cloud da OVHcloud</ManagerLink>.
...
[Primeiros passos com a API Swift](/guides/storage-and-backup/object-storage/pcs-create-container)
