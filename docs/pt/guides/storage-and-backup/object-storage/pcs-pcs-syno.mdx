...
- [Criar um acesso à interface Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user#criação-de-um-utilizador-openstack)
...
- [Carregar as variáveis de ambiente OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etapa-1-recuperar-as-variáveis)
