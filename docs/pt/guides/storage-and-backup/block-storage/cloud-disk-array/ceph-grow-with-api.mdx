...
[[cpnav:storage-cloud-disk-array|en]]
...
Use the service name (UUID) from Step 1 to get the corresponding service ID, filtering on the `resourceName` parameter:
...
Open the <ApiLink>API console</ApiLink>.
