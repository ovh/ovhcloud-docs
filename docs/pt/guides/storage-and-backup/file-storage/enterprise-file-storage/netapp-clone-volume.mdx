...
:::info
Pode criar um volume e uma snapshot de tipo "manual" graças à <ApiLink>API OVHcloud</ApiLink> ou a partir do seu <ManagerLink to="/">espaço cliente OVHcloud</ManagerLink>.
