...
Aceda à <ApiLink>consola de API</ApiLink> e utilize as API abaixo para alterar o anúncio do bloco IP.

<Api version="v1" section="/vrack" method="GET" route={"/vrack"} />

Esta API permite recuperar a lista dos serviços vRack. Caso não consigo identificar o serviço afetado através destas referências, consulte a <ManagerLink to="/">Área de Cliente de OVHcloud</ManagerLink> para o consultar.
