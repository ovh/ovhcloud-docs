...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="generate_efi" src="/images/bare-metal-cloud/dedicated-servers/intervention-support/generate_efi-v2.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="select_efi" src="/images/bare-metal-cloud/dedicated-servers/intervention-support/select_efi-v2.mp4" />
