...
Para saber também se o Gmail, o Yahoo e outros grandes fornecedores de e-mail entregam a mensagem na caixa de entrada ou no spam, pode utilizar o [Email Spam Tester](https://email-spam-tester.com/pt/).
