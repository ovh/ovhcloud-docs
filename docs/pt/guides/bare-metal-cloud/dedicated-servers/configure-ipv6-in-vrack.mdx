...
Introduza o ID do seu vRack (por exemplo, `pn-9000000`) no *path parameter* `serviceName` e indique o bloco IPv6 no *request body*:
...
Utilize a seguinte chamada para definir uma sub-rede deste tipo:
