...
Através da <ApiLink>API OVHcloud</ApiLink>, pode também definir scripts personalizados.
...
Por exemplo, o script seguinte encadeia o menu de arranque [netboot.xyz](https://netboot.xyz/):
...
Pode alternar de novo entre o disco ou o modo rescue a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> (consulte o nosso guia "[Ativar e utilizar o modo rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)") ou através da <ApiLink>API OVHcloud</ApiLink>.
