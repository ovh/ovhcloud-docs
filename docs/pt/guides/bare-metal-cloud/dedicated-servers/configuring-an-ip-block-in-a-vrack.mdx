...
Em seguida, temos de criar uma nova rota IP para o vRack. Vamos adicionar uma nova regra de tráfego (`1 vrack`) modificando o ficheiro, como se indica abaixo:
