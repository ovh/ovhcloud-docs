...
- [How to Manage Your Payment Methods with OVHcloud](/guides/account/billing/manage-payment-methods)
...
![Setup fee - Overview](/images/account/billing/overview/setup-fee.png)
...
![Month - Overview](/images/account/billing/overview/12-month.png)
...
![Monthly - Overview](/images/account/billing/overview/monthly.png)
...
![And 24 month commitment pricing](/images/account/billing/overview/12-24-month-commitment.png)
...
- [Switching from Hourly to Monthly Billing (B2/C2/R2 Instances)](/guides/public-cloud/compute/changing-hourly-monthly-billing)
- [Increasing Public Cloud Quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota)

#### Cancellation

- [Canceling a Public Cloud Project](/guides/public-cloud/cross-functional/delete-a-project)
- [Canceling an Instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#management-options-on-the-instance-dashboard)
...
![Hourly - Overview](/images/account/billing/overview/hourly.png)
...
![Billing overview - step 1](/images/account/billing/overview/billing-overview-01.png)
