...
- One or more **identities** targeted by this policy.
  - It can be account IDs, users, or user groups (like the ones used in [Federation](/guides/account/account-information/sso-active-directory-federation-services) - other SSO guides are available).
...
![IAM diagram - Use policies control panel](/images/account/account-information/use-iam-policies-control-panel/iam-diagram.png)

 

## Topics

- [Accessing the IAM menu](/guides/account/account-information/use-iam-policies-control-panel#accessing-the-iam-menu)
- [Managing policies](/guides/account/account-information/use-iam-policies-control-panel#managing-policies)
- [Managing identities](/guides/account/account-information/use-iam-policies-control-panel#managing-identities)
- [Managing resource groups](/guides/account/account-information/use-iam-policies-control-panel#managing-resource-groups)
...
- Know [how to manage account users](/guides/account/account-information/manage-local-users)
...
[**Beta**](/guides/account/account-information/control-panel-navigation)**&#x20;version:**
...
If you are accessing this menu for the first time, the following page appears. Click [`Create a policy`](/guides/account/account-information/use-iam-policies-control-panel#creating-a-policy) or [`Create users`](/guides/account/account-information/use-iam-policies-control-panel#managing-identities), depending on the action you want to perform.
...
![IAM onboarding - Use policies control panel](/images/account/account-information/use-iam-policies-control-panel/iam-onboarding.png)
...
![Tab empty - Use IAM policies control panel](/images/account/account-information/use-iam-policies-control-panel/tab-empty.png)
...
Once added, conditions are displayed with the [syntax used on the API](/guides/manage-and-operate/iam/using-policies-ovhcloud-api).

![Add policy conditions](/images/account/account-information/use-iam-policies-control-panel/add-policy-conditions.png)
...
1. <details>
   ...
   ![Actions authorize all](/images/account/account-information/use-iam-policies-control-panel/actions-authorize-all.png)
...
2. <details>
   ...
   Details of the content of the managed permission groups are available in the [associated documentation](/guides/account/account-information/iam-permission-groups).

   Managed action groups can be used in addition to unit actions.

   ![Actions managed permission groups](/images/account/account-information/use-iam-policies-control-panel/actions-managed-permission-groups.png)
...
3. <details>
   ...
   ![Actions add manually](/images/account/account-information/use-iam-policies-control-panel/actions-add-manually.png)
...
4. <details>
   ...
   ![Actions select - Use IAM policies control panel](/images/account/account-information/use-iam-policies-control-panel/actions-select.png)
...
![Tab more options](/images/account/account-information/use-iam-policies-control-panel/tab-more-options.png)
...
Details about user management are available in the [dedicated documentation](/guides/account/account-information/manage-local-users).
...
![Resource groups tab](/images/account/account-information/use-iam-policies-control-panel/resource-groups-tab.png)
...
![Add resource group vRack](/images/account/account-information/use-iam-policies-control-panel/add-resource-group-vrack.png)
...
![Resource groups more options](/images/account/account-information/use-iam-policies-control-panel/resource-groups-more-options.png)
