...
![Account email - Recognize phishing scams - step 1](/images/account/account-information/recognize-phishing-scams/account-email-01.png)
...
**The best way to permanently secure your account is to activate&#x20;**[**two-factor authentication**](/guides/account/account-information/secure-account-two-factor-authentication)**.**
