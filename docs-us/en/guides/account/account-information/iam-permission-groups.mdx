...
- [How to set up IAM policies via the Control Panel](/guides/account/account-information/use-iam-policies-control-panel)
- [How to implement IAM policies via the API](/guides/manage-and-operate/iam/using-policies-ovhcloud-api)
...
![IAM permissiongroups - Permission groups - step 1](/images/account/account-information/iam-permission-groups/iam-permissiongroups-01.png)
