...
![oktasso00.png](/images/account/account-information/sso-okta/43236232637843.png)

Click `Create App Integration`, select `SAML 2.0`, then select `Next`.

![oktasso01.png](/images/account/account-information/sso-okta/43236245509139.png)

![oktasso02.png](/images/account/account-information/sso-okta/43236232641811.png)

In the **General Settings** step, add a name for this application, such as "OVHcloud," and click `Next`.

![oktasso03.png](/images/account/account-information/sso-okta/43236232643987.png)
...
![oktasso04.png](/images/account/account-information/sso-okta/43236245511315.png)
...
![oktasso06\*.png](/images/account/account-information/sso-okta/43236245512851.png)

In the **Feedback** step, select the appropriate option and click `Finish`.

![oktasso6b.png](/images/account/account-information/sso-okta/43236245513363.png)

Then open the application, go to the `Assignments` tab, and assign users or groups to the application.

![oktasso07B.png](/images/account/account-information/sso-okta/43236245514003.png)

Before going to the next section, go to the `Sign On` tab, access the **Metadata URL**, and save the provided XML file.

![oktasso08.png](/images/account/account-information/sso-okta/43236245514771.png)
...
![local\_identities.png](/images/account/account-information/sso-okta/43236245515283.png)

Click the `SSO connection` button.

![oktasso12.png](/images/account/account-information/sso-okta/43236232650515.png)
...
![oktasso13\*.png](/images/account/account-information/sso-okta/43236232651411.png)

Now you need to retrieve your Okta as the identity provider, as well as default groups.

![oktasso14.png](/images/account/account-information/sso-okta/43236245517459.png)

For more information, click on the link under **SSO service URL**.

![oktasso15.png](/images/account/account-information/sso-okta/43236232652947.png)

The *more options* `...` button allows you to update or delete the SSO, and view its details.

![oktasso16.png](/images/account/account-information/sso-okta/43236245518483.png)
...
![oktasso17.png](/images/account/account-information/sso-okta/43236245521043.png)

![oktasso18\*.png](/images/account/account-information/sso-okta/43236232656147.png)

You can then verify that the group is added to your OVHcloud account in the "Groups" section:

![oktasso19.png](/images/account/account-information/sso-okta/43236245522707.png)
...
![local\_login.png](/images/account/account-information/sso-okta/43236245525011.png)
...
![oktasso21.png](/images/account/account-information/sso-okta/43236245525395.png)

You are now logged in with the same customer code but through your Okta user.

![local\_account.png](/images/account/account-information/sso-okta/43236245526291.png)
