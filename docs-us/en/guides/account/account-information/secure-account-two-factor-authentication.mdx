...
- An understanding of the [password management recommendations for accessing your account](/guides/account/account-information/manage-account-password)
...
![2FA - step 1](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-1.png)
...
![2FA - step 2](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-2.png)
...
![2FA 3 mobile app](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-3-mobile-app.png)
...
![2FA 3 security key](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-3-security-key.png)
...
![2FA - step 4](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-4.png)
...
![2FA - Secure account two factor authentication - step 6](/images/account/account-information/secure-account-two-factor-authentication/2fa-06.png)

Two-factor authentication is now enabled! Click `Confirm` to finish.

![2FA - step 5](/images/account/account-information/secure-account-two-factor-authentication/2fa-step-5.png)
...
![2FA - Secure account two factor authentication - step 8](/images/account/account-information/secure-account-two-factor-authentication/2fa-08.png)
...
![2FA - Secure account two factor authentication - step 10](/images/account/account-information/secure-account-two-factor-authentication/2fa-10.png)
...
Once you have gathered your supporting documents, [contact our OVHcloud support team](/guides/account/account-information/contact-us-support).
