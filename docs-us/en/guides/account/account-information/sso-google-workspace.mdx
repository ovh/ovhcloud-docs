...
![googlesso01.png](/images/account/account-information/sso-google-workspace/43236080635667.png)

Click `Add app` then `Add custom SAML app`.

![googlesso1b\*.png](/images/account/account-information/sso-google-workspace/43236080641683.png)

In the **App details** step, add a name for this interconnection, "OVHcloud" for example. Click `Continue`.

![googlesso02.png](/images/account/account-information/sso-google-workspace/43236087566995.png)
...
![googlesso3\*.png](/images/account/account-information/sso-google-workspace/43236080647315.png)
...
![googlesso04\*.png](/images/account/account-information/sso-google-workspace/43236087577747.png)
...
![googlesso05.png](/images/account/account-information/sso-google-workspace/43236080653459.png)

Enable access to this application by clicking `OFF for everyone` in the "User access" section.

![googlesso06.png](/images/account/account-information/sso-google-workspace/43236080658963.png)

Click `ON for everyone` then the `SAVE` button.

![googlesso07\*.png](/images/account/account-information/sso-google-workspace/43236080662803.png)
...
![local\_identities.png](/images/account/account-information/sso-google-workspace/43236080664851.png)

Click the `SSO connection` button.

![googlesso11.png](/images/account/account-information/sso-google-workspace/43236080666387.png)
...
![googlesso12\*.png](/images/account/account-information/sso-google-workspace/43236087601555.png)

Now you need to retrieve your Google Workspace as the identity provider, as well as default groups.

![googlesso13.png](/images/account/account-information/sso-google-workspace/43236087604371.png)

For more information, click on the link under **SSO Service URL**.

![googlesso14.png](/images/account/account-information/sso-google-workspace/43236080678547.png)

The *more options* `...` button allows you to update or delete the SSO, and view its details.

![googlesso15.png](/images/account/account-information/sso-google-workspace/43236087614099.png)
...
![googlesso17.png](/images/account/account-information/sso-google-workspace/43236087614611.png)

Click `SAML attribute mapping` to edit the mapping of information shared between Google Workspace and OVHcloud.

![googlesso18.png](/images/account/account-information/sso-google-workspace/43236087620755.png)
...
![googlesso19.png](/images/account/account-information/sso-google-workspace/43236087623315.png)
...
![googlesso20.png](/images/account/account-information/sso-google-workspace/43236087627667.png)

![googlesso21.png](/images/account/account-information/sso-google-workspace/43236087630995.png)

You can then verify that the group is added to your OVHcloud account in the **Groups** section:

![googlesso22.png](/images/account/account-information/sso-google-workspace/43236080704659.png)
...
![local\_login.png](/images/account/account-information/sso-google-workspace/43236080707859.png)
...
![googlesso24.png](/images/account/account-information/sso-google-workspace/43236080714899.png)

You are now logged in with the same customer code but through your Google Workspace user.

![local\_account.png](/images/account/account-information/sso-google-workspace/43236080717331.png)
