...
For more information about finding your customer code, see [this guide](/guides/account/account-information/create-account#customer-code).
...
Before you make any changes, please ensure that all contact email addresses are valid, otherwise the request will not be successful. For full instructions, please see our [dedicated guide](/guides/account/account-information/secure-account-manage-personal-information#personal-info).
