...
Creating an account is free and simple. Your account is designed to give you easy access to your information and help you manage your services. To learn how to create an account, [click here](/guides/account/account-information/create-account).
...
For more information about finding your customer code, see [this guide](/guides/account/account-information/create-account#what-is-my-customer-code).

 

### What if I cannot log in to my customer account?

For various reasons — such as forgetting your password, or losing access to your email address or your mobile phone — you may not be able to log in to the OVHcloud Control Panel. If this happens to you, please follow [this guide](/guides/account/account-information/secure-account-two-factor-authentication#what-do-i-do-if-i-lose-one-of-my-devices-or-if-it-stops-working), which is designed for resolving situations like this.

 

### How do I change my personal information?

To view or change your personal details, log in to the OVHcloud Control Panel with your login credentials. You can access your personal information by clicking directly on your name and initials in the top right-hand corner of your dashboard in the OVHcloud Control Panel. See [this guide](/guides/account/account-information/secure-account-manage-personal-information) for more details.
...
Before you make any changes, please ensure that all contact email addresses are valid, otherwise the request will not be successful. For full instructions, please see our [dedicated guide](/guides/account/account-information/secure-account-manage-personal-information#changing-your-personal-details).
...
For more information, see our guides on [password management](/guides/account/account-information/manage-account-password), [two-factor authentication](/guides/account/account-information/secure-account-two-factor-authentication), and [IP restriction](/guides/account/account-information/restrict-ip-access).
...
For further information, please refer to our [guide](/guides/account/account-information/secure-account-two-factor-authentication).
...
More details are available in our dedicated [guide](/guides/account/account-information/secure-account-two-factor-authentication).
...
To identify and report a phishing email, please refer to our [dedicated guide](/guides/account/account-information/recognize-phishing-scams).
...
- [Secure your OVHcloud account and manage your personal information](/guides/account/account-information/secure-account-manage-personal-information)
- [Change your account password](/guides/account/account-information/manage-account-password)
- [Secure your OVHcloud account with two-factor authentication](/guides/account/account-information/secure-account-two-factor-authentication)
- [Secure a VPS](/guides/bare-metal-cloud/vps/secure-your-vps)
