...
Refer to the [Terraform guide](/guides/public-cloud/cross-functional/how-to-use-terraform) for the initial provider setup.
...
For more information, please consult our guides in the [Public Cloud Network Services](/guides/public-cloud/network-services/networking-concepts) section. The [Concepts guide](/guides/public-cloud/network-services/networking-concepts) provides an introduction to Public Cloud Networking.
...
Your total Public Cloud resources will initially be limited. Check your quotas via `Quota & Regions` under **Settings** in the left navigation bar. See [the dedicated documentation](/guides/public-cloud/cross-functional/increasing-public-cloud-quota) for more information.
...
Choose between **monthly** (lower cost, non-reversible) or **hourly** (flexible, [convertible to monthly](/guides/public-cloud/compute/changing-hourly-monthly-billing)). Hourly billing runs until the **instance is deleted**. See the [billing documentation](/guides/public-cloud/cross-functional/public-cloud-billing).
...
- [Rescue mode](/guides/public-cloud/compute/activating-rescue-mode-public-cloud-instance)
...
This guide does not cover private networking for instances. Please consult our documentation on [Public Cloud Network Services](/guides/public-cloud/network-services/networking-concepts) regarding this topic.
...
If you receive error messages regarding your **SSH keys**, verify that your local device has a properly configured private SSH key using the information in [this guide](/guides/public-cloud/compute/creating-ssh-keys).
...
If you have created an instance without an SSH key, via the [OVHcloud API](/guides/manage-and-operate/api/first-steps) or the [OpenStack Horizon interface](/guides/public-cloud/compute/create-instance-in-horizon), you can only add an SSH key to your instance via [rescue mode](/guides/public-cloud/compute/activating-rescue-mode-public-cloud-instance) by following the instructions set out in [this guide](/guides/public-cloud/compute/replacing-lost-ssh-key-pair).
...
[Depending on your setup](#step-1-create-an-ssh-key-set), you will have to enter a passphrase that protects your private key or specify the path to your key file. Consult our [SSH keys guide](/guides/public-cloud/compute/creating-ssh-keys) for detailed information on this topic.

If you use an alternative SSH client software, refer to its user documentation. A usage example for the open-source solution `PuTTY` is available in [this guide](/guides/bare-metal-cloud/dedicated-servers/ssh-using-putty-on-windows).
...
![First instance - Getting started - step 16](/images/public-cloud/compute/getting-started/first-instance-16.png)
...
![First instance - Getting started - step 17](/images/public-cloud/compute/getting-started/first-instance-17.png)
...
![First instance - Getting started - step 18](/images/public-cloud/compute/getting-started/first-instance-18.png)
...
![First instance - Getting started - step 19](/images/public-cloud/compute/getting-started/first-instance-19.png)
...
![First instance - Getting started - step 20](/images/public-cloud/compute/getting-started/first-instance-20.png)
...
![First instance - Getting started - step 22](/images/public-cloud/compute/getting-started/first-instance-22.png)
...
![First instance - Getting started - step 23](/images/public-cloud/compute/getting-started/first-instance-23.png)
...
![First instance - Getting started - step 24](/images/public-cloud/compute/getting-started/first-instance-24.png)
...
When configuring user accounts and permission levels on an instance, we recommend to make use of the information in our [user account guide](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server).
...
## Go further
[How to activate a Windows license for an instance in private mode](/guides/public-cloud/compute/activate-windows-license-private-mode)

[How to reset a Windows Administrator password](/guides/bare-metal-cloud/vps/reset-windows-password)
