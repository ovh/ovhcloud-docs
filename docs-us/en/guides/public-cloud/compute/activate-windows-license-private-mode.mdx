...
We recommend that you read our guide on [Accessing the Horizon](/guides/public-cloud/cross-functional/introducing-horizon) interface to familiarize yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.us/auth/login/) interface using the method listed in the [first part of this guide](/guides/public-cloud/network-services/configure-vrack).

Choose the proper work zone.

![Activate Windows license - step 1](/images/public-cloud/compute/activate-windows-license-private-mode/activate-windows-license-01.png)
...
![Activate Windows license - step 2](/images/public-cloud/compute/activate-windows-license-private-mode/activate-windows-license-02.png)

 

Select your interface and confirm.

![Activate Windows license - step 3](/images/public-cloud/compute/activate-windows-license-private-mode/activate-windows-license-03.png)
...
- [How to Set OpenStack Environment Variables](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
