...
3. Select `Linux server` as the device type.
   ...
   ![PCI\_compute\_tutorials\_VPNtailscale01.png](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/33770343615251.png)
...
4) Enable `ephemeral nodes` to ensure that nodes are automatically removed from the network when their corresponding server is deleted.
   ...
   ![PCI\_compute\_tutorials\_VPNtailscale02.png](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/33770343619347.png)
...
4) Approve the node using the menu on the right (with the *more options* `...` button).
   ...
   ![PCI\_compute\_tutorials\_VPNtailscale03.png](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/33770343621139.png)
...
![PCI\_compute\_tutorials\_VPNtailscale04.png](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/33770343623315.png)
