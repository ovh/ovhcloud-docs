...
- [Two Public Cloud instances](/guides/public-cloud/compute/getting-started) deployed in different [OVHcloud Local Zones](https://us.ovhcloud.com/public-cloud/local-zone/) (we will use Miami and Denver for this example)
...
[Create two instances](/guides/public-cloud/compute/getting-started) in different OVHcloud Local Zones, like Miami and Denver.
...
3. Select `Linux server` as the device type.
   ...
   ![Compute tutorials VPN Tailscale](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/compute-tutorials-vpn-tailscale.png)
...
4) Enable `ephemeral nodes` to ensure that nodes are automatically removed from the network when their corresponding server is deleted.
   ...
   ![Compute tutorials VPN Tailscale - step 4](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/compute-tutorials-vpn-tailscale-4.png)
...
4) Approve the node using the menu on the right (with the *more options* `...` button).
   ...
   ![Compute tutorials VPN Tailscale - step 2](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/compute-tutorials-vpn-tailscale-2.png)
...
![Compute tutorials VPN Tailscale - step 3](/images/public-cloud/compute/local-zones-vpn-tailscale-integration/compute-tutorials-vpn-tailscale-3.png)
