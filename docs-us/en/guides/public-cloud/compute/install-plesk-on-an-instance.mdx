...
- A message states: "You can also log in as 'root' using your 'root' password.". However, by default, no root password is generated. If needed, customers can follow [this guide](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server)**&#x20;**&#x74;o enable the root user and set a password.

Once on the Plesk page, follow the on-screen instructions to complete the setup.

![Signup - Install plesk on an instance](/images/public-cloud/compute/install-plesk-on-an-instance/signup.png)
