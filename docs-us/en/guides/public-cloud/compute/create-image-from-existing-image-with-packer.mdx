...
- An [OVHcloud Public Cloud project](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- A terminal
...
You can retrieve the `openrc.sh` file from the [OVHcloud Control Panel](https://manager.us.ovhcloud.com/) using the procedure documented in [this guide](/guides/public-cloud/compute/upload-own-image#using-cli).
