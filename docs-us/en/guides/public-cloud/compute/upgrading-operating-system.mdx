...
**WARNING:** As with any major release upgrade of an operating system there is a risk of failure, data loss, or broken software configuration. Therefore, OVHcloud strongly recommends [backing up your instance](/guides/public-cloud/compute/save-an-instance) and conducting extensive testing on your applications to ensure they work on the new operating system version before following this tutorial.
...
- [root access](/guides/public-cloud/compute/getting-started) to the server
