...
Copy this key string to [add it to a new instance](/guides/public-cloud/compute/getting-started#4.3-select-an-image) or to [import it into the OVHcloud Control Panel](/guides/public-cloud/compute/getting-started#step-2-storing-public-keys-in-the-ovhcloud-control-panel).
