...
You can find more information in our [create a Public Cloud instance](/guides/public-cloud/compute/getting-started) guide.
...
For example, [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) is an open-source SSH client software with many useful features. Find out how to use it for connections to OVHcloud servers and instance in our detailed tutorial, [How to use PuTTY](/guides/bare-metal-cloud/dedicated-servers/ssh-using-putty-on-windows).
...
Copy this key string to [add it to a new instance](/guides/public-cloud/compute/getting-started#step-4-create-the-instance) or to [import it into the OVHcloud Control Panel](/guides/public-cloud/compute/getting-started#step-2-import-ssh-keys).
...
- [How to Configure Additional SSH Keys](/guides/public-cloud/compute/configuring-additional-ssh-keys)
