...
- [Administrative access (root) to your instance via SSH](/guides/public-cloud/compute/creating-ssh-keys)
...
You can also find information on [managing multiple keys](/guides/public-cloud/compute/creating-ssh-keys#creating-key-pairs-for-openssh-connections) on your local device if your setup requires it.

 

### Step 2: Configure a new user account

[Connect to your instance](/guides/public-cloud/compute/getting-started) and use the commands below to create a new user account and `.ssh` folder:
...
You can learn more about user permissions and related topics in our [user account guide](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server).
...
[Connect to your instance](/guides/public-cloud/compute/getting-started) and open the file `authorized_keys` in the personal folder of the new user with your preferred text editor (`nano` is used in this example):
