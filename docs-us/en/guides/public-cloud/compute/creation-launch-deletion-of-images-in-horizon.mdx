...
![Select region - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/select-region.png)
...
![List - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/list.png)
...
![Create - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/create.png)
...
![Dashboard - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/dashboard.png)

You can click on the image name for details:

![Details - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/details.png)

In the **Actions** column, you can:

- launch the image selected to create an instance - when you do this, the menu appears

  ![Instances details - Creation launch deletion of images in Horizon](/images/public-cloud/compute/creation-launch-deletion-of-images-in-horizon/instances-details.png)
