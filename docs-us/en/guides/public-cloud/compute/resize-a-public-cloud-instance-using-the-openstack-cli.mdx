...
description: "Learn how to resize your Public Cloud instance using the OpenStack CLI."
zendesk_id: 22653696589203
zendesk_hash: 77c177841cfdc487
content_hash: 742ed7e51c7e336d
updated: 2023-11-13
---
...
**Limitations:&#x20;**&#x4F;nly upscaling is possible with Public Cloud instances.
...
**NOTE:** This manipulation causes the instance to be shut down for the time of the operation.

:::

### Performing a backup

When performing a resize, the instance is shut down for the time of the operation. We therefore recommend that you back up your instance and stop all running processes before proceeding. For more information on how to back up your instance, read the following [guide](https://support.us.ovhcloud.com/hc/en-us/articles/4460743125395).
