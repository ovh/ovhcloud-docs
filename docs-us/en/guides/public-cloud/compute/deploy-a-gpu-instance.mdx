...
- An [SSH key](/guides/public-cloud/compute/getting-started#step-1-create-an-ssh-key-set) created to deploy a Linux GPU instance
...
Next, follow the remaining steps in [this guide](/guides/public-cloud/compute/getting-started). The process may take a few minutes.
