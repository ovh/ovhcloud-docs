...
![Diagram compare classic boot from](/images/public-cloud/compute/start-instance-on-attached-volume/diagram-compare-classic-boot-from.png)
...
![Horizon volumes dashboard](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-volumes-dashboard.png)
...
![Horizon create configurator](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-create-configurator.png)
...
![Horizon details - Start instance on attached volume](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-details.png)
...
![Horizon instances dashboard](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-instances-dashboard.png)
...
![Horizon create configurator - step 2](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-create-configurator-2.png)
...
![Horizon details - Start instance on attached volume - step 2](/images/public-cloud/compute/start-instance-on-attached-volume/horizon-details-2.png)
