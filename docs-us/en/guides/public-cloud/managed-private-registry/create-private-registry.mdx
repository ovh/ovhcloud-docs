...
- [OVHcloud CLI](/guides/manage-and-operate/cli/getting-started-ovhcloud-cli) installed and configured
...
## Go further
- [Connecting to the Harbor user interace](/guides/public-cloud/managed-private-registry/connecting-harbor-user-interface)
