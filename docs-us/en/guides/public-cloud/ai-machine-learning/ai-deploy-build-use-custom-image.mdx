...
![PaaS AI docker - step 1](/images/public-cloud/ai-machine-learning/ai-deploy-build-use-custom-image/paas-ai-docker-01.png)
...
You can find a basic example in the section below, and more advanced tutorials in our [AI Deploy documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-getting-started).
...
![Manager AI dashboard docker tab](/images/public-cloud/ai-machine-learning/ai-deploy-build-use-custom-image/manager-ai-dashboard-docker-tab.png)

From there, scroll down to the **Shared Docker Registries** area.

![Manager AI dashboard docker tab - step 2](/images/public-cloud/ai-machine-learning/ai-deploy-build-use-custom-image/manager-ai-dashboard-docker-tab-2.png)
