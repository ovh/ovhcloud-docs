...
![AI order advanced configuration](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/ai-order-advanced-configuration.png)

Once created, all the labels of an AI Deploy app are listed on the app details, in the **Labels** panel:

![Manager AI dashboard](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard.png)
...
![Manager AI dashboard general information](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard-general-information.png)

</Tab>

<Tab label="Via the ovhai CLI">

To follow this section, make sure you have installed the [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-install-client) on your computer or on an instance.
...
![Manager AI dashboard tab](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard-tab.png)
...
![Manager AI dashboard create token - step 2](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard-create-token-2.png)
...
An operator token grants read access along with management access for the matching apps. This means that you can manage the AI Deploy app lifecycle (start/stop/delete) using either the CLI (more info [here](/guides/public-cloud/ai-machine-learning/cli-install-client)) or the [AI Training API](https://us-east-va.ai.cloud.ovh.us/) by providing this token.

![Manager AI dashboard create token - step 3](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard-create-token-3.png)
...
![PaaS AI access - step 7](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/paas-ai-access-07.png)
...
![PaaS AI access - step 8](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/paas-ai-access-08.png)
...
![Manager AI dashboard tab more options](/images/public-cloud/ai-machine-learning/ai-deploy-tokens/manager-ai-dashboard-tab-more-options.png)
