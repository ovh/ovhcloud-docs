...
![PaaS AI compare audio - step 1](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-01.png)
...
- A [user for AI Training](/guides/public-cloud/ai-machine-learning/manage-users-roles)
...
![PaaS AI compare audio - step 2](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-02.jpg)
...
If you want to upload it from the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/), go to the Object Storage section and [create a new object container](/guides/public-cloud/ai-machine-learning/compliance)**&#xA0;**&#x62;y clicking `Object Storage` > `Create an object container`.
...
If you want to run it with the CLI, just follow [this guide](/guides/public-cloud/ai-machine-learning/cli-access-data). You have to choose the region, the name of your container, and the path where your data is located and use the following command:
...
![PaaS AI compare audio 02 - step 2](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-02-2.png)
...
![PaaS AI compare audio - step 3](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-03.png)
...
Here we will use the [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-run-job). If you wish to do this from the OVHcloud Control Panel, refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-training-submit-job).
...
![PaaS AI compare audio - step 4](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-04.png)

*Loss:*

![PaaS AI compare audio - step 5](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-05.png)

- **Validation data:**

*Accuracy:*

![PaaS AI compare audio - step 6](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-06.png)

*Loss:*

![PaaS AI compare audio - step 7](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-07.png)

You can then observe which model is better in terms of speed, accuracy, or resource consumption...

![PaaS AI compare audio - step 8](/images/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb/paas-ai-compare-audio-08.png)
