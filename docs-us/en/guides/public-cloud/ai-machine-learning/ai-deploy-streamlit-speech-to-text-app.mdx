...
![AI diagram speech text](/images/public-cloud/ai-machine-learning/ai-deploy-streamlit-speech-to-text-app/ai-diagram-speech-text.png)

Overview of the Speech-to-Text app:

![PaaS AI - step 2](/images/public-cloud/ai-machine-learning/ai-deploy-streamlit-speech-to-text-app/paas-ai-02.png)
...
- A [user for AI Deploy](/guides/public-cloud/ai-machine-learning/manage-users-roles)
...
**NOTE:** The shared registry should only be used for testing purposes. Please consider creating and attaching your own registry. More information about this can be found [here](/guides/public-cloud/ai-machine-learning/manage-registries). The images pushed to this registry are for AI Tools workloads only and will not be accessible for external uses.
