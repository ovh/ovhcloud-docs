...
description: "Learn how to deploy an application for Exploratory Data Analysis (EDA) and interactive prediction."
zendesk_id: 37232672183187
zendesk_hash: bbaa251f34f51782
content_hash: 6ecf524d82222804
updated: 2025-06-27
---
...
![PaaS\_AI\_deploy\_streamlitEDA01.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-deploy-an-interactive-app-for-eda-and-prediction-using-stream/37233212536723.png)
...
To do this, you will use [Streamlit](https://streamlit.io/), a Python framework that turns scripts into a shareable web application. You will also learn how to build and use a custom Docker image for a Streamlit application.
...
- More information about Streamlit's capabilities can be found [here](https://docs.streamlit.io/en/stable/).
- A direct link to the full Python file can be found [here](https://github.com/ovh/ai-training-examples/blob/main/apps/streamlit/eda-classification-iris/app.py).
...
This Python file is dedicated to loading the **PyTorch model**. You can find the full code [here](https://github.com/ovh/ai-training-examples/blob/main/apps/streamlit/eda-classification-iris/utils.py).
...
All the functions defined above are called in the `main` Python file `app.py` to build the Streamlit app. You can find this part of the code as well as the different functions defined previously on the [GitHub repository](https://github.com/ovh/ai-training-examples/blob/main/apps/streamlit/eda-classification-iris/app.py).
...
- You can imagine deploying an AI model with an other tool: **Gradio**. Refer to this [tutorial](https://support.us.ovhcloud.com/hc/en-us/articles/37223194768147).
