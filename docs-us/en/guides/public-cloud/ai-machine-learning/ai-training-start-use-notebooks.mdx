...
Follow the same steps as a classic job submission described [here](/guides/public-cloud/ai-machine-learning/ai-training-submit-job) until you reach [the Docker image step](/guides/public-cloud/ai-machine-learning/ai-training-submit-job#step-5---providing-a-docker-image).
...
![Manager AI order docker](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/manager-ai-order-docker.png)

 

### Step 3 - Continue as a classic job submission

Continue to follow the same steps as a classic job submission described [here](/guides/public-cloud/ai-machine-learning/ai-training-submit-job) until you reach [Step 3 - Consulting your job](/guides/public-cloud/ai-machine-learning/ai-training-submit-job#step-10---consulting-your-job).
...
![Manager AI dashboard - step 2](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/manager-ai-dashboard-2.png)
...
If you have never created a user for AI Training yet, you can follow the instructions [here](/guides/public-cloud/ai-machine-learning/manage-users-roles).

:::

Fill in the fields and click `Connect`.

![PaaS AI docker - step 3](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/paas-ai-docker-03.png)
...
![PaaS AI docker - step 4](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/paas-ai-docker-04.png)

Select the one that you want to use, and you will be redirected to the corresponding editor.

![PaaS AI docker - step 5](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/paas-ai-docker-05.png)
...
![PaaS AI docker - step 6](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/paas-ai-docker-06.png)

From the Jupyter Notebook interface, the `!nvidia-smi` command will retrieve the same information.

![PaaS AI docker 06](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/paas-ai-docker-06-b.png)
...
![Manager AI service list more options](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/manager-ai-service-list-more-options.png)
...
![Manager AI dashboard interrupted](/images/public-cloud/ai-machine-learning/ai-training-start-use-notebooks/manager-ai-dashboard-interrupted.png)
