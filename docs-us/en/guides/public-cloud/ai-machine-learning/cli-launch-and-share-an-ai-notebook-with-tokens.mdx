...
This guide shows how to share [notebooks](https://support.us.ovhcloud.com/hc/en-us/articles/34842392686867) with other people through the **ovhai** CLI.

 

## Requirements

- a working `ovhai` CLI (get started with [this guide](https://support.us.ovhcloud.com/hc/en-us/articles/34692499017619))
...
![PaaS\_AI\_CLI\_shareNotebookTokens01.png](/images/public-cloud/ai-machine-learning/cli-launch-and-share-an-ai-notebook-with-tokens/34764409872403.png)
...
![PaaS\_AI\_CLI\_shareNotebookTokens02.png](/images/public-cloud/ai-machine-learning/cli-launch-and-share-an-ai-notebook-with-tokens/34764409880211.png)
