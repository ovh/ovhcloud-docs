...
description: "Learn how to deploy an application for sketch recognition using a trained model."
zendesk_id: 37223194768147
zendesk_hash: 66618e246e2941ed
content_hash: f199405424916d85
updated: 2025-06-25
---
...
The use case is **handwritten digit recognition**, based on the [MNIST dataset](http://yann.lecun.com/exdb/mnist/).

To do this, you will use [Gradio](https://gradio.app/), an open-source Python library that is a quick way to expose and use Machine Learning models. You will also learn how to build and use a custom Docker image for a Gradio application.

Overview of the app:

![PaaS\_AI\_deploy\_sketch01.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-deploy-a-gradio-app-for-sketch-recognition/37224277948563.png)
...
- More information about Gradio's capabilities can be found [here](https://gradio.app/docs/).
- A direct link to the full Python file can be found [here](https://github.com/ovh/ai-training-examples/blob/main/apps/gradio/sketch-recognition/app.py).

Here we will mainly discuss how to write the `app.py` code, the `requirements.txt` file, and the `Dockerfile`. If you want to see the whole code, please refer to the [GitHub repository](https://github.com/ovh/ai-training-examples/tree/main/apps/gradio/sketch-recognition).
...
Here you will use your trained model, then save it in an Object Storage container. Click [here](https://support.us.ovhcloud.com/hc/en-us/articles/34772059068435) to learn more about Object Storage.
...
The `-t` argument allows you to choose the identifier to give to your image. Usually image identifiers are composed of a **name** and a **version tag** `<name>:<version>`. For this example we chose **gradio\_app:latest**.
