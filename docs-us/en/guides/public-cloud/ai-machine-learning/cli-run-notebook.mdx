...
For more information on **installing and configuring the ovhai CLI, see our&#x20;**[**dedicated guide**](/guides/public-cloud/ai-machine-learning/cli-install-client)**.**
...
![PaaS AI CLI launch - step 1](/images/public-cloud/ai-machine-learning/cli-run-notebook/paas-ai-cli-launch-01.png)
...
You are billed for `RUNNING` notebooks but not for `STARTING`, `STOPPING`, and `STOPPED` notebooks. However, to restore your code when you restart a `STOPPED` notebook, it needs to be stored in your Object Storage, which you are billed for. You can find more information about the AI Notebooks billing in the [Billing and Lifecycle guide](/guides/public-cloud/ai-machine-learning/ai-notebooks-billing).
...
## Go further
Learn how to access your Object Storage data and Git repositories from your notebooks [here](/guides/public-cloud/ai-machine-learning/cli-access-data).

Learn how to share your notebooks with other people [here](/guides/public-cloud/ai-machine-learning/cli-sharing-notebooks).
