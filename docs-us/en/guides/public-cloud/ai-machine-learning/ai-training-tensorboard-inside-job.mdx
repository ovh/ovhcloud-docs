...
![PaaS AI - step 1](/images/public-cloud/ai-machine-learning/ai-training-tensorboard-inside-job/paas-ai-01.png)
...
- a working `ovhai` CLI [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-install-client)
...
## Go further
To compare AI models based on resource consumption, accuracy, and training time, refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb).
