...
description: "Learn how to run, access, restart, stop, and delete AI Notebooks through the ovhai CLI."
zendesk_id: 34697540152723
zendesk_hash: efd8dd956211c574
content_hash: 75a06dcd2de56d58
updated: 2025-12-08
---
...
For more information on **installing and configuring the ovhai CLI, see our&#x20;**[**dedicated guide**](https://support.us.ovhcloud.com/hc/en-us/articles/34692499017619)**.**
...
By default, this notebook will be run on a single `L4-1-GPU`, with `restricted access` and the `latest version` available of the framework you have selected.
...
For example, to launch a notebook with the `ai1-1-cpu` flavor, you would use the following command:
...
Then, you can add to your command the `--cpu <NUMBER>` or `--gpu <NUMBER>` flag to specify how many CPUs/GPUs you want. The following example will run the same notebook but on `2 ai1-1` CPUs:
...
Status:
  ...
  State:                STARTING
  Duration:             0
  Url:                  https://7600dda5-27f7-4937-9260-e24c987ae3c6.notebook.us-east-va.ai.cloud.ovh.us
  Grpc Address:         7600dda5-27f7-4937-9260-e24c987ae3c6.nb-grpc.us-east-va.ai.cloud.ovh.us:443
  Info Url:             https://ui.us-east-va.ai.cloud.ovh.us/notebook/7600dda5-27f7-4937-9260-e24c987ae3c6
  Monitoring Url:       ~
  Ssh Url:              ~
  Last Started At:      ~
  Last Stopped At:      ~
...
Status:
  ...
  Grpc Address:         7600dda5-27f7-4937-9260-e24c987ae3c6.nb-grpc.us-east-va.ai.cloud.ovh.us:443
  Info Url:             https://ui.us-east-va.ai.cloud.ovh.us/notebook/7600dda5-27f7-4937-9260-e24c987ae3c6
  Monitoring Url:       https://monitoring.us-east-va.ai.cloud.ovh.us/d/job?var-notebook=7600dda5-27f7-4937-9260-e24c987ae3c6&from=1726049489545
  Ssh Url:              ~
...
![PaaS\_AI\_CLI\_launchNotebook01.png](/images/public-cloud/ai-machine-learning/cli-launch-an-ai-notebook/34722888613267.png)
...
You are billed for `RUNNING` notebooks but not for `STARTING`, `STOPPING`, and `STOPPED` notebooks. However, to restore your code when you restart a `STOPPED` notebook, it needs to be stored in your Object Storage, which you are billed for. You can find more information about the AI Notebooks billing in the [Billing and Lifecycle guide](https://support.us.ovhcloud.com/hc/en-us/articles/35069201682835).
...
Learn how to access your Object Storage data and Git repositories from your notebooks [here](https://support.us.ovhcloud.com/hc/en-us/articles/34835415246483).

Learn how to share your notebooks with other people [here](https://support.us.ovhcloud.com/hc/en-us/articles/34763559719955).
