...
![Manager AI onboarding](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/manager-ai-onboarding.png)
...
You can find the capabilities for AI Deploy in the guide [AI Deploy capabilities](/guides/public-cloud/ai-machine-learning/ai-deploy-capabilities).
...
![Manager AI order resources](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/manager-ai-order-resources.png)
...
![Manager AI order application](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/manager-ai-order-application.png)
...
![AI order scaling disabled](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/ai-order-scaling-disabled.png)
...
For more detailed information about scaling strategies, please refer to our [AI Deploy - Scaling strategies](/guides/public-cloud/ai-machine-learning/ai-deploy-apps-deployments) guide.
...
![Manager AI order confidentiality](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/manager-ai-order-confidentiality.png)
...
To learn more about data, volumes, and permissions, check out our [data](/guides/public-cloud/ai-machine-learning/data-concepts-best-practices) guide.
...
Learn more about this feature in the [AI Deploy - Accessing your app with tokens](/guides/public-cloud/ai-machine-learning/ai-deploy-tokens) guide.
...
You can also generate the equivalent `ovhai` CLI command, which enables you to deploy the same application using the command line. This CLI can be downloaded [here](/guides/public-cloud/ai-machine-learning/cli-install-client). For more information, consult the [CLI - Launch an AI Deploy app](/guides/public-cloud/ai-machine-learning/cli-deploy-app) documentation.
...
![Manager AI dashboard create token](/images/public-cloud/ai-machine-learning/ai-deploy-getting-started/manager-ai-dashboard-create-token.png)
...
To follow this part, make sure you have installed the [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-install-client) on your computer or on an instance.
...
- Do you want to use **Streamlit** in order to create an app? Follow [this guide](/guides/public-cloud/ai-machine-learning/ai-deploy-build-use-flask-image).
