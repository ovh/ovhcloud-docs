...
This is the next step after you have designed the model with AI Notebooks. You can see the Notebook step in the tutorial: [Audio analysis and classification with AI](https://support.us.ovhcloud.com/hc/en-us/articles/37103267819667).
...
- The ovhai CLI interface installed on your system (more information [here](https://support.us.ovhcloud.com/hc/en-us/articles/34692499017619))
- [Docker](https://www.docker.com/get-started) installed and configured to build images.
- An OCI / Docker image registry. You can use a public registry (such as [Docker Hub](https://hub.docker.com/) for example) or a private registry. Refer to the [Creating a private registry](https://support.us.ovhcloud.com/hc/en-us/articles/19464979390099) documentation to create a private registry based on Harbor.
...
To train the model you'll need data and a place where to save the trained model. You can reuse the previous object storage used in the Notebook tutorial [Audio analysis and classification with AI](https://support.us.ovhcloud.com/hc/en-us/articles/37103267819667) or follow the step [Uploading your dataset on Public Cloud Storage](https://support.us.ovhcloud.com/hc/en-us/articles/37103267819667#uploading-your-dataset-on-public-cloud-storage) of this same tutorial.
...
If your images are stored in a private registry, please follow the documentation [Registries - Use & manage your registries](https://support.us.ovhcloud.com/hc/en-us/articles/34651189645331) to add your registry.
...
For more explanations about the CLI command for AI Training, please read this guide: [CLI Reference](https://support.us.ovhcloud.com/hc/en-us/articles/34765516794131).
