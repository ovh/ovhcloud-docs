...
**Learn about the submission of [apps](/guides/public-cloud/ai-machine-learning/ai-deploy-getting-started) through the [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-install-client).** To deploy an app, some parameters are mandatory. Others are optional, depending on your needs. We will show you how each of the parameters works by showing examples.

## Requirements

- A working `ovhai` CLI (see [this guide](/guides/public-cloud/ai-machine-learning/cli-install-client) to get started)
...
More information about adding and managing public and private registries can be found [here](/guides/public-cloud/ai-machine-learning/manage-registries).
...
## Go further
To know more about the CLI and available commands to interact with your app check out the [overview of ovhai](/guides/public-cloud/ai-machine-learning/cli-overview).
