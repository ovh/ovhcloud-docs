...
- The **OVHcloud AI CLI** (`ovhai`) installed; for instructions, see [how to install ovhai](/guides/public-cloud/ai-machine-learning/cli-install-client)
...
![AI order scaling disabled](/images/public-cloud/ai-machine-learning/ai-deploy-apps-deployments/ai-order-scaling-disabled.png)
...
![AI order scaling enabled](/images/public-cloud/ai-machine-learning/ai-deploy-apps-deployments/ai-order-scaling-enabled.png)
...
![AI order scaling enabled custom](/images/public-cloud/ai-machine-learning/ai-deploy-apps-deployments/ai-order-scaling-enabled-custom.png)
