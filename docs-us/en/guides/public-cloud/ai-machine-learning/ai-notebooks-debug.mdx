...
- An [Object Storage Container](/guides/storage-and-backup/object-storage/getting-started) in your OVHcloud account
...
All steps for starting and working on AI Notebooks are described in the [AI Notebooks - Getting Started](/guides/public-cloud/ai-machine-learning/ai-notebooks-getting-started) guide.
...
- **You have an authorized user or an authorized token:** To be able to connect to your notebook, you must have created a user or token. To create a new user, log into the OVHcloud Control Panel and open your Public Cloud project. In the left menu, click on `AI Dashboard` in the **AI & Machine Learning** section. This will allow you to manage and create AI users. To access AI solutions, use the `AI Platform - Read Only` role. For more advanced use, including management, select the `AI Platform - Operator` role. To follow all the steps in detail, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/manage-users-roles).

As an alternative, you can generate an authorized token directly via our [CLI](/guides/public-cloud/ai-machine-learning/cli-app-token).
