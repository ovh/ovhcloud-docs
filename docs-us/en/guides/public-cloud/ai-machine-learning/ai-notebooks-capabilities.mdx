...
AI Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-install-client).
...
GPU and CPU availability is subject to the quota set on your Public Cloud Project. You can [reach out to our support team](/guides/account/account-information/contact-us-support) to increase your quota.
