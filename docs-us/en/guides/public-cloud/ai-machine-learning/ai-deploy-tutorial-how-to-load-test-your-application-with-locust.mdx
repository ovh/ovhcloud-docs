...
description: "Learn how to load test your deployed applications by gradually querying your APIs with a load testing tool."
zendesk_id: 37314889423891
zendesk_hash: 23336a03c26027ea
content_hash: 038dcf763c8c9f26
updated: 2025-06-17
---
...
You can go for a SaaS load tester, such as [Gatling.io](https://gatling.io/) or [K6.io](https://k6.io/); nothing to install, easy to start.

A second option is using open-source load testing tools. Some tools are only command-line based, such as [hey](https://github.com/rakyll/hey) or [Wrk2](https://github.com/giltene/wrk2), while others come with a web interface like [Locust](https://locust.io/).
...
For this tutorial, we will load test a spam classifier API from the [AI Deploy app portfolio](https://support.us.ovhcloud.com/hc/en-us/articles/35572480827155). This API takes sentences (emails) as input text and outputs a spam probability score.

You can deploy this API easily from the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/) or [OVHcloud CLI](https://support.us.ovhcloud.com/hc/en-us/articles/34692499017619). A good strategy is to deploy with autoscaling, with minimum and maximum replicas. This way, we will monitor the growth of used replicas.
...
To be able to connect to your AI Deploy app, you have to [create a token](https://support.us.ovhcloud.com/hc/en-us/articles/34761257426707) bearer for your OVHcloud AI user.
...
- We put the token to access our API, generated via the OVHcloud Control Panel or `ovhai` CLI. We specify it in the header of the request. If you want to know more about the generation and use of tokens, you can follow [this tutorial](https://support.us.ovhcloud.com/hc/en-us/articles/35455776415507).
...
![locust\_aiDeploy\_newLoadTest.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240815753363.png)
...
![locust\_aiDeploy\_statisticsTab.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240799008531.png)
...
![locust\_aiDeploy\_chartsTab.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240799009043.png)
...
![locust\_aiDeploy\_appMonitoring.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240799011219.png)
...
![locust\_aiDeploy\_CPUmonitoring.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240799012883.png)
...
![locust\_aiDeploy\_latencyMonitoring.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240799013395.png)
...
![locust\_aiDeploy\_scaling.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-how-to-load-test-your-application-with-locust/42240815761683.png)
...
Comparison of load testing tools: [Comparison of load testing tools](https://grafana.com/blog/2020/03/03/open-source-load-testing-tool-review/)
