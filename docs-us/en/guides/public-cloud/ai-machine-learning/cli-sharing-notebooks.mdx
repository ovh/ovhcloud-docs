...
description: "This guide shows how to share notebooks with other people through the ovhai CLI."
zendesk_id: 34763559719955
zendesk_hash: fe8ec2e6d3d9b09b
content_hash: 80e13967f1f73514
updated: 2025-03-11
---

# CLI - Launch and share an AI Notebook with tokens

This guide shows how to share [notebooks](/guides/public-cloud/ai-machine-learning/ai-notebooks-getting-started) with other people through the **ovhai** CLI.

 

## Requirements

- a working `ovhai` CLI (get started with [this guide](/guides/public-cloud/ai-machine-learning/cli-install-client))
...
Status:     
  ...
  Transitioned At: 
  Duration:        53s
  Url:             https://d8d809f2-717b-4b60-9881-07e6987a144d.notebook.us-east-va.ai.cloud.ovh.us
  Monitoring Url:  https://monitoring.us-east-va.ai.cloud.ovh.us/d/gpu?var-notebook=d8d809f2-717b-4b60-9881-07e6987a144d&from=1622124009877
  Transitioned At: 27-05-21 14:01
```

Here, the URL is `https://d8d809f2-717b-4b60-9881-07e6987a144d.notebook.us-east-va.ai.cloud.ovh.us`. It will be different for every notebook you create. Anyone in your Public Cloud project can now access this URL from their browser using their own credentials.
...
We just created a token named `my-token`, that will allow to access any notebook that has a label `subject=image-recognition`. The `--role read` option means people using this token will only be allowed to access the address from their browser but they won't be able to stop or delete the notebook. If you want to allow other people to do so, you should use `--role operator` instead.
...
Status:     
  ...
  Transitioned At: 
  Duration:        34s
  Url:             https://3cd20aa3-3f5d-49be-b027-ccaf6dd06f01.notebook.us-east-va.ai.cloud.ovh.us
  Monitoring Url:  https://monitoring.us-east-va.ai.cloud.ovh.us/d/gpu?var-notebook=3cd20aa3-3f5d-49be-b027-ccaf6dd06f01&from=1622124160516
  Transitioned At: 27-05-21 14:03
```

The `Url` field corresponds to the address to paste in your browser to access the notebook. If you're already logged in with your browser, then it will display the notebook. Otherwise, you will get a page like this:

![PaaS AI CLI share notebook tokens - step 1](/images/public-cloud/ai-machine-learning/cli-sharing-notebooks/paas-ai-cli-share-notebook-tokens-01.png)

You can try in a private navigation window to get the login page and test the token. Clicking on `Login with token` leads to this page:

![PaaS AI CLI share notebook tokens - step 2](/images/public-cloud/ai-machine-learning/cli-sharing-notebooks/paas-ai-cli-share-notebook-tokens-02.png)
...
Status:     
  ...
  Transitioned At: 
  Duration:        20s
  Url:             https://8e3ac445-0b47-4eea-9269-19a36b7213c7.notebook.us-east-va.ai.cloud.ovh.us
  Monitoring Url:  https://monitoring.us-east-va.ai.cloud.ovh.us/d/gpu?var-notebook=8e3ac445-0b47-4eea-9269-19a36b7213c7&from=1622124347366
  Transitioned At: 27-05-21 14:06
```

Anyone can now access the notebook by pasting the URL shown in the `ovhai notebook get` output in their browser. In this example, the `Url` is `https://8e3ac445-0b47-4eea-9269-19a36b7213c7.notebook.us-east-va.ai.cloud.ovh.us`.
