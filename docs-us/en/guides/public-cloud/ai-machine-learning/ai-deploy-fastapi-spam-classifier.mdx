...
- You can imagine deploying an AI model with another tool: **Gradio**. Read this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-gradio-sketch-recognition).
