...
AI Deploy is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-install-client).
...
**Local storage** is limited and not the recommended way to handle data, see the [OVHcloud documentation on data](/guides/public-cloud/ai-machine-learning/data-concepts-best-practices) for more information.
...
AI Deploy authorizes the deployment of your own Docker images and applications from the [OVHcloud portfolio](/guides/public-cloud/ai-machine-learning/ai-deploy-apps-portfolio).

Docker images can be hosted in a public or private registry.

The use of `docker-compose` is not possible.

Please be aware that images need to be built with an **AMD architecture**. For more information, see [this guide](/guides/public-cloud/ai-machine-learning/ai-training-build-use-custom-image).
