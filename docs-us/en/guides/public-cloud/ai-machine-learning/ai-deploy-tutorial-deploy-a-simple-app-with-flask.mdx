...
description: "Learn how to build and use a custom Docker image for a Flask application. Flask is an open-source micro framework for web development in Python."
zendesk_id: 37144941925523
zendesk_hash: bc5d532b5fd45587
content_hash: 5bf22c21729dfd9d
updated: 2025-06-27
---

# AI Deploy - Tutorial - Deploy a simple app with Flask

**Learn how to build and use a custom Docker image for a Flask application. [Flask](https://flask.palletsprojects.com/en/2.0.x/) is an open-source micro framework for web development in Python.**
...
- A direct link to the full Python file can be found [here](https://github.com/ovh/ai-training-examples/tree/main/apps/flask/hello-world).
...
- A direct link to the full Dockerfile can be found [here](https://github.com/ovh/ai-training-examples/blob/main/apps/flask/hello-world/Dockerfile).
...
![PaaS\_AI\_deploy\_flask01.png](/images/public-cloud/ai-machine-learning/ai-deploy-tutorial-deploy-a-simple-app-with-flask/37145899411219.png)

 

## Go further

- **Flask** allows you to do sentiment classification on texts using Hugging Face models. [Here it is](https://support.us.ovhcloud.com/hc/en-us/articles/37228374318867).
