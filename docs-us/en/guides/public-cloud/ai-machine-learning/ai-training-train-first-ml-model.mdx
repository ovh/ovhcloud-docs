...
description: "Learn how to train your first Model in AI Training."
zendesk_id: 37640590695443
zendesk_hash: 4e76d20780f6184f
content_hash: 627f8d715a79b122
updated: 2025-06-17
---
...
More information about AI Training can be found [here](https://us.ovhcloud.com/public-cloud/ai-training/).

 

## Use case

We will train an image classifier on the *Fashion MNIST* dataset. This dataset contains 70,000 examples of *Zalando*'s article images. Each one is a 28x28 grayscale image associated with a label from 10 classes. This dataset is available on their [GitHub repository](https://github.com/zalandoresearch/fashion-mnist), but you can directly download it from [Kaggle](https://www.kaggle.com/datasets/zalando-research/fashionmnist). It is a `.zip` file (72MB).
...
**NOTE:** For more in-depth instructions, see [our GitHub page](https://github.com/ovh/ai-training-examples/tree/main/jobs/getting-started/train-first-model) on this process.
...
On the other hand, you can upload your data (dataset, python and requirements files, etc.) to the cloud, in the Object Storage. This can be done in two ways: either from the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/) or via the [ovhai CLI](https://cli.us-east-va.ai.cloud.ovh.us/).
...
First, go to the [OVHcloud Public Cloud section](https://us.ovhcloud.com/manager/).

Then, select the Object Storage section (in the Storage category) and [create a new object container](https://support.us.ovhcloud.com/hc/en-us/articles/34529635846419) by clicking `Storage` > `Object Storage` > `Create an object container`.
...
To follow this part, make sure you have installed the [ovhai CLI](https://cli.us-east-va.ai.cloud.ovh.us/) on your computer or an instance.
...
To launch your training job, you can also use the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/) or the [ovhai CLI](https://cli.us-east-va.ai.cloud.ovh.us/).
...
`<docker_image_name>`: Choose the Docker image you want to use to create your environment. You can get a list of the framework images hosted by OVHcloud [here](https://registry.hub.docker.com/u/ovhcom). You can also [use your own Docker image](https://support.us.ovhcloud.com/hc/en-us/articles/36029131111955).
...
`<BUCKET>`: container\@data\_store. Name and region of the container to download from.
...
- If you want to learn about Docker, check out this [tutorial](https://support.us.ovhcloud.com/hc/en-us/articles/36029131111955).
