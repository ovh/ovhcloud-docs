...
Then, select the Object Storage section (in the Storage category) and [create a new object container](/guides/public-cloud/ai-machine-learning/compliance) by clicking `Storage` > `Object Storage` > `Create an object container`.
