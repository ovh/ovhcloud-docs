...
description: "Learn all about the Python ovhai library."
zendesk_id: 34690650608147
zendesk_hash: baf4c35040288f2b
content_hash: b55c0671c900357f
updated: 2025-04-17
---

# AI Tools - ovhai SDK

**Learn all about the Python `ovhai` library.**

The `ovhai` library is a Python client that allows developers to easily use the [OVHcloud AI API](https://us-east-va.ai.cloud.ovh.us/). With this SDK, you can run, manage, and automate your notebooks, training, and deployments in the cloud using OVHcloud's AI products (AI Notebooks, AI Training, and AI Deploy).
...
Once you've installed the AI SDK, you can import it to use OVHcloud's AI products using the [API](https://us-east-va.ai.cloud.ovh.us/).
...
The token used to create the client can be created via the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/), from the AI Dashboard.
...
Every [OVHcloud's AI API](https://us-east-va.ai.cloud.ovh.us/) endpoint has its dedicated Python module that comes with four functions:
