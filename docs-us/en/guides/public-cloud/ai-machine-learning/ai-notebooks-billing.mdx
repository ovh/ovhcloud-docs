...
- `STARTING`: The notebook is being started and, if any, the remote data is synchronized from the Object Storage. To learn more about data synchronization, please check out the [Data - Concept and best practices](/guides/public-cloud/ai-machine-learning/data-concepts-best-practices) documentation. Then, the system allocates the necessary compute resources (CPUs/GPUs) for your Notebook. Finally, the base framework you have chosen is pulled for use in the notebook.
...
- `FAILED`: The notebook ended in error, e.g., the process in the notebook finished with a non-zero exit code. For more information, refer to [this section of our Troubleshooting documentation](/guides/public-cloud/ai-machine-learning/ai-notebooks-debug#cli-my-notebook-is-in-failed-status).
...
![AI notebooks lifecycle](/images/public-cloud/ai-machine-learning/ai-notebooks-billing/ai-notebooks-lifecycle.png)
...
![AI notebooks billing](/images/public-cloud/ai-machine-learning/ai-notebooks-billing/ai-notebooks-billing.png)
...
By default, your notebook will be mounted to a remote Object Storage container on the [/workspace](/guides/public-cloud/ai-machine-learning/ai-notebooks-workspace) location. This will be your default folder when you access your notebook.
