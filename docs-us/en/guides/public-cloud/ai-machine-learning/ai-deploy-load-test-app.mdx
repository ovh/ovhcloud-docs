...
For this tutorial, we will load test a spam classifier API from the [AI Deploy app portfolio](/guides/public-cloud/ai-machine-learning/ai-deploy-apps-portfolio). This API takes sentences (emails) as input text and outputs a spam probability score.

You can deploy this API easily from the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/) or [OVHcloud CLI](/guides/public-cloud/ai-machine-learning/cli-install-client). A good strategy is to deploy with autoscaling, with minimum and maximum replicas. This way, we will monitor the growth of used replicas.
...
To be able to connect to your AI Deploy app, you have to [create a token](/guides/public-cloud/ai-machine-learning/cli-app-token) bearer for your OVHcloud AI user.
...
- We put the token to access our API, generated via the OVHcloud Control Panel or `ovhai` CLI. We specify it in the header of the request. If you want to know more about the generation and use of tokens, you can follow [this tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-tokens).
...
![Locust AI new](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-new.png)
...
![Locust AI statistics tab](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-statistics-tab.png)
...
![Locust AI charts tab](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-charts-tab.png)
...
![Locust AI monitoring](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-monitoring.png)
...
![Locust AI umonitoring](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-umonitoring.png)
...
![Locust AI latency monitoring](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-latency-monitoring.png)
...
![Locust AI scaling](/images/public-cloud/ai-machine-learning/ai-deploy-load-test-app/locust-ai-scaling.png)
