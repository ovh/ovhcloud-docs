...
description: "Learn some tips to debug your AI Notebooks if things go wrong."
zendesk_id: 35066437160339
zendesk_hash: 16e3213cf13b0161
content_hash: 7688c0f3a5612b05
updated: 2026-08-27
---

# AI Notebooks - Troubleshooting

**Learn some tips to debug your AI Notebooks if things go wrong.**
...
- An [Object Storage Container](https://support.us.ovhcloud.com/hc/en-us/articles/4603838122643) in your OVHcloud account
...
### What is an AI Notebook, and how do I launch one?

All steps for starting and working on AI Notebooks are described in the [AI Notebooks - Getting Started](https://support.us.ovhcloud.com/hc/en-us/articles/34842392686867) guide.
...
- **Your notebook is up and running:** To connect to your notebook, it must be in the `RUNNING` or `IN SERVICE` status (green color in the OVHcloud Control Panel). If your notebook is starting up, wait a few moments until your data synchronizes, and you will be able to connect. The starting time may vary due to some parameters. The more data you synchronize, the more time it will take.
- **You have an authorized user or an authorized token:** To be able to connect to your notebook, you must have created a user or token. To create a new user, log into the OVHcloud Control Panel and open your Public Cloud project. In the left menu, click on `AI Dashboard` in the **AI & Machine Learning** section. This will allow you to manage and create AI users. To access AI solutions, use the `AI Platform - Read Only` role. For more advanced use, including management, select the `AI Platform - Operator` role. To follow all the steps in detail, please refer to this [documentation](https://support.us.ovhcloud.com/hc/en-us/articles/34504142321171).

As an alternative, you can generate an authorized token directly via our [CLI](https://support.us.ovhcloud.com/hc/en-us/articles/34761257426707).
...
- **Install packages in a terminal:** First, open a new terminal. If you have chosen the `Jupyterlab` editor, open a new terminal: `File` > `New` > `Terminal` If you have chosen the `VScode` editor, open a new terminal by clicking the menu icon > `Terminal` > `New Terminal`
...
You only pay for the resources you use and eventually the local storage. Check [this documentation](https://support.us.ovhcloud.com/hc/en-us/articles/35069201682835) for detailed examples.

 

### I don't see my data synchronized in the Object Storage

When you create an AI Notebook, we copy your data into attached Object Storage containers near your compute resources (`CPU` and `GPU`) to increase performance and reduce latency.
...
- **Your notebook is stopped:** To see your synchronized data in the Object Storage, your notebook must be stopped beforehand. The status of your notebook must be stopped (red colored). If your notebook is `STOPPING`, wait for this process to complete and you will be able to see your synchronized data.
...
Please note that each AI Notebook is limited to a maximum amount of CPUs and GPUs. You can refer to the AI Notebooks [Capabilities and Limitations](https://support.us.ovhcloud.com/hc/en-us/articles/34988105363475) guide.
...
For the second case, you can verify on [OVHcloud status](https://status.us.ovhcloud.com/) if a task is affecting our infrastructure.

If this is not the case, contact our support.
...
OVHcloud AI Notebooks come with a preinstalled AI environment (such as TensorFlow, PyTorch, or HuggingFace) and useful packages.

But you may need a very specific package or notebook.
...
If you want to build and use a custom Docker image, you can do it with AI Training by following this [tutorial](https://support.us.ovhcloud.com/hc/en-us/articles/36029131111955).
...
However, you can access other ports by appending them to the URL. For example, the notebook URL (starting with the notebook's ID, filled with 0 here) for accessing the 8501 port is https\://00000000-0000-0000-0000-000000000000-8501.job.us-east-va.ai.cloud.ovh.us/.
