...
A MySQL[®](#go-further) instance can be managed in multiple ways. One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect to MySQL® with CLI](/guides/public-cloud/databases/mysql-connect-cli).
