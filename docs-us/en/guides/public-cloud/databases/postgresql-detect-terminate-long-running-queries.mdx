...
- A PostgreSQL® database running on your OVHcloud Managed Databases (also called *Cloud Databases*); [this guide](/guides/public-cloud/databases/getting-started) can help you to meet this requirement
...
![Manager database - PostgreSQL detect terminate long running queries](/images/public-cloud/databases/postgresql-detect-terminate-long-running-queries/manager-database.png)
