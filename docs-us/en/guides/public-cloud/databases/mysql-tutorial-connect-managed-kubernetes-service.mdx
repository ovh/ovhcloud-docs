...
You need to have [Helm](https://docs.helm.sh/) installed on your workstation and your cluster. Please refer to the [How to install Helm on OVHcloud Managed Kubernetes Service](/guides/public-cloud/managed-kubernetes/install-helm) tutorial.

Finally, you need to be able to order a database solution in the OVHcloud Control Panel, as explained in our [Getting Started with Cloud Databases](/guides/public-cloud/databases/getting-started) guide.
...
Please follow the steps of our [Databases & Analytics - Getting started](/guides/public-cloud/databases/getting-started) guide while ensuring that you select the MySQL® database in the initial step.
...
![MySQL tutorial connect managed Kubernetes service - step 12](/images/public-cloud/databases/mysql-tutorial-connect-managed-kubernetes-service/kube-12.jpg)

 

Following the related documentation on how to [authorize the suitable IP addresses](/guides/public-cloud/databases/mysql-configure-instance-accept-incoming-connections#step-2-authorize-incoming-connections-from-the-mysql-client), add your Kubernetes cluster node IPs to the authorized list.

![Manager database - MySQL tutorial connect managed Kubernetes service - step 2](/images/public-cloud/databases/mysql-tutorial-connect-managed-kubernetes-service/manager-database-2.png)
...
- The db Password
  ...
  ![Manager database - MySQL tutorial connect managed Kubernetes service](/images/public-cloud/databases/mysql-tutorial-connect-managed-kubernetes-service/manager-database.png)
...
As described in the [Installing WordPress on OVHcloud Managed Kubernetes](/guides/public-cloud/managed-kubernetes/install-wordpress) tutorial, remove the default storage class and install the new one.
...
![MySQL tutorial connect managed Kubernetes service - step 11](/images/public-cloud/databases/mysql-tutorial-connect-managed-kubernetes-service/kube-11.png)
