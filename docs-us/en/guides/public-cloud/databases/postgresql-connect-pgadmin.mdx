...
![pgAdmin4 Home Page.PNG](/images/public-cloud/databases/postgresql-connect-pgadmin/25511518972947.png)

In the **Create - Server** dialog box, in the `General` tab, fill in the **Name** field.

![postgreSQL\_pgAdmin02.png](/images/public-cloud/databases/postgresql-connect-pgadmin/21489740432787.png)
...
![postgreSQL\_pgAdmin03.png](/images/public-cloud/databases/postgresql-connect-pgadmin/21489740458259.png)

Finally, select the `SSL` tab and set the **SSL Mode** to **Require**.

![postgreSQL\_pgAdmin04.png](/images/public-cloud/databases/postgresql-connect-pgadmin/21489787995923.png)
...
![postgreSQL\_pgAdmin05.PNG](/images/public-cloud/databases/postgresql-connect-pgadmin/25102320888723.png)
