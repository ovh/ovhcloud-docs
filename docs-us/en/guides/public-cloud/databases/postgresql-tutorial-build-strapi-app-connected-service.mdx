...
You need to be able to order a database solution in the OVHcloud Control Panel, as explained in our [Getting Started with Cloud Databases](/guides/public-cloud/databases/getting-started) guide.
...
To set up a PostgreSQL®, follow the instructions in our [PostgreSQL® - Configure an Instance to Accept Incoming Connections](/guides/public-cloud/databases/postgresql-configure-instance-accept-incoming-connections) guide.
...
![Manager - PostgreSQL tutorial build strapi app connected service](/images/public-cloud/databases/postgresql-tutorial-build-strapi-app-connected-service/manager.png)
...
![PostgreSQL strapi - Tutorial build app connected service - step 11](/images/public-cloud/databases/postgresql-tutorial-build-strapi-app-connected-service/postgresql-strapi-11.png)

You are now using a Strapi app connected to an OVHcloud-managed PostgreSQL® database.

![PostgreSQL strapi - Tutorial build app connected service - step 12](/images/public-cloud/databases/postgresql-tutorial-build-strapi-app-connected-service/postgresql-strapi-12.png)
...
![PostgreSQL strapi - Tutorial build app connected service - step 13](/images/public-cloud/databases/postgresql-tutorial-build-strapi-app-connected-service/postgresql-strapi-13.png)
...
![Manager - PostgreSQL tutorial build strapi app connected service - step 2](/images/public-cloud/databases/postgresql-tutorial-build-strapi-app-connected-service/manager-2.png)
