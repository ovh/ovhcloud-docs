...
![Manager database - PostgreSQL tutorial install wagtail connect service - step 2](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/manager-database-2.png)
...
![Manager database - PostgreSQL tutorial install wagtail connect service - step 4](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/manager-database-4.png)
...
![Manager database - PostgreSQL tutorial install wagtail connect service - step 3](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/manager-database-3.png)
...
![Manager database - PostgreSQL tutorial install wagtail connect service](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/manager-database.png)
...
![PostgreSQL - PostgreSQL tutorial install wagtail connect service - step 4](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/postgre-sql-04.png)

 

You can now access the administrative area at `http://<your VM's IP>/admin`:

![PostgreSQL - PostgreSQL tutorial install wagtail connect service - step 5](/images/public-cloud/databases/postgresql-tutorial-install-wagtail-connect-service/postgre-sql-05.png)
