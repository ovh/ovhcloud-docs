...
description: "MongoDB® is a leading NoSQL database that provides a flexible, scalable, and high-performance solution for modern application development. It stores data in JSO"
zendesk_id: 43786118773907
zendesk_hash: 437ba8e84ec783bd
content_hash: f55c63111ca29ea2
updated: 2026-07-24
---
...
- **Key Points:**
  ...
  - Nested Documents: The address field in both documents is a nested document containing subfields like street, city, and postal\_code.
  - Array Fields: The phone\_numbers field in both documents is an array containing multiple phone numbers.
  - Varying Fields: The email field is present only in the first document, while the date\_of\_birth field is present only in the second document. The structure and number of fields vary between the two documents within the same collection.
...
- [Scalability](https://www.mongodb.com/resources/basics/scaling): Horizontal scaling with replica sets ensures high availability and scalability to meet growing data and workload demands.
  ...
  ![Diagram scalability - MongoDB why MongoDB](/images/public-cloud/databases/mongodb-why-mongodb/diagram-scalability.png)
...
![Diagram terminology - MongoDB why MongoDB](/images/public-cloud/databases/mongodb-why-mongodb/diagram-terminology.png)
