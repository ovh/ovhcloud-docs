...
![Manager database add pool](/images/public-cloud/databases/postgresql-create-use-connection-pools/manager-database-add-pool.png)
...
![Manager database pool more](/images/public-cloud/databases/postgresql-create-use-connection-pools/manager-database-pool-more.png)

Click on `Information`, then collect the required information.

![Manager database pool](/images/public-cloud/databases/postgresql-create-use-connection-pools/manager-database-pool.png)
