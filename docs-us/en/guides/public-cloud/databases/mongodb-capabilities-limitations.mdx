...
Logs and metrics are available via the OVHcloud Control Panel, API, and can be forwarded to [Logs Data Platform](/guides/manage-and-operate/logs-data-platform/introduction-to-logs-data-platform). For more information about logs forwarding, see our [Set up logs forwarding guide](/guides/public-cloud/databases/set-up-logs-forwarding).
