...
![DBaaS Redis - step 1](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-01.png)
...
![DBaaS Redis - step 2](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-02.png)
...
![Manager database - Valkey tutorial boost cms from example wordpress](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/manager-database.png)
...
![DBaaS Redis - step 4](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-04.png)

Then click `Enable Object Cache`.

![DBaaS Redis - step 5](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-05.png)
...
![DBaaS Redis - step 6](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-06.png)
...
![DBaaS Redis - step 7](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-07.png)

With the cache, there is a total of 19 database queries taking 0.0085s:

![DBaaS Redis - step 8](/images/public-cloud/databases/valkey-tutorial-boost-cms-from-example-wordpress/dbaas-redis-08.png)
