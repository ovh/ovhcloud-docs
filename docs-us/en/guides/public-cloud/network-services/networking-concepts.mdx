...
![Pciconcepts - Networking concepts - step 1](/images/public-cloud/network-services/networking-concepts/pciconcepts-01.png)
...
Read more about it in our [Getting Started with Load Balancer on Public Cloud](/guides/public-cloud/network-services/getting-started-load-balancer) guide.
...
![Pciconcepts - Networking concepts - step 3](/images/public-cloud/network-services/networking-concepts/pciconcepts-03.png)
...
Find out more about Additional IP and Floating IP in the [Getting Started with Additional IPs](/guides/network/additional-ip/purchasing-managing-additional-ips) guide.
