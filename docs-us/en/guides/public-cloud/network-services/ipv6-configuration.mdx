...
Floating IP and Gateway currently do not support IPv6. You can only use IPv6 with instances in [Public Mode](/guides/public-cloud/network-services/networking-concepts#public-mode-a-public-ip-is-attached-directly-to-the-instance).
...
![Instances more options](/images/public-cloud/network-services/ipv6-configuration/instances-more-options.png)

All the information you need is in the **Networks** section.

![General information IPv - step 6](/images/public-cloud/network-services/ipv6-configuration/general-information-ipv-6.png)
...
![IPv configuration - step 603](/images/public-cloud/network-services/ipv6-configuration/config-ipv-603.png)

Then go to `Properties` for your network card by right-clicking on it.

![IPv configuration - step 604](/images/public-cloud/network-services/ipv6-configuration/config-ipv-604.png)

Next, click on `IPv6`, and `Properties`.

![IPv configuration - step 605](/images/public-cloud/network-services/ipv6-configuration/config-ipv-605.png)

Lastly, enter your IPv6 details.

![IPv configuration - step 606](/images/public-cloud/network-services/ipv6-configuration/config-ipv-606.png)
...
Firstly, [put your instance into rescue-pro mode](/guides/public-cloud/compute/activating-rescue-mode-public-cloud-instance).
