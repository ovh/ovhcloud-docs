...
![PCI\_instances\_moreOptions.png](/images/public-cloud/network-services/ipv6-configuration/50010818391955.png)

All the information you need is in the **Networks** section.

![pci\_general-information\_ipv6.PNG](/images/public-cloud/network-services/ipv6-configuration/50010818393875.png)
...
![pci\_configIPv603.png](/images/public-cloud/network-services/ipv6-configuration/21183611760275.png)

Then go to `Properties` for your network card by right-clicking on it.

![pci\_configIPv604.png](/images/public-cloud/network-services/ipv6-configuration/21183611763347.png)

Next, click on `IPv6`, and `Properties`.

![pci\_configIPv605.png](/images/public-cloud/network-services/ipv6-configuration/21183611774355.png)

Lastly, enter your IPv6 details.

![pci\_configIPv606.png](/images/public-cloud/network-services/ipv6-configuration/21183611812755.png)
