...
- A [private network](/guides/public-cloud/network-services/configure-vrack) configured in your project
...
You can read more about it in our dedicated [Concepts - Additional IP or Floating IP](/guides/public-cloud/network-services/additional-ip-vs-floating-ip) guide.
...
![Deploy - Octavia use lbaas OpenStack - step 1](/images/public-cloud/network-services/octavia-use-lbaas-openstack/deploy-01.png)
