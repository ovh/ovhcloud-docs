...
![Manager add project](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-add-project.png)
...
![Manager add IP block](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-add-ip-block.png)
...
![Manager private network onboarding](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-private-network-onboarding.png)
...
![Manager private network order select](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-private-network-order-select.png)

![Manager private network order select - step 2](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-private-network-order-select-2.png)
...
![Manager private network order VLAN](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-private-network-order-vlan.png)
...
![Manager private network order subnet](/images/public-cloud/network-services/configure-ip-block-vrack-instance/manager-private-network-order-subnet.png)
...
![Horizon select region](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-select-region.png)
...
![Horizon networks dashboard more](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-networks-dashboard-more.png)
...
![Horizon network create subnet - step 2](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-network-create-subnet-2.png)
...
![Horizon network create subnet](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-network-create-subnet.png)

Once the subnet has been created, your private network will appear as follows:

![Horizon network details subnet](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-network-details-subnet.png)
...
![Horizon instances more options](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-instances-more-options.png)
...
![Horizon instances attach interface](/images/public-cloud/network-services/configure-ip-block-vrack-instance/horizon-instances-attach-interface.png)
