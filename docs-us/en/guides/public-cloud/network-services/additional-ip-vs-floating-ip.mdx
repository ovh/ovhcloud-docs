...
More information about configuring Additional IP addresses is available in [this guide](/guides/public-cloud/network-services/configuring-additional-ip-public-cloud).
...
More information about configuring Floating IP is available in the [Public Cloud Networking Concepts](/guides/public-cloud/network-services/networking-concepts) guide.
...
![Network concepts additionalfloating - step 1](/images/public-cloud/network-services/additional-ip-vs-floating-ip/network-concepts-additionalfloating-01.png)
