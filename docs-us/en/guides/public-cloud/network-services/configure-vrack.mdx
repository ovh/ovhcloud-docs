...
See our [Introducing Horizon](/guides/public-cloud/cross-functional/introducing-horizon) guide to familiarize yourself with the Horizon interface.
...
See our [First steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps) guide to get started with the OVHcloud APIv6.[]()
...
You need to select the correct Terraform provider and resource. Find more information in our [Using Terraform with OVHcloud](/guides/manage-and-operate/terraform/using-terraform-with-ovhcloud) guide.
...
The [OVHcloud CLI](/guides/manage-and-operate/cli/getting-started-ovhcloud-cli) lets you manage Public Cloud resources from your terminal, including private networks and instance interfaces.
...
Log in to the OVHcloud APIv6 (see [this guide](/guides/manage-and-operate/api/first-steps) for more information) and follow these steps:
...
Log in to the OVHcloud APIv6 (see [this guide](/guides/manage-and-operate/api/first-steps) for more information).
...
To learn more about this topic, please refer to our [Creating Multiple vLANs in a vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack) guide.
...
- **Layer 2 network options**
  ...
  If you want to be able to communicate with dedicated servers in this VLAN, please consult our [Creating Multiple vLANs in a vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack) guide.
...
- **Network gateway options**
  ...
  **Assign a Gateway and connect to the private network:** Select this option if you intend to create instances with a private network only. For more information, please consult the following guides: [Creating a Private Network with a Gateway](/guides/public-cloud/network-services/create-private-network-gateway) and [Creating and Connecting a Public Cloud Instance](/guides/public-cloud/compute/getting-started).
...
For help, see [How to create a Public Cloud instance and connect to it](/guides/public-cloud/compute/getting-started). When creating an instance, choose a network mode, then a private network.
...
Also, note the information in [this guide](/guides/public-cloud/compute/starting-with-nova):
...
![Configure vRack - step 11](/images/public-cloud/network-services/configure-vrack/vrack-11.png)
...
![Configure vRack - step 12](/images/public-cloud/network-services/configure-vrack/vrack-12.png)
...
![Configure vRack - step 14](/images/public-cloud/network-services/configure-vrack/vrack-14.png)
...
- [Creating multiple VLANs in a vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack)
