...
![PCI\_createGateway.png](/images/public-cloud/network-services/create-private-network-gateway/40630295372179.png)

**Step 2 — Select the region and size**

Select the region where your private instances are located.

![PCI\_createGateway\_selectLocation.png](/images/public-cloud/network-services/create-private-network-gateway/40630295375507.png)

Then select your gateway size (see the models table above).

![PCI\_createGateway\_selectSize.png](/images/public-cloud/network-services/create-private-network-gateway/40630308208147.png)
...
![PCI\_createGateway\_attachExistingNetwork.png](/images/public-cloud/network-services/create-private-network-gateway/40630308212627.png)
...
![PCI\_createGateway\_attachNewNetwork.png](/images/public-cloud/network-services/create-private-network-gateway/40630295386899.png)
...
![PCI\_listPrivateNetworks.png](/images/public-cloud/network-services/create-private-network-gateway/40630308219155.png)
...
![PCI\_listGateways.png](/images/public-cloud/network-services/create-private-network-gateway/40630295388307.png)
