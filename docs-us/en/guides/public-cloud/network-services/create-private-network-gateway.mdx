...
- **For the OpenStack API:** an OpenStack environment configured ([Preparing an environment](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment))
...
You must have an active vRack before proceeding. If you do not have a vRack, please consult [this section](/guides/public-cloud/network-services/configure-vrack#step-1-activating-and-managing-a-vrack) of the relevant guide.

Next, click `Create a Gateway`.

![Create gateway - Private network](/images/public-cloud/network-services/create-private-network-gateway/create-gateway.png)

**Step 2 — Select the region and size**

Select the region where your private instances are located.

![Select location - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/select-location.png)

Then select your gateway size (see the models table above).

![Select size - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/select-size.png)
...
![Attach existing - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/attach-existing.png)
...
![Attach new - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/attach-new.png)
...
![List networks - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/list-networks.png)
...
![List gateways - Create private network gateway](/images/public-cloud/network-services/create-private-network-gateway/list-gateways.png)
...
Before proceeding, consult our [How to Use Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform) guide.
