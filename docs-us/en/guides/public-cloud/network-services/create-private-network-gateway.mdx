...
You must have an active vRack before proceeding. If you do not have a vRack, please consult [this section](/guides/public-cloud/network-services/configure-vrack#configure-vrack-PCI-instructions) of the relevant guide.
