...
3. Select the `name` of the load balancer.
   ...
   ![PCI\_network\_resources\_prometheus01\*\*\*.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/28960887777171.png)
...
7. Click `Add` to trigger the listener creation.
   ...
   ![PCI\_network\_resources\_prometheus02.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/27850795765651.png)

The new listener is added to the listeners list.

![PCI\_network\_resources\_prometheus03\*\*.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/27850810226835.png)
...
![PCI\_network\_resources\_prometheus04\*\*.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/27852669361171.png)

Click the `Listeners` tab and then `Create Listener`.

![PCI\_network\_resources\_prometheus05.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/27852690791699.png)
...
![PCI\_network\_resources\_prometheus06\*.png](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/27852669425043.png)
