...
- A [Load Balancer](/guides/public-cloud/network-services/getting-started-load-balancer) created.
...
3. Select the `name` of the load balancer.
   ...
   ![Network resources - Load balancer monitoring prometheus - step 1](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-01.png)
...
7. Click `Add` to trigger the listener creation.
   ...
   ![Network resources - Load balancer monitoring prometheus - step 2](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-02.png)

The new listener is added to the listeners list.

![Network resources - Load balancer monitoring prometheus - step 3](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-03.png)
...
![Network resources - Load balancer monitoring prometheus - step 4](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-04.png)

Click the `Listeners` tab and then `Create Listener`.

![Network resources - Load balancer monitoring prometheus - step 5](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-05.png)
...
![Network resources - Load balancer monitoring prometheus - step 6](/images/public-cloud/network-services/loadbalancer-monitoring-prometheus/network-resources-06.png)
