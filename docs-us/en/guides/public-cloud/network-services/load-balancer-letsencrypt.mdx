...
If you are not yet familiar with creating a Load Balancer, please follow our [Getting started with Load Balancer on Public Cloud](/guides/public-cloud/network-services/getting-started-load-balancer) guide before you continue with this tutorial.
