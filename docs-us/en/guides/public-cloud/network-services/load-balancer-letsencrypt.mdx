...
description: "Learn how to configure a secure Public Cloud Load Balancer with Let's Encrypt."
zendesk_id: 21194412563219
zendesk_hash: 44a17c8b5be1ee78
content_hash: 6e7008ab77724be3
updated: 2025-06-10
---
...
- [Preparing your environment for using the OpenStack API](https://support.us.ovhcloud.com/hc/en-us/articles/1500009262762)
- [OpenStack Octavia client](https://docs.openstack.org/python-octaviaclient/latest/install/index.html) and [OpenStack Barbican](https://docs.openstack.org/python-barbicanclient/latest/install/index.html) setup
- A Load Balancer running in your project

If you are not yet familiar with creating a Load Balancer, please follow our [Getting started with Load Balancer on Public Cloud](https://support.us.ovhcloud.com/hc/en-us/articles/18610207964051) guide before you continue with this tutorial.
...
You can create an instance in your project in the region where your Load Balancer is located. Read about the details in our [guide](https://support.us.ovhcloud.com/hc/en-us/articles/360002245164) if necessary. The d2-2 instance type will be sufficient for this operation. We recommend that you use Ubuntu as your operating system.
