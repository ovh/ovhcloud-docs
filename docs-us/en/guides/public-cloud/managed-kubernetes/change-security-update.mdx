...
![PaaS guides policy - step 1](/images/public-cloud/managed-kubernetes/change-security-update/paas-guides-policy-01.png)

From the **Management** panel, click on `Change security policy`.

![PaaS guides policy - step 2](/images/public-cloud/managed-kubernetes/change-security-update/paas-guides-policy-02.png)
...
![PaaS guides policy - step 3](/images/public-cloud/managed-kubernetes/change-security-update/paas-guides-policy-03.png)
...
To retrieve this information, please follow our [First Steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) tutorial.
...
![PaaS guides policy - step 4](/images/public-cloud/managed-kubernetes/change-security-update/paas-guides-policy-04.png)
...
![PaaS guides policy - step 5](/images/public-cloud/managed-kubernetes/change-security-update/paas-guides-policy-05.png)
