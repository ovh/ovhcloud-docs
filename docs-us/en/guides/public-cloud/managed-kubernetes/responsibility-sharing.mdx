---
title: "Managed Kubernetes - Responsibility sharing"
description: "The RACI below details shared responsibilities between OVHcloud and the customer for the Managed Kubernetes service. This shared model can help relieve the cust"
zendesk_id: 43555499179027
zendesk_hash: efbe2c544a20c14c
content_hash: 3647a9f8338e2d5a
updated: 2025-08-04
---

# Managed Kubernetes - Responsibility sharing
...
| **Activity**                                                           | **Customer** | **OVHcloud** |
| ---------------------------------------------------------------------- | ------------ | ------------ |
| Manage accessibility and functioning of the Managed Kubernetes service |              | RA           |
| Manage accessibility and functioning of the installed IS               | RA           |              |
...
| **Activity**                                                              | **Customer** | **OVHcloud** |
| ------------------------------------------------------------------------- | ------------ | ------------ |
| Manage access to the OVHcloud Control Panel within a Public Cloud project | RA           | I            |
...
| Destroy Managed Kubernetes configurations related to the client following service termination |              | RA           |
