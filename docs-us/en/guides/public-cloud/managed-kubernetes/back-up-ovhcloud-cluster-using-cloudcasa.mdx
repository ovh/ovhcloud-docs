...
![CloudCasa - Back up OVHcloud cluster using - step 1](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-1.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 2](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-2.png)

Provide the cluster name and description. Then click the `Save` button.

![CloudCasa - Back up OVHcloud cluster using - step 3](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-3.png)

This will display a kubectl command to run, which will install the CloudCasa agent.

![CloudCasa - Back up OVHcloud cluster using - step 4](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-4.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 5](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-5.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 6](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-6.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 7](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-7.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 8](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-8.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 9](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-9.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 10](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-10.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 11](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-11.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 12](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-12.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 13](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-13.png)

![CloudCasa - Back up OVHcloud cluster using - step 14](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-14.png)

Confirm that the application is back up and running.

![CloudCasa - Back up OVHcloud cluster using - step 15](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-15.png)
...
![CloudCasa - Back up OVHcloud cluster using - step 16](/images/public-cloud/managed-kubernetes/back-up-ovhcloud-cluster-using-cloudcasa/cloudcasa-16.png)
