...
![PaaS serverless open faas - step 1](/images/public-cloud/managed-kubernetes/install-openfaas/paas-serverless-open-faas-01.png)
...
If you want to understand the difference between these three modes better, you can read our [dedicated guide](/guides/public-cloud/managed-kubernetes/using-lb#some-concepts-clusterip-nodeport-ingress-and-loadbalancer).
...
![PaaS serverless open faas - step 2](/images/public-cloud/managed-kubernetes/install-openfaas/paas-serverless-open-faas-02.jpg)
