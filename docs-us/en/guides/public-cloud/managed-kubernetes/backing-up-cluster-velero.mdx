...
This tutorial presupposes that you already have a working OVHcloud Managed Kubernetes cluster and some basic knowledge of how to operate it. If you want to know more about those topics, please look at our [deploying a Hello World application](/guides/public-cloud/managed-kubernetes/deploying-node-pool) documentation.
