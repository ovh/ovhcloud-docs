...
You also need to have [Helm](https://docs.helm.sh/) installer on your workstation and your cluster, please refer to the [How to Install Helm on OVHcloud Managed Kubernetes Service](/guides/public-cloud/managed-kubernetes/install-helm) tutorial.
...
- [Get OpenStack RC File v3 from Horizon](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
![Stash - Backing up volumes - step 1](/images/public-cloud/managed-kubernetes/backing-up-volumes-stash/stash-1.png)
