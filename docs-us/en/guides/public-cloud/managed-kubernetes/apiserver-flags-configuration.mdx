...
If you are unfamiliar with the API Explorer, see our [First Steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps) guide.

:::

To find the Kubernetes API calls, select the `/cloud` section, filter with "kube," and click `Search`.

![PaaS Kubernetes user guides API serverflags - step 2](/images/public-cloud/managed-kubernetes/apiserver-flags-configuration/paas-kube-user-guides-api-serverflags-2.png)
...
To retrieve this necessary information, please follow our [First Steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps) tutorial.
...
![Api server flags configuration - step 3](/images/public-cloud/managed-kubernetes/apiserver-flags-configuration/serverflags-3.png)
...
![PaaS Kubernetes user guides API serverflags](/images/public-cloud/managed-kubernetes/apiserver-flags-configuration/paas-kube-user-guides-api-serverflags.png)
