...
This guide follows the [Using the cluster autoscaler](/guides/public-cloud/managed-kubernetes/using-cluster-autoscaler) guide, and it will cover a description of the cluster autoscaler configuration.
...
- A basic understanding of [how the cluster autoscaler works and how to enable it](/guides/public-cloud/managed-kubernetes/using-cluster-autoscaler)
