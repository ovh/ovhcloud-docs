...
- [Load Balancer for Managed Kubernetes annotations](/guides/public-cloud/managed-kubernetes/using-lb#supported-annotations)
- [Public Cloud Load Balancer annotations](/guides/public-cloud/managed-kubernetes/expose-applications-using-load-balancer#supported-annotations--features)
