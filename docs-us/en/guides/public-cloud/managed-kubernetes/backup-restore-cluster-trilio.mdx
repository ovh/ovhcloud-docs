...
![triliovault1.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587130131.png)
...
- `Backup & Recovery`: This is the main dashboard, which gives you a general overview of the whole cluster (e.g., Discovered namespaces, Applications, Backup plans list, Targets, Hooks, Policies, etc.)
  ...
  - `Namespaces`: ![triliovault2.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619465875.png)
  - `Applications`: ![triliovault3.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587190291.png)
  - `backup plans`: ![triliovault4.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587190035.png)
  - `Targets`: ![triliovault5.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587243283.png)
  - `Scheduling Policy`: ![triliovault6.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619559059.png)
  - `Retention Policy`: ![triliovault7.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587326099.png)
...
- `Monitoring`: This has two options: **TrilioVault Monitoring** and **Velero Monitoring**, if the user has Velero configured on their OVHcloud cluster.
  ...
  - `TrilioVault Monitoring`: It shows the backup and restore summary of the Kubernetes cluster.![triliovault8.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619637651.png)
  - `Velero Monitoring`:![triliovault9.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587365395.png)

- `Disaster Recovery`: Allows you to manage and perform disaster recovery operations.![triliovault10.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587365523.png)
...
![triliovault11.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587405715.png)
...
![triliovault12.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619738515.png)
...
![triliovault13.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587433107.png)

![triliovault14.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619801107.png)
...
![triliovault15.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587477651.png)
...
![triliovault16.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587477907.png)
...
![triliovault17.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587544083.png)

To start the restore process, click the `Restore` button. A progress window will be displayed similar to the one below:

![triliovault18.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619920531.png)
...
![triliovault19.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373587568787.png)
...
![triliovault20.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373619984275.png)
...
![triliovault21.png](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/13373620016787.png)
