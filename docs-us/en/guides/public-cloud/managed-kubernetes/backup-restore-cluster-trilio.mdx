...
- To create a Target for the `OVHcloud Object Storage using S3 Swift API`, use [this link](/guides/storage-and-backup/object-storage/pcs-create-container).
- To create a Target for the `S3™ compatible Object Storage`, use [this link](/guides/storage-and-backup/object-storage/pcs-create-container).
...
Next, create an Access Key and Secret Key to access the Object Storage Container using the [Getting Started with the Swift S3 API](/guides/storage-and-backup/object-storage/getting-started-swift-api) tutorial.

:::info

If you have created a container with High Performance, follow the [Getting Started with Object Storage](/guides/storage-and-backup/object-storage/getting-started) documentation.
...
![Trilio Vault - step 1](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-1.png)
...
- `Backup & Recovery`: This is the main dashboard, which gives you a general overview of the whole cluster (e.g., Discovered namespaces, Applications, Backup plans list, Targets, Hooks, Policies, etc.)
  ...
  - `Namespaces`: ![Trilio Vault - step 2](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-2.png)
  - `Applications`: ![Trilio Vault - step 3](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-3.png)
  - `backup plans`: ![Trilio Vault - step 4](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-4.png)
  - `Targets`: ![Trilio Vault - step 5](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-5.png)
  - `Scheduling Policy`: ![Trilio Vault - step 6](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-6.png)
  - `Retention Policy`: ![Trilio Vault - step 7](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-7.png)
...
- `Monitoring`: This has two options: **TrilioVault Monitoring** and **Velero Monitoring**, if the user has Velero configured on their OVHcloud cluster.
  ...
  - `TrilioVault Monitoring`: It shows the backup and restore summary of the Kubernetes cluster.![Trilio Vault - step 8](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-8.png)
  - `Velero Monitoring`:![Trilio Vault - step 9](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-9.png)

- `Disaster Recovery`: Allows you to manage and perform disaster recovery operations.![Trilio Vault - step 10](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-10.png)
...
![Trilio Vault - step 11](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-11.png)
...
![Trilio Vault - step 12](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-12.png)
...
![Trilio Vault - step 13](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-13.png)

![Trilio Vault - step 14](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-14.png)
...
Next, re-create the cluster as described in [Creating an OVHcloud Managed Kubernetes Cluster](/guides/public-cloud/managed-kubernetes/create-cluster).
...
![Trilio Vault - step 15](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-15.png)
...
![Trilio Vault - step 16](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-16.png)
...
![Trilio Vault - step 17](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-17.png)

To start the restore process, click the `Restore` button. A progress window will be displayed similar to the one below:

![Trilio Vault - step 18](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-18.png)
...
![Trilio Vault - step 19](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-19.png)
...
![Trilio Vault - step 20](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-20.png)
...
![Trilio Vault - step 21](/images/public-cloud/managed-kubernetes/backup-restore-cluster-trilio/trilio-vault-21.png)
