...
At any time, customers can find the currently supported versions on the [dedicated page](/guides/public-cloud/managed-kubernetes/plugins-software-versions-reserved-resources).
