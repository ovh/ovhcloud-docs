...
![upgradeversion1.png](/images/public-cloud/managed-kubernetes/upgrading-version/13761494206867.png)

![upgradeversion2.png](/images/public-cloud/managed-kubernetes/upgrading-version/13761513244691.png)
...
1. Log into the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/). Go to the `Public Cloud` section at the top, then `Managed Kubernetes Service` in the left-hand menu.
   ...
   ![upgradeversion01.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457228618515.png)

2. Click the `...` button at the right end button of your Kubernetes cluster and choose `Manage cluster`.

   ![upgradeversion02.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457189116819.png)

   :::warning

   **NOTE:** Your security policy must be set at least to “Minimum unavailability”. Otherwise, the upgrade will fail.\
   ![upgradeversion03.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457228625555.png)

   :::

3) On the *Management* section, click on `Upgrade to the next minor version`.

   ![upgradeversion04.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457228627347.png)

4. Click on `Confirm`.

   ![upgradeversion05.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457189122707.png)
...
![upgradeversion06.png](/images/public-cloud/managed-kubernetes/upgrading-version/19457189125907.png)
