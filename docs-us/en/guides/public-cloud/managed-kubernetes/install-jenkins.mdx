...
![Jenkins login](/images/public-cloud/managed-kubernetes/install-jenkins/public-cloud-containers-orchestration-managed-kubernetes-installing-jenkins-imag.png)

Log in with the user `user` and the password you got before. And here you have your Jenkins:

![Leeeeeeeroy Jenkins!](/images/public-cloud/managed-kubernetes/install-jenkins/public-cloud-containers-orchestration-managed-kubernetes-installing-jenkins-imag.png)
