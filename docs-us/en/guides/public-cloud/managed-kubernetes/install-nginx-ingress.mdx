...
![Kubernetes Ingress](/images/public-cloud/managed-kubernetes/install-nginx-ingress/public-cloud-containers-orchestration-managed-kubernetes-installing-nginx-ingres.png)
...
In order to test your `nginx-ingress`, you can, for example, [install a WordPress](/guides/public-cloud/managed-kubernetes/install-wordpress) on your cluster, and then create a YAML file for the Ingress that uses the controller:
...
![WordPress using Ingress](/images/public-cloud/managed-kubernetes/install-nginx-ingress/public-cloud-containers-orchestration-managed-kubernetes-installing-nginx-ingres.png)
