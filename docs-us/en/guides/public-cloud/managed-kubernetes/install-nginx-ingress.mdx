...
![Public cloud containers orchestration managed](/images/public-cloud/managed-kubernetes/install-nginx-ingress/public-cloud-containers-orchestration-managed.png)
