...
- At least one node on the cluster (see the [ordering a node](/guides/public-cloud/managed-kubernetes/deploying-node-pool) guide for details)
- A well-configured `kubectl` (see the [configuring kubectl](/guides/public-cloud/managed-kubernetes/configure-kubectl) guide for details)
...
![Public cloud containers orchestration managed](/images/public-cloud/managed-kubernetes/deploy-hello-world/public-cloud-containers-orchestration-managed.png)
