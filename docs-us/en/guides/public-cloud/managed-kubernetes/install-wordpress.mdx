...
If you experience permission errors while enabling persistence, see [this guide](/guides/public-cloud/managed-kubernetes/persistentvolumes-permission-errors) for troubleshooting steps.
...
![Public cloud containers orchestration managed](/images/public-cloud/managed-kubernetes/install-wordpress/public-cloud-containers-orchestration-managed.png)
