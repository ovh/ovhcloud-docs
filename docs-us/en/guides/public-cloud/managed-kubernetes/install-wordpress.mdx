...
![Installing WordPress](/images/public-cloud/managed-kubernetes/install-wordpress/public-cloud-containers-orchestration-managed-kubernetes-installing-wordpress-im.png)
