...
![K8ssdashboard - step 1](/images/public-cloud/managed-kubernetes/install-kubernetes-dashboard/k-8-sdashboard-1.png)
...
![K8ssdashboard - step 2](/images/public-cloud/managed-kubernetes/install-kubernetes-dashboard/k-8-sdashboard-2.png)

 

You will then be taken directly to your Dashboard:

![K8ssdashboard - step 3](/images/public-cloud/managed-kubernetes/install-kubernetes-dashboard/k-8-sdashboard-3.png)
