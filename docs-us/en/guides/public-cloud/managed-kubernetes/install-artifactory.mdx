...
- The Helm client installed and configured. For more information, follow this OVHcloud tutorial: [Installing Helm on OVHcloud Managed Kubernetes](/guides/public-cloud/managed-kubernetes/install-helm).
- The `kubectl` client installed and configured. For more information, follow this OVHcloud tutorial: [Configuring kubectl on an OVHcloud Managed Kubernetes Cluster](/guides/public-cloud/managed-kubernetes/configure-kubectl)
...
![Install artifactory - step 1](/images/public-cloud/managed-kubernetes/install-artifactory/artifactory-1.png)

**Note:&#x20;**&#x44;o not forget to change the default password!

And that’s it - you can start using your JFrog Artifactory instance:

![Install artifactory - step 2](/images/public-cloud/managed-kubernetes/install-artifactory/artifactory-2.png)
...
![Install artifactory - step 3](/images/public-cloud/managed-kubernetes/install-artifactory/artifactory-3.png)
