...
![Public cloud containers orchestration managed](/images/public-cloud/managed-kubernetes/create-cluster/public-cloud-containers-orchestration-managed.png)
...
![Public cloud containers orchestration managed](/images/public-cloud/managed-kubernetes/create-cluster/public-cloud-containers-orchestration-managed.jpg)
...
![Manager onboarding - Create cluster](/images/public-cloud/managed-kubernetes/create-cluster/manager-onboarding.png)

Choose a name for your cluster and click `Next`.

![Manager ordering name](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-name.png)

Select a location for your new cluster and click `Next`.

![Manager ordering location](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-location.png)
...
![Manager ordering version](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-version.png)
...
![Manager ordering network](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-network.png)
...
![Manager ordering node name](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-node-name.png)
...
![Manager ordering node size](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-node-size.png)

Once you are finished customizing your node pool, click `Add node pool` and then `Next`.

![Manager ordering add node pool](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-add-node-pool.png)
...
![Manager ordering confirm order](/images/public-cloud/managed-kubernetes/create-cluster/manager-ordering-confirm-order.png)
...
![Token rights - Create cluster](/images/public-cloud/managed-kubernetes/create-cluster/token-rights.png)
...
![Copy project id](/images/public-cloud/managed-kubernetes/create-cluster/copy-project-id.png)
...
![List - Create cluster](/images/public-cloud/managed-kubernetes/create-cluster/list.png)

If you click on your cluster and then on the `Node pools` tab, you will see that our node pool is created, too.

![Node pools tab](/images/public-cloud/managed-kubernetes/create-cluster/node-pools-tab.png)
...
![Service tab management panel](/images/public-cloud/managed-kubernetes/create-cluster/service-tab-management-panel.png)
