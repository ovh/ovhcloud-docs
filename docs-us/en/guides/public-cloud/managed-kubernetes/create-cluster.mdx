...
Choose the minor version of Kubernetes and preferred [security policy](/guides/public-cloud/managed-kubernetes/change-security-update), and click `Next`.

:::info

We recommend that you use the last stable version. Please read our [End of life / end of support](/guides/public-cloud/managed-kubernetes/eos-eol-policies) article to understand our version policy.
...
For more information about this option, please read our [Using the vRack](/guides/public-cloud/managed-kubernetes/using-vrack-private-network) guide.
...
You can read the [Managing node pools](/guides/public-cloud/managed-kubernetes/managing-nodes) guide to get more information on node pools.
...
To retrieve this necessary information, please follow our [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) tutorial.
...
To check your quotas and increase them, please see our [How to increase Public Cloud quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota) guide.
...
To deploy your first application on your Kubernetes cluster, we invite you to follow our guide to [configuring default settings for `kubectl`](/guides/public-cloud/managed-kubernetes/configure-kubectl) and [deploying a Hello World application](/guides/public-cloud/managed-kubernetes/deploying-node-pool).
