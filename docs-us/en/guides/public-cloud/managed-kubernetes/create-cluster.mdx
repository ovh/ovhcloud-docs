...
![](/images/public-cloud/managed-kubernetes/create-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.png)
...
![](/images/public-cloud/managed-kubernetes/create-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.jpg)
...
![manager\_mks\_onboarding.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944235539.png)

Choose a name for your cluster and click `Next`.

![manager\_mks\_ordering\_clusterName.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951201939.png)

Select a location for your new cluster and click `Next`.

![manager\_mks\_ordering\_clusterLocation.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951205523.png)
...
![manager\_mks\_ordering\_clusterVersion.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944242835.png)
...
![manager\_mks\_ordering\_clusterNetwork.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944244115.png)
...
![manager\_mks\_ordering\_nodeName.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944247699.png)
...
![manager\_mks\_ordering\_nodeSize.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951213843.png)

Once you are finished customizing your node pool, click `Add node pool` and then `Next`.

![manager\_mks\_ordering\_addNodePool.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944250643.png)
...
![manager\_mks\_ordering\_confirmOrder.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951217043.png)
...
![apiToken\_rights.PNG](/images/public-cloud/managed-kubernetes/create-cluster/49367074364435.png)
...
![](/images/public-cloud/managed-kubernetes/create-cluster/49367100902419.png)
...
![MKS\_clusterList.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951218451.png)

If you click on your cluster and then on the `Node pools` tab, you will see that our node pool is created, too.

![MKS\_nodePoolsTab.PNG](/images/public-cloud/managed-kubernetes/create-cluster/49367074369427.png)
...
![Kubernetes cluster and node pool](/images/public-cloud/managed-kubernetes/create-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.png)
...
![PCI\_copyProjectID.PNG](/images/public-cloud/managed-kubernetes/create-cluster/49367100902419.png)
...
![manager\_mks\_serviceList\_moreOptions.png](/images/public-cloud/managed-kubernetes/create-cluster/42495951218451.png)
...
![manager\_mks\_serviceTab\_managementPanel.png](/images/public-cloud/managed-kubernetes/create-cluster/42495944254995.png)
