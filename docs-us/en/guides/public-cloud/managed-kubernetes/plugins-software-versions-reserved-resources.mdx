...
If you run a Managed Kubernetes Service using an older version, we strongly encourage you to use the [version upgrade feature](/guides/public-cloud/managed-kubernetes/upgrading-version) to receive official support for your cluster.

You will find more details about our [End-of-Sale, End-of-Service, and End-of-Life Policies](/guides/public-cloud/managed-kubernetes/eos-eol-policies) in the dedicated section.
