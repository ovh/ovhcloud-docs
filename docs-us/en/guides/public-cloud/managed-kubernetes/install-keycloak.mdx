...
![Keycloak - Install - step 1](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-1.png)
...
![Keycloak - Install - step 2](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-2.png)
...
For more information, please refer to the following documentation: [Using the OVHcloud Managed Kubernetes Load Balancer](/guides/public-cloud/managed-kubernetes/using-lb)
...
\
For more information, please refer to the following documentation: [Setting Up a Persistent Volume on OVHcloud Managed Kubernetes](/guides/public-cloud/managed-kubernetes/set-up-persistent-volume)
...
![Keycloak - Install - step 3](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-3.png)
...
![Keycloak - Install - step 4](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-4.png)
...
![Keycloak - Install - step 5](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-5.png)
...
1. From the previously created realm, click on the left-hand `Clients` menu under the `Configure` category:
   ...
   ![Keycloak - Install - step 6](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-6.png)
...
3) Fill in the form with the following parameters:
   ...
   ![Keycloak - Install - step 7](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-7.png)
...
5. In the newly-created client, find the `Access Type` field and set its value to `confidential` to require a secret to initiate the login protocol. Then click the blue `Save` button to save the change.
   ...
   ![Keycloak - Install - step 8](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-8.png)
...
![Keycloak - Install - step 9](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-9.png)

![Keycloak - Install - step 10](/images/public-cloud/managed-kubernetes/install-keycloak/keycloak-10.png)
