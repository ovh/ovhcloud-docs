...
![keycloak1.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004676472979.png)
...
![keycloak2.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004706800019.png)
...
![keycloak3.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004676598163.png)
...
![keycloak4.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004707289875.png)
...
![keycloak5.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004707286931.png)
...
1. From the previously created realm, click on the left-hand `Clients` menu under the `Configure` category:
   ...
   ![keycloak6.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004676888851.png)
...
3) Fill in the form with the following parameters:
   ...
   ![keycloak7.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004707502739.png)
...
5. In the newly-created client, find the `Access Type` field and set its value to `confidential` to require a secret to initiate the login protocol. Then click the blue `Save` button to save the change.
   ...
   ![keycloak8.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004677049491.png)
...
![keycloak9.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004707699091.png)

![keycloak10.png](/images/public-cloud/managed-kubernetes/install-keycloak/14004707799699.png)
