...
**NOTE:** This documentation is about "Load Balancer for Managed Kubernetes". If you want to benefit from the new MKS LoadBalancer based on Octavia LoadBalancer, please refer to [this page](/guides/public-cloud/managed-kubernetes/expose-applications-using-load-balancer).
...
![DBaaS expose app deployed - step 1](/images/public-cloud/managed-kubernetes/using-lb/dbaas-expose-app-deployed-01.png)
...
![DBaaS expose app deployed - step 2](/images/public-cloud/managed-kubernetes/using-lb/dbaas-expose-app-deployed-02.png)
...
![DBaaS expose app deployed - step 3](/images/public-cloud/managed-kubernetes/using-lb/dbaas-expose-app-deployed-03.png)
...
A dedicated documentation for [Public Load Balancer](/guides/public-cloud/managed-kubernetes/expose-applications-using-load-balancer) is available here.
...
![DBaaS expose app deployed - step 4](/images/public-cloud/managed-kubernetes/using-lb/dbaas-expose-app-deployed-04.png)
