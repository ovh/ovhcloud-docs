...
![Oidc - Configure provider - step 1](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-1.png)

Click on your Kubernetes cluster.

![Oidc - Configure provider - step 2](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-2.png)

Click the `...` button in the `OIDC provider` section.

![Oidc - Configure provider - step 3](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-3.png)
...
![Oidc - Configure provider - step 4](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-4.png)
...
![Oidc - Configure provider - step 5](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-5.png)
...
In order to retrieve this information, please follow our [First Steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) tutorial.
...
![Oidc - Configure provider - step 6](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-6.png)
...
![Oidc - Configure provider - step 7](/images/public-cloud/managed-kubernetes/configure-oidc-provider/oidc-7.png)
