...
You can also point your browser to `http://<YOUR_GATEWAY_URL>/productpage` (in this example, `http://clusterId.nodes.c1.gra.k8s.ovh.net:31380/productpage`) to view the Bookinfo web page. If you refresh the page several times, you should see different versions of reviews shown in productpage, presented in a round robin style (red stars, black stars, no stars), since we haven’t yet used Istio to control the version routing.
