...
description: "The OVHcloud Managed Kubernetes service lets you deploy production-ready clusters without the operational overhead of setting them up or maintaining them. You c"
zendesk_id: 1500004767902
zendesk_hash: 9066330f379bcc65
content_hash: 82a3ea8d4b5525a3
updated: 2026-08-17
---
...
<details>
<summary>Learn more about Terraform...</summary>
...
<details>
<summary>Learn more about CDK for Terraform...</summary>

![](/images/public-cloud/containers-orchestration/creating-a-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.png)
...
<details>
<summary>Learn more about Pulumi...</summary>

![](/images/public-cloud/containers-orchestration/creating-a-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.jpg)

[Pulumi](https://www.pulumi.com/) is an Infrastructure as Code (IasC) tool that allows you to build your infrastructure with a programming language, in Golang, for example.\
...
The specific prerequisites for each tool will be annotated in the [Instructions](#instructions) below.
...
![manager\_mks\_onboarding.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944235539.png)

Choose a name for your cluster and click `Next`.

![manager\_mks\_ordering\_clusterName.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951201939.png)

Select a location for your new cluster and click `Next`.

![manager\_mks\_ordering\_clusterLocation.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951205523.png)

Choose the minor version of Kubernetes and preferred [security policy](https://support.us.ovhcloud.com/hc/en-us/articles/13949662286099), and click `Next`.

:::info

We recommend that you use the last stable version. Please read our [End of life / end of support](https://support.us.ovhcloud.com/hc/en-us/articles/1500005048081) article to understand our version policy.

:::

![manager\_mks\_ordering\_clusterVersion.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944242835.png)
...
For more information about this option, please read our [Using the vRack](https://support.us.ovhcloud.com/hc/en-us/articles/1500009286462) guide.

![manager\_mks\_ordering\_clusterNetwork.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944244115.png)
...
You can read the [Managing node pools](https://support.us.ovhcloud.com/hc/en-us/articles/1500004963921) guide to get more information on node pools.

:::

First, choose a name for your node pool.

![manager\_mks\_ordering\_nodeName.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944247699.png)
...
![manager\_mks\_ordering\_nodeSize.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951213843.png)

Once you are finished customizing your node pool, click `Add node pool` and then `Next`.

![manager\_mks\_ordering\_addNodePool.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944250643.png)
...
![manager\_mks\_ordering\_confirmOrder.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951217043.png)
...
To create a Kubernetes cluster and other resources, OVHcloud provides a [Terraform provider](https://registry.terraform.io/providers/ovh/ovh/latest) that is available in the official Terraform registry.
...
- A [cloud\_project\_kube](https://registry.terraform.io/providers/ovh/ovh/latest/docs/resources/cloud_project_kube), that represents an OVHcloud Managed Kubernetes cluster
- A [cloud\_project\_kube\_nodepool](https://registry.terraform.io/providers/ovh/ovh/latest/docs/resources/cloud_project_kube_nodepool), that represents a Kubernetes Node Pool
...
To retrieve this necessary information, please follow our [First steps with the OVHcloud APIs](https://support.us.ovhcloud.com/hc/en-us/articles/360018130839) tutorial.

Concretely, you have to generate these credentials via the [OVH token generation page](https://us.ovhcloud.com/auth/api/createToken) with the following rights:

![apiToken\_rights.PNG](/images/public-cloud/containers-orchestration/creating-a-cluster/49367074364435.png)
...
In the [Public Cloud section](https://manager.us.ovhcloud.com/#/public-cloud/pci/projects/) of the OVHcloud Control Panel, you can retrieve your service name ID thanks to the `Copy to clipboard` button.

![](/images/public-cloud/containers-orchestration/creating-a-cluster/49367100902419.png)
...
Then, create a `variables.tf` with service\_name:
...
Now, log in to the [OVHcloud Control Panel](https://manager.us.ovhcloud.com/), go to the `Public Cloud` section, and click on `Managed Kubernetes Service`.

As you can see, your cluster has been successfully created:

![MKS\_clusterList.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951218451.png)

If you click on your cluster and then on the `Node pools` tab, you will see that our node pool is created, too.

![MKS\_nodePoolsTab.PNG](/images/public-cloud/containers-orchestration/creating-a-cluster/49367074369427.png)
...
![Kubernetes cluster and node pool](/images/public-cloud/containers-orchestration/creating-a-cluster/public-cloud-containers-orchestration-managed-kubernetes-creating-a-cluster-imag.png)
...
To retrieve the necessary information, please follow the tutorial [First steps with the OVHcloud APIs](https://support.us.ovhcloud.com/hc/en-us/articles/360018130839).
...
In the [Public Cloud section](https://manager.us.ovhcloud.com/#/public-cloud/pci/projects/) of the OVHcloud Control Panel, you can retrieve your Public Cloud project ID thanks to the `Copy to clipboard` button.

![PCI\_copyProjectID.PNG](/images/public-cloud/containers-orchestration/creating-a-cluster/49367100902419.png)

Summary of the needed environment variables:

| Provider Argument    | Environment Variables       | Description                        | Mandatory |
| -------------------- | --------------------------- | ---------------------------------- | --------- |
| `endpoint`           | `OVH_ENDPOINT`              | OVHcloud Endpoint. Value: `ovh-us` | ✅         |
...
These keys can be generated via the [OVHcloud token generation page](https://us.ovhcloud.com/auth/api/createToken).
...
func NewMyStack(scope constructs.Construct, id string) cdktf.TerraformStack {
    ...
    ovh.NewOvhProvider(stack, jsii.String("ovh"), &ovh.OvhProviderConfig{
        Endpoint: jsii.String("ovh-us"), //required
    })
    ...
    kube := cloudprojectkube.NewCloudProjectKube(stack, jsii.String("my_desired_cluster"), &cloudprojectkube.CloudProjectKubeConfig{
        ...
        Region:      jsii.String("US-EAST-VA-1"),
    })
...
To create a Kubernetes cluster and other resources, you will use the [OVHcloud Pulumi provider](https://github.com/ovh/pulumi-ovh). This provider is a bridge to our official [Terraform provider](https://registry.terraform.io/providers/ovh/ovh/latest).
...
In order to retrieve this necessary information, please follow our [First steps with the OVHcloud APIs](https://support.us.ovhcloud.com/hc/en-us/articles/360018130839) guide.

In concrete terms, you have to generate these credentials via the [OVH token generation page](https://us.ovhcloud.com/auth/api/createToken) with the following rights:
...
func main() {
    pulumi.Run(func(ctx *pulumi.Context) error {
        ...
        myKube, err := cloudproject.NewKube(ctx, "my_desired_cluster", &cloudproject.KubeArgs{
            ...
            Region:      pulumi.String("US-EAST-VA-1"),
        })
        if err != nil {
            return err
        }
...
my-pool   b3-8     false         false            false           3         3         3            3           3     3     1d
```
...
my-pool-node-1bb290   Ready    <none>   1d   v1.34.2
my-pool-node-8280a6   Ready    <none>   1d   v1.34.2
my-pool-node-8a1bfe   Ready    <none>   1d   v1.34.2
```
...
my-pool   b3-8     false        false           false          1         1         1            1           1     3     80m
```
...
NAME                  STATUS   ROLES    AGE   VERSION
my-pool-node-0784ed   Ready    <none>   76m   v1.34.2
```
...
$ kubectl --kubeconfig=kubeconfig.yaml get nodepool
NAME              FLAVOR   AUTOSCALED   MONTHLYBILLED   ANTIAFFINITY   DESIRED   CURRENT   UP-TO-DATE   AVAILABLE   MIN   MAX   AGE
my-desired-pool   b3-8     false        false           false          1         1         1            1           1     3     3m25s
```
...
To check your quotas and increase them, please see our [How to increase Public Cloud quotas](https://support.us.ovhcloud.com/hc/en-us/articles/22188629448339) guide.
...
Diagnostics:
  pulumi:providers:ovh (default_github_/api.github.com/ovh/pulumi-ovh):
    error: pulumi:providers:ovh resource 'default_github_/api.github.com/ovh/pulumi-ovh' has a problem: Provider is missing a required configuration key, try `pulumi config set ovh:endpoint`: The OVH API endpoint to target (ex: "ovh-us").
...
Diagnostics:
  ...
  ovh:CloudProject:KubeNodePool (my_desired_pool):
    error: 1 error occurred:
        * calling Post /cloud/project/xxxxxxxxxx/kube/xxxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/nodepool with params my_desired_pool(b3-8): 1/1/3:
...
![manager\_mks\_serviceList\_moreOptions.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495951218451.png)
...
![manager\_mks\_serviceTab\_managementPanel.png](/images/public-cloud/containers-orchestration/creating-a-cluster/42495944254995.png)
...
Terraform will perform the following actions:
  ...
  - resource "ovh_cloud_project_kube" "my_kube_cluster" {
      ...
      - nodes_url                   = "z2tj25.nodes.c1.va1.k8s.ovh.us" -> null
...
To deploy your first application on your Kubernetes cluster, we invite you to follow our guide to [configuring default settings for `kubectl`](https://support.us.ovhcloud.com/hc/en-us/articles/1500005047721) and [deploying a Hello World application](https://support.us.ovhcloud.com/hc/en-us/articles/1500004910382).
