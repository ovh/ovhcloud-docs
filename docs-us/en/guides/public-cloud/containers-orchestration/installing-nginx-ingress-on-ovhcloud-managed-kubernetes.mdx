...
description: "Learn how to set up Nginx Ingress on your OVHcloud Managed Kubernetes Service."
zendesk_id: 1500004961501
zendesk_hash: 38b596700665dd29
content_hash: 237983a165e2a98b
updated: 2025-03-18
---

# Installing Nginx Ingress on OVHcloud Managed Kubernetes

**Learn how to set up [Nginx Ingress](https://github.com/kubernetes/ingress-nginx) on your [OVHcloud Managed Kubernetes Service](https://us.ovhcloud.com/public-cloud/kubernetes/).**
...
![Kubernetes Ingress](/images/public-cloud/containers-orchestration/installing-nginx-ingress-on-ovhcloud-managed-kubernetes/public-cloud-containers-orchestration-managed-kubernetes-installing-nginx-ingres.png)
...
`yaml service: annotations: service.beta.kubernetes.io/ovh-loadbalancer-proxy-protocol: v1`
...
In order to test your `nginx-ingress`, you can, for example, [install a WordPress](https://support.us.ovhcloud.com/hc/en-us/articles/1500004935301) on your cluster, and then create a YAML file for the Ingress that uses the controller:
...
![WordPress using Ingress](/images/public-cloud/containers-orchestration/installing-nginx-ingress-on-ovhcloud-managed-kubernetes/public-cloud-containers-orchestration-managed-kubernetes-installing-nginx-ingres.png)
