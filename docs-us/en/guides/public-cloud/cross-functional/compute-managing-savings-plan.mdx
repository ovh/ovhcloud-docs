...
- Access to the [OVHcloud API](https://api.us.ovhcloud.com/) (create your credentials using [this guide](/guides/manage-and-operate/api/first-steps))
...
![Plans onboarding - Compute managing savings plan](/images/public-cloud/cross-functional/compute-managing-savings-plan/plans-onboarding.png)
...
![Plans list - Compute managing savings plan](/images/public-cloud/cross-functional/compute-managing-savings-plan/plans-list.png)
...
![Plans service list](/images/public-cloud/cross-functional/compute-managing-savings-plan/plans-service-list.png)
...
![Plans service details](/images/public-cloud/cross-functional/compute-managing-savings-plan/plans-service-details.png)
...
![Plans details - Compute managing savings plan](/images/public-cloud/cross-functional/compute-managing-savings-plan/plans-details.png)
