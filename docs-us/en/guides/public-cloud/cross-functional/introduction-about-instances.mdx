...
description: "There are many terms specific to cloud computing that are often ill-defined. This document provides some details on aspects of vocabulary, particularly for inst"
zendesk_id: 21740390395283
zendesk_hash: a0edf96b99e3be18
content_hash: 3fc51473216ce2b6
updated: 2023-10-23
---
...
"By creating a snapshot of my first instance, I create a new image in the catalog which I can use to boot a new instance, potentially using a more powerful flavor."
...
All of the available images make up the "catalog". Among these are public images provided by OVH, and private images which are specific to each cloud project.
...
- Distribution: The application’s critical elements (data, services, etc.) should be distributed in several locations to minimize the impact of any infrastructure failures.
- Self-healing: When an element of the infrastructure is lost, the application recognizes the failure, and takes action to fix the problem. Often, an orchestration tool is used alongside a monitoring tool to manage these cases.
