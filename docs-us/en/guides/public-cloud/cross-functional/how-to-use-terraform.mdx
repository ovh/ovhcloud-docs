...
- [Configuring user access to Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- [How to Prepare an Environment for Using the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- [Setting OpenStack environment variables](/guides/public-cloud/cross-functional/compute-horizon-access-security)
- [Your OVHcloud API identifiers and authorization key](/guides/manage-and-operate/api/first-steps)
- [An SSH key](/guides/bare-metal-cloud/dedicated-servers/create-use-authentication-keys-ssh-connections-ovhcloud-server)
...
![Key example - How to use terraform - step 1](/images/public-cloud/cross-functional/how-to-use-terraform/key-example-1.png)

![Key example - How to use terraform - step 2](/images/public-cloud/cross-functional/how-to-use-terraform/key-example-2.png)
...
You now need to [create a new OpenStack user](/guides/public-cloud/cross-functional/create-and-delete-a-user), and the generate the OpenRC file containing all of the credentials you want to export as environment variables.
...
![R cfile Horizon](/images/public-cloud/cross-functional/how-to-use-terraform/r-cfile-horizon.png)
...
![Howtoterraform - How to use terraform - step 1](/images/public-cloud/cross-functional/how-to-use-terraform/howtoterraform-01.png)
