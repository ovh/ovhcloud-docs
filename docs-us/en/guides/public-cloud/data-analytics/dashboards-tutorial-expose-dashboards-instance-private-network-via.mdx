...
![Diagram - Dashboards tutorial expose dashboards instance private network via](/images/public-cloud/data-analytics/dashboards-tutorial-expose-dashboards-instance-private-network-via/diagram.png)
...
- A Dashboards service running on your OVHcloud Public Cloud project ([this guide](/guides/public-cloud/databases/getting-started) can help you meet this requirement)

:::info

If you need more details on the private network configuration, use [this guide](/guides/public-cloud/databases/configure-private-network).
...
[This guide](/guides/public-cloud/databases/getting-started) can help you create a new instance in your vRack.
...
![Grafana - Dashboards tutorial expose dashboards instance private network via](/images/public-cloud/data-analytics/dashboards-tutorial-expose-dashboards-instance-private-network-via/grafana.png)
