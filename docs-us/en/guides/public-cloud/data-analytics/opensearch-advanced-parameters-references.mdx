...
- An OpenSearch™ Analytics service ([this guide](/guides/public-cloud/databases/getting-started) can help you to meet this requirement)
...
Please refer to this [guide](/guides/public-cloud/databases/advanced-configuration#using-api) to learn how to change your advanced parameters from the OVHcloud API.
