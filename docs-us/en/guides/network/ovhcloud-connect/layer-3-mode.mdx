...
![OVHcloud connect diagram - step 3](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3.png)
...
![OVHcloud connect diagram 3 2 pops](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-2-pops.png)

As a result, L3 makes it compatible with a multi-DC configuration.

![OVHcloud connect diagram 3 multi dc](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-multi-dc.png)
...
![OVHcloud connect diagram 3 rules](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-rules.gif)

The following schema shows the mix of L2 and L3. They can end in the same OVHcloud data center or not.

![OVHcloud connect diagram 3 - step 2](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-2.png)

 

### Connection mode details

![OVHcloud connect diagram 3 connection details](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-connection-details.png)
...
![OVHcloud connect diagram 3 BGP v rack](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-bgp-v-rack.png)

At a more global level, BGP topology will look like this:

![OVHcloud connect diagram 3 BGP global](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-bgp-global.png)
...
![OVHcloud connect diagram 3 BGP path](/images/network/ovhcloud-connect/layer-3-mode/ovhcloud-connect-diagram-3-bgp-path.png)
