...
**NOTE:** To ensure the correct operation of this service, you must be aware of the [technical capabilities and limitations of the OVHcloud Connect solution](/guides/network/ovhcloud-connect/technical-capabilities-limitations) and configure your network devices accordingly.

:::

- An [OVHcloud Connect service](https://us.ovhcloud.com/network/ovhcloud-connect/)
- Access to the [OVHcloud APIv6](https://api.us.ovhcloud.com/console) (create your credentials by consulting [this guide](/guides/manage-and-operate/api/first-steps))
