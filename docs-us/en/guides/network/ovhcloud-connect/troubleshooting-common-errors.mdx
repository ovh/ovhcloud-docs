---
title: "OVHcloud Connect - Troubleshooting common errors"
description: "- An OVHcloud Connect solution"
zendesk_id: 6980759419411
zendesk_hash: 535c16592c9c251c
content_hash: fb4c222a1aaca6e3
updated: 2025-06-11
---

# OVHcloud Connect - Troubleshooting common errors

## Requirements

- An [OVHcloud Connect solution](https://us.ovhcloud.com/network/ovhcloud-connect/)
...
- If **IN** is **DOWN**, the following reasons may be the cause:
  ...
  - The port can be disabled or have a defect that prevents it from emitting light
...
If there is a fiber inversion between Port A and Port B, the light is not received in the right place and the **IN** **(Rx)** port will display **DOWN**. If your service has not yet been delivered, contact the support teams so that the link status can be checked.
...
For more information, please read the [technical capabilities and limitations of the OVHcloud Connect solution](/guides/network/ovhcloud-connect/technical-capabilities-limitations).
...
- AS number: We recommend ASNs between 64512 and 65534. The choice is yours, except for the following numbers, which are reserved for OVHcloud.
