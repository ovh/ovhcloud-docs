...
zendesk_id: 47472299312275
zendesk_hash: b07cace78be2e190
content_hash: f1acba5ebb57d6eb
updated: 2026-01-06
---
...
![IP\_serviceList.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47972660978707.png)
...
![IP\_order\_selectVersion\_IPv6.PNG](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47972660982803.png)
...
![DS\_network\_configIPv6vrack02\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299287315.png)
...
![DS\_network\_configIPv6vrack12\*\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256571155.png)
...
![DS\_network\_configIPv6vrack13\*\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256572435.png)
...
![DS\_network\_configIPv6vrack03\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299289747.png)
...
![DS\_network\_configIPv6vrack04\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256573459.png)
...
![DS\_network\_configIPv6vrack05\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299291539.png)
...
![DS\_network\_configIPv6vrack06\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256578451.png)
...
![DS\_network\_configIPv6vrack07\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256582035.png)
...
In a basic configuration, you may want to set up an IP address and routing manually. This is also the suggested way when your machine acts as a router (see [configuring routed subnet](https://support.us.ovhcloud.com/hc/en-us/articles/31163475160211#configuring-an-ipv6-in-a-vrack-for-routed-mode)) and has ipv6.forwarding mode enabled.
...
Important to note is that this setting will not work if ipv6.forwarding is enabled in your system. In such case please refer to [Automatic IP configuration for routed subnet](https://support.us.ovhcloud.com/hc/en-us/articles/31163475160211#configuring-an-ipv6-in-a-vrack-for-routed-mode) for details.
...
![DS\_network\_configIPv6vrack08.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299298451.png)
...
![DS\_network\_configIPv6vrack14.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256582931.png)

On the right, you have an IP section, and you can add a new subnet by clicking `+ Add a subnet`.

![DS\_network\_configIPv6vrack15.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472256596883.png)
...
![DS\_network\_configIPv6vrack16\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299301267.png)
...
![DS\_network\_configIPv6vrack17\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299302675.png)
...
![DS\_network\_configIPv6vrack09\*.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299303699.png)
...
![DS\_network\_configIPv6vrack10.png](/images/network/additional-ip/configuring-an-additional-ipv6-block-in-a-vrack/47472299304339.png)
