...
**Related Guide**: [Configuring IPv6 on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/network-ipv6)
...
For more information about moving Additional IP, please read [this guide](/guides/bare-metal-cloud/dedicated-servers/move-failover-ip).
