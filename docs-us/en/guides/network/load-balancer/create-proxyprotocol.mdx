...
![Informal panel - Create proxyprotocol](/images/network/load-balancer/create-proxyprotocol/informal-panel.png)
...
![Server advanced settings](/images/network/load-balancer/create-proxyprotocol/server-advanced-settings.png)
