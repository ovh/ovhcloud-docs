...
For an overview of the OVHcloud Load Balancer service components, please refer to our [Introduction to the OVHcloud Load Balancer](/guides/network/load-balancer/use-presentation) guide.
...
![Server cluster more options](/images/network/load-balancer/create-balancing/server-cluster-more-options.png)
...
![Server cluster advanced settings](/images/network/load-balancer/create-balancing/server-cluster-advanced-settings.png)
...
![Apply configuration page](/images/network/load-balancer/create-balancing/apply-configuration-page.png)
