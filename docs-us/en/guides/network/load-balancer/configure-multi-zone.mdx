...
![IPLB\_diagram\_multiple-zones.png](/images/network/load-balancer/configure-multi-zone/47772082594579.png)
...
![IPLB\_home\_configurationPanel\_addZone.PNG](/images/network/load-balancer/configure-multi-zone/47772066554387.png)

Then select the zone(s) you wish to order and click `Add`.

![IPLB\_addNewZone.PNG](/images/network/load-balancer/configure-multi-zone/47772082598803.png)
...
![IPLB\_frontends\_selectAllDatacenters.PNG](/images/network/load-balancer/configure-multi-zone/47772082603795.png)
...
![IPLB\_applyConfiguration\_banner.png](/images/network/load-balancer/configure-multi-zone/47772066558355.png)
