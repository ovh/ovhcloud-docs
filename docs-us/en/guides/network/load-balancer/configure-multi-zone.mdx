...
![Diagram multiple zones](/images/network/load-balancer/configure-multi-zone/diagram-multiple-zones.png)
...
![Home configuration panel add](/images/network/load-balancer/configure-multi-zone/home-configuration-panel-add.png)

Then select the zone(s) you wish to order and click `Add`.

![Add new - Configure multi zone](/images/network/load-balancer/configure-multi-zone/add-new.png)
...
![Frontends select all datacenters](/images/network/load-balancer/configure-multi-zone/frontends-select-all-datacenters.png)
...
![Apply configuration banner](/images/network/load-balancer/configure-multi-zone/apply-configuration-banner.png)
