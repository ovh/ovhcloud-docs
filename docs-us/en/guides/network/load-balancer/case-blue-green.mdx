...
![Diagram blue green](/images/network/load-balancer/case-blue-green/diagram-blue-green.png)
...
![Server cluster tab empty](/images/network/load-balancer/case-blue-green/server-cluster-tab-empty.png)

Provide or choose a **Name**, **Protocol**, **Port**, and **Datacenter**, and then click `Add`.

![Tutorial add infra](/images/network/load-balancer/case-blue-green/tutorial-add-infra.png)
...
![Tutorial add server infra](/images/network/load-balancer/case-blue-green/tutorial-add-server-infra.png)

Provide or choose a **Name**, **IPv4 address**, and **Port**, and then click `Add`.

![Tutorial add server](/images/network/load-balancer/case-blue-green/tutorial-add-server.png)
...
![Tutorial add infra](/images/network/load-balancer/case-blue-green/tutorial-add-infra-b.png)
...
![Tutorial add server infra](/images/network/load-balancer/case-blue-green/tutorial-add-server-infra-b.png)

Provide or choose a **Name**, **IPv4 address**, and **Port**, and then click `Add`.

![Tutorial add server](/images/network/load-balancer/case-blue-green/tutorial-add-server-b.png)

At this stage, you should see two clusters with a server attached to each:

![Tutorial clusters servers](/images/network/load-balancer/case-blue-green/tutorial-clusters-servers.png)
...
![Frontends empty - Case blue green](/images/network/load-balancer/case-blue-green/frontends-empty.png)

Provide or choose a **Name**, **Protocol**, **Port**, **Datacenter**, and **Default server cluster**, and then click `Add`.

![Tutorial add frontend - step 2](/images/network/load-balancer/case-blue-green/tutorial-add-frontend-2.png)
...
![Frontends menu only](/images/network/load-balancer/case-blue-green/frontends-menu-only.png)

Provide or choose a **Name**, **Protocol**, **Port**, **Datacenter**, and **Default server cluster**, and then click `Add`.

![Tutorial add frontend](/images/network/load-balancer/case-blue-green/tutorial-add-frontend.png)
...
![Apply configuration banner](/images/network/load-balancer/case-blue-green/apply-configuration-banner.png)

On the next screen, select `☑` your **Datacenter** and click the `Apply configuration` button.

![Apply configuration page](/images/network/load-balancer/case-blue-green/apply-configuration-page.png)
...
![Tutorial front ends](/images/network/load-balancer/case-blue-green/tutorial-front-ends.png)
