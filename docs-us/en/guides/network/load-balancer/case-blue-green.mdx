...
**NOTE:** If you are not using the [beta version](/guides/account/account-information/control-panel-navigation) of the OVHcloud Control Panel, you can find the OVHcloud Load Balancer via the `Bare Metal Cloud` or `Hosted Private Cloud` sections.
