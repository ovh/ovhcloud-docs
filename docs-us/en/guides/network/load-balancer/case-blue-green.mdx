...
![network\_LB\_cases\_bluegreen01.png](/images/network/load-balancer/case-blue-green/29004528544147.png)
...
![IPLB\_serverClusterTab\_empty.png](/images/network/load-balancer/case-blue-green/46746641926163.png)

Provide or choose a **Name**, **Protocol**, **Port**, and **Datacenter**, and then click `Add`.

![IPLB\_tutorial\_blue-green\_addInfraA.PNG](/images/network/load-balancer/case-blue-green/46746615282323.png)
...
![IPLB\_tutorial\_blue-green\_addServer-InfraA.PNG](/images/network/load-balancer/case-blue-green/46746641930643.png)

Provide or choose a **Name**, **IPv4 address**, and **Port**, and then click `Add`.

![IPLB\_tutorial\_blue-green\_addServer-ServerA.png](/images/network/load-balancer/case-blue-green/46746615283987.png)
...
![IPLB\_tutorial\_blue-green\_addServer-InfraB.png](/images/network/load-balancer/case-blue-green/46746615284883.png)
...
![IPLB\_tutorial\_blue-green\_addServer-ServerB.PNG](/images/network/load-balancer/case-blue-green/46746641937299.png)

Provide or choose a **Name**, **IPv4 address**, and **Port**, and then click `Add`.

![IPLB\_tutorial\_blue-green\_addServer-ServerB.png](/images/network/load-balancer/case-blue-green/46746641938323.png)

At this stage, you should see two clusters with a server attached to each:

![network\_LB\_cases\_bluegreen10\*.png](/images/network/load-balancer/case-blue-green/29405839212179.png)
...
![IPLB\_frontends\_empty.png](/images/network/load-balancer/case-blue-green/46746641941267.png)

Provide or choose a **Name**, **Protocol**, **Port**, **Datacenter**, and **Default server cluster**, and then click `Add`.

![IPLB\_tutorial\_blue-green\_addFrontend-blue.png](/images/network/load-balancer/case-blue-green/46746615287955.png)
...
![IPLB\_frontends\_menu-only.png](/images/network/load-balancer/case-blue-green/46746615288339.png)

Provide or choose a **Name**, **Protocol**, **Port**, **Datacenter**, and **Default server cluster**, and then click `Add`.

![IPLB\_tutorial\_blue-green\_addFrontend-green.png](/images/network/load-balancer/case-blue-green/46746641945235.png)
...
![IPLB\_applyConfiguration\_banner.png](/images/network/load-balancer/case-blue-green/46746615299347.png)

On the next screen, select `☑` your **Datacenter** and click the `Apply configuration` button.

![IPLB\_applyConfiguration\_page.png](/images/network/load-balancer/case-blue-green/46746615301907.png)
...
![IPLB\_tutorial\_blue-green\_front-ends.PNG](/images/network/load-balancer/case-blue-green/46746615302803.png)
