...
![Server cluster advanced settings](/images/network/load-balancer/create-probes/server-cluster-advanced-settings.png)

A new configuration window will appear, with the probe’s settings.

![Server cluster probe settings](/images/network/load-balancer/create-probes/server-cluster-probe-settings.png)
