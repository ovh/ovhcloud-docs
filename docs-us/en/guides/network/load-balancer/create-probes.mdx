...
![IPLB\_serverCluster\_advancedSettings\_probes.PNG](/images/network/load-balancer/create-probes/48146676499987.png)

A new configuration window will appear, with the probe’s settings.

![IPLB\_serverCluster\_probeSettings.PNG](/images/network/load-balancer/create-probes/48146657796115.png)
