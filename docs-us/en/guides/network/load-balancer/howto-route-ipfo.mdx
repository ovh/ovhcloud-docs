...
For more information on the OVH Load Balancer solution, you can read our [Introduction to the OVHcloud Load Balancer](/guides/network/load-balancer/use-presentation).
...
![Frontend advanced settings](/images/network/load-balancer/howto-route-ipfo/frontend-advanced-settings.png)
...
![Apply configuration banner](/images/network/load-balancer/howto-route-ipfo/apply-configuration-banner.png)
