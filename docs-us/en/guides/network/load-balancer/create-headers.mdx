...
![Informal panel - Create headers](/images/network/load-balancer/create-headers/informal-panel.png)
...
![Frontends custom header](/images/network/load-balancer/create-headers/frontends-custom-header.png)
...
![Frontends custom header - step 2](/images/network/load-balancer/create-headers/frontends-custom-header-2.png)
