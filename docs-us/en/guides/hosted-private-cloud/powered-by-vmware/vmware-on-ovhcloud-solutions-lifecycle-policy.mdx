---
title: "VMware on OVHcloud solutions lifecycle policy"
description: "NOTE: This page is for general informational purposes only, and OVHcloud does not guarantee that the information is complete or up-to-date. The contracts govern"
zendesk_id: 44679026373907
zendesk_hash: 60d5c07bfc78c936
content_hash: b4038b08c8f098dc
updated: 2026-08-06
---
...
**NOTE:** This page is for general informational purposes only, and OVHcloud does not guarantee that the information is complete or up-to-date. The contracts governing this product (notably the general and specific terms of use) and the specific communications sent by OVHcloud to the clients will prevail over any information displayed on this page.
...
![diagram\_vmwareLifecycle.png](/images/hosted-private-cloud/powered-by-vmware/vmware-on-ovhcloud-solutions-lifecycle-policy/44732637544339.png)

 

## OVHcloud Commercial Range Status

**WARNING:** This page is for general informational purposes only, and OVHcloud does not guarantee that the information is complete or up-to-date. The contracts governing this product (notably the general and specific terms of use) and the specific communications sent by OVHcloud to the clients will prevail over any information displayed on this page.
...
| Public VMware Cloud Foundation as-a-Service | 2026                 |                  |             |                |
...
- **End of Growth** refers to the date when the growth for an existing cluster is discontinued. Past this date, customers will not be able to order this hardware generation anymore. However, this does not affect contractual service commitments for running clusters as the product is still supported (updates, spares, SLA).
- **End of Support** refers to the date when updates, runtime fixes, service access, OVHcloud assistance, and SLAs cease.

| Hardware Generation                 | General Availability | End of Sales | End of Growth | End of Support |
| ----------------------------------- | -------------------- | ------------ | ------------- | -------------- |
| SDDC2018 (Intel Broadwell)          | 2018                 | 2018-11-30   | 2026-08-01    | 2027-06-30     |
| Essentials (Intel Broadwell)        | 2020                 | 2026-05-26   | 2026-08-01    | 2027-06-30     |
...
- [VMware Product Lifecycle](https://support.broadcom.com/group/ecx/productlifecycle)
