...
Encryption is still possible at the VM and its data level, as described in the guide [Enabling VM Encryption with vSphere Native Key Provider](/guides/hosted-private-cloud/vmware/vm-encrypt-vnkp).
...
![Cluster configure vSphere availability](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/cluster-configure-vsphere-availability.png)

Turn off vSphere HA and click `OK`.

![Cluster edit HA disabled](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/cluster-edit-ha-disabled.png)
...
![Cluster vSAN services](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/cluster-vsan-services.png)
...
![Hyperconverg vSAN - step 10](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-10.png)
...
![Hyperconverg vSAN - step 11](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-11.png)
...
![Hyperconverg vSAN - step 12](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-12.png)

You are given the option to migrate data. With an empty datastore, there is no data migration necessary.

Click on `Remove`.

![Hyperconverg vSAN - step 13](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-13.png)
...
![Hyperconverg vSAN - step 15](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-15.png)

Confirm by clicking `TURN OFF` in the next window.

![Hyperconverg vSAN - step 16](/images/hosted-private-cloud/vmware/hyperconvergence-with-vsan/hyperconverg-vsan-16.png)
