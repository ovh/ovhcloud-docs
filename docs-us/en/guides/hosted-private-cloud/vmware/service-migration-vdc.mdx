...
To do this, please refer to our guides on [changing user rights](https://support.us.ovhcloud.com/hc/en-us/articles/17981389376915), [changing the user password](/guides/hosted-private-cloud/vmware/change-user-password), and [associating an email with a vSphere user](/guides/hosted-private-cloud/vmware/vsphere-edit-user).
