...
- A [VMware on OVHcloud](https://us.ovhcloud.com/hosted-private-cloud/vmware/) environment with an [active Logs Data Platform stream](/guides/manage-and-operate/logs-data-platform/getting-started)
...
- Read our [Introduction to the Logs Data Platform](/guides/manage-and-operate/logs-data-platform/introduction-to-logs-data-platform) guide
...
For further information on the technical specifications of the Logs Data Platform (ports, protocols, etc.), please refer to our guide [Quick Start for Logs Data Platform](/guides/manage-and-operate/logs-data-platform/getting-started).
...
![VMware activation](/images/hosted-private-cloud/vmware/ovhcloud-logs-forwarding-logs-data-platform/vmware-activation.png)
...
You can refer to this guide to find out how to create a stream via the Logs Data Platform interface: [Quick start for Logs Data Platform](/guides/manage-and-operate/logs-data-platform/getting-started).
...
You can refer to the [Logs Data Platform documentation](/guides/manage-and-operate/logs-data-platform/getting-started) for more information on the levels of security and responsibilities available.
...
![VMware - OVHcloud logs forwarding logs data platform](/images/hosted-private-cloud/vmware/ovhcloud-logs-forwarding-logs-data-platform/vmware.png)
...
![VMware subscribe](/images/hosted-private-cloud/vmware/ovhcloud-logs-forwarding-logs-data-platform/vmware-subscribe.png)
...
To retrieve the **streamId** of your LDP account, read our guide [Quick Start for Logs Data Platform](/guides/manage-and-operate/logs-data-platform/getting-started).
...
To manage your streams from the OVHcloud Control Panel, please see our [Quick Start for Logs Data Platform](/guides/manage-and-operate/logs-data-platform/getting-started) guide.
...
![VMware unsubscribe](/images/hosted-private-cloud/vmware/ovhcloud-logs-forwarding-logs-data-platform/vmware-unsubscribe.png)
...
- [View your logs in a Grafana dashboard](/guides/manage-and-operate/logs-data-platform/using-grafana-with-logs)
- [Use the "LDP Tail" cli to watch your logs live](/guides/manage-and-operate/logs-data-platform/tail)
- [Push logs from Apache to LDP](/guides/manage-and-operate/logs-data-platform/apache-logs)
