...
![Enter maintenance - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/enter-maintenance.png)
...
![Confirm maintenance - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/confirm-maintenance.png)
...
![VMs tab](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/vms-tab-png.png)

Once the host is in Maintenance Mode, right-click on the host and select **Power** and then **Reboot** from the drop-down menu.

![Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/reboot.png)

 

You will be prompted to enter a reason for the host reboot. Enter the reason and click **OK**.

![Reason - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/reason.png)
...
![Exit maintenance - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/exit-maintenance.png)

Verify that the correct version is showing on the host.

![Correct version - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/correct-version.png)
...
![Resources - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/resources.png)
...
![Affinity rules - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/affinity-rules.png)
...
![Disable rule - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/disable-rule.png)
...
![Error - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/error.png)

Click on the VM that has the attached device. Click **Actions** and then **Edit Settings**.

![Edit settings - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/edit-settings.png)
...
![Cd drive - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/cd-drive.png)
...
![Migrate - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/migrate.png)

Proceed through the migration menu. Verify that "change compute resource only" is selected and click **Next**.

![Migration menu - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/migration-menu.png)
...
![Compute resource - Reboot host after upgrade](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/compute-resource.png)
