...
![enter\_maintenance.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/enter-maintenance-png.png)
...
![confirm\_maintenance.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/confirm-maintenance-png.png)
...
![vms\_tab.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/vms-tab-png.png)

Once the host is in Maintenance Mode, right-click on the host and select **Power** and then **Reboot** from the drop-down menu.

![reboot.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/reboot-png.png)

 

You will be prompted to enter a reason for the host reboot. Enter the reason and click **OK**.

![reboot\_reason.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/reboot-reason-png.png)
...
![exit\_maintenance.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/exit-maintenance-png.png)

Verify that the correct version is showing on the host.

![correct\_version.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/correct-version-png.png)
...
![resources.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/resources-png.png)
...
![affinity\_rules.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/affinity-rules-png.png)
...
![disable\_rule.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/disable-rule-png.png)
...
![error.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/error-png.png)

Click on the VM that has the attached device. Click **Actions** and then **Edit Settings**.

![edit\_settings.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/edit-settings-png.png)
...
![cd\_drive.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/cd-drive-png.png)
...
![migrate.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/migrate-png.png)

Proceed through the migration menu. Verify that "change compute resource only" is selected and click **Next**.

![migration\_menu.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/migration-menu-png.png)
...
![compute\_resource.png](/images/hosted-private-cloud/vmware/reboot-host-after-upgrade/compute-resource-png.png)
