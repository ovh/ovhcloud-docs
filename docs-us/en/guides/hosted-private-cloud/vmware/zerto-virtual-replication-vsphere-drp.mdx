...
![zerto01.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18305911216403.png)

 

Select `Between two OVHcloud Private Cloud solutions` then click `Enable Zerto DRP`.

![zerto02.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18305911226387.png)
...
![zerto03.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18398133068307.png)
...
![zerto04.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18398133084051.png)
...
![zerto05.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18467266498323.png)
...
![zerto06.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18467286662035.png)
...
![zerto07.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18467286664723.png)
...
![zerto08.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468906970643.png)
...
![zerto09.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468892895763.png)
...
![zerto10.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468906978963.png)
...
![zerto11.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468906980755.png)
...
![zerto12.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468906982803.png)

In the **Extended Journal** section:

Click `NEXT`.

![zerto13.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468906985107.png)

The **Summary** section will show the settings for the new VPG. If everything is OK, click `Done`.

![zerto14.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18468892908051.png)

 

On the dashboard, you will see the new VPG with the status "Initializing."

![zerto15.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18469281506067.png)
...
![zerto16.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471013128851.png)
...
![zerto17.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471045271827.png)
...
![zerto18.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471045277843.png)
...
![zerto19.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471045279507.png)

When all checks have been performed, you can stop the test by clicking on the "stop" icon next to **Testing Failover**.

![zerto20.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471045281555.png)

At this stage, you can add a result of the test for future reference.

Confirm the end of the test by clicking `Stop`.

![zerto21.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471013144595.png)
...
![zerto22.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002826387.png)
...
![zerto23.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471981470867.png)
...
![zerto24.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002834963.png) ![zerto25.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471981479443.png)
...
![zerto26.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002844307.png)

 

The summary screen is displayed. If everything is OK, you can start the test by clicking `START FAILOVER`.

![zerto27.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18471981487379.png)
...
![zerto28.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002849299.png)
...
![zerto29.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002857235.png)
...
![zerto30.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002862611.png)

 

If you check the VPG, you will see that the replication direction has changed.

![zerto31.png](/images/hosted-private-cloud/vmware/zerto-virtual-replication-vsphere-drp/18472002864531.png)
