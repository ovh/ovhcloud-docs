...
![Federation - Use active directory server as authentication source - step 1](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-1.png)
...
![Federation - Use active directory server as authentication source - step 2](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-2.png)
...
![Federation - Use active directory server as authentication source - step 3](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-3.png)
...
![Federation - Use active directory server as authentication source - step 4](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-4.png)
...
![Federation - Use active directory server as authentication source - step 5](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-5.png)

A task status window appears, wait until it’s fully completed and click `Close`.

![Federation - Use active directory server as authentication source - step 6](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-6.png)
...
![Federation - Use active directory server as authentication source - step 7](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-7.png)
...
![Federation - Use active directory server as authentication source - step 8](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-8.png)

Select your Active Directory, click `Import Group`, type the `name of your group` and click `Next`.

![Federation - Use active directory server as authentication source - step 9](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-9.png)
...
![Federation - Use active directory server as authentication source - step 10](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-10.png)
...
![Federation - Use active directory server as authentication source - step 11](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-11.png)
...
![Federation - Use active directory server as authentication source - step 12](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-12.png)
...
![Federation - Use active directory server as authentication source - step 13](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-13.png)
...
![Federation - Use active directory server as authentication source - step 14](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-14.png)
...
![Federation - Use active directory server as authentication source - step 15](/images/hosted-private-cloud/vmware/use-active-directory-server-as-authentication-source-federation/federation-15.png)
