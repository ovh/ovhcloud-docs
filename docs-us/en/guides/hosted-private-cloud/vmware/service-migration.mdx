...
Should you choose to migrate an infrastructure to a new vDC instead, please follow this [dedicated guide](/guides/hosted-private-cloud/vmware/service-migration-vdc).
...
You can link your PCC services within the same vRack as part of a migration process. Please consult our guide to [using private cloud within a vRack](/guides/hosted-private-cloud/vmware/use-private-cloud-within-vrack).
...
Please consult our guide to [Migrate an IP block between two Hosted Private Cloud services](/guides/hosted-private-cloud/vmware/add-ip-block).
...
The migration involves reconfiguring VMware High Availability (HA), including boot order and priority. Please consult our guide about [VMware HA configuration](/guides/hosted-private-cloud/vmware/ha-high-availability).
...
The migration involves reconfiguring the VMware Distributed Resource Scheduler (DRS) feature, in particular the affinity or anti-affinity rules for groups of hosts and VMs. Please consult our guide about [configuring VMware DRS](/guides/hosted-private-cloud/vmware/drs-distributed-ressource-scheduler).
...
Please refer to our guide on [activating and using Veeam Managed Backup](/guides/hosted-private-cloud/vmware/veeam-backup-as-a-service).
...
- A [Veeam Backup & Replication](/guides/hosted-private-cloud/vmware/veeam-veeam-backup-replication) virtual machine on the source PCC
- [Authorizing the Veeam Backup & Replication virtual machine to connect](/guides/hosted-private-cloud/vmware/authorise-ip-vcenter-access) to the source and destination vCenter

Please refer to our guide on setting up [Veeam Backup & Replication](/guides/hosted-private-cloud/vmware/veeam-veeam-backup-replication). You can also refer to the [Veeam documentation](https://www.veeam.com/veeam_backup_10_0_user_guide_vsphere_pg.pdf) (PDF).
