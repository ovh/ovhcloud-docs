...
In the [migration guide](/guides/hosted-private-cloud/vmware/service-migration-vdc), you can find out how to move your existing IP from your NSX-v platform and route it to the IP attached to the Tier-0 section.
...
The NSX Edge cluster is compatible with an OVHcloud vRack. You can add your virtual data center that carries NSX-T in the vRack of your choice. Find more information on [this page](/guides/hosted-private-cloud/vmware/overview-vrack-compatibility-hosted-private-cloud).
...
Please see our [Getting Started with NSX](/guides/hosted-private-cloud/vmware/nsx-first-steps) guide and our other documentation for [VMware on OVHcloud](/guides/hosted-private-cloud/vmware/ovhcloud-responsibility-sharing).
