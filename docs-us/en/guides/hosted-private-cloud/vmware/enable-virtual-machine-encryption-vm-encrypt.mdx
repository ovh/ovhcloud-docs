...
![Enable virtual machine encryption VM encrypt - step 1](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-01.png)

 

Extract the value on `SHA1 Fingerprint` line

![Enable virtual machine encryption VM encrypt - step 2](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-02.png)
...
![Enable virtual machine encryption VM encrypt - step 3](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-03.png)
...
![Enable virtual machine encryption VM encrypt - step 4](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-04.png)

 

A last window displays the progress of the task.

![Enable virtual machine encryption VM encrypt - step 5](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-05.png)
...
![Enable virtual machine encryption VM encrypt - step 6](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-06.png)
...
![Enable virtual machine encryption VM encrypt - step 7](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-07.png)
...
![Enable virtual machine encryption VM encrypt - step 8](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-08.png)
...
![Enable virtual machine encryption VM encrypt - step 9](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-09.png)

 

Select the VM files and other hard disks that need to be encrypted.

![Enable virtual machine encryption VM encrypt - step 10](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-10.png)
...
![Enable virtual machine encryption VM encrypt - step 11](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-11.png)
...
![Enable virtual machine encryption VM encrypt - step 12](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-12.png)

 

![Enable virtual machine encryption VM encrypt - step 13](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-13.png)

 

![Enable virtual machine encryption VM encrypt - step 14](/images/hosted-private-cloud/vmware/enable-virtual-machine-encryption-vm-encrypt/vm-encryption-14.png)
