...
![Getting started - NSX first steps - step 1](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-01.jpg)
...
![Getting started - NSX first steps - step 2](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-02.jpg)

The NSX interface appears.

![Getting started - NSX first steps - step 3](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-03.jpg)
...
![Getting started - NSX first steps - step 4](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-04.jpg)

A view of all network elements is displayed.

Click `Network Topology` to the left.

![Getting started - NSX first steps - step 5](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-05.jpg)
...
- **ovh-segment-nsxpublic** which is a network segment connected to the OVHcloud public network on a VLAN, it contains the network of public addresses usable for customer configurations. Click the rectangular icon below to view this segment. You can find more information about segments in this guide: [Segment Management in NSX](/guides/hosted-private-cloud/vmware/nsx-segment-management).

![Getting started - NSX first steps - step 6](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-06.jpg)
...
![Getting started - NSX first steps - step 7](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-07.jpg)
...
![Getting started - NSX first steps - step 8](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-08.jpg)

Click the `>` scroll button to the left of **Name** to view the configuration.

![Getting started - NSX first steps - step 9](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-09.jpg)

Click on the `Number` to the right of **HA VIP Configuration**.

![Getting started - NSX first steps - step 10](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-10.jpg)

You see the public virtual IP address that can be used in your **NSX** configurations, click `Close` to close this window.

![Getting started - NSX first steps - step 11](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-11.jpg)
...
![Getting started - NSX first steps - step 12](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-12.jpg)
...
![Getting started - NSX first steps - step 13](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-13.jpg)
...
![Getting started - NSX first steps - step 14](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-14.jpg)

Click `CLOSE EDITING`.

![Getting started - NSX first steps - step 15](/images/hosted-private-cloud/vmware/nsx-first-steps/gettingstarted-15.jpg)
