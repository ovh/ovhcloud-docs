...
- You must have activated the Windows licenses in your [OVHcloud Control Panel](https://manager.us.ovhcloud.com/#/public-cloud/pci/projects). See the "Windows license" section of our [Introduction to the VMware on OVHcloud Control Panel](/guides/hosted-private-cloud/vmware/introduction-ovhcloud-control-panel#exploring-the-pcc-dashboard) guide for more information.
...
![VMware datacenters tab](/images/hosted-private-cloud/vmware/spla-license-management/vmware-datacenters-tab.png)
...
3. Click the *more options* `...` button on the right, then click `Activate licence`.
   ...
   ![Datacenter VM tab activate](/images/hosted-private-cloud/vmware/spla-license-management/datacenter-vm-tab-activate.png)
...
Virtual machines deployed from [VMware content libraries](/guides/hosted-private-cloud/vmware/how-to-use-content-library) are automatically attached to a corresponding Windows license.
