...
![VMware\_datacentersTab.PNG](/images/hosted-private-cloud/vmware/spla-license-management/52653691507987.png)
...
3. Click the *more options* `...` button on the right, then click `Activate licence`.
   ...
   ![datacenter\_vmTab\_activateLicense.PNG](/images/hosted-private-cloud/vmware/spla-license-management/52653691509395.png)
