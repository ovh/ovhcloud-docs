...
- Have read the Public VCF as-a-Service guides:\
  [Public VCF as-a-Service - Network concepts and best practices](/guides/hosted-private-cloud/public-vcf-aas/network-concepts)\
  [Public VCF as-a-Service - The fundamentals of Public VCF as-a-Service](/guides/hosted-private-cloud/public-vcf-aas/get-concepts)\
  [Public VCF as-a-Service - Logging in to your organization](/guides/hosted-private-cloud/public-vcf-aas/logging)
...
To connect to your Public VCF as-a-Service environment, follow [this guide](/guides/hosted-private-cloud/public-vcf-aas/logging).

Under the `Networking` section, select the `IP Spaces` tab and click `NEW`.

![Networking IP spaces](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces.png)
...
![Networking IP spaces create - step 1](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-01.png)
...
![Networking IP spaces create - step 2](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-02.png)
...
![Networking IP spaces create - step 3](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-03.png)
...
![Networking IP spaces create - step 4](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-04.png)
...
![Networking IP spaces create - step 5](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-05.png)
...
![Networking IP spaces create - step 6](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-ip-spaces-create-06.png)
...
![Networking data center groups empty](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-data-center-groups-empty.png)
...
![Networking data center groups create - step 1](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-data-center-groups-create-01.png)
...
![Networking data center groups create - step 2](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-data-center-groups-create-02.png)
...
![Networking data center groups create - step 3](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-data-center-groups-create-03.png)
...
![Networking data center groups create - step 4](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-data-center-groups-create-04.png)
...
![Networking networks empty](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-empty.png)
...
![Networking networks create - step 1](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-01.png)

![Networking networks create 01](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-01-b.png)
...
![Networking networks create - step 2](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-02.png)
...
![Networking networks create - step 3](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-03.png)
...
![Networking networks create - step 4](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-04.png)
...
![Networking networks create - step 5](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-05.png)
...
![Networking networks create - step 6](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-06.png)
...
![Networking networks create - step 7](/images/hosted-private-cloud/public-vcf-aas/network-creation/networking-networks-create-07.png)
