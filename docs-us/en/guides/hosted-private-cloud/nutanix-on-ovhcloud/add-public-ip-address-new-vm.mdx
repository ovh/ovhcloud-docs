...
![Add public IP address new VM - step 1](/images/hosted-private-cloud/nutanix-on-ovhcloud/add-public-ip-address-new-vm/addpublic-01.png)
...
![Add public IP address new VM - step 2](/images/hosted-private-cloud/nutanix-on-ovhcloud/add-public-ip-address-new-vm/addpublic-02.png)

 

Select `Place image directly on clusters`, then select your cluster and `Save`.

![Add public IP address new VM - step 3](/images/hosted-private-cloud/nutanix-on-ovhcloud/add-public-ip-address-new-vm/addpublic-03.png)
