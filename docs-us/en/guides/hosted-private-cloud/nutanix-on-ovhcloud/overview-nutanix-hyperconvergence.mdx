...
![hyperconvergence01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044515913747.png)
...
![hyperconvergence02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044572687251.png)
...
![hyperconvergence03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044574966291.png)

 

This allows you to check the storage status by node.

![hyperconvergence04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044576330131.png)

 

Click on the `Hardware` menu to view the details of the storage per node, as well as the number of disks allocated per node.

![hyperconvergence05.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044589917075.png)

 

Click `Diagram` for a graphical summary as shown below.

![hyperconvergence06.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/16044591120019.png)
