...
![Hyperconvergence - Overview Nutanix - step 1](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-01.png)
...
![Hyperconvergence - Overview Nutanix - step 2](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-02.png)
...
![Hyperconvergence - Overview Nutanix - step 3](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-03.png)

 

This allows you to check the storage status by node.

![Hyperconvergence - Overview Nutanix - step 4](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-04.png)

 

Click on the `Hardware` menu to view the details of the storage per node, as well as the number of disks allocated per node.

![Hyperconvergence - Overview Nutanix - step 5](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-05.png)

 

Click `Diagram` for a graphical summary as shown below.

![Hyperconvergence - Overview Nutanix - step 6](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-nutanix-hyperconvergence/hyperconvergence-06.png)
