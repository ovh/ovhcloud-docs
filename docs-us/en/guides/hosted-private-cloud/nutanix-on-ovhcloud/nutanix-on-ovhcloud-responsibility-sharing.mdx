---
title: "Nutanix on OVHcloud - Responsibility sharing"
description: "The RACI below details shared responsibilities between OVHcloud and the customer for the Hosted Private Cloud service Nutanix on OVHcloud. This model is designe"
zendesk_id: 19065081114643
zendesk_hash: 50ea937b27c9c830
content_hash: f3b4147179059694
updated: 2025-08-04
---

# Nutanix on OVHcloud - Responsibility sharing
...
| Choose Nutanix license pack based on your needs or import your own licenses                                                                | RA           | I            |
| Choose the model and range of dedicated servers following your needs and defined criteria                                                  | RA           | I            |
...
| Install the Nutanix Acropolis Operating System (AOS)                                                                                                                                                      | I            | RA           |
...
| **Activity**                                                                                                                                 | **Customer** | **OVHcloud** |
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------ |
| Import virtual machines from any source compatible with Nutanix technology (VMware, Hyper-V, AHV) manually or by using the Nutanix Move tool | RA           | I            |
...
| Install and configure software and middleware on the cluster                              | RA           |              |
...
| Configure and administer Nutanix solution                                          | RA           |              |
| Administer applications installed on Nutanix virtual layer                         | RA           |              |
...
| Manage risks of environment installed                                              | RA           |              |
| Deploy and ensure the functioning of the backup policy in the client's environment | RA           |              |
...
| Manage users' access to Nutanix cluster (i.e. Prism Administration interface, SSH, CLI) | RA           |              |
| Manage users' access and security policy in environment                                 | RA           |              |
| Manage physical access to infrastructures for OVHcloud teams                            | I            | RA           |
...
| Keep logs related to administration activities of the cluster made available with Nutanix tools (i.e. Prism, SSH, CLI) or with any external tool and those of hosted environment | RA           |              |
| Keep logs of the Control Plane that monitors and administers Nutanix service                                                                                                     |              | RA           |
| Monitor the performance of Nutanix cluster (incident alerts, usage report, etc.) and other software installed by the client on the environment                                   | RA           |              |
| Monitor the performance of the IPLB service usage integrated into the Nutanix offer (using performance graphs)                                                                   | RA           | I            |
...
| **Activity**                                                                  | **Customer** | **OVHcloud** |
| ----------------------------------------------------------------------------- | ------------ | ------------ |
| Create, modify, control, restore, and delete backups jobs                     | RA           |              |
| Manage content hosted on infrastructure                                       | RA           |              |
...
| Carry out maintenance on the storage and back devices provided by OVHcloud    | CI           | RA           |
...
| **Activity**                                                                    | **Customer** | **OVHcloud** |
| ------------------------------------------------------------------------------- | ------------ | ------------ |
| Provide an inventory of infrastructure and services used                        | I            | RA           |
| Manage the security of management infrastructures (Control Plane)               |              | RA           |
| Manage the security of Nutanix software and middleware installed on the cluster | RA           |              |
| Manage the security of data stored by the customer on the infrastructure        | RA           |              |
| Manage the physical security of equipment and infrastructure hosted at OVHcloud | I            | RA           |
...
| Maintain a business continuity and disaster recovery plan for the hosted environment | RA           |              |
...
| **Activity**                                                                                                                             | **Customer** | **OVHcloud** |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------ |
| Open tickets for incidents related to Nutanix software (in case of subscription to packaged odder and dysfunction of Nutanix software)   | RA           | I            |
| Open tickets for incidents related to Bring Your Own license offer (related to dysfunction of hardware elements in the Dedicated Server) | RA           | I            |
...
| **Activity**                                                                                   | **Customer** | **OVHcloud** |
| ---------------------------------------------------------------------------------------------- | ------------ | ------------ |
| Deploy patches, update, and configure the Nutanix software, middleware, and hosted environment | RA           |              |
| Provide the new firmware version as the Dedicated Server                                       | I            | RA           |
| Update virtual machines                                                                        | RA           |              |
| Approve change requests of defective hardware elements submitted by OVHcloud                   | A            | R            |
| Schedule changes requested by the customer                                                     | RA           | RI           |
...
| **Activity**                                                                                                                                 | **Customer** | **OVHcloud** |
| -------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------ |
| Export virtual machines from any source compatible with Nutanix technology (VMware, Hyper-V, AHV) manually or by using the Nutanix Move tool | RA           | C            |
...
| **Activity**                                                              | **Customer** | **OVHcloud** |
| ------------------------------------------------------------------------- | ------------ | ------------ |
| Decommission client-related configurations following contract termination | I            | RA           |
