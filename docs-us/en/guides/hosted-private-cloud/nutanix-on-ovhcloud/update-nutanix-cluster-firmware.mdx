...
![ntnx\_updatefirmware01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108134675.png)

- Run an NCC check.

In the Prism Element interface, click `Health` from the main menu.

![ntnx\_updatefirmware02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108140947.png)

 

Then click `Actions` to the right and click `Run NCC Checks`.

![ntnx\_updatefirmware03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108142739.png)

 

Select `All checks` and click `Run`.

![ntnx\_updatefirmware04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108147347.png)
...
![ntnx\_updatefirmware05.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108147987.png)
...
![ntnx\_updatefirmware06.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100668819.png)
...
![ntnx\_updatefirmware07.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108155667.png)
...
![ntnx\_updatefirmware08.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100677395.png)
...
![ntnx\_updatefirmware09.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100680339.png)
...
![ntnx\_updatefirmware10.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100687763.png)

On the main dashboard, the "**Data Resiliency Status**" will become `Critical`, the cluster is now running with two nodes.

![ntnx\_updatefirmware11.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100689555.png)
...
![ntnx\_updatefirmware12.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100694931.png)
...
![ntnx\_updatefirmware13.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100696339.png)
...
![ntnx\_updatefirmware14.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100698771.png)

 

Change the netboot by choosing `Boot in rescue mode`, choose the `rescue-customer` version, and click `Next`.

![ntnx\_updatefirmware15.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100701203.png)

 

Confirm your choice.

![ntnx\_updatefirmware16.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108201235.png)
...
![ntnx\_updatefirmware17.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108213779.png)
...
![ntnx\_updatefirmware18.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793100718355.png)
...
![ntnx\_updatefirmware19.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108221843.png)
...
![ntnx\_updatefirmware20.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/update-nutanix-cluster-firmware/19793108224019.png)
