...
![nutanixcustomsizes01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497269771155.png)

In the configuration pages for your Load Balancer, go to the `Server clusters` tab and click `Add a server cluster`.

![nutanixcustomsizes02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497208585619.png)
...
![nutanixcustomsizes03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497208587795.png)

Within the server cluster, click `Add server`.

![nutanixcustomsizes04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497269777555.png)
...
![nutanixcustomsizes05.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497269782035.png)
...
![nutanixcustomsizes06.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497208603411.png)

Select your location and click on `Apply configuration`.

![selectandapply.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/18846770708499.png)
...
![nutanixcustomsizes09.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497306732691.png)

When the task is finished, go to the `Front-ends` tab and click `Add a Front-end`.

![nutanixcustomsizes10.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497306735763.png)
...
![nutanixcustomsizes11.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17497353252499.png)
...
![nutanixcustomsizes12.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502164968595.png)

Click `Apply configuration` to the right of the warning message `Your load balancer configuration has not been applied in all datacenters`.

![nutanixcustomsizes13.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173903379.png)
...
![nutanixcustomsizes16.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173909523.png)
...
![nutanixcustomsizes17.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173911443.png)

Click `Continue` when prompted to activate Pulse.

![nutanixcustomsizes18.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502164997907.png)

Click the Prism Central configuration `gear` icon.

![nutanixcustomsizes19.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502164999955.png)

Click `Prism Central Management` to the left and click `Scale Out PC`.

![nutanixcustomsizes20.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165002259.png)

Click `Confirm`.

![nutanixcustomsizes21.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165006227.png)
...
![nutanixcustomsizes22.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165008531.png)

:::warning

**NOTE:** Please wait while the expansion is in progress; it may take around thirty minutes.

![nutanixcustomsizes23.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165011091.png)
...
![nutanixcustomsizes24.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165014419.png)
...
![nutanixcustomsizes25.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173935379.png)

Click `Add Server`.

![nutanixcustomsizes26.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173937811.png)
...
![nutanixcustomsizes27.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165030291.png)

Click the `...` configuration icon to the right of the **prismCentral** server and choose `Remove` from the menu.

![nutanixcustomsizes28.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173947155.png)

Click `delete`.

![nutanixcustomsizes29.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165036307.png)

Click `Apply Configuration`.

![nutanixcustomsizes30.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502173950739.png)
...
![nutanixcustomsizes33.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/prism-central-expansion/17502165054995.png)
