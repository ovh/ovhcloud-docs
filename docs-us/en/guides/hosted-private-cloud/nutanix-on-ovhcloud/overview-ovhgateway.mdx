...
![OVHgateway01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065547923.png)
...
![OVHgateway02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756054242195.png)

 

However, if the gateway is not present, check the subnet by going to `Hardware` then `Hosts` in the Prism Central WebUI.

![OVHgateway03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065555219.png)
...
![OVHgateway04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065563667.png)
...
![OVHgateway05.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065564691.png)

 

You then need to attach a disk. To do this, you can select the image used to create the original gateway.

![OVHgateway06.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065573523.png)

![OVHgateway07.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756054263187.png)

 

Then add **two nics** to the “base” network:

![OVHgateway08.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065575571.png)

![OVHgateway09.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/18756065579027.png)
...
![Guest customization](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/cloud-nutanix-23-ovh-gateway-doc-images-cloud-init-png.png)
