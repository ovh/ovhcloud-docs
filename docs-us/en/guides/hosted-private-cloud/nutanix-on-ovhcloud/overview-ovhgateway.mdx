...
![OVHgateway - Overview OVHgateway - step 1](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-01.png)
...
![OVHgateway - Overview OVHgateway - step 2](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-02.png)

 

However, if the gateway is not present, check the subnet by going to `Hardware` then `Hosts` in the Prism Central WebUI.

![OVHgateway - Overview OVHgateway - step 3](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-03.png)
...
![OVHgateway - Overview OVHgateway - step 4](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-04.png)
...
![OVHgateway - Overview OVHgateway - step 5](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-05.png)

 

You then need to attach a disk. To do this, you can select the image used to create the original gateway.

![OVHgateway - Overview OVHgateway - step 6](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-06.png)

![OVHgateway - Overview OVHgateway - step 7](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-07.png)

 

Then add **two nics** to the “base” network:

![OVHgateway - Overview OVHgateway - step 8](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-08.png)

![OVHgateway - Overview OVHgateway - step 9](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/ovhgateway-09.png)
...
![Overview ovhgateway](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-ovhgateway/cloud-nutanix-23-ovh-gateway-doc-images-init.png)
