...
![installationinfo01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615075289363.png)

 

Click the `List` tab and note down the **AOS version** for the cluster concerned.

![installationinfo02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18878101803667.png)
...
![installationinfo03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615257340179.png)
...
![installationinfo04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615257345811.png)
...
![installationinfo05.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615257347987.png)
...
![installationinfo06.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615435491987.png)
...
![installationinfo07.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615588342035.png)

 

To the right of the window, click on `Actions`, then `Run NCC checks`.

![installationinfo08.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615588344211.png)
...
![installationinfo09.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18615630253331.png)
...
![installationinfo10.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18616028536595.png)

 

Once the verification is complete, click `Succeeded` in the "Status" column.

![installationinfo11.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18616012517011.png)

 

You can then download the NCC report in .txt format by clicking `Download Output`.

![installationinfo12.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18616028545299.png)
...
![installationinfo13.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18616028546963.png)
...
![installationinfo14.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/retrieve-nutanix-installation-status-information/18616012525203.png)
