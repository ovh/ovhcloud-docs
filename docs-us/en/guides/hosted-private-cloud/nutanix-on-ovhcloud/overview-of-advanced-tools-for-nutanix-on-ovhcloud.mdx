...
![advancedtools01.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-of-advanced-tools-for-nutanix-on-ovhcloud/17270995337747.png)

 

Click the `drop-down icons` to the right of one of the command groups to display all possible commands in that group.

![advancedtools02.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-of-advanced-tools-for-nutanix-on-ovhcloud/18846227780371.png)

 

Click `Expand operations` to list the syntax for a particular command.

![advancedtools03.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-of-advanced-tools-for-nutanix-on-ovhcloud/17270995351315.png)

![advancedtools04.png](/images/hosted-private-cloud/nutanix-on-ovhcloud/overview-of-advanced-tools-for-nutanix-on-ovhcloud/17270995354387.png)
...
You can install Linux from pre-installed images, and you can customize the configuration with cloud-init, which uses the yaml file format. To import images into a Nutanix cluster, you can refer to our guide on [importing ISO images](https://support.us.ovhcloud.com/hc/en-us/articles/16864667698451).
