...
- You already have a [private network](/guides/public-cloud/network-services/configure-vrack) available in your project.
...
Retrieve the [private IP address](/guides/public-cloud/network-services/configure-vrack) of your client VM and ensure it is on the same private network as the share.
...
![Windows activate NFS client](/images/storage-and-backup/file-storage/getting-started/windows-activate-nfs-client.png)
...
1. Add your dedicated server to your vRack (see [more information](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server)).

2. In your Public Cloud project, create a [private network using the same vRack](/guides/public-cloud/network-services/configure-vrack) that your server is on.
...
## Go further
Browse all the [File Storage guides](/guides/storage-and-backup/file-storage/landing-page-file-storage).
...
Learn more about [File Storage](https://us.ovhcloud.com/public-cloud/file-storage/) on the OVHcloud US website.
