...
For step-by-step provisioning and mounting, see [File Storage Service – Getting Started](/guides/storage-and-backup/file-storage/getting-started).
...
For API steps to manage snapshots, see [File Storage Service – Managing Share Snapshots](/guides/storage-and-backup/file-storage/create-snapshot).
