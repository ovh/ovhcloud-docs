...
- Administrative (root) access to your instance [via SSH (Linux) or RDP (Windows)](/guides/public-cloud/compute/getting-started#step-4-connecting-to-your-instance)
...
![blockStorage\_serviceList\_moreOptions\_detach.PNG](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/48655449689491.png)

In the next screen, increase **Volume capacity** and click `Modify the volume`.

![manager\_blockStorage\_editVolume.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054686848147.png)
...
![windows\_blockStorage\_extendPartition1.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054686848787.png)

The extended disk now displays the additional capacity as unallocated space.

![windows\_blockStorage\_extendPartition2.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054686849427.png)

Right-click on the volume and select `Extend Volume` from the context menu.

![windows\_blockStorage\_extendPartition3.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054669278995.png)
...
![windows\_blockStorage\_extendPartition4.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054686850835.png)

Click on `Finish` to complete the process.

The resized volume now includes the additional disk space.

![windows\_blockStorage\_extendPartition5.png](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/41054686851603.png)
