...
- An [additional disk](/guides/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance) created in your project
- Administrative (root) access to your instance [via SSH (Linux) or RDP (Windows)](/guides/public-cloud/compute/getting-started#step-5-connect-to-the-instance)
...
The following steps presume that you have configured an additional disk according to [our guide](/guides/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance).
...
![Block storage service list](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/block-storage-service-list.png)

In the next screen, increase **Volume capacity** and click `Modify the volume`.

![Block storage edit volume](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/block-storage-edit-volume.png)
...
![Windows start management](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/windows-start-management.png)

The extended disk now displays the additional capacity as unallocated space.

![Windows block storage extend](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/windows-block-storage-extend.png)

Right-click on the volume and select `Extend Volume` from the context menu.

![Windows block storage extend - step 2](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/windows-block-storage-extend-2.png)
...
![Windows block storage extend - step 4](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/windows-block-storage-extend-4.png)

Click on `Finish` to complete the process.

The resized volume now includes the additional disk space.

![Windows block storage extend - step 3](/images/storage-and-backup/block-storage/increase-the-size-of-an-additional-disk/windows-block-storage-extend-3.png)
