...
description: "You'll need to check the speed of your disks when you carry out your tests. Whether you want to compare the performance of different disks or just check if they"
zendesk_id: 23011724595347
zendesk_hash: eba6630e4ffa7c72
content_hash: 5ae9c68c350ad16a
updated: 2026-01-08
---
...
To install `fio`, run the following command:
...
To test the speed of an additional disk, you will need to mount the disk. For more information, consult this [guide](/guides/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance).
