...
![horizon\_volumes.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/45214020368147.png)
...
![horizon\_createVolume.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/45214029324307.png)
...
![horizon\_volumes\_moreOptions.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/45214020380819.png)

Select the instance to which you wish to attach your volume, then click on `Attach Volume`.

![horizon\_volume\_manageAttachments.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/45214020383891.png)
...
![PCI\_blockstorage\_gettingstarted05.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076069651.png)

The disk appears as an unknown volume with unallocated space.

![PCI\_blockstorage\_gettingstarted06.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076071059.png)
...
![PCI\_blockstorage\_gettingstarted07.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076073747.png)

Right-click again and select `Initialize Disk`.

![PCI\_blockstorage\_gettingstarted08.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497067037075.png)
...
![PCI\_blockstorage\_gettingstarted09.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497067039507.png)
...
![PCI\_blockstorage\_gettingstarted10.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076082963.png)

Type `cmd` and click `OK`.

![PCI\_blockstorage\_gettingstarted11.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076083987.png)
...
![PCI\_blockstorage\_gettingstarted12.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076084755.png)

In the wizard, click `Next` to confirm the volume size (maximum by default), then `Next` again.

![PCI\_blockstorage\_gettingstarted13.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497067047315.png)

Accept the drive letter or select another, then click `Next`.

![PCI\_blockstorage\_gettingstarted14.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076087059.png)

Label the volume (optional) and click `Next`.

![PCI\_blockstorage\_gettingstarted15.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076088595.png)

Click `Finish` to format the disk.

![PCI\_blockstorage\_gettingstarted16.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497067054739.png)
...
![PCI\_blockstorage\_gettingstarted17.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076091155.png)

Right-click the volume and select `Change Drive Letter and Paths...`.

![PCI\_blockstorage\_gettingstarted18.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076092563.png)

Click `Remove`.

![PCI\_blockstorage\_gettingstarted19.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497076093203.png)

Click `Yes` to confirm.

![PCI\_blockstorage\_gettingstarted20.png](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/42497067061523.png)
