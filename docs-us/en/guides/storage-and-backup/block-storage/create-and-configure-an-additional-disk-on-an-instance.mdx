...
- A [Public Cloud instance](/guides/public-cloud/compute/getting-started) in your account
...
Existing High Speed volumes remain supported. You can also [change your Block Storage volume type](/guides/storage-and-backup/block-storage/switch-volume-type) to migrate them to Gen2.
...
**Select a region:** Select the location for your block storage volume. For more information about Local Zones, see [this guide](/guides/public-cloud/compute/getting-started-local-zones).
...
![Horizon volumes - Create and configure an additional disk on an instance](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/horizon-volumes.png)
...
![Horizon volume - Create and configure an additional disk on an instance](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/horizon-volume.png)
...
![Horizon volumes - Create and configure an additional disk on an instance - step 2](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/horizon-volumes-2.png)

Select the instance to which you wish to attach your volume, then click on `Attach Volume`.

![Horizon volume - Create and configure an additional disk on an instance - step 2](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/horizon-volume-2.png)
...
Establish an [SSH connection to your instance](/guides/public-cloud/compute/getting-started), then use the command below to list the attached disks.
...
![Block storage - Create and configure an additional disk on an instance - step 2](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-2.png)

The disk appears as an unknown volume with unallocated space.

![Block storage - Create and configure an additional disk on an instance - step 3](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-3.png)
...
![Block storage - Create and configure an additional disk on an instance - step 4](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-4.png)

Right-click again and select `Initialize Disk`.

![Block storage - Create and configure an additional disk on an instance - step 5](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-5.png)
...
![Block storage - Create and configure an additional disk on an instance](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage.png)
...
![Block storage - Create and configure an additional disk on an instance - step 6](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-6.png)

Type `cmd` and click `OK`.

![Block storage - Create and configure an additional disk on an instance - step 7](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-7.png)
...
![Block storage - Create and configure an additional disk on an instance - step 11](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-11.png)

In the wizard, click `Next` to confirm the volume size (maximum by default), then `Next` again.

![Block storage - Create and configure an additional disk on an instance - step 8](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-8.png)

Accept the drive letter or select another, then click `Next`.

![Block storage - Create and configure an additional disk on an instance - step 9](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-9.png)

Label the volume (optional) and click `Next`.

![Block storage - Create and configure an additional disk on an instance - step 10](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-10.png)

Click `Finish` to format the disk.

![Block storage - Create and configure an additional disk on an instance - step 15](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-15.png)
...
[Connect via SSH](/guides/public-cloud/compute/getting-started), then list the attached disks.
...
![Block storage - Create and configure an additional disk on an instance - step 12](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-12.png)

Right-click the volume and select `Change Drive Letter and Paths...`.

![Block storage - Create and configure an additional disk on an instance - step 14](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-14.png)

Click `Remove`.

![Block storage - Create and configure an additional disk on an instance - step 16](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-16.png)

Click `Yes` to confirm.

![Block storage - Create and configure an additional disk on an instance - step 13](/images/storage-and-backup/block-storage/create-and-configure-an-additional-disk-on-an-instance/block-storage-13.png)
