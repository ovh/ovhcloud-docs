---
title: "Object Storage - Responsibility sharing"
description: "The RACI below details shared responsibilities between OVHcloud and the customer for the Public Cloud Object Storage service. This shared model can help relieve"
zendesk_id: 35157254128531
zendesk_hash: b6c628ace49a9920
content_hash: d7452062ddc01cb1
updated: 2025-08-04
---

# Object Storage - Responsibility sharing
...
| -------------------------------------------------------------------------------------------------------------------- | ------------ | ------------ |
| Choose the Object Storage container service range following business needs (SWIFT, High Performance, Standard, etc.) | RA           | I            |
...
| **Activity**                                  | **Customer** | **OVHcloud** |
| --------------------------------------------- | ------------ | ------------ |
| Use Amazon S3®\* API to import data in bucket | RA           |              |
