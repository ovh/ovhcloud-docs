...
![Nextcloud\_1.PNG](/images/storage-and-backup/object-storage/nextcloud/11965071022227.png)

Select the `Disabled Apps` in the left panel.

Locate the **External storage support&#x20;**&#x61;pplication and click `Enable`.

![Nextcloud\_2.PNG](/images/storage-and-backup/object-storage/nextcloud/11965071027731.png)
...
![Nextcloud\_3.PNG](/images/storage-and-backup/object-storage/nextcloud/11965076825491.png)
...
![Nextcloud\_4.PNG](/images/storage-and-backup/object-storage/nextcloud/11965071124755.png)

Open the `Files` application, select the `External storage` menu in the **Administrative** menu and then select your `container`.

![Nextcloud\_5.PNG](/images/storage-and-backup/object-storage/nextcloud/11965071161747.png)

The result should be similar to this:

![Nextcloud\_6.PNG](/images/storage-and-backup/object-storage/nextcloud/11965071170323.png)
