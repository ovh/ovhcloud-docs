...
![Nextcloud - step 1](/images/storage-and-backup/object-storage/nextcloud/nextcloud-1.png)

Select the `Disabled Apps` in the left panel.

Locate the **External storage support&#x20;**&#x61;pplication and click `Enable`.

![Nextcloud - step 2](/images/storage-and-backup/object-storage/nextcloud/nextcloud-2.png)
...
![Nextcloud - step 3](/images/storage-and-backup/object-storage/nextcloud/nextcloud-3.png)
...
![Nextcloud - step 4](/images/storage-and-backup/object-storage/nextcloud/nextcloud-4.png)

Open the `Files` application, select the `External storage` menu in the **Administrative** menu and then select your `container`.

![Nextcloud - step 5](/images/storage-and-backup/object-storage/nextcloud/nextcloud-5.png)

The result should be similar to this:

![Nextcloud - step 6](/images/storage-and-backup/object-storage/nextcloud/nextcloud-6.png)
