...
- Make sure the region you are hosting your bucket in supports the storage class you choose. You can check the list of supported storage classes by region [here](/guides/storage-and-backup/object-storage/endpoints-geoavailability).
