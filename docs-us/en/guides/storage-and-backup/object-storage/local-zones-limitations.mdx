...
The feature sets for Object Storage in regions and Local Zones are mostly the same. However, some key differences are highlighted in the features matrix in [this guide](/guides/storage-and-backup/object-storage/compliancy).
