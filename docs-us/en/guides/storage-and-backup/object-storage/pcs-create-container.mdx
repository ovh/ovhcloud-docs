...
- Depending on the tool you plan to use:
  ...
  - **Swift S3**[**1**](#go-further)**&#x20;API**: An environment [prepared for the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) with `python-openstackclient` and `awscli` installed
  ...
  - **OVHcloud CLI**: The [OVHcloud CLI](/guides/manage-and-operate/cli/getting-started-ovhcloud-cli) installed and configured
...
Ensure the OVHcloud CLI is installed and configured with your credentials. For setup instructions, refer to the [OVHcloud CLI documentation](/guides/manage-and-operate/cli/getting-started-ovhcloud-cli).
