...
Discover how to maximize your performance with [this guide](/guides/storage-and-backup/object-storage/performance-optimization).
...
| ----------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Maximum number of buckets per project** | 100                 | Up to 1,000 buckets (requires manual intervention; please [contact the support team](/guides/account/account-information/contact-us-support))                        |
...
| **Maximum lifecycle rules**               | 1,000               | Understanding [lifecycle rules](/guides/storage-and-backup/object-storage/bucket-lifecycle)                                                                            |
| **Maximum replication rules**             | 1,000               | Understanding [bucket replication](/guides/storage-and-backup/object-storage/asynchronous-replication)                                                                         |
| **Maximum bucket tags**                   | 50                  | -                                                                                                                                                                            |
| **Maximum object tags**                   | 10                  | -                                                                                                                                                                            |
| **Maximum number of versions per object** | 100,000             | Beyond this value, a 403 error is returned with MaxVersionsReached code. Understanding [object versioning](/guides/storage-and-backup/object-storage/versioning) |
...
See our [Object Storage - Compliancy](/guides/storage-and-backup/object-storage/compliancy) guide.
