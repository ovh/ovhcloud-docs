...
More details about available regions can be found [here](/guides/storage-and-backup/object-storage/endpoints-geoavailability).
...
More details about lifecycle management can be found [here](/guides/storage-and-backup/object-storage/bucket-lifecycle).
...
The list of all API endpoints can be found [here](/guides/storage-and-backup/object-storage/endpoints-geoavailability).
