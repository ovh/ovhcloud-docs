...
![ObjectStorage\_tutorial\_bucketACL01.png](/images/storage-and-backup/object-storage/object-storage-bucket-acl/23886809282579.png)
...
- **log delivery group**: this group contains the applicative users used by OVHcloud services to write server access logs inside buckets (read our [Server access logging](https://support.us.ovhcloud.com/hc/en-us/articles/23888209235347) guide for more information)
