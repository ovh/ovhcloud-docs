...
If you are using legacy Swift Object Storage, follow [this guide](/guides/storage-and-backup/object-storage/pcs-create-container).
...
- An [Object Storage user](/guides/storage-and-backup/object-storage/identity-and-access-management) already created
...
If you wish to use the OVHcloud Terraform provider, see our [Manage an Object Storage bucket with Terraform](/guides/storage-and-backup/object-storage/terraform) guide.
...
![Object storage container dashboard enabled](/images/storage-and-backup/object-storage/getting-started/object-storage-container-dashboard-enabled.png)
...
For a list of endpoints by region and storage class, see the [Object Storage - Endpoints and geoavailability](/guides/storage-and-backup/object-storage/endpoints-geoavailability) guide.
...
See our [Getting Started with OVHcloud CLI](/guides/manage-and-operate/cli/getting-started-ovhcloud-cli) guide to learn about the OVHcloud CLI.
...
![Object storage containers tab](/images/storage-and-backup/object-storage/getting-started/object-storage-containers-tab.png)
...
![Object storage create container - step 1](/images/storage-and-backup/object-storage/getting-started/object-storage-create-container-1.png)
...
Versioning allows you to keep multiple variants of an object in the same bucket. This feature helps **preserve, retrieve, and restore every version of every object stored in your buckets**, making it easier to recover from unintended user actions or application failures. By default, versioning is disabled on buckets; enable it if needed. For more information about versioning, see our [Object Storage - Getting started with versioning](/guides/storage-and-backup/object-storage/versioning) guide.

You can also enable [Object Lock](/guides/storage-and-backup/object-storage/managing-object-lock) to store your objects in WORM (Write Once, Read Many) mode and guarantee their immutability for a defined retention period.
...
You can now decide whether or not you wish to **encrypt your data** using [SSE-OMK (server-side encryption with OVHcloud Managed Keys)](/guides/storage-and-backup/object-storage/encrypt-your-objects-with-sse-c).

Once you have finished configuring your bucket, click `Create`.

![Object storage create container - step 2](/images/storage-and-backup/object-storage/getting-started/object-storage-create-container-2.png)
...
When uploading objects, select a storage class to control availability, redundancy, and cost. To help you choose the right storage class for your needs, see the [Choosing the right storage class for your needs](/guides/storage-and-backup/object-storage/choosing-the-right-storage-class-for-your-needs) guide.
...
If your bucket has Object Lock enabled, you will not be able to permanently delete your objects. See our [documentation](/guides/storage-and-backup/object-storage/managing-object-lock) to learn more about Object Lock. If you use Object Lock in GOVERNANCE mode and have the permission to bypass GOVERNANCE mode, you will have to add the `--bypass-governance-retention` option to your delete commands.
