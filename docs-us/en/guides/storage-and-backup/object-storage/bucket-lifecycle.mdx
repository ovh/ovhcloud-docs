...
This feature is **not** supported on the legacy **.perf** endpoint and is only available through the **.io** endpoint. For more information about the differences between the two endpoints, see [this documentation](https://support.us.ovhcloud.com/hc/en-us/articles/10667991081107).
...
You can use the [Server Access Logging](https://support.us.ovhcloud.com/hc/en-us/articles/23888209235347) feature to monitor actions taken by your lifecycle rules on your S3 bucket. Server Access Logging provides detailed records for the requests that are made to a bucket including expiration operations, transitions of objects to another storage tier, etc.
...
Delete operations resulting from application of lifecycle rules are not replicated. See the documentation for [asynchronous replication](https://support.us.ovhcloud.com/hc/en-us/articles/34270032176019) for further details on what is replicated and what is not.
