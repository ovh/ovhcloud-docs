...
description: "Server Access Logging provides detailed records for the requests made to a container. Server access logs have many useful applications, such as security and acc"
zendesk_id: 23888209235347
zendesk_hash: 68b27623fad7502e
content_hash: 4d9d81ec1f4cfae6
updated: 2026-04-27
---

# Object Storage - Server Access Logging

Server Access Logging provides detailed records for the requests made to a container. Server access logs have many useful applications, such as security and access audits.

 

## Requirements

- An Object Storage container (see our [Getting Started with Object Storage](/guides/storage-and-backup/object-storage/getting-started) guide)
...
- Operation: operation listed here is declared
  ...
  - SOAP.operation
  - REST.HTTP\_method.resource\_type
  - WEBSITE.HTTP\_method.resource\_type
  - BATCH.DELETE.OBJECT
  - S3.action.resource\_type for Lifecycle and logging
...
- Error Code: Amazon S3[™\*](#go-further) Error code
  - ex: NoSuchBucket
