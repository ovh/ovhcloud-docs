...
zendesk_id: 4603929872275
zendesk_hash: e9f2f7b34027287b
content_hash: 87ff827f13bf9c0a
updated: 2026-07-31
---
...
![Object storage users add new user](/images/storage-and-backup/object-storage/identity-and-access-management/object-storage-users-add-new-user.png)

Once your user has been created, you will see the credentials:

![Object storage users credentials](/images/storage-and-backup/object-storage/identity-and-access-management/object-storage-users-credentials.png)
...
![Object storage containers tab more](/images/storage-and-backup/object-storage/identity-and-access-management/object-storage-containers-tab-more.png)

Select the user, choose a role, and click `Add`.

![Object storage container add user](/images/storage-and-backup/object-storage/identity-and-access-management/object-storage-container-add-user.png)
...
![Object storage users more options](/images/storage-and-backup/object-storage/identity-and-access-management/object-storage-users-more-options.png)
