---
title: "Public Cloud Instances - Responsibility sharing"
description: "The RACI below details shared responsibilities between OVHcloud and the customer for Public Cloud Instances Service. This shared model can help relieve the cust"
zendesk_id: 43546529594387
zendesk_hash: 6c3a1310120fd2db
content_hash: 8f79609714bbae24
updated: 2025-08-04
---

# Public Cloud Instances - Responsibility sharing
...
| Install internal functional bricks needed to maintain operational and security conditions of the Service (firmware, BIOS) | I            | RA           |
| Deploy the first network configuration on the Service                                                                     | I            | RA           |
| Buy and hold licenses and usage rights for Microsoft OS available on the OVHcloud catalog                                 | CI           | RA           |
| Buy and hold licenses and usage rights for other OS used                                                                  | RA           |              |
...
| ----------------------------- | ------------ | ------------ |
| Install OS                    | RA           | RI           |
| Install other software needed | RA           |              |
...
| Manage backups                                                                      | RA           |              |
| Manage backups following Customer requests (optional)                               | CI           | RA           |
...
| Monitor the functioning of software installed on Instances                               | RA           |              |
...
| Create, modify, control, restore, and delete jobs of backups                             | RA           |              |
