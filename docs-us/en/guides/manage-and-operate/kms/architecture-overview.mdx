...
Access to the keys is controlled by the [OVHcloud IAM](/guides/account/account-information/use-iam-policies-control-panel). Only the users allowed by an IAM policy can manage the keys or use them to encrypt or sign data.
...
![Manage - Architecture overview - step 1](/images/manage-and-operate/kms/architecture-overview/manage-01.png)
