...
![Manager dashboard - Use key management service](/images/manage-and-operate/kms/use-key-management-service/manager-dashboard.png)
...
![Manage using - Use key management service - step 2](/images/manage-and-operate/kms/use-key-management-service/manage-using-02.png)
...
**NOTE:** If you created your original access certificate with a CSR and in the OVHcloud Control Panel, the `ID_privatekey.pem` is the one you created in our [Getting Started with KMS](/guides/manage-and-operate/kms/quick-start#creating-an-access-certificate) guide.
...
![Manage using 03 - step 1](/images/manage-and-operate/kms/use-key-management-service/manage-using-03-1.png)

- Go to the tab named `Your Certificates`, then `Import...` and select the location of your `client.p12` file.

![Manage using 03 - step 2](/images/manage-and-operate/kms/use-key-management-service/manage-using-03-2.png)
...
![Manage using - Use key management service - step 5](/images/manage-and-operate/kms/use-key-management-service/manage-using-05.png)
...
![Manage using - Use key management service - step 6](/images/manage-and-operate/kms/use-key-management-service/manage-using-06.png)

**In Chrome/Chromium**

![Manage using 06](/images/manage-and-operate/kms/use-key-management-service/manage-using-06-b.png)
...
![Manage using - Use key management service - step 7](/images/manage-and-operate/kms/use-key-management-service/manage-using-07.png)
...
![Manage using - Use key management service - step 8](/images/manage-and-operate/kms/use-key-management-service/manage-using-08.png)
...
## Go further
Browse all the [Key Management Service (KMS) guides](/guides/manage-and-operate/kms/landing-page-kms).
...
Learn more about [Key Management Service](https://us.ovhcloud.com/identity-security-operations/key-management-service/) on the OVHcloud US website.
