...
![Manage quickstart - Quick start - step 1](/images/manage-and-operate/kms/quick-start/manage-quickstart-01.png)

Choose a region for your KMS.

![Manage quickstart - Quick start - step 2](/images/manage-and-operate/kms/quick-start/manage-quickstart-02.png)

You can then finalize the order in another tab. If it has not opened automatically, the URL is displayed:

![Manage quickstart - Quick start - step 3](/images/manage-and-operate/kms/quick-start/manage-quickstart-03.png)
...
![Manage quickstart - Quick start - step 4](/images/manage-and-operate/kms/quick-start/manage-quickstart-04.png)
...
![Manage quickstart - Quick start - step 5](/images/manage-and-operate/kms/quick-start/manage-quickstart-05.png)
...
![Manage quickstart - Quick start - step 6](/images/manage-and-operate/kms/quick-start/manage-quickstart-06.png)
...
![Manage quickstart - Quick start - step 7](/images/manage-and-operate/kms/quick-start/manage-quickstart-07.png)
...
The necessary steps to create an access certificate are available in our [Manage your OKMS access certificate](/guides/manage-and-operate/kms/okms-certificate-management) guide.
...
- Using the [Rest API](/guides/manage-and-operate/kms/use-key-management-service), if you want to manually use the API to encrypt or sign your data.
- Using the [KMIP protocol](/guides/manage-and-operate/kms/connect-product-using-kmip), if you want to connect any KMIP compatible product with your OVHcloud KMS.
