...
description: "Learn about the usage of the KMIP protocol and the different operations and types supported by the OVHcloud KMS."
zendesk_id: 34925746801555
zendesk_hash: 705e81691c31d75c
content_hash: 07e6fafbd27d85c3
updated: 2025-07-11
---

# How to connect a compatible product using KMIP protocol

**Learn about the usage of the KMIP protocol and the different operations and types supported by the OVHcloud KMS.**
...
[KMIP](https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=kmip) (Key Management Interoperability Protocol) is designed to standardize communications with a KMS.
...
The configuration depends on the product's integration but does not need any specific configuration on the OVHcloud KMS other than generating an access certificate. Software editors usually offer dedicated guides for this purpose.
...
You can also use [our SDK for Go](https://github.com/ovh/kmip-go).

 

### IAM rights

KMIP operations with IAM users need specific authorizations as described below:
...
The OVHcloud KMS covers, at least in part, versions 1.0 to 1.4 of the KMIP standard.
...
- [OASIS](https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=kmip) website
