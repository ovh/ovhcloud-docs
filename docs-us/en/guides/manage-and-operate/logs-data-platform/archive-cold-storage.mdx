...
As implied in the title, you will need a stream. If you don't know what a stream is or if you don't have any, you can follow this [quick start tutorial](/guides/manage-and-operate/logs-data-platform/getting-started). You can edit the stream configuration from the OVHcloud Control Panel:
...
![Operate security - Archive cold storage - step 1](/images/manage-and-operate/logs-data-platform/archive-cold-storage/operate-security-01.png)
...
- The content of your archives: GELF, one special field [X-OVH-TO-FREEZE](/guides/manage-and-operate/logs-data-platform/field-naming-convention), or both (you will get two separate archives in this case)
...
![Operate security - Archive cold storage - step 2](/images/manage-and-operate/logs-data-platform/archive-cold-storage/operate-security-02.png)
...
![Operate security - Archive cold storage - step 3](/images/manage-and-operate/logs-data-platform/archive-cold-storage/operate-security-03.png)
...
![Operate security - Archive cold storage - step 4](/images/manage-and-operate/logs-data-platform/archive-cold-storage/operate-security-04.png)
