---
title: "Logs Data Platform - Field Naming Convention"
description: "Learn how to ensure that your logs are properly parsed."
zendesk_id: 28131111525907
zendesk_hash: 5a2f6b32445baf1a
content_hash: e89564baddadbc22
updated: 2024-07-23
---

# Logs Data Platform - Field Naming Convention
...
| short\_message     | String  | A short descriptive message; MUST be set by client library.                                                                                      |
| full\_message      | String  | A long message that can i.e. contain a backtrace; optional.                                                                                      |
...
**NOTE:** You cannot use the field **source** since it is replaced by the content of the field **host** in Graylog.
...
![Operate ingest names - step 1](/images/manage-and-operate/logs-data-platform/field-naming-convention/operate-ingest-names-01.png)
