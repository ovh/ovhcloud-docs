---
title: "Logs Data Platform - Responsibility sharing"
description: "The Logs Data Platform is an interface for collecting, indexing, and analyzing logs. Wherever your logs come from, you can use the platform to choose different"
zendesk_id: 28056236542739
zendesk_hash: b657d106bf5a553a
content_hash: 8bed793a90d87f79
updated: 2025-08-04
---

# Logs Data Platform - Responsibility sharing
...
For your information, a **Log forwarder agent** is considered a tool (full software, script, or library) that is required to forward logs to LDP.
...
| Setup audit trails as a stream on dedicated clusters (enterprise)                                | I            | RA           |
...
| Install and configure the log forwarder agent and adapt its buffer following the needs and purpose of the processing | RA           |              |
...
| Decide to observe audit trails available in the audit stream (enterprise) | RA           |              |
...
| Decide to renew the password at least every quarter                                             | RA           | I            |
...
| Create, modify, control, restore, and delete internal backup jobs on management infrastructure | I            | RA           |
...
| Ensure that external tools remain compatible with the Logs Data Platform's major updates                      | RA           |              |
| Handle the major upgrade of the subscribed data gathering tool(s) regarding the external tool's compatibility | RA           |              |
...
| Notify incidents on the LDP service with the ticketing system            | RA           | I            |
