...
![operate\_LDP\_ingest\_syslog-ngLinux01\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348594185747.png)

In the top-left corner, chose **..last 1 day** as your `range`, then click on the green button `🔍` to search.

![operate\_LDP\_ingest\_syslog-ngLinux02\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348594203411.png)

On the top right corner of the histogram, click the *more options* `▼` icon and select `Copy to Dashboard`.

![operate\_LDP\_ingest\_syslog-ngLinux03\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348594214291.png)

Choose the dashboard you want to add to, then click `Select`.

![operate\_LDP\_ingest\_syslog-ngLinux04\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348594227347.png)
...
![operate\_LDP\_ingest\_syslog-ngLinux05\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348594238867.png)

On the next screen, under **VISUALIZATION TYPE** select `Pie Chart` and then click `Save`.

![operate\_LDP\_ingest\_syslog-ngLinux06\*.png](/images/manage-and-operate/logs-data-platform/log-linux/30348587125779.png)
