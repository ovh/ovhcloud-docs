...
![Operate ingest syslog-ng - step 1](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-01.png)

In the top-left corner, chose **..last 1 day** as your `range`, then click on the green button `🔍` to search.

![Operate ingest syslog-ng - step 2](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-02.png)

On the top right corner of the histogram, click the *more options* `▼` icon and select `Copy to Dashboard`.

![Operate ingest syslog-ng - step 3](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-03.png)

Choose the dashboard you want to add to, then click `Select`.

![Operate ingest syslog-ng - step 4](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-04.png)
...
![Operate ingest syslog-ng - step 5](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-05.png)

On the next screen, under **VISUALIZATION TYPE** select `Pie Chart` and then click `Save`.

![Operate ingest syslog-ng - step 6](/images/manage-and-operate/logs-data-platform/log-linux/operate-ingest-syslog-ng-06.png)

The best feature is the ability to mix criteria, based on what is important to you. For example, `facility:auth AND level:6`. Why not [create an alert](/guides/manage-and-operate/logs-data-platform/alerting) on this condition?
