...
![Operate ingest - Dedicated input logstash - step 1](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-01.png)
...
![Operate ingest - Dedicated input logstash - step 2](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-02.png)
...
![Operate ingest - Dedicated input logstash - step 3](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-03.png)
...
![Operate ingest - Dedicated input logstash - step 4](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-04.png)
...
![Operate ingest - Dedicated input logstash - step 5](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-05.png)
...
![Operate ingest - Dedicated input logstash - step 6](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-06.png)
...
![Operate ingest - Dedicated input logstash - step 7](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-07.png)
...
![Operate ingest - Dedicated input logstash - step 8](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-08.png)

![Operate ingest - Dedicated input logstash - step 9](/images/manage-and-operate/logs-data-platform/dedicated-input-logstash/operate-ingest-09.png)
