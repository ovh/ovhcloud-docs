...
If you are new to Logs Data Platform, completion of the [Quick Start Tutorial](/guides/manage-and-operate/logs-data-platform/getting-started) is highly recommended.
...
- [Pushing Logs with a Forwarder - Filebeat (Linux)](/guides/manage-and-operate/logs-data-platform/filebeat-logs)
