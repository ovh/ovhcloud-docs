...
4. Save the entry by clicking the `Save` button.
   ...
   ![Operate vQE use open search - step 2](/images/manage-and-operate/logs-data-platform/elastalert/operate-vqe-use-open-search-02.png)

5) Once the alias has been created, use the *more options* `...` button to the right and select `Attach content to the alias` option.

   ![Operate vQE use open search - step 3](/images/manage-and-operate/logs-data-platform/elastalert/operate-vqe-use-open-search-03.png)

6. Define the Graylog streams you want to associate with your alias.

If you only have [indices](/guides/manage-and-operate/logs-data-platform/index-as-a-service), you can use them directly in the ElastAlert configuration.
...
- `<password>` is the associated password. You can use [tokens](/guides/manage-and-operate/logs-data-platform/secure-apis-with-tokens)**&#xA0;**&#x69;n place of the username/password couple for your credentials.
...
To test your alert you can use the following curl command sending logs to our [OpenSearch endpoint](/guides/manage-and-operate/logs-data-platform/mutualized-inputs-opensearch-api):
