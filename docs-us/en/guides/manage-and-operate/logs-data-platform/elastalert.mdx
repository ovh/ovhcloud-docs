...
4. Save the entry by clicking the `Save` button.
   ...
   ![operate\_LDP\_vqe\_useOpenSearchAPI02.png](/images/manage-and-operate/logs-data-platform/elastalert/32090531388691.png)

5) Once the alias has been created, use the *more options* `...` button to the right and select `Attach content to the alias` option.

   ![operate\_LDP\_vqe\_useOpenSearchAPI03\*.png](/images/manage-and-operate/logs-data-platform/elastalert/32090531397651.png)
