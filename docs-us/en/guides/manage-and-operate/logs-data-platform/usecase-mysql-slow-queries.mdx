...
Our favorite way to send MySQL slow query logs is to send logs directly to Logs Data Platform by using [Filebeat](https://www.elastic.co/fr/downloads/beats/filebeat-oss). We cover Filebeat in depth in [another tutorial](/guides/manage-and-operate/logs-data-platform/filebeat-logs). Here is a minimal **filebeat.yml** configuration file.
...
![Operate use cases SQL - step 1](/images/manage-and-operate/logs-data-platform/usecase-mysql-slow-queries/operate-use-cases-sql-01.png)
...
All this information can help you analyze the most difficult queries for your database. You will know when to scale, when your database is too big for your hardware, or when to optimize your queries. Of course, it is always better to have a nice dashboard to display your own key performance indicators. One way to have this critical information as soon as it arrives is to use the [alerting feature](/guides/manage-and-operate/logs-data-platform/alerting).

![Operate use cases SQL - step 2](/images/manage-and-operate/logs-data-platform/usecase-mysql-slow-queries/operate-use-cases-sql-02.png)
