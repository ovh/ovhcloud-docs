...
description: "Learn how to query your logs from the Bonfire command line tool."
zendesk_id: 29188695448851
zendesk_hash: 06cd530de353feb9
content_hash: 8026f3156207d377
updated: 2024-08-07
---
...
If you want to use a parametric query **user\_id** for a field named **user\_id**, you can use the following form for your query in your **.bonfire.cfg**:
