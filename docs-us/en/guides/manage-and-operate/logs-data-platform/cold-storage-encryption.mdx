...
With the [Cold Storage feature](/guides/manage-and-operate/logs-data-platform/archive-cold-storage), you can generate daily archives for your log streams.
...
- a stream with cold storage enabled (you can follow this [Cold Storage tutorial](/guides/manage-and-operate/logs-data-platform/archive-cold-storage) to set it up)
...
![Operate security encrypt - step 1](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-01.png)
...
![Operate security encrypt - step 2](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-02.png)
...
![Operate security encrypt - step 3](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-03.png)
...
- Ensure the `Enable long-term storage` option is checked. You can refer to the [Cold Storage feature](/guides/manage-and-operate/logs-data-platform/archive-cold-storage) documentation to know about each of its fields.
...
![Operate security encrypt - step 4](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-04.png)
...
![Operate security encrypt - step 5](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-05.png)
...
![Operate security encrypt - step 6](/images/manage-and-operate/logs-data-platform/cold-storage-encryption/operate-security-encrypt-06.png)

 

#### Download and decrypt your archives

Once your encrypted archives are available, you can retrieve them [following this tutorial](/guides/manage-and-operate/logs-data-platform/archive-cold-storage). To decrypt a given archive, you can use `gpg` on a machine on which your private key is present:
...
If the situation described above happens (you lost your private key, but your archive is also encrypted with the `LDP Recovery Key`), you will have to [contact OVHcloud support](/guides/account/account-information/contact-us-support). Open a ticket and describe precisely the name of your Logs Data Platform service, the name of the stream and the name of the archive. You will also have to provide a new PGP encryption key (a key you already added to your Logs Data Platform account).
