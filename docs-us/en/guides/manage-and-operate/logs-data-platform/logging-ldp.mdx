...
- a facility to ensure fields suit the [LDP naming conventions](/guides/manage-and-operate/logs-data-platform/field-naming-convention).
...
- Fields are types using the [LDP naming convention](/guides/manage-and-operate/logs-data-platform/field-naming-convention): `manager.age` is renamed `manager_age_int`
