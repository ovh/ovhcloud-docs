...
- [at least one Stream and its token](/guides/manage-and-operate/logs-data-platform/getting-started)
...
![Operate ingest - Apache logs - step 1](/images/manage-and-operate/logs-data-platform/apache-logs/operate-ingest-01.png)
...
To keep things brief, this extract has only the parts relevant to the access log file. [The syslog-ng tutorial](/guides/manage-and-operate/logs-data-platform/log-linux) covers the configuration for any syslog file (like the error log file). This configuration is only valid for syslog-ng 3.8+.
...
If you want to use your own log format and include some useful information here is a cheat sheet for you (note that the labels follow [the field naming conventions](/guides/manage-and-operate/logs-data-platform/field-naming-convention)).
...
The latest releases of **Filebeat** have a dedicated module for **Apache2**. This solution is ready-to-use to configure and is more production-ready. The complete procedure of its installation is described [on this page](/guides/manage-and-operate/logs-data-platform/alerting) in the Apache logs use case.
