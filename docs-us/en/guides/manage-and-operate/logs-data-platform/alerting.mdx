...
- [Quick Start for Logs Data Platform](/guides/manage-and-operate/logs-data-platform/getting-started)
- [Logs Data Platform - Dedicated Input (Logstash)](/guides/manage-and-operate/logs-data-platform/dedicated-input-logstash)
...
For this tutorial, we will configure the three alerts that we can use for a website. These three alerts can help you to react immediately in the case of a failure or unexpected problems, or just to verify that all your websites are working correctly. But before going into the alerting feature itself, we need to configure our Apache Logging format to include all the information we need. We will also use [Filebeat](/guides/manage-and-operate/logs-data-platform/filebeat-logs) to send our logs to Logs Data Platform.
...
The configuration is inspired by the one you can find in [this tutorial](/guides/manage-and-operate/logs-data-platform/apache-logs).
...
![Operate vqe alert configuration - step 1](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-01.png)
...
![Operate vqe alert configuration - step 2](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-02.png)
...
![Operate vqe alert configuration - step 3](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-03.png)

You can remove the alert by clicking on the `Delete` button.

![Operate vqe alert configuration - step 4](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-04.png)

As soon as the alert is fired you will receive a mail, detailing the alert condition that triggered the alert.

![Operate vqe alert configuration - step 5](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-05.png)
...
![Operate vqe alert configuration - step 6](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-06.png)
...
![Operate vqe alert configuration - step 7](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-07.png)
...
![Operate vqe alert configuration - step 8](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-08.png)
...
![Operate vqe alert configuration - step 9](/images/manage-and-operate/logs-data-platform/alerting/operate-vqe-alert-config-09.png)
