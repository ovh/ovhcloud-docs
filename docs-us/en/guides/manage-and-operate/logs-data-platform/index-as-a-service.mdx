...
- an activated [Logs Data Platform account](/guides/manage-and-operate/logs-data-platform/getting-started)
...
![Operate open search - step 1](/images/manage-and-operate/logs-data-platform/index-as-a-service/operate-open-search-01.png)
...
If you have enabled [IAM on your account](/guides/manage-and-operate/logs-data-platform/iam-presentation-faq) you first need to create a policy and give the creation rights to your preferred user/account. See the [IAM for LDP documentation policy guide](/guides/manage-and-operate/logs-data-platform/iam-access-management).
...
The prefix of all indices or aliases created is `<service_name>`. Example: ldp-ab-12345-i-my-awesome-index. To interact with the OpenSearch API, you can either create [service accounts](/guides/manage-and-operate/iam/using-service-accounts-connect-ovhcloud-apis) and leverage the OpenID workflow, or create [local users](/guides/account/account-information/manage-local-users) with their Personal Access Token with the API:
...
If you don't know how to create a Logstash collector, please refer to the [Logstash guide](/guides/manage-and-operate/logs-data-platform/dedicated-input-logstash). Edit the configuration of Logstash. For this example we will use a SSL TCP input with the GELF codec. Here is the input configuration.
...
- **username**: This is the username to authenticate yourself against the API. Again, we recommend that you use [tokens](/guides/manage-and-operate/logs-data-platform/secure-apis-with-tokens) for that.
...
- **fields**: This is where the magic happens. The field of the document found will be added to the event. The field of the document is on the left and the new (or updated) field of the event is on the right. Be sure to follow the [field naming conventions](/guides/manage-and-operate/logs-data-platform/field-naming-convention).
...
![Operate open search - step 2](/images/manage-and-operate/logs-data-platform/index-as-a-service/operate-open-search-02.png)
...
![Operate open search - step 3](/images/manage-and-operate/logs-data-platform/index-as-a-service/operate-open-search-03.png)
...
![Operate open search - step 4](/images/manage-and-operate/logs-data-platform/index-as-a-service/operate-open-search-04.png)
