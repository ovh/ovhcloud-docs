...
![operate\_LDP\_security\_APItokens01\*\*.png](/images/manage-and-operate/logs-data-platform/secure-apis-with-tokens/31665274619923.png)

On this page, you will have the ability to create and remove tokens. Note that you cannot modify a token.

![operate\_LDP\_security\_APItokens02A\*\*\*.png](/images/manage-and-operate/logs-data-platform/secure-apis-with-tokens/31665281469587.png)
