...
Default settings can be set using a configuration file named `.ovh.conf` and located in your `${HOME}` directory. You can check [this guide](/guides/manage-and-operate/api/first-steps) to learn how to create API credentials.
