...
![Dashboard - Kv2 API](/images/manage-and-operate/secret-manager/kv2-api/dashboard.png)
...
![Swagger - Kv2 API](/images/manage-and-operate/secret-manager/kv2-api/swagger.png)
