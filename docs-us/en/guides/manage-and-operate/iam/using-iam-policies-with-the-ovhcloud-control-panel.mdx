...
zendesk_id: 19185780752019
zendesk_hash: 190b1d78369ecc1a
content_hash: 5c3b40f6f5fa66fc
updated: 2025-11-24
---
...
![Manage\_IAM\_controlPanel01.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594108051.png)

 

## Topics

- [Accessing the IAM menu](#accessing-the-iam-menu)
- [Managing policies](#managing-policies)
- [Managing identities](#managing-identities)
- [Managing resource groups](#managing-resource-groups)
...
If you are accessing this menu for the first time, the following page appears. Click [`Create a policy`](#creating-a-policy) or [`Create users`](#managing-identities), depending on the action you want to perform.
...
![Manage\_IAM\_controlPanel04.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594114195.png)
...
![policies\_myPoliciesTab\_empty.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/46811428071827.png)
...
![policies\_addPolicy\_conditions.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/46811392937363.png)
...
1. <details>
   ...
   ![Manage\_IAM\_controlPanel07.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408619679635.png)
...
2. <details>
   ...
   ![Manage\_IAM\_controlPanel08.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594139283.png)
...
3. <details>
   ...
   ![Manage\_IAM\_controlPanel09.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594157587.png)
...
4. <details>
   ...
   ![Manage\_IAM\_controlPanel10.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594164627.png)
...
![policies\_myPoliciesTab\_moreOptions.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/46811428082195.png)
...
![Manage\_IAM\_controlPanel14\*.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408619713427.png)
...
![Manage\_IAM\_controlPanel15\*.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594197011.png)
...
![policies\_resourceGroups\_moreOptions.png](/images/manage-and-operate/iam/using-iam-policies-with-the-ovhcloud-control-panel/38408594200851.png)
