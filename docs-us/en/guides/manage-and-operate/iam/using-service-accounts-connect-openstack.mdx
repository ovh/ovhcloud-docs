...
- You know [how to configure access policies via API](/guides/manage-and-operate/iam/using-policies-ovhcloud-api)
- You know [how to use the OpenStack API](/guides/public-cloud/compute/starting-with-nova)
- You have created a [service account via API](/guides/manage-and-operate/api/managing-ovhcloud-service-accounts-via)
...
If you do not already have a service account, follow the steps in [this guide](/guides/manage-and-operate/api/managing-ovhcloud-service-accounts-via) before continuing.
