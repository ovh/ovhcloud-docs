...
- OVHcloud API: [How to Manage OVHcloud Service Accounts via the API](/guides/manage-and-operate/api/managing-ovhcloud-service-accounts-via)
- OpenStack API: [How to Use Service Accounts to Connect to OpenStack](/guides/manage-and-operate/iam/using-service-accounts-connect-openstack)
...
- You know [how to configure IAM access policies via the OVHcloud Control Panel](/guides/account/account-information/use-iam-policies-control-panel)
...
Service accounts are one of the types of identities that can be set up on your OVHcloud account. Other account types are described in the [related documentation](/guides/manage-and-operate/iam/presentation-identity-interactions-within-ovhcloud-account).
...
Like all OVHcloud APIs, the management of these credentials is subject to configurable access rights within the access policies. You can find more information in our guide on [using IAM policies via the OVHcloud Control Panel](/guides/account/account-information/use-iam-policies-control-panel).
...
To modify access for a service account, you can associate it with an existing access policy or create a new one. To find out more about managing access policies, please read our guide on [using IAM policies via the OVHcloud API](/guides/manage-and-operate/iam/using-policies-ovhcloud-api).
...
- [How to Use Service Accounts to Connect to OVHcloud APIs](/guides/manage-and-operate/iam/using-service-accounts-connect-ovhcloud-apis)
- [How to Use Service Accounts to Connect to OpenStack](/guides/manage-and-operate/iam/using-service-accounts-connect-openstack)
