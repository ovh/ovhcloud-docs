...
The event and task examples shown above may vary by API section. Please refer to [this documentation](/guides/manage-and-operate/api/console-preview) to view the exact definition for each section.
...
[Using Terraform with OVHcloud](/guides/manage-and-operate/terraform/using-terraform-with-ovhcloud)
