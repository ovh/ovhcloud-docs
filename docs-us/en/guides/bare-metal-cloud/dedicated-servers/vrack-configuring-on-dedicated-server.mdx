...
![Network configure - vRack configuring on dedicated server - step 1](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-01.png)
...
![Network configure - vRack configuring on dedicated server - step 2](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-02.png)
...
![Network configure - vRack configuring on dedicated server - step 3](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-03.png)
...
![Network configure 04 - step 5](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-04-5.png)

In the pop-up window, select `▼` the vRack network you wish to attach, and then click `Attach`.

![Network configure 04 5](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-04-5-b.png)
...
The following sections contain the configurations for the most commonly used recent distributions/operating systems. The first step is always to [log in to your server](/guides/bare-metal-cloud/dedicated-servers/getting-started-dedicated-server-windows-linux) via SSH or an RDP session (for Windows). The examples below presume you are logged in as a user with elevated permissions (Administrator/sudo).
...
![Network configure - vRack configuring on dedicated server - step 4](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-04.png)
...
![Debian 11 configuration example](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/debian-11-config-example.png)
...
![Ubuntu configuration example](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/ubuntu-config-example.png)
...
![CentOS configuration example](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/cent-os-config-example.png)
...
![Network configure - vRack configuring on dedicated server - step 5](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-05.png)

Click on `Network and Internet`.

![Network configure - vRack configuring on dedicated server - step 6](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-06.png)

Open `Network and Sharing Center`.

![Network configure - vRack configuring on dedicated server - step 7](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-07.png)

Click on `Change Adapter Settings`.

![Network configure - vRack configuring on dedicated server - step 8](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-08.png)
...
![Network configure - vRack configuring on dedicated server - step 9](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-09.png)

Double-click `Internet Protocol Version 4 (TCP/IPv4)`.

![Network configure - vRack configuring on dedicated server - step 10](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-10.png)
...
![Network configure - vRack configuring on dedicated server - step 11](/images/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server/network-configure-11.png)
