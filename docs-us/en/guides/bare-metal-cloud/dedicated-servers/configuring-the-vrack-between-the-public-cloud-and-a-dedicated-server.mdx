...
![Configuring the vRack between the public cloud and a dedicated server](/images/bare-metal-cloud/dedicated-servers/configuring-the-vrack-between-the-public-cloud-and-a-dedicated-server/v.png)
...
- Overview:
  ...
  ![Bare - Configuring the vRack between the public cloud and a dedicated server](/images/bare-metal-cloud/dedicated-servers/configuring-the-vrack-between-the-public-cloud-and-a-dedicated-server/bare.png)
