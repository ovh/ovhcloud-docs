...
If you need assistance, follow our [Creating and Connecting a Public Cloud Instance](/guides/public-cloud/compute/getting-started) guide. When creating an instance, you can choose to connect your instance to a specific private network. Choose your previously created vRack from the drop-down menu.
...
From here, please refer to the [Configuration examples](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server#configuration-examples) section of our [Configuring the vRack on your dedicated servers](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server) guide.
...
From here, continue by using the instructions for [Windows configuration](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server#configuration-examples) in our [Configuring the vRack on your dedicated servers](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server) guide.
