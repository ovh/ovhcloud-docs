...
![Windows firewall configuration - Activate port firewall SoftWin - step 1](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-01.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 2](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-02.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 3](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-03.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 4](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-04.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 5](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-05.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 6](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-06.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 7](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-07.png)
...
![Windows firewall configuration - Activate port firewall SoftWin - step 8](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-08.png)

 

You can then make changes to the settings of the new rule you have created.

![Windows firewall configuration - Activate port firewall SoftWin - step 9](/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/config-windows-firewall-09.png)
