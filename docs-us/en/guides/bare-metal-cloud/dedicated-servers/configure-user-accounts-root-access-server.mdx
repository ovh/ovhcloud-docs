...
For more detailed instructions on this topic, please refer to our [How to get started with SSH connections](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) guide.
