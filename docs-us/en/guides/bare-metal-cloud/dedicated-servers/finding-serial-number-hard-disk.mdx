...
![Powershell - Finding serial number hard disk](/images/bare-metal-cloud/dedicated-servers/finding-serial-number-hard-disk/powershell.jpg)
...
For an in-depth look at these commands and how to test your hard disks, refer to [this guide (LSI raid controller)](/guides/bare-metal-cloud/dedicated-servers/managing-hardware-raid).
...
You can refer to [this guide (LSI raid controller)](/guides/bare-metal-cloud/dedicated-servers/managing-hardware-raid) to find which hard drive relates to a designated sg device.
