...
- [How to secure a VPS](/guides/bare-metal-cloud/vps/secure-your-vps)
...
![Cli install iptables output](/images/bare-metal-cloud/dedicated-servers/firewall-linux-iptable/cli-install-iptables-output.png)
...
![Cli iptables status](/images/bare-metal-cloud/dedicated-servers/firewall-linux-iptable/cli-iptables-status.png)
...
- [How to use the KVM console to access a VPS](/guides/bare-metal-cloud/vps/using-kvm-for-vps)
...
![Cli iptables list rules](/images/bare-metal-cloud/dedicated-servers/firewall-linux-iptable/cli-iptables-list-rules.png)
