...
- IPv4:
  ...
  - [Configuring IP aliasing on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing)
  - [Configuring IP aliasing on a VPS](/guides/bare-metal-cloud/vps/configuring-ip-aliasing)

- IPv6:

  - [Configuring IPv6 on dedicated servers](/guides/bare-metal-cloud/dedicated-servers/network-ipv6)
  - [Configuring IPv6 on a VPS](/guides/bare-metal-cloud/vps/configuring-ipv6)
...
- The details of your server's **private** interface (see [this guide](/guides/bare-metal-cloud/dedicated-servers/configuring-network-proxmox-ve-high-grade-scale-advance-ranges#collect-environment-data) for instructions on how to find it)
...
![IP service list](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/ip-service-list.png)
...
![IP order select version IPv - step 6](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/ip-order-select-version-ipv6.png)
...
![Network configuration IPv6 - step 2](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-02.png)
...
![Network configuration IPv6 - step 12](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-12.png)
...
![Network configuration IPv6 - step 13](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-13.png)
...
![Network configuration IPv6 - step 3](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-03.png)
...
![Network configuration IPv6 - step 4](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-04.png)
...
![Network configuration IPv6 - step 5](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-05.png)
...
![Network configuration IPv6 - step 6](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-06.png)
...
![Network configuration IPv6 - step 7](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-07.png)
...
![Network configuration IPv6 - step 8](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-08.png)
...
![Network configuration IPv6 - step 14](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-14.png)

On the right, you have an IP section, and you can add a new subnet by clicking `+ Add a subnet`.

![Network configuration IPv6 - step 15](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-15.png)
...
![Network configuration IPv6 - step 16](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-16.png)
...
![Network configuration IPv6 - step 17](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-17.png)
...
![Network configuration IPv6 - step 9](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-09.png)
...
![Network configuration IPv6 - step 10](/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/network-config-ipv6-10.png)
