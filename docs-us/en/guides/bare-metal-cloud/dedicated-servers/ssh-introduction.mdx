...
![Start SSH - Introduction - step 1](/images/bare-metal-cloud/dedicated-servers/ssh-introduction/start-ssh-01.png)
...
![Start SSH - Introduction - step 2](/images/bare-metal-cloud/dedicated-servers/ssh-introduction/start-ssh-02.png)
...
[How to use PuTTY](/guides/bare-metal-cloud/dedicated-servers/ssh-using-putty-on-windows)
...
## Go further
[How to configure user accounts and root access on a server](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server)
