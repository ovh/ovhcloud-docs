...
[Contact OVHcloud support](/guides/account/account-information/contact-us-support) to investigate. Make sure to provide logs and screenshots.
...
![Account menu - Troubleshooting](/images/bare-metal-cloud/dedicated-servers/troubleshooting/account-menu.png)

In the pop-up menu, choose `Login Info`, enter your current password, create a new one, and click `Finish`.

![Account login information](/images/bare-metal-cloud/dedicated-servers/troubleshooting/account-login-info.png)
