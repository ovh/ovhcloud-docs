...
![VSPC\_accountMenu.PNG](/images/bare-metal-cloud/dedicated-servers/troubleshooting/54151810142867.png)

In the pop-up menu, choose `Login Info`, enter your current password, create a new one, and click `Finish`.

![VSPC\_account\_loginInfo.PNG](/images/bare-metal-cloud/dedicated-servers/troubleshooting/54151811760019.png)
