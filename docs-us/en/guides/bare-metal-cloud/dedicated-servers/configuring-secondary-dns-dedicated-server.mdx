...
![dedicated\_secondaryDNStab.png](/images/bare-metal-cloud/dedicated-servers/configuring-secondary-dns-dedicated-server/50983020903187.png)

Enter your IP address and the domain name to add, then click `Next`.

![dedicated\_secondaryDNStab\_addDomain-1.PNG](/images/bare-metal-cloud/dedicated-servers/configuring-secondary-dns-dedicated-server/50983010130963.png)
...
![dedicated\_secondaryDNStab\_addDomain-2.PNG](/images/bare-metal-cloud/dedicated-servers/configuring-secondary-dns-dedicated-server/50983010133011.png)
...
![dedicated\_secondaryDNStab\_addDomain-3.png](/images/bare-metal-cloud/dedicated-servers/configuring-secondary-dns-dedicated-server/50983010136083.png)
