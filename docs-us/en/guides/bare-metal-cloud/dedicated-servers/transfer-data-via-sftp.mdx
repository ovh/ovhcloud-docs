...
If you are certain that you need to access files of the `root` user via SFTP, learn how to enable this connection in our [user account guide](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server).
...
![FileZilla mount point](/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/filezilla-mount-point.png)
...
![FileZilla remote site](/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/filezilla-remote-site.png)
...
![FileZilla progress - Transfer data via sftp](/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/filezilla-progress.png)
