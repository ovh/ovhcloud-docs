...
![Bare metal cloud dedicated servers - step 2](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-2.png)
...
![Bare metal cloud dedicated servers](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers.png)
...
![Network VLANs - step 3](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-03.png)

Next, right-click on the network interface and select `Add to New Team`.

![Network VLANs - step 4](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-04.png)

In the pop-up window, create a new team by typing a team name into the **Team name** field. When you have finished, click `OK`.

![Network VLANs - step 5](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-05.png)
...
![Network VLANs - step 6](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-06.png)

Now, we need to configure the IP address of the VLAN. Click the `Start` button on your keyboard, then click `Control Panel`.

![Network VLANs - step 7](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-07.png)

 

Next, click `Network and Internet`.

![Network VLANs - step 8](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-08.png)

 

Then `Network and Sharing Center`.

![Network VLANs - step 9](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-09.png)

 

Then click `Change adapter settings`.

![Network VLANs - step 10](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-10.png)

 

Next, right-click the VLAN interface and click `Properties`.

![Network VLANs - step 11](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-11.png)
...
![Network VLANs - step 12](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-12.png)
...
![Network VLANs - step 13](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/network-vlans-13.png)
