...
![debian VLAN](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-creating-multiple-vlans-in-a-vrack-images-mul.png)
...
![ubuntu VLAN](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-creating-multiple-vlans-in-a-vrack-images-vra.png)
...
![ubuntu VLAN](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-creating-multiple-vlans-in-a-vrack-images-mul.png)
...
![alma VLAN](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-creating-multiple-vlans-in-a-vrack-images-mul.png)
...
![config](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/bare-metal-cloud-dedicated-servers-creating-multiple-vlans-in-a-vrack-images-mul.png)
...
![DS\_network\_multipleVLANs03.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504762387.png)

Next, right-click on the network interface and select `Add to New Team`.

![DS\_network\_multipleVLANs04.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516513039763.png)

In the pop-up window, create a new team by typing a team name into the **Team name** field. When you have finished, click `OK`.

![DS\_network\_multipleVLANs05.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504797331.png)
...
![DS\_network\_multipleVLANs06.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504813971.png)

Now, we need to configure the IP address of the VLAN. Click the `Start` button on your keyboard, then click `Control Panel`.

![DS\_network\_multipleVLANs07.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516513104659.png)

 

Next, click `Network and Internet`.

![DS\_network\_multipleVLANs08.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504845203.png)

 

Then `Network and Sharing Center`.

![DS\_network\_multipleVLANs09.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516513140627.png)

 

Then click `Change adapter settings`.

![DS\_network\_multipleVLANs10.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504866707.png)

 

Next, right-click the VLAN interface and click `Properties`.

![DS\_network\_multipleVLANs11.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504874643.png)
...
![DS\_network\_multipleVLANs12.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516504894227.png)
...
![DS\_network\_multipleVLANs13.png](/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-vrack/25516513217555.png)
