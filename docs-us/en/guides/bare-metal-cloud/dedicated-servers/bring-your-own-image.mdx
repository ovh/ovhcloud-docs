...
- Access to the [OVHcloud API](/guides/manage-and-operate/api/first-steps) (for the "[Deployment via API](#deploying-your-image-via-the-apis)" section of this guide)
