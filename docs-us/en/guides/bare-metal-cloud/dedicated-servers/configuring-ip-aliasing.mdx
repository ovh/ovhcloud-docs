...
This article is about Additional IPv4 configuration on a public interface. You can also configure Primary IPv6 addresses on your dedicated servers using [this guide](https://support.us.ovhcloud.com/hc/en-us/articles/4412804434195).
...
Learn how to configure Additional IP addresses in a vRack with our guides for [IPv4](https://support.us.ovhcloud.com/hc/en-us/articles/4403594838803) and [IPv6](https://support.us.ovhcloud.com/hc/en-us/articles/31163475160211).
...
**NOTE:** Be careful – the server will no longer be accessible if you enter incorrect information. You will then have to make the corrections in [Winrescue mode](https://support.us.ovhcloud.com/hc/en-us/articles/115001754490) or via the [IPMI](https://support.us.ovhcloud.com/hc/en-us/articles/360007816120).
...
[Configuring a network bridge](https://support.us.ovhcloud.com/hc/en-us/articles/19833829144083)
