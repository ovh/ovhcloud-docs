...
![WHM\_controlPanel.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471861187603.png)
...
![WHM\_addIP.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877851155.png)
...
![WHM\_IPfunctions.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471861197971.png)
...
![windows\_console\_ipConfig\_output.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877855891.png)
...
![windows\_IPv4\_properties.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877859347.png)

In the `IP Address` section, click `Add`:

![windows\_advancedTCP-IPsettings.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471861203475.png)

Type in your Additional IP and the subnet mask **255.255.255.255**. Then click on `Add`

![windows\_addTCP-IPaddress.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471861204499.png)
...
![windows\_console\_ipConfig\_output-2.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877863955.png)
...
![plesk\_controlPanel.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877868947.png)
...
![plesk\_IPaddresses.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471861216403.png)

Enter your Additional IP in the form `xxx.xxx.xxx.xxx/32` into the field "IP address and subnet mask", then click on `OK`.

![plesk\_addIPaddress.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877873427.png)
...
![plesk\_verifyIPadded.png](/images/bare-metal-cloud/dedicated-servers/configuring-ip-aliasing/45471877874323.png)
