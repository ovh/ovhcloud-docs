...
zendesk_id: 4403594838803
zendesk_hash: 7b803c975ba17b9c
content_hash: b1863f9a4b562872
updated: 2026-05-29
---
...
vRack supports both IPv4 and IPv6 public routing with Additional IP address blocks. You can find the instructions on how to configure IPv6 blocks in our [Configuring an Additional IPv6 block in a vRack](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack) guide.
...
![Configure IP on vRack](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack.png)
...
![Configure IP on vRack - step 2](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-02.png)

Then, check the properties:

![Configure IP on vRack - step 3](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-03.png)

![Configure IP on vRack - step 4](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-04.png)
...
![Configure IP on vRack - step 5](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-05.png)

Define the IP information:

![Configure IP on vRack - step 6](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-06.png)
...
![Configure IP on vRack - step 7](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-07.png)

Then, enable the interface:

![Configure IP on vRack - step 8](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/configure-ip-on-vrack-08.png)
