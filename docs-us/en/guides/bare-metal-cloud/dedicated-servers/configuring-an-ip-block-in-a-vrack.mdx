...
![configureIPonVRack.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600111321875.png)
...
![configureIPonVRack02\*.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123606419.png)

Then, check the properties:

![configureIPonVRack03\*.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123609619.png)

![configureIPonVRack04\*.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123618707.png)
...
![configureIPonVRack05.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123633171.png)

Define the IP information:

![configureIPonVRack06.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123637395.png)
...
![configureIPonVRack07\*.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600111344659.png)

Then, enable the interface:

![configureIPonVRack08\*.png](/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/40600123653011.png)
