...
- Please refer to the following guides instead:
  ...
  - [Configuring the network on Proxmox VE on the High Grade, Scale, and Advance ranges](/guides/bare-metal-cloud/dedicated-servers/configuring-network-proxmox-ve-high-grade-scale-advance-ranges)
  - [Configuring the Network on Windows Server with Hyper-V on the HG & Scale Ranges](/guides/bare-metal-cloud/dedicated-servers/configuring-network-windows-server-hyper-v-hg-scale-ranges) 
  - [Configuring the Network on Windows Server with Hyper-V on the Advance Range](/guides/bare-metal-cloud/dedicated-servers/configuring-network-windows-server-hyper-v-advance-gen-3-serv)
...
Please follow the instructions in our [Assigning a Virtual MAC to an Additional IP](/guides/bare-metal-cloud/dedicated-servers/network-virtual-mac) guide.
...
![Gateway manager - Network bridging](/images/bare-metal-cloud/dedicated-servers/network-bridging/gateway-manager.png)
...
![Network bridge configuration - Network bridging - step 4](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-04.png)

Then, add the vMAC address created previously.

![Network bridge configuration - Network bridging - step 5](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-05.png)
...
**NOTE:** The ESXi hypervisor is no longer supported by OVHcloud. More information can be found on this dedicated page.
...
![Network bridge configuration - Network bridging - step 6](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-06.png)
...
![Network bridge configuration - Network bridging - step 7](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-07.png)
...
![Network bridge configuration - Network bridging - step 8](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-08.jpg)
...
![Network bridge configuration - Network bridging - step 9](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-09.jpg)
...
![Network bridge configuration - Network bridging - step 10](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-10.jpg)
...
![Network bridge configuration - Network bridging - step 11](/images/bare-metal-cloud/dedicated-servers/network-bridging/config-network-bridge-11.jpg)
