...
- Before attempting any firmware update, a backup of the data on the drive must be made. Use our [Getting Started - Backing Up a Bare Metal Server with Veeam Enterprise](/guides/bare-metal-cloud/dedicated-servers/getting-started-backing-up-bare-metal-server-veeam-enterprise) guide to see an option for how to do this.
