...
description: "Learn how to upgrade your NVMe Samsung PM9A1 firmware."
zendesk_id: 22361371147923
zendesk_hash: be42ccc2b959660f
content_hash: 26260291ad59d870
updated: 2024-12-20
---

# Advance Dedicated Servers - Upgrading Your Samsung NVMe PM9A1 Firmware

**Learn how to upgrade your NVMe Samsung PM9A1 firmware.**

Routine firmware updates are pivotal in upholding your NVMe drives' performance, stability, and security. Such updates often encompass critical bug fixes, enhanced compatibility, and advanced security features that are indispensable for preserving your data integrity and maintaining optimal operational efficiency.

Use [this link to view the firmware changelog](https://last-public-ovh-baremetal.snap.mirrors.ovh.net/hardware/PM9A1/PM9A1_FW_Change_Notification_for_General_customer_v2.1_PDF.pdf).

 

## Requirements

- An [Advance Dedicated Server](https://us.ovhcloud.com/bare-metal/advance/) with NVMe Samsung PM9A1, from the following:
...
- Before attempting any firmware update, a backup of the data on the drive must be made. Our [Getting Started - Backing Up a Bare Metal Server with Veeam Enterprise](/guides/bare-metal-cloud/dedicated-servers/getting-started-backing-up-bare-metal-server-veeam-enterprise) guide can guide you through the process of using Object Storage as a backup and recovery solution. 
...
```
wget https://last-public-ovh-baremetal.snap.mirrors.ovh.us/hardware/PM9A1/GXA7802Q_Noformat.bin
```

Execute the following command for each identified drive with firmware different from version **GXA7802Q**:
...
In our previous example, both NVMe drives need a firmware update to the latest version GXA7802Q. Here's how we update the two NVMe drives and the command line returns:
...
In your command, replace `X` with the NVME node listed in [Step 2](#esxi-step2).
...
- Replace `X` with the NVME node listed in [Step 2](#esxi-step2).
...
Here's how we updated the two NVMe drives and the command line returns:
...
```
C:\Users\admin\DownloadsSamsung_SSD_DC_Toolkit_for_Windows_1.exe -L
================================================================================================
...
**NOTE:** This command displays all the disks present in the server. Only the lines `SAMSUNG MZVL2512HCJQ-00B07` have to be checked.
...
In our previous example, both NVMe drives needed a firmware update to the latest version GXA7802Q. Here's how we updated the two NVMe drives and the command line returns:

```
C:\Users\admin\DownloadsSamsung_SSD_DC_Toolkit_for_Windows_1.exe --disk 0:c --nvme-firmware-download --path C:\Users\admin\Downloads\GXA7802Q_Noformat.bin --action 1 --slot 1
================================================================================================
Samsung DC Toolkit Version 2.1.W.Q.0
Copyright (C) 2017 SAMSUNG Electronics Co. Ltd. All rights reserved.
================================================================================================
...
C:\Users\admin\DownloadsSamsung_SSD_DC_Toolkit_for_Windows_1.exe --disk 1:c --nvme-firmware-download --path C:\Users\admin\Downloads\GXA7802Q_Noformat.bin --action 1 --slot 1
================================================================================================
Samsung DC Toolkit Version 2.1.W.Q.0
Copyright (C) 2017 SAMSUNG Electronics Co. Ltd. All rights reserved.
================================================================================================
