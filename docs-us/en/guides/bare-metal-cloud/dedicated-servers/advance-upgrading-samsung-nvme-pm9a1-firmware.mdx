...
- Before attempting any firmware update, a backup of the data on the drive must be made. Our [Getting Started - Backing Up a Bare Metal Server with Veeam Enterprise](https://support.us.ovhcloud.com/hc/en-us/articles/24017627392531) guide can guide you through the process of using Object Storage as a backup and recovery solution. 
