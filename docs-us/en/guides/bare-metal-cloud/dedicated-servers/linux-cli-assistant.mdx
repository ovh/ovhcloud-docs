...
| Item           | Detail                                                                                                                                                                                                                                                                              |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **OS**         | Linux **compatible** with Veeam Agent for Linux (see the [Veeam system requirements](https://helpcenter.veeam.com/docs/agentforlinux/userguide/system_requirements.html?ver=13) and [Backup Agent restrictions](/guides/bare-metal-cloud/dedicated-servers/restrictions)). |
...
![Backup agent download](/images/bare-metal-cloud/dedicated-servers/linux-cli-assistant/backup-agent-download.png)
...
For advanced diagnostics, see our [Backup Agent troubleshooting guide](/guides/bare-metal-cloud/dedicated-servers/troubleshooting).
...
- [Configure your first backup](/guides/bare-metal-cloud/dedicated-servers/first-configuration)
- [Manage your backups and restores](/guides/bare-metal-cloud/dedicated-servers/backup-restore)
- [Troubleshooting guide](/guides/bare-metal-cloud/dedicated-servers/troubleshooting)
