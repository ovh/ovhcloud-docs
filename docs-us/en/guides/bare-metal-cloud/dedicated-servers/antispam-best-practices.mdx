...
![IP alert - Antispam best practices](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/ip-alert.png)

Click on the *more options* `...` next to the corresponding IP/service and select `Anti-spam unblocking`.

![IP blocked - Antispam best practices](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/ip-blocked.png)

In the pop-up windows, click `Unblock the IP` at the bottom and confirm.

![IP unblock - Antispam best practices](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/ip-unblock.png)
...
- configure [Reverses](/guides/network/network-tools/configure-reverse-dns) on all IPs correctly.
...
For more information on the above services, please consult our guide on [How to Optimize the Sending of Emails](/guides/bare-metal-cloud/dedicated-servers/mail-sending-optimization).
