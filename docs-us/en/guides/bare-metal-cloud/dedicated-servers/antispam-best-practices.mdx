...
![IP\_antispam\_alert.PNG](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/47967840770835.png)

Click on the *more options* `...` next to the corresponding IP/service and select `Anti-spam unblocking`.

![IP\_antispam\_blocked.PNG](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/47967840772627.png)

In the pop-up windows, click `Unblock the IP` at the bottom and confirm.

![IP\_antispam\_unblock.png](/images/bare-metal-cloud/dedicated-servers/antispam-best-practices/47967840774547.png)
