...
The only significant difference is that [private networks](/guides/network/ovhcloud-connect/concepts-overview) do not have access to everything that does not belong to your infrastructure.
...
![Diagram netboot schema](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/diagram-netboot-schema.png)
...
- You must have all of the network interfaces for this server in **private** mode, which implies that you have already configured [our OLA feature](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager)
  ...
  ![Network interfaces OLA configured](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/network-interfaces-ol-aconfigured.png)
...
![Diagram infra layer - step 2](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/diagram-infra-layer-2.png)
...
![Uef inetboot preview](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/uef-inetboot-preview.gif)

*Corresponds to the result of steps 8 and 9.*

![Uef inetboot final](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/uef-inetboot-final-step.png)
