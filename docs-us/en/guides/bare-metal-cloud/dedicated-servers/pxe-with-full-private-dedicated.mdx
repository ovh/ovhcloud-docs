...
![diagram\_netbootSchema.png](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/48642506450323.png)
...
- You must have all of the network interfaces for this server in **private** mode, which implies that you have already configured [our OLA feature](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager)
  ...
  ![dedicated\_networkInterfaces\_OLAconfigured.PNG](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/48642481464851.png)
...
![diagram\_privateInfra\_layer2.png](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/48642506456595.png)
...
![dedicated\_UEFInetboot-preview.gif](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/48642506457619.gif)

*Corresponds to the result of steps 8 and 9.*

![dedicated\_UEFInetboot\_finalStep.png](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/48642506461331.png)
