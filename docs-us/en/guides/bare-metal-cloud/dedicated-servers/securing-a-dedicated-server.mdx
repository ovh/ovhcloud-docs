...
If you are configuring your first OVHcloud dedicated server, we recommend consulting our guide on [getting started with a dedicated server](/guides/bare-metal-cloud/dedicated-servers/getting-started-dedicated-server-windows-linux) before continuing.
...
For more information on our backup solutions, please see our [backup with Veeam guide](/guides/bare-metal-cloud/dedicated-servers/getting-started-backing-up-bare-metal-server-veeam-enterprise).
