...
![Diagram anti-DDoS](/images/bare-metal-cloud/dedicated-servers/firewall-network/diagram-anti-ddos.png)
...
![IP server more options](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-server-more-options.png)
...
![IP edge rules](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-edge-rules.png)
...
![IP edge add rule](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-edge-add-rule.png)
...
![IP edge add rule tcp](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-edge-add-rule-tcp.png)
...
![IP edge activate](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-edge-activate.png)
...
![IP edge rules example](/images/bare-metal-cloud/dedicated-servers/firewall-network/ip-edge-rules-example.png)
...
For a detailed insight into detected attacks and the results of scrubbing center activities, we encourage you to explore our [Network Security Dashboard](/guides/bare-metal-cloud/dedicated-servers/network-security-dashboard).
...
## Go further
See our [Protecting a Game Server with the Application Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-game-ddos) guide.
