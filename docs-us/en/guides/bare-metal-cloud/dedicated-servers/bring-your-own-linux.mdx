...
- Access to the [OVHcloud API](/guides/manage-and-operate/api/first-steps) (for the "[Deployment via API](#deploy-your-image-via-the-apis)" section of this guide)
...
See the OVHcloud API and Storage [Common customer errors](/guides/bare-metal-cloud/dedicated-servers/partitioning-ovh#common-customer-errors) for related partitioning issues.
