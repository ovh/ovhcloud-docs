...
To do this, you will need to [reboot](/guides/bare-metal-cloud/dedicated-servers/getting-started-dedicated-server-windows-linux#restarting-your-dedicated-server) your ESXi server via the OVHcloud Control Panel.
...
![ESXi host monitor](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-host-monitor.png)
...
You can enable and use our [Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network) filtering solution. This solution will allow you to manage legitimate access easily, in addition to the access you have set up through your ESXi system.
...
![IP firewall authorize](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/ip-firewall-authorize.png)
...
![ESXi host services](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-host-services.png)
...
![ESXi services tsm SSH](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-services-tsm-ssh.png)

Apply the same settings for the `slpd` service:

![ESXi services slpd](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-services-slpd.png)
...
![ESXi network firewall](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-network-firewall.png)
...
![ESXi firewall allow](/images/bare-metal-cloud/dedicated-servers/manage-secure-esxi-dedicated-server-from-outset/esxi-firewall-allow.png)
