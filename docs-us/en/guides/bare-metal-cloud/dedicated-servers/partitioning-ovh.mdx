...
With [OVHcloud Dedicated Servers](https://us.ovhcloud.com/bare-metal/), you can configure Disks, [hardware RAID](/guides/bare-metal-cloud/dedicated-servers/managing-hardware-raid), Partitions, [software RAID](/guides/bare-metal-cloud/dedicated-servers/configure-rebuild-software-raid), LVM, ZFS, etc., during [OS reinstallation](/guides/bare-metal-cloud/dedicated-servers/getting-started-dedicated-server-windows-linux) from the OVHcloud Control Panel, as well as the [OVHcloud API](https://api.us.ovhcloud.com/), which is the focus of this guide. This will give us more details about the engine that is running in the background in order to create the storage customization on the dedicated server from the input data passed on to the OVHcloud API.
...
On this page, we are focusing only on the `storage` sub-hash of the API call used to reinstall an OS on a dedicated server. For other customizations not related to storage, please read [OVHcloud API & OS installation](/guides/bare-metal-cloud/dedicated-servers/ovhcloud-api-os-installation) for more details.
...
- [software RAID](/guides/bare-metal-cloud/dedicated-servers/configure-rebuild-software-raid) (SR),
...
![DS\_RAID\_APIstorage01.png](/images/bare-metal-cloud/dedicated-servers/partitioning-ovh/42857971112083.png)
...
[OVHcloud API & OS installation](/guides/bare-metal-cloud/dedicated-servers/ovhcloud-api-os-installation)

[Managing software RAID](/guides/bare-metal-cloud/dedicated-servers/configure-rebuild-software-raid)

[Managing hardware RAID](/guides/bare-metal-cloud/dedicated-servers/managing-hardware-raid)
