...
![DS\_serverMan\_customerRescueMode01.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905996564883.png)

You can then see the disks and volumes of the server.

![DS\_serverMan\_customerRescueMode02.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954327187.png)
...
![DS\_serverMan\_customerRescueMode03.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905996570771.png)
...
![DS\_serverMan\_customerRescueMode04.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954335891.png)

Disks are now seen as "Dynamic" and "Foreign".

Right-click *Disk 1* again and select `Import Foreign Disks`.

![DS\_serverMan\_customerRescueMode05.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905996577299.png)

Click `OK` twice.

![DS\_serverMan\_customerRescueMode06a.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954339987.png)

![DS\_serverMan\_customerRescueMode06b.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954349203.png)
...
![DS\_serverMan\_customerRescueMode07.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954354835.png)
...
![DS\_serverMan\_customerRescueMode08.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954357267.png)

Browse to `E:\WINDOWS\SYSTEM32\CONFIG\`.

Select and open the SAM file to display the user accounts by clicking `Open`.

![DS\_serverMan\_customerRescueMode09.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954369683.png)

Select the user account "admin" and click on `Change password`.

![DS\_serverMan\_customerRescueMode10.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/30905954377619.png)
...
![manager\_dedicated\_serviceStatus\_moreOptions.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/41383341998355.png)
...
![DS\_serverMan\_changeAdminPW05.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/45601422013587.png)
...
![DS\_serverMan\_changeAdminPW06.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/45601416886547.png)
...
![DS\_serverMan\_changeAdminPW07.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/45601416891923.png)

Click on `OK` and you will be logged in.

![DS\_serverMan\_changeAdminPW08.png](/images/bare-metal-cloud/dedicated-servers/reset-administrator-password-windows-server/45601416895763.png)
