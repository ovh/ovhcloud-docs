...
zendesk_id: 43778050006419
zendesk_hash: 763f1408c8432d81
content_hash: 45b1a7aeec7df1e0
updated: 2026-06-15
---
...
- [User account management](#user-account-management)
  ...
  - [Creating an unprivileged user account](#creating-an-unprivileged-user-account)
  - [Creating a user account with root privileges](#creating-a-user-account-with-root-privileges)
  - [Executing commands as an administrator ("sudo")](#executing-commands-as-an-administrator-sudo)
  - [Disabling a user account](#disabling-a-user-account)
  - [Enabling a user account](#enabling-a-user-account)
  - [Deleting a user account](#deleting-a-user-account)
  - [Switching user accounts](#switching-user-accounts)
  - [Switching to the "root" account ("root shell")](#switching-to-the-root-account-root-shell)

- [Activating login for the user "root"](#activating-login-for-the-user-root)

  - [Enabling the "root" account](#step-1-enable-the-root-account)
  - [Editing the file "sshd\_config"](#step-2-edit-the-file-sshd_config)
  - [Restarting the SSH service](#step-3-restart-the-ssh-service)
...
This means that the user you are currently logged in with can execute all commands by preceding them with the `sudo` command (`root privileges`). You can find more detailed information in the [corresponding guide section below](#executing-commands-as-an-administrator-sudo).
