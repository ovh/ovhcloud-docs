...
![Bare metal cloud servers](/images/bare-metal-cloud/dedicated-servers/verify-bmc-firmware-version-dedicated-server/bare-metal-cloud-servers.png)
...
![Bare metal cloud servers - step 2](/images/bare-metal-cloud/dedicated-servers/verify-bmc-firmware-version-dedicated-server/bare-metal-cloud-servers-2.png)
