...
**Note:** If you are using a Scale or HG server, please refer to the following guide instead: [How to Configure the Network on Windows Server with Hyper-V with SCALE and HG Servers](/guides/bare-metal-cloud/dedicated-servers/configuring-network-windows-server-hyper-v-hg-scale-ranges)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 1](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-1.png)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 2](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-2.png)

In the popup menu, change the "Type" to "ovh" and enter the name of your virtual machine.

![Hyper-V - Connect VM internet using microsoft hyper v - step 3](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-3.png)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 4](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-4.png)

Select **External** in the Virtual Switch Manager and then click **Create Virtual Switch**.

![Hyper-V - Connect VM internet using microsoft hyper v - step 5](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-5.png)

Select the external network that we found at the beginning of this section and click **OK**.

![Hyper-V - Connect VM internet using microsoft hyper v - step 6](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-6.png)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 7](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-7.png)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 8](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-8.png)
...
- - 2\. Next to "addresses", replace "192.0.2.1" with the additional IP to which you have added the vMAC in the OVHcloud Manager plus the subnet you wish to use in CIDR notation.
  - 3\. Next to "gateway4" and in the "routes" section, replace the "203.0.113.254" with the IPv4 Gateway of your server, found in the OVHcloud Control Panel. (See more [here](/guides/bare-metal-cloud/dedicated-servers/network-bridging#via-the-ovhcloud-control-panel).)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 9](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-9.jpg)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 10](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-10.jpg)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 11](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-11.jpg)
...
![Hyper-V - Connect VM internet using microsoft hyper v - step 12](/images/bare-metal-cloud/dedicated-servers/connect-vm-internet-using-microsoft-hyper-v/hyperv-12.png)
...
- - 1\. Next to "IP address", replace "203.0.113.32" with the additional IP to which you have added the vMAC in the OVHcloud Manager.
  ...
  - 3\. Next to "Default gateway", replace the "147.135.0.254" with the IPv4 Gateway of your server, found in the OVHcloud Control Panel. (See more [here](/guides/bare-metal-cloud/dedicated-servers/network-bridging#via-the-ovhcloud-control-panel).)
