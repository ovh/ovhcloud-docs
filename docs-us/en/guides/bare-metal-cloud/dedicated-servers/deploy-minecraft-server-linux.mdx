...
![Startscreen - Deploy minecraft server Linux](/images/bare-metal-cloud/dedicated-servers/deploy-minecraft-server-linux/startscreen.png)
...
![Multiplayerscreen - Deploy minecraft server Linux - step 2](/images/bare-metal-cloud/dedicated-servers/deploy-minecraft-server-linux/multiplayerscreen-2.png)
...
![Add server - Deploy minecraft server Linux](/images/bare-metal-cloud/dedicated-servers/deploy-minecraft-server-linux/addserver.png)
