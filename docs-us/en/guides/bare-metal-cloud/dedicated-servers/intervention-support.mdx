...
![Troubleshooting finalize maintenance - step 0](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-00.png)
...
![Troubleshooting finalize maintenance - step 1](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-01.png)
...
1\. Log in as an administrator from the [IPMI/KVM](/guides/bare-metal-cloud/dedicated-servers/use-ipmi-console) interface.\
2\. Open the `Run` utility (Windows logo key + `R`), and through the `run` prompt, run the `devmgmt.msc` command:

![Troubleshooting finalize maintenance - step 2](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-02.png)
...
![Troubleshooting finalize maintenance - step 3](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-03.png)
...
![Troubleshooting finalize maintenance - step 4](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-04.png)

4\. Then click `Load Hive...`.

![Troubleshooting finalize maintenance - step 5](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-05.png)
...
![Troubleshooting finalize maintenance - step 6](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-06.png)
...
![Troubleshooting finalize maintenance - step 7](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-07.png)
...
![Troubleshooting finalize maintenance - step 8](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-08.gif)
...
![Troubleshooting finalize maintenance - step 9](/images/bare-metal-cloud/dedicated-servers/intervention-support/troubleshooting-finalize-maintenance-09.gif)
