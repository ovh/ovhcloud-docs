...
![ESXi configuration](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-01-x.png)
...
![ESXi configuration - step 2](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-02.png)

At the bottom of this screen, look at the list of Network Interfaces, focusing on the **Type** and **MAC Address** columns.

![ESXi configuration - step 3](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-03.png)
...
![ESXi configuration - step 4](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-04.png)
...
![ESXi configuration - step 5](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-05.png)
...
1. Create the aggregate in LACP mode on the vSwitch that carries the public interfaces.
   ...
   ![ESXi configuration - step 6](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-06.png)
   ...
   ![ESXi configuration - step 7](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-07.png)
...
2. Create vSwitch and vRack aggregation on private interfaces.
   ...
   ![ESXi configuration - step 8](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-08.png)
...
4. Create VMKernal NIC with the following settings:
   ...
   ![Create VM kernal nic](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/create-vm-kernal-nic.png)
...
5. Open the settings for your vRack vSwitch. In the **NIC teaming** section, change the **Load balancing** setting to `Route based on IP hash`.
   ...
   ![vRack vSwitch](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/v-rackv-switch.png)
...
6. Configure the VM.
   ...
   ![Configuring network VMware ESXi scale hg servers - step 4](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/esxibridge-4.png)

   From the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/#/hub), click `Network` and `vRack private network`.

   ![ESXi configuration - step 9](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-09.png)

   Move your IP range to your vRack.

   ![ESXi configuration - step 10](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-10.png)

   Once completed, it should look like this.

   ![ESXi configuration - step 11](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/config-esxi-11.png)
...
You can learn more about configuring an Additional IP in a vRack in our [dedicated guide](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
