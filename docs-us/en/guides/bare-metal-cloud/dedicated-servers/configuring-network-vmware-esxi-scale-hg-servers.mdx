...
![configESXiScaleHG01x.PNG](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17350705964179.png)
...
![configESXiScaleHG02.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17350545743891.png)

At the bottom of this screen, look at the list of Network Interfaces, focusing on the **Type** and **MAC Address** columns.

![configESXiScaleHG03.PNG](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17350481915795.png)
...
![configESXiScaleHG04.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17350545758611.png)
...
![configESXiScaleHG05.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17351235700627.png)
...
1. Create the aggregate in LACP mode on the vSwitch that carries the public interfaces.
   ...
   ![configESXiScaleHG06.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17352110961683.png)
   ...
   ![configESXiScaleHG07.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17353908563731.png)
...
2. Create vSwitch and vRack aggregation on private interfaces.
   ...
   ![configESXiScaleHG08.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17354679154835.png)
...
4. Create VMKernal NIC with the following settings:
   ...
   ![](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/49428577913619.png)
...
5. Open the settings for your vRack vSwitch. In the **NIC teaming** section, change the **Load balancing** setting to `Route based on IP hash`.
   ...
   ![](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/49428584825363.png)
...
6. Configure the VM.
   ...
   ![esxibridge4.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/4408548831763.png)

   From the [OVHcloud Control Panel](https://us.ovhcloud.com/manager/#/hub), click `Network` and `vRack private network`.

   ![configESXiScaleHG09.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17378923984531.png)

   Move your IP range to your vRack.

   ![configESXiScaleHG10.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17379040865811.png)

   Once completed, it should look like this.

   ![configESXiScaleHG11.png](/images/bare-metal-cloud/dedicated-servers/configuring-network-vmware-esxi-scale-hg-servers/17379001976723.png)
