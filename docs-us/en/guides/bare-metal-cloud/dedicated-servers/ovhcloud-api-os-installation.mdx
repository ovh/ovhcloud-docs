...
**Learn about fully automating OS installation or reinstallation on a [dedicated server](https://us.ovhcloud.com/bare-metal/) with the [OVHcloud API](/guides/manage-and-operate/api/first-steps).**
...
1 Customers that don't use images from the OVHcloud catalog (installation from a custom image ([BYOI](/guides/bare-metal-cloud/dedicated-servers/bring-your-own-image)/[BYOLinux](/guides/bare-metal-cloud/dedicated-servers/bring-your-own-linux)), installation over the network, or manually via IPMI) are not affected by this limitation.

2 For more details, see [partitioning customization](/guides/bare-metal-cloud/dedicated-servers/partitioning-ovh).
...
`storage` contains customization related to disks and hardware RAID, partitions, software RAID, LVM, ZFS, etc. See [OVHcloud API and Storage](/guides/bare-metal-cloud/dedicated-servers/partitioning-ovh) for more details.
