...
![Add port group](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/add-port-group.png)
...
![VM details - Deploy VLANs VMware ESXi](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/vm-details.png)
...
![VM settings add vRack network](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/vm-settings-add-vrack-network.png)
...
![Ethernet - Deploy VLANs VMware ESXi - step 1](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/ethernet-1.jpg)

Now right-click the second Ethernet adapter and select `Properties` from the drop-down menu.

![Ethernet 1 - Deploy VLANs VMware ESXi - step 2](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/ethernet-1-2.jpg)

Double-click the `Internet Protocol Version 4 (TCP/IPv4)` button.

![IPv4 - Deploy VLANs VMware ESXi - step 2](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/ipv-4-2.jpg)
...
![IPv - Deploy VLANs VMware ESXi - step 4](/images/bare-metal-cloud/dedicated-servers/deploy-vlans-vmware-esxi/ipv-4.jpg)
