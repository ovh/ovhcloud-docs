...
- At least two [dedicated servers](https://us.ovhcloud.com/bare-metal/) with [ESXi installed](/guides/bare-metal-cloud/dedicated-servers/esxi-partitioning) (hardware requirements are in the [Broadcom documentation](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/esx-upgrade/upgrading-esxi-hosts-upgrade/esxi-requirements-upgrade/esxi-hardware-requirements-upgrade.html)) in a [vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server).
...
![Networking add switch](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/networking-add-switch.png)
...
![Networking add port group](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/networking-add-port-group.png)
...
![VM port group manual](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/vm-port-group-manual.png)
...
![Ethernet - Use VLANs multiple VMware ESXi hosts - step 1](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/ethernet-1.jpg)

Now right-click the second Ethernet adapter and select `Properties` from the drop-down menu.

![Ethernet 1 - Use VLANs multiple VMware ESXi hosts - step 2](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/ethernet-1-2.jpg)

Double-click the `Internet Protocol Version 4 (TCP/IPv4)` button.

![IPv4 - Use VLANs multiple VMware ESXi hosts - step 2](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/ipv-4-2.jpg)
...
![IPv - Use VLANs multiple VMware ESXi hosts - step 4](/images/bare-metal-cloud/dedicated-servers/use-vlans-multiple-vmware-esxi-hosts/ipv-4.jpg)
