...
![Dedicated panel - Network ipv6 - step 2](/images/bare-metal-cloud/dedicated-servers/network-ipv6/dedicated-panel-2.png)
...
If you are not able to ping this IPv6 address, check your configuration and try again. Also ensure that the machine you are testing from is connected with IPv6. If it still does not work, please test your configuration in [Rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
...
Find more information in [this guide](/guides/bare-metal-cloud/dedicated-servers/getting-started-dedicated-server-windows-linux).
...
![Windows sharingpng - Network ipv6](/images/bare-metal-cloud/dedicated-servers/network-ipv6/windows-sharingpng.png)

Click `Change adapter settings`.

![Windows change adapter settings](/images/bare-metal-cloud/dedicated-servers/network-ipv6/windows-change-adapter-settings.png)

Right-click your network adapter, then click `Properties`.

![Windows adapter - Network ipv6](/images/bare-metal-cloud/dedicated-servers/network-ipv6/windows-adapter.png)

Select `Internet Protocol Version 6`, then click `Properties`.

![Windows adapter properties](/images/bare-metal-cloud/dedicated-servers/network-ipv6/windows-adapter-properties.png)
...
![Windows edit IP vproperties](/images/bare-metal-cloud/dedicated-servers/network-ipv6/windows-edit-ip-vproperties.png)
...
In any case, feel free to [contact our support team](/guides/account/account-information/contact-us-support) and ask to review your configurations. You will need to provide:
