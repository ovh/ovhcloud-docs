...
![dedicated\_networkPanel-2.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444993391507.png)
...
![windows\_networkAndSharingpng.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444985782675.png)

Click `Change adapter settings`.

![windows\_changeAdapterSettings.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444993398035.png)

Right-click your network adapter, then click `Properties`.

![windows\_adapter.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444985790739.png)

Select `Internet Protocol Version 6`, then click `Properties`.

![windows\_adapterProperties.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444993410451.png)
...
![windows\_editIPVproperties.png](/images/bare-metal-cloud/dedicated-servers/network-ipv6/45444985794963.png)
