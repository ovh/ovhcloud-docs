...
description: "Learn some general tips for securing a GNU/Linux-based server."
zendesk_id: 4416199959955
zendesk_hash: 181f9738758f007b
content_hash: 02718dcddf574ebd
updated: 2026-06-15
---

# How to secure a dedicated server

**Learn some general tips for securing a GNU/Linux-based server.**

When you order your dedicated server, you can choose a distribution or operating system to pre-install. The server is therefore ready to use after delivery, but it will be up to you as the administrator to implement measures that ensure the security and stability of your system.
...
If you are configuring your first OVHcloud dedicated server, we recommend consulting our guide on [getting started with a dedicated server](https://support.us.ovhcloud.com/hc/en-us/articles/19309916819987) before continuing.

:::

The following examples presume that you are logged in as a [user with elevated permissions](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419).
...
One of the first things to do on your server is to configure the SSH service's listening port. It is set to **port 22** by default; therefore, server hacking attempts by robots will target this port. Modifying this setting by using a different port is a simple measure to harden your server against automated attacks.
...
<details>
<summary>For Ubuntu 23.04 and later</summary>
...
Remember that you will have to indicate the new port any time you [establish an SSH connection to your server](https://support.us.ovhcloud.com/hc/en-us/articles/360000416484):
...
**NOTE:** Please note that changing the default port for SSH or any other protocol is a potential risk. You may find that some services cannot be configured with non-standard ports and will not work if the default port is changed.
...
In general, tasks that do not require root privileges should be performed via a standard user. Please refer to the information in [this guide](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419) for details.
...
You can learn more about iptables in our [Firewall guide](https://support.us.ovhcloud.com/hc/en-us/articles/48860288669587).
...
Restart the service to make sure it runs with the customizations applied:
...
For more information on our backup solutions, please see our [backup with Veeam guide](https://support.us.ovhcloud.com/hc/en-us/articles/24017627392531).

 

## Go further

[Configuring the firewall on Windows](https://support.us.ovhcloud.com/hc/en-us/articles/19832173395603)
