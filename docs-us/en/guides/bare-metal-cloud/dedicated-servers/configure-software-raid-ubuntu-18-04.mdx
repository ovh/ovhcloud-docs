...
- [How to Install an OS with IPMI](/guides/bare-metal-cloud/dedicated-servers/use-ipmi-console)
...
![Manual - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/manual.png)

From this new page, we are able to see all of our hard disks and begin creating our partition tables.

![Disks - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/disks.png)
...
![Partition created - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/partition-created.png)
...
![Efi partition - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/efi-partition.png)
...
![Efi system done](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/efi-system-done.png)
...
![Swap partition - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-partition.png)
...
![Max - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/max.png)
...
![Root partition - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/root-partition.png)

When configured correctly, your first disk should look like SCSI1.

![Disk - Configure software RAID ubuntu 18 04 - step 1](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/disk-1.png)
...
![RAID - Configure software ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid.png)
...
![Create md - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/create-md.png)
...
**![RAID 1 md](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-1-md.png)**
...
![RAID 1 disks](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-1-disks.png)
...
![Swap selected - Configure software RAID ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-selected.png)
...
![RAID 5 selections](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-5-selections.png)
...
![Swap RAID - Configure software ubuntu 18 04](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-raid.png)

On the new page, highlight the **Use as:  do not use** option and select it. Partition the disk as **swap area**.

![Swap RAID partition](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-raid-partition.png)
...
![RAID 5 array selection](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-5-array-selection.png)
...
![RAID 5 complete](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-5-complete.png)
...
![RAID 5 done](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid-5-done.png)
