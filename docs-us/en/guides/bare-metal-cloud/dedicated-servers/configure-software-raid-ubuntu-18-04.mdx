...
![manual.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/manual-png.png)

From this new page, we are able to see all of our hard disks and begin creating our partition tables.

![disks.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/disks-png.png)
...
![partition\_created.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/partition-created-png.png)
...
![EFI\_partition.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/efi-partition-png.png)
...
![EFI\_system\_done.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/efi-system-done-png.png)
...
![swap\_partition.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-partition-png.png)
...
![max.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/max-png.png)
...
![root\_partition.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/root-partition-png.png)

When configured correctly, your first disk should look like SCSI1.

![disk\_1.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/disk-1-png.png)
...
![configure\_RAID.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/configure-raid-png.png)
...
![create\_MD.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/create-md-png.png)
...
**![raid1\_MD.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid1-md-png.png)**
...
![raid1\_disks.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid1-disks-png.png)
...
![swap\_selected.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-selected-png.png)
...
![raid5\_selections.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid5-selections-png.png)
...
![swap\_raid.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-raid-png.png)

On the new page, highlight the **Use as:  do not use** option and select it. Partition the disk as **swap area**.

![swap\_raid\_partition.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/swap-raid-partition-png.png)
...
![raid5\_array\_selection.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid5-array-selection-png.png)
...
![raid5\_complete.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid5-complete-png.png)
...
![raid5\_done.png](/images/bare-metal-cloud/dedicated-servers/configure-software-raid-ubuntu-18-04/raid5-done-png.png)
