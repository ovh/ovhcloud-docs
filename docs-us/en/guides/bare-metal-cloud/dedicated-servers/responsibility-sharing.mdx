---
title: "Dedicated Servers - Responsibility sharing"
description: "The RACI below details shared responsibilities between OVHcloud and the customer for Dedicated Servers services. This shared model can help relieve the customer"
zendesk_id: 30125467665683
zendesk_hash: c732e338b753bd1e
content_hash: 221c7fd28dbaead5
updated: 2025-08-04
---

# Dedicated Servers - Responsibility sharing
...
| Install and configure the internal functional building blocks to the dedicated server that are required to keep it in operational and secure condition (firmware, BIOS, BMC, IPMI, etc.). |              | RA           |
| Buy and hold licenses and usage rights for the OS used                                                                                                                                    | RA           |              |
...
| **Activity**                                                              | **Customer** | **OVHcloud** |
| ------------------------------------------------------------------------- | ------------ | ------------ |
| Transfer your data (OS, software, backups, etc.) according to your choice | RA           |              |
...
| **Activity**                                                                 | **Customer** | **OVHcloud** |
| ---------------------------------------------------------------------------- | ------------ | ------------ |
| Create, modify, control, restore, and delete backup jobs                     | RA           |              |
...
| **Activity**                                                                                                                                                                                     | **Customer** | **OVHcloud** |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ | ------------ |
| Ensure that automatic network management systems work (architecture, implementation, software and hardware maintenance for deployed public and private networks, primary IP of dedicated server) | I            | RA           |
...
| Create support tickets in the event of hardware and network issues and provide valid contact information for account | RA           | I            |
| Handle hardware and network incidents                                                                                | I            | RA           |
...
| Destroy storage media that has reached its end of life or when the secure destruction processes are generating errors |              | RA           |
