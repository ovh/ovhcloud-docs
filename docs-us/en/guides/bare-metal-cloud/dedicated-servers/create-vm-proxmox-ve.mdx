...
![Local - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/local.png)

Next, under the "Content" section, click the **Upload&#xA0;**&#x62;utton at the top of the screen.

![Upload - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/upload.png)
...
![Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/vm.png)

This will bring up the following pop-up window.

![General - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/general.png)
...
![Os - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/os.png)
...
![Hard disk - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/hard-disk.png)
...
![CPU - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/cpu.png)

Once you have set your CPU settings, click **Next**. On the **Memory** tab, select how much RAM you wish to allocate to your VM.

![Memory - Create VM Proxmox ve](/images/bare-metal-cloud/dedicated-servers/create-vm-proxmox-ve/memory.png)

Click **Next** to advance to the **Network** tab. For networking information, please check out our [How to Connect a VM to the Internet Using Proxmox VE](/guides/bare-metal-cloud/dedicated-servers/connecting-vm-internet-using-proxmox-ve) article. Once you reach the **Confirm** tab, ensure the information is correct and then click **Finish**. Your VM will be created []()with the parameters you have chosen.
