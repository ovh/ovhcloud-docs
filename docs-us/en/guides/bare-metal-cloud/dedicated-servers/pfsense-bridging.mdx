...
![IP\_additional-IP\_moreOptions\_addVMAC.PNG](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/50979731672979.png)

Select `ovh` from the **Type** dropdown box, type a name in the **Virtual machine name** field, and then `Confirm` your options.

![IP\_addVMAC\_ovh.PNG](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/50979747396115.png)
...
![pfsense4.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321175922067.png)

![pfsense5.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321186949523.png)
...
![pfsense6.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321197859347.png)

If your CPU has the AES instruction set, it must be enabled (from the `CPU` tab).

![pfsense7.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202688147.png)
...
![pfsense8.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321142842899.png)
...
![pfsense9.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321197916947.png)

![pfsense10.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321187024915.png)
...
![pfsense11.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321142883987.png)
...
![pfsense12.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202802835.png)
...
![pfsense13.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321142910227.png)
...
![pfsense14.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202831507.png)
...
![pfsense15.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202837779.png)

![pfsense16.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202846867.png)
...
![pfsense17.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321176159251.png)

Now we enable the network, if it was already enabled, simply disable then enable it again.

![pfsense18.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321202937107.png)
...
![pfsense19.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321179351443.png)

![pfsense20.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198156179.png)
...
![pfsense21.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321187232275.png)
...
![pfsense22.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321176256659.png)

Make sure the settings match what is shown in the screenshots below, and enter your `Additional IP`.

![pfsense23.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321203027731.png)

The IPv4 Upstream gateway will be configured later.

![pfsense24.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198219539.png)
...
![pfsense25.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321176306451.png)

Make sure the settings match what is shown in the screenshots below, then select the `Add` icon to create our gateway.

![pfsense26.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321203122195.png)

![pfsense27.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321203121043.png)

Make sure the settings match what is shown in the screenshots below and enter your `Gateway IP`.

![pfsense28.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198349331.png)

Make sure to open the advanced settings.

![pfsense29.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321203193363.png)

Select the `Use non-local gateway through interface specific route` box and `Save` your settings.

![pfsense30.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198378515.png)

Select your default gateway and `Save` your settings.

![pfsense31.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321187463571.png)
...
![pfsense32.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321203251091.png)

![pfsense33.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321176462611.png)
...
![pfsense34.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321187538835.png)
...
![pfsense35.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198497811.png)

![pfsense36.png](/images/bare-metal-cloud/dedicated-servers/pfsense-bridging/6321198555283.png)
