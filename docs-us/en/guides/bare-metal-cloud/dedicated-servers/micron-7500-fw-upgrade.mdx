...
description: "Learn how to upgrade your Micron 7500 PRO PCIe 4.0 NVMe firmware."
zendesk_id: 46404206561171
zendesk_hash: b92a4bcb173ff5b2
content_hash: 3cc84dc80ae6ac83
updated: 2025-11-10
---
...
**Learn how to upgrade your Micron 7500 PRO PCIe 4.0 NVMe firmware.**
...
- Before attempting any firmware update, a backup of the data on the drive **must** be made. Our [Getting Started - Backing Up a Bare Metal Server with Veeam Enterprise](/guides/bare-metal-cloud/dedicated-servers/getting-started-backing-up-bare-metal-server-veeam-enterprise) guide can walk you through using Object Storage as a backup and recovery solution.
...
Choose the tab that corresponds to your environment.
...
| Rocky 9 OS      | 2.11‑6.el9\_6           | E3MQ005  | OK     |
| Rocky 10 OS     | 2.11‑6.el10\_0          | E3MQ005  | OK     |
...
[https://last-public-ovh-baremetal.snap.mirrors.ovh.net/hardware/7500\_PRO/msecli-windows.exe](https://last-public-ovh-baremetal.snap.mirrors.ovh.net/hardware/7500_PRO/msecli-windows.exe)
...
Execute the following command for each identified NVMe in step 2. (Replace `X` with the "OS Device" index listed in step 2.)
...
In our previous example, both NVMe drives need a firmware update to the latest version **E3MQ005**. Here are example commands for how to update the two NVMe drives and their output:
