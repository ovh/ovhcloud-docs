...
![Diagram anti-DDoS](/images/bare-metal-cloud/dedicated-servers/firewall-game-ddos/diagram-anti-ddos.png)
...
**NOTE:** Game DDoS protection takes effect after rules are defined in the [Edge Network firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network). For both to work properly, the Edge Network protection cannot be too strict and needs to pass traffic to the GAME DDoS protection.
...
If you host a bigger service with one of the supported games but still observe false positives from the Anti-DDoS Infrastructure systems, please reach out to our [support team](/guides/account/account-information/contact-us-support) with all the details to tune up the application profile.
...
![IP protocol list](/images/bare-metal-cloud/dedicated-servers/firewall-game-ddos/ip-protocol-list.png)
...
You will need to share relevant network traffic dumps as examples for such attacks (*.pcap* file) to request protection tuning of your profile. This can be done by contacting our [support team](/guides/account/account-information/contact-us-support).
