...
description: "In particular, this guide explains how to:"
zendesk_id: 47239835019923
zendesk_hash: af0fea5c085e84e9
content_hash: 2243f99154082346
updated: 2025-12-09
---
...
- An offer compatible with our [Network Firewall](https://support.us.ovhcloud.com/hc/en-us/articles/115001729044) feature, if you would like to use it for filtering
...
If this system triggers and you want to log into your ESXi immediately, you will need to unlock the administrator account manually.

To do this, you will need to [reboot](https://support.us.ovhcloud.com/hc/en-us/articles/19309916819987#restarting-your-dedicated-server) your ESXi server via the OVHcloud Control Panel.
...
![ESXi\_host\_monitor.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241106227987.png)
...
You can enable and use our [Network Firewall](https://support.us.ovhcloud.com/hc/en-us/articles/115001729044) filtering solution. This solution will allow you to manage legitimate access easily, in addition to the access you have set up through your ESXi system.
...
![IP\_firewall\_authorizeAdmin.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241129265683.png)
...
**NOTE:** We strongly advise disabling **SSH** and **SLP** services. If you still use the SSH service, restrict its use and access as much as possible. This also applies to **shell** access. Prioritise only what is strictly necessary for each of your needs.
...
![ESXi\_host\_manage\_services.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241106233235.png)
...
![ESXi\_services\_tsm-ssh.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241129269011.png)

Apply the same settings for the `slpd` service:

![ESXi\_services\_slpd.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241106240915.png)
...
![ESXi\_network\_firewallRules.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241129272467.png)
...
![ESXi\_firewall\_allowIP.png](/images/bare-metal-cloud/dedicated-servers/manage-and-secure-your-esxi-dedicated-server-from-the-outset/47241106244243.png)
...
Authorize only the legitimate IP address 192.168.1.10:
...
**NOTE:** Authentication works with a key pair: one public and one private. Do not share your **private** key, it must remain on the machine where it was generated.
...
You can find even more details on security best practices in [this VMware suggested guide](https://www.vmware.com/resources/resource-center?term\[]=security%20configuration).
