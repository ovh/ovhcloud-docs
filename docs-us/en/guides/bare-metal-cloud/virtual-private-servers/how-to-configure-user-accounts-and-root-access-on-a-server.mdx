...
description: "With the delivery of an OVHcloud dedicated server or a VPS, you will gain \"root access\" to your service. In basic terms, this means that you are the system's ad"
zendesk_id: 43781783708435
zendesk_hash: 7a8abde5af84dbff
content_hash: a117fec8a3d9f684
updated: 2026-06-15
---
...
The following examples presume that you are connected to your server via SSH.\
For more detailed instructions on this topic, please refer to our [How to get started with SSH connections](https://support.us.ovhcloud.com/hc/en-us/articles/360000416484) guide.
...
- [User account management](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#user-account-management)

  - [Creating an unprivileged user account](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#creating-an-unprivileged-user-account)
  - [Creating a user account with root privileges](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#creating-a-user-account-with-root-privileges)
  - [Executing commands as an administrator ("sudo")](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#executing-commands-as-an-administrator-sudo)
  - [Disabling a user account](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#disabling-a-user-account)
  - [Enabling a user account](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#enabling-a-user-account)
  - [Deleting a user account](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#deleting-a-user-account)
  - [Switching user accounts](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#switching-user-accounts)
  - [Switching to the "root" account ("root shell")](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#switching-to-the-root-account-root-shell)

- [Activating login for the user "root"](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#activating-login-for-the-user-root)

  - [Enabling the "root" account](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#step-1-enable-the-root-account)
  - [Editing the file "sshd\_config"](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#step-2-edit-the-file-sshd_config)
  - [Restarting the SSH service](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#step-3-restart-the-ssh-service)
...
This means that the user you are currently logged in with can execute all commands by preceding them with the `sudo` command (`root privileges`). You can find more detailed information in the [corresponding guide section below](https://support.us.ovhcloud.com/hc/en-us/articles/43778050006419#executing-commands-as-an-administrator-sudo).
...
- [Securing a dedicated server](https://support.us.ovhcloud.com/hc/en-us/articles/4416199959955)
...
#### Step 2: Edit the file "sshd\_config"
