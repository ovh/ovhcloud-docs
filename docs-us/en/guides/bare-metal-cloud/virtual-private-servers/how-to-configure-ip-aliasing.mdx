...
description: "IP aliasing is a special network configuration for your OVHcloud servers that allows you to associate multiple IP addresses with a single network interface."
zendesk_id: 360014248820
zendesk_hash: 0201da9fb474ef06
content_hash: b571a6e64a0c9d7c
updated: 2026-06-15
---
...
IP aliasing is a special network configuration for your OVHcloud servers that allows you to associate multiple IP addresses with a single network interface.
...
- A [Virtual Private Server](https://us.ovhcloud.com/vps/) on your OVHcloud account
- An [Additional IP](https://us.ovhcloud.com/network/additional-ip/) address or an Additional IP block
- Administrative access (sudo) via SSH or GUI to your server
- Basic networking and administration knowledge

:::warning

**NOTE:** Additional IP addresses are currently unavailable for Virtual Private Servers in [Local Zones](https://us.ovhcloud.com/vps/vps-amd/).
...
| ADDITIONAL\_IP     | An Additional IP address assigned to your service                                                        | 203.0.113.0    |
...
Select the tab below that corresponds to your operating system:
...
![Add new IP](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-cpanel-a.png)
...
![enter new IP information](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-cpanel-a.png)
...
![acces to the ip addresses management](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-pleskip1.png)
...
![add ip information](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-20.png)

Enter your Additional IP in the form `xxx.xxx.xxx.xxx/32` into the field "IP address and subnet mask", then click on `OK`.

![add ip information](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-ad.png)
...
![current IP configuration](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-fi.png)
...
![config\_IPalias\_VPS01.png](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/19877485388819.png)
...
1. Go to `Start`> `Control Panel`>`Network and Internet`> `Network and Sharing Center`> `Change Adapter Settings`(in the left-hand menu).
...
![change the ip configuration](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-configur.png)
...
![advance configuration section](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-configur.png)

Confirm by clicking on `Add`.

![Additional IP configuration](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-addition.png)

Once done, click on `OK` to apply the configuration.

![Additional IP configuration](/images/bare-metal-cloud/virtual-private-servers/how-to-configure-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-final-co.png)
...
To test the connection, simply ping your Additional IP from the outside. If it responds in rescue mode, which probably means that there is a configuration error. If, however, the IP is still not working, please inform our support teams by [creating a support request](https://support.us.ovhcloud.com/hc/en-us/articles/115001819764) for further investigations.
