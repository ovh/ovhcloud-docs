...
![Order premium backup](/images/bare-metal-cloud/vps/using-automated-backups/order-premium-backup.png)
...
![Backup tab edit time](/images/bare-metal-cloud/vps/using-automated-backups/backup-tab-edit-time.png)
...
![Backup tab edit time confirm](/images/bare-metal-cloud/vps/using-automated-backups/backup-tab-edit-time-confirm.png)
...
![Backup tab more options](/images/bare-metal-cloud/vps/using-automated-backups/backup-tab-more-options.png)
...
![Backup tab unmount](/images/bare-metal-cloud/vps/using-automated-backups/backup-tab-unmount.png)
...
![Windows disk management](/images/bare-metal-cloud/vps/using-automated-backups/windows-disk-management.png)
...
![Windows VPS backup mounted](/images/bare-metal-cloud/vps/using-automated-backups/windows-vps-backup-mounted.png)

The disk will appear as `Offline`, right-click on the disk and select `Online`.

![Windows VPS backup mounted online](/images/bare-metal-cloud/vps/using-automated-backups/windows-vps-backup-mounted-online.png)

Once done, your mounted backup will be accessible in the `File Explorer`.

![Windows VPS backup mounted file](/images/bare-metal-cloud/vps/using-automated-backups/windows-vps-backup-mounted-file.png)
