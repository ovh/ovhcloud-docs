...
\[primary]This article is about Primary IPv6 configuration on a public interface. You can also configure Additional IP addresses on your VPS using [this guide](/guides/bare-metal-cloud/vps/configuring-ip-aliasing).
...
![Home tab - Configuring ipv6](/images/bare-metal-cloud/vps/configuring-ipv6/home-tab.png)
...
Once you have gathered the necessary information for the IPv6 configuration, log in to your VPS via SSH. If you require assistance, please refer to this guide: [How to get started with SSH connections](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction).
...
![IPv6 - Configuring ipv6 - step 3](/images/bare-metal-cloud/vps/configuring-ipv6/ipv-6-3.png)
...
![IPv6 - Configuring ipv6 - step 4](/images/bare-metal-cloud/vps/configuring-ipv6/ipv-6-4.png)
...
![IPv6 - Configuring ipv6 - step 5](/images/bare-metal-cloud/vps/configuring-ipv6/ipv-6-5.png)
