...
![Dashboard partial - Eos cPanel plesk](/images/bare-metal-cloud/vps/eos-cpanel-plesk/dashboard-partial.png)
...
1. [Back up your data](/guides/bare-metal-cloud/vps/using-automated-backups) (web content, database, emails, etc.).
2. Reinstall a compatible OS from the OVHcloud Control Panel by following the `Reinstalling your VPS` section of our guide [How to get started with a VPS](/guides/bare-metal-cloud/vps/starting-with-a-vps).
...
To find out the end of life and end of support dates for images and operating systems (VPS and Public Cloud), please refer to our [Public Cloud and VPS - Image Lifecycle](/guides/bare-metal-cloud/vps/public-cloud-image-os-lifecycle-end-life-support-announcements) guide.
