...
- [Rescue mode](/guides/bare-metal-cloud/vps/recover-rescue-mode) activated on the VPS (Linux only)
...
If the VPS is not already in rescue mode, activate it by using [our guide](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
...
![Bare metal cloud virtual private servers images file](/images/bare-metal-cloud/vps/upsize-partition/bare-metal-cloud-virtual-private-servers-images-file.png)
...
![Bare metal cloud virtual private servers images](/images/bare-metal-cloud/vps/upsize-partition/bare-metal-cloud-virtual-private-servers-images.png)
