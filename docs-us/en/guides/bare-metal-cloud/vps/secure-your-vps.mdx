...
If you are configuring your first OVHcloud VPS, we recommend consulting our guide on [getting started with a VPS](/guides/bare-metal-cloud/vps/starting-with-a-vps)

first.

:::

The following examples presume that you are logged in as a [user with elevated permissions](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server).
...
- [Tutorial - How to use PuTTY for SSH connections and authentication](/guides/bare-metal-cloud/dedicated-servers/ssh-using-putty-on-windows)
...
If you are locked out of your system, you can use our [rescue mode](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair) environment to revert your changes.

 

### Creating a user with restricted rights

In general, tasks that do not require root privileges should be performed via a standard user. Please refer to the information in [this guide](/guides/bare-metal-cloud/dedicated-servers/configure-user-accounts-root-access-server) for details.
...
[Getting started with a VPS](/guides/bare-metal-cloud/vps/starting-with-a-vps)

[How to create and use SSH keys](/guides/bare-metal-cloud/dedicated-servers/create-use-authentication-keys-ssh-connections-ovhcloud-server)

[Configuring the firewall on Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)

[Configuring the firewall on Linux with iptables](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable)
