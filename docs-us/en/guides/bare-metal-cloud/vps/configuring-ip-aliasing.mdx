...
![Add new IP](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-cpanel-a.png)
...
![enter new IP information](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-cpanel-a.png)
...
![acces to the ip addresses management](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-pleskip1.png)
...
![add ip information](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-20.png)

Enter your Additional IP in the form `xxx.xxx.xxx.xxx/32` into the field "IP address and subnet mask", then click on `OK`.

![add ip information](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-ad.png)
...
![current IP configuration](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-plesk-fi.png)
...
![config\_IPalias\_VPS01.png](/images/bare-metal-cloud/vps/configuring-ip-aliasing/19877485388819.png)
...
![change the ip configuration](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-configur.png)
...
![advance configuration section](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-configur.png)

Confirm by clicking on `Add`.

![Additional IP configuration](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-addition.png)

Once done, click on `OK` to apply the configuration.

![Additional IP configuration](/images/bare-metal-cloud/vps/configuring-ip-aliasing/bare-metal-cloud-virtual-private-servers-configuring-ip-aliasing-images-final-co.png)
