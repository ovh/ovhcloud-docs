...
1. Local settings
   ...
   ![vps\_getting started08\*.png](/images/bare-metal-cloud/vps/starting-with-a-vps/40373954968211.png)

2) Administrator password

   Set a password for your Windows `Administrator` / `admin` account, confirm it, then click on `Finish`.

   ![vps\_getting started09\*.png](/images/bare-metal-cloud/vps/starting-with-a-vps/40373954970003.png)
...
3. Login screen
   ...
   ![vps\_getting started10.png](/images/bare-metal-cloud/vps/starting-with-a-vps/40373985962387.png)

4) Administrator login

   Enter the `Administrator` password you have created in the previous step and click on the `Arrow` button.

   ![vps\_getting started11.png](/images/bare-metal-cloud/vps/starting-with-a-vps/40373954976275.png)
...
![vps\_getting started12.png](/images/bare-metal-cloud/vps/starting-with-a-vps/40373985968659.png)
