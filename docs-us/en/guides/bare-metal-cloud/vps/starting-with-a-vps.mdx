...
To understand the management interface of your VPS and the available actions in the OVHcloud Control Panel, refer to our [guide dedicated to getting started with the OVHcloud Control Panel for VPS](/guides/bare-metal-cloud/vps/understand-control-panel).
...
Find more information about this tool in our [KVM guide](/guides/bare-metal-cloud/vps/using-kvm-for-vps).
...
1. Local settings
   ...
   ![Getting started - Starting with a vps - step 8](/images/bare-metal-cloud/vps/starting-with-a-vps/getting-started-08.png)

2) Administrator password

   Set a password for your Windows `Administrator` / `admin` account, confirm it, then click on `Finish`.

   ![Getting started - Starting with a vps - step 9](/images/bare-metal-cloud/vps/starting-with-a-vps/getting-started-09.png)
...
3. Login screen
   ...
   ![Getting started - Starting with a vps - step 10](/images/bare-metal-cloud/vps/starting-with-a-vps/getting-started-10.png)

4) Administrator login

   Enter the `Administrator` password you have created in the previous step and click on the `Arrow` button.

   ![Getting started - Starting with a vps - step 11](/images/bare-metal-cloud/vps/starting-with-a-vps/getting-started-11.png)
...
![Getting started - Starting with a vps - step 12](/images/bare-metal-cloud/vps/starting-with-a-vps/getting-started-12.png)
...
In the event of problems, you can facilitate troubleshooting by **enabling Windows boot logs**. See our [dedicated guide](/guides/bare-metal-cloud/vps/windows-boot-logs) for more information.
...
If you wish to secure your VPS, we recommend following our guide "[Securing a VPS](/guides/bare-metal-cloud/vps/secure-your-vps)". This guide walks you through the process and details the following actions:
...
- [Enable a free SSL certificate (Let's Encrypt)](/guides/bare-metal-cloud/vps/install-ssl-certificate) to secure access to your websites via HTTPS.
