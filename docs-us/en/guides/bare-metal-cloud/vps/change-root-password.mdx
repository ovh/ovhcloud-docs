...
For more information about connecting to your VPS, please consult the [first steps guide](/guides/bare-metal-cloud/vps/starting-with-a-vps).
...
Log in to your [OVHcloud Control Panel](https://us.ovhcloud.com/manager/) and reboot the VPS in rescue mode. If you need further instructions about activating rescue mode with a VPS, you may consult the [rescue mode guide](/guides/bare-metal-cloud/vps/recover-rescue-mode).
...
\
We recommend taking measures to secure your VPS first. You can refer to our guide on [Securing a VPS](/guides/bare-metal-cloud/vps/secure-your-vps).
...
- Check the KVM for important information as to why the VPS is unable to start. Consult the [KVM guide](/guides/bare-metal-cloud/vps/using-kvm-for-vps) for help using this feature in the OVHcloud Control Panel.
