...
- An [additional disk](/guides/bare-metal-cloud/vps/configuring-additional-disk) configured on the VPS
...
The following steps presume that you have configured an additional disk according to [our guide](/guides/bare-metal-cloud/vps/configuring-additional-disk).
...
![Home your configuration](/images/bare-metal-cloud/vps/increase-additional-disk/home-your-configuration.png)

Choose the new disk size in the pop-up window, then click on `Increase`.

![Disks increase - Additional disk](/images/bare-metal-cloud/vps/increase-additional-disk/disks-increase.png)
...
![Disks order funnel](/images/bare-metal-cloud/vps/increase-additional-disk/disks-order-funnel.png)
...
![Disks more options](/images/bare-metal-cloud/vps/increase-additional-disk/disks-more-options.png)
...
![Increase additional disk - step 5](/images/bare-metal-cloud/virtual-private-servers/increase-additional-disk/increase-additional-disk-05.png)
...
![Increase additional disk - step 6](/images/bare-metal-cloud/virtual-private-servers/increase-additional-disk/increase-additional-disk-06.png)
...
![Increase additional disk - step 7](/images/bare-metal-cloud/virtual-private-servers/increase-additional-disk/increase-additional-disk-07.png)

Click on `Finish` to complete the process.

The resized volume now includes the additional disk space.

![Increase additional disk - step 8](/images/bare-metal-cloud/virtual-private-servers/increase-additional-disk/increase-additional-disk-08.png)
