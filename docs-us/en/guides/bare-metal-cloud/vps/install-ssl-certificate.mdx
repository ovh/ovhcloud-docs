...
1. Download an SSH client like [PuTTY](/guides/bare-metal-cloud/dedicated-servers/ssh-using-putty-on-windows) or use your operating system's built-in terminal.
