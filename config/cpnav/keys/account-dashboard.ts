  ...
  locations: [
    {
      ...
      source: { labels: ['user_account_menu_profile'] },
      text: {
        ...
        it: {
          product: 'Accedere al mio account',
          crumbs: ['Accedere al mio account'],
        },
        pl: { product: 'Dostęp do konta', crumbs: ['Dostęp do konta'] },
        pt: {
          product: 'Aceder à minha conta',
          crumbs: ['Aceder à minha conta'],
        },
      },
    },
  ],
