...
// Manager nav tree: node 'domains-operations' — application 'web-ongoing-operations'
// (publicURL '#/web-ongoing-operations') + hash '#/'. Domain and DNS are two tabs of the
// same screen, so the last step names both and neither is a nav node of its own.
export const webOngoingOperations: CpNavKey = {
  universe: 'web-cloud',
  locations: [
    {
      route: '/#/web-ongoing-operations/',
      source: { node: 'domains-operations' },
      text: {
        en: {
