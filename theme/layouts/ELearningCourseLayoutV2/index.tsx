...
export interface ELearningCourseLayoutV2Props {
...
/**
 * Alternate, tab-less course layout (variant under evaluation).
 *
 * Single page instead of Overview / Curriculum tabs:
 *   - left column: Description, What you will learn, Video
 *   - right column: the full curriculum
 *   - OVHcloud Services spans full width below both columns
 *
 * Reuses the same Header / Overview-section / Curriculum components as the
 * original ELearningCourseLayout, so content + styling stay in sync. The
 * page-feedback widget and DocFooter are intentionally omitted, as on the
 * original course template.
 */
export function ELearningCourseLayoutV2(props: ELearningCourseLayoutV2Props) {
  ...
  return (
    <>
      ...
      <div className="rp-doc-layout__container">
        ...
        <div className="rp-elearning-course-v2__content">
          <main className="rp-elearning-course-v2__main">
            {beforeDocContent}

            <ELearningCourseHeader title={title} meta={meta} cta={cta} />

            <div className="rp-elearning-course-v2__columns">
              <div className="rp-elearning-course-v2__left">
                <CourseDescription
